 ...
 * pre-transformed typedEntities. Falls back to the sibling longterm app's copy.
...
// Path to the local data directory (database.json is generated here)
const LOCAL_DATA_DIR = path.resolve(process.cwd(), "src/data");

// Fallback: path to the repo-root data directory
