...
quality: 48
readerImportance: 5
llmSummary: "Transparently documents that this wiki was created using AI assistance (Claude), explicitly acknowledges biases toward AI safety community perspectives, and provides structured guidance for evaluating claims. Offers unusual meta-level transparency about limitations, embedded assumptions, and coverage gaps, with concrete examples of what's well-covered vs. under-covered."
ratings:
  novelty: 6.5
  rigor: 6
  actionability: 3
  completeness: 7.5
---
import { InfoBox, EntityLink } from '@components/wiki';
...
<InfoBox
  ...
  customFields={[
    ...
    { label: "Last Data Build", value: wikiStats.lastBuildDate },
  ]}
/>
...
This wiki is an experimental project exploring how to structure and communicate AI safety arguments. It was created primarily using Claude Code (<EntityLink id="E22" name="anthropic">Anthropic</EntityLink>'s AI coding assistant) as an experiment in AI-assisted content creation.
...
- Shared vocabulary (TAI, P(doom), alignment, <EntityLink id="E197" name="mesa-optimization">mesa-optimization</EntityLink>)
- Shared heroes (Bostrom, Yudkowsky, Russell, etc.)
- Shared funding sources (<EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>, EA funders)
...
### Sources
- Alignment Forum and <EntityLink id="E538" name="lesswrong">LessWrong</EntityLink> posts
- Academic papers on AI safety
- Public statements from researchers and organizations
- AI safety organization websites
- Forecasting platforms (<EntityLink id="E199" name="metaculus">Metaculus</EntityLink>, <EntityLink id="E512" name="ai-impacts">AI Impacts</EntityLink> surveys)
