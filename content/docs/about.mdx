...
This wiki is an experimental project exploring how to structure and communicate AI safety arguments. It was created primarily using Claude Code (<EntityLink id="anthropic">Anthropic</EntityLink>'s AI coding assistant) as an experiment in AI-assisted content creation.
...
- Shared vocabulary (TAI, P(doom), alignment, <EntityLink id="mesa-optimization">mesa-optimization</EntityLink>)
...
### Sources
- Alignment Forum and <EntityLink id="lesswrong">LessWrong</EntityLink> posts
- Academic papers on AI safety
- Public statements from researchers and organizations
- AI safety organization websites
- Forecasting platforms (<EntityLink id="metaculus">Metaculus</EntityLink>, <EntityLink id="ai-impacts">AI Impacts</EntityLink> surveys)
