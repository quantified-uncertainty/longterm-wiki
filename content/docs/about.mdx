...
This wiki is an experimental project exploring how to structure and communicate AI safety arguments. It was created primarily using Claude Code (<EntityLink id="E22">Anthropic</EntityLink>'s AI coding assistant) as an experiment in AI-assisted content creation.
...
- Shared vocabulary (TAI, P(doom), alignment, <EntityLink id="E197">mesa-optimization</EntityLink>)
- Shared heroes (Bostrom, Yudkowsky, Russell, etc.)
- Shared funding sources (<EntityLink id="E521">Coefficient Giving</EntityLink>, EA funders)
...
### Sources
- Alignment Forum and <EntityLink id="E538">LessWrong</EntityLink> posts
- Academic papers on AI safety
- Public statements from researchers and organizations
- AI safety organization websites
- Forecasting platforms (<EntityLink id="E199">Metaculus</EntityLink>, <EntityLink id="E512">AI Impacts</EntityLink> surveys)
