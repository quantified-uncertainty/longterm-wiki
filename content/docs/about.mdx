...
summary: Transparently documents that this wiki was created using AI assistance (Claude), explicitly acknowledges biases toward AI safety community perspectives, and provides structured guidance for evaluating claims. Offers unusual meta-level transparency about limitations, embedded assumptions, and coverage gaps, with concrete examples of what's well-covered vs. under-covered.
---
