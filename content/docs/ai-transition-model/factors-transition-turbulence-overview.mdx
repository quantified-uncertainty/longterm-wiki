---
numericId: "E668"
title: "Transition Turbulence (Overview)"
readerImportance: 42.3
...
tacticalValue: 35
quality: 39
llmSummary: "This overview page defines 'Transition Turbulence' as a root factor in an AI transition model, cataloging its drivers (rapid capability growth, economic displacement, racing dynamics, coordination failures), manifestations, and effects on existential catastrophe and long-term trajectory. Probability estimates are qualitative and unsourced; interventions listed are generic policy proposals without quantified tradeoffs."
ratings:
  focus: 7.5
  novelty: 2.5
  rigor: 2.5
