...
---
import {Mermaid, DataInfoBox, FactorSubItemsList, PageCauseEffectGraph, Backlinks, EntityLink} from '@components/wiki';

<DataInfoBox entityId="transition-turbulence" />

Transition Turbulence measures how much disruption occurs as society navigates from current AI to whatever future emerges. Unlike <EntityLink id="scenarios-overview">Ultimate Scenarios</EntityLink> (which describe *what* happens), Transition Turbulence describes *how rough the journey is*—and that roughness affects both whether we survive (<EntityLink id="existential-catastrophe">Existential Catastrophe</EntityLink>) and what world we end up in (<EntityLink id="long-term-trajectory">Long-term Trajectory</EntityLink>).
...
|---------------------|--------------|
| <EntityLink id="scenarios-ai-takeover-overview">AI Takeover</EntityLink> | Turbulence increases risk of loss of control |
| <EntityLink id="scenarios-human-catastrophe-overview">Human-Caused Catastrophe</EntityLink> | Turbulence can trigger state failures and desperate actions |
| <EntityLink id="scenarios-long-term-lockin-overview">Long-term Lock-in</EntityLink> | Turbulent periods often lock in emergency measures |
...
### Ultimate Outcomes
- <EntityLink id="existential-catastrophe">Existential Catastrophe</EntityLink> — Turbulence can trigger catastrophes
- <EntityLink id="long-term-trajectory">Long-term Trajectory</EntityLink> — Turbulence shapes achievable futures

### Ultimate Scenarios
- <EntityLink id="scenarios-long-term-lockin-overview">Long-term Lock-in</EntityLink> — Crisis periods often lock in values/power structures
- <EntityLink id="scenarios-ai-takeover-overview">AI Takeover</EntityLink> — Turbulence increases loss of control risk

### Risks
- <EntityLink id="economic-disruption">Economic Disruption</EntityLink>
- <EntityLink id="racing-dynamics">Racing Dynamics</EntityLink>

<PageCauseEffectGraph slug="transition-turbulence" client:load />

<Backlinks entityId="transition-turbulence" />
