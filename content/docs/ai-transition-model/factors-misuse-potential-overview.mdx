...
---
import {Backlinks, DataInfoBox, FactorSubItemsList, FactorRelationshipDiagram, ImpactList, PageCauseEffectGraph, EntityLink} from '@components/wiki';
...
- <EntityLink id="existential-catastrophe">Existential Catastrophe</EntityLink> — The outcome this primarily affects
- <EntityLink id="factors-misalignment-potential-overview">Misalignment Potential</EntityLink> — The complementary factor for AI-caused catastrophe
- <EntityLink id="factors-civilizational-competence-overview">Civilizational Competence</EntityLink> — Governance can moderate misuse through regulation

<PageCauseEffectGraph slug="misuse-potential" client:load />
