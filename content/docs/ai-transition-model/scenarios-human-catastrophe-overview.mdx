...
- **<EntityLink id="E130">Existential Catastrophe</EntityLink>**: Mass casualty events, civilizational collapse
- May trigger **Long-term <EntityLink id="E189">Lock-in</EntityLink>**: Crisis enables authoritarian consolidation
