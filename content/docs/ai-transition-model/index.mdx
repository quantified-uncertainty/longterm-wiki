...
- **Risks** (like <EntityLink id="E93">deceptive alignment</EntityLink>, <EntityLink id="E239">racing dynamics</EntityLink>) tend to *increase* harmful factors or *decrease* protective ones
- **Interventions** (like interpretability research, compute governance) work to counteract risks

**Interactive Views:**
- **<EntityLink id="E675">Parameter Table</EntityLink>** - Sortable tables with ratings (changeability, uncertainty, x-risk impact, trajectory)
...
- "<EntityLink id="E68">Concentration of power</EntityLink> threatens democracy"
