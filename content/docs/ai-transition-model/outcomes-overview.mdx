...
Ultimate Outcomes represent what we fundamentally care about when thinking about AI's impact on humanity. Unlike <EntityLink id="E674">Scenarios</EntityLink> (which describe intermediate scenarios) or parameters (which measure specific factors), Ultimate Outcomes describe the **final states** we're trying to achieve or avoid.
