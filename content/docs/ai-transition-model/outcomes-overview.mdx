---
numericId: "E669"
title: "Ultimate Outcomes (Overview)"
...
Ultimate Outcomes represent what we fundamentally care about when thinking about AI's impact on humanity. Unlike <EntityLink id="scenarios-overview">Scenarios</EntityLink> (which describe intermediate scenarios) or <EntityLink id="ai-transition-model">parameters</EntityLink> (which measure specific factors), Ultimate Outcomes describe the **final states** we're trying to achieve or avoid.
