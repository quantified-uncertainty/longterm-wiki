...
- <EntityLink id="scenarios-overview">Scenarios</EntityLink> — The intermediate scenarios
- <EntityLink id="__index__/ai-transition-model">AI Transition Model</EntityLink> — All parameters
- <EntityLink id="factors-overview">Aggregate Parameters</EntityLink> — How parameters group together
