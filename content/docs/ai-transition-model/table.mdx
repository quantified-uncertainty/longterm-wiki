...
<details className="mb-4 max-w-4xl">
  ...
  <div className="mt-2 pl-4 border-l-2 border-slate-200 text-sm text-slate-600 space-y-1">
    <div><a href="https://www.alignmentforum.org/posts/sGkRDrpphsu6Jhega/a-model-based-approach-to-ai-existential-risk" className="text-sky-600 hover:underline" target="_blank" rel="noopener">Model-based Approach to AI X-risk</a> – <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink>'s framework</div>
