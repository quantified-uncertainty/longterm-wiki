...
<R id="MTkzYTEzZG"><EntityLink id="E148" name="gary-marcus">Gary Marcus</EntityLink>'s Substack</R> (AI skepticism) •
<R id="ZDcyYjlhMz"><EntityLink id="E582" name="yann-lecun">Yann LeCun</EntityLink>'s posts</R> (AGI skepticism) •
<R id="ZjhhN2MxZG"><EntityLink id="E1305" name="timnit-gebru">Timnit Gebru</EntityLink> et al.</R> (AI ethics)
