...
update_frequency: 30
summary: An interactive sortable table comparing 8 deployment architecture patterns including agency level, decomposition, oversight mechanisms, and modularity. Supports grouped/unified views by category.
clusters:
  - ai-safety
---
