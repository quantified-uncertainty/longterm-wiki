...
|--------------|--------|-----------------|---------------|--------|
| <EntityLink id="E218" name="openai">OpenAI</EntityLink> | Sam Altman | 2025-2028 | "We are now confident we know how to build AGI"; 2026 models will "amaze us" | [Sam Altman Blog](https://blog.samaltman.com/the-gentle-singularity) |
| <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> | Dario Amodei | 2026-2027 | "AI may surpass humans in most tasks by 2027"; "rapidly running out of convincing blockers" | [Lex Fridman Interview](https://lexfridman.com/dario-amodei-transcript/) |
| <EntityLink id="E98" name="deepmind">DeepMind</EntityLink> | Demis Hassabis | "Within this decade" (by 2030) | "I'd bet on achieving what you might call AGI within the next few years" | <R id="76ad6e98c47f6ff5">Nature interview 2024</R> |
| <EntityLink id="E98" name="deepmind">DeepMind</EntityLink> | Shane Legg | 50% by 2028 | "Minimal AGI" prediction (January 2026) | DeepMind cofounder |
