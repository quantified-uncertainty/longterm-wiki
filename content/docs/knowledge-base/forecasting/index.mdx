...
### <EntityLink id="E399" name="agi-timeline">AGI Timeline</EntityLink>
...
|--------|-------|--------|--------------|
| <EntityLink id="E199" name="metaculus">Metaculus</EntityLink> | AI milestones | Prediction market | Good calibration |
| <EntityLink id="E125" name="epoch-ai">Epoch AI</EntityLink> | Compute trends | Trend extrapolation | Strong on hardware |
