...
### <EntityLink id="forecasting/agi-development">AGI Development</EntityLink>
...
### <EntityLink id="forecasting/agi-timeline">AGI Timeline</EntityLink>
...
|--------|-------|--------|--------------|
| <EntityLink id="metaculus">Metaculus</EntityLink> | AI milestones | Prediction market | Good calibration |
| <EntityLink id="epoch-ai">Epoch AI</EntityLink> | Compute trends | Trend extrapolation | Strong on hardware |
