...
- **Industry-wide**: <EntityLink id="E461" name="responsible-scaling-policies">Responsible scaling policies</EntityLink>, <EntityLink id="E369" name="voluntary-commitments">voluntary commitments</EntityLink>
