...
### Foundational Texts
- <R id="NWY3YWM3Mz">Superintelligence</R> by <EntityLink id="E215" name="nick-bostrom">Nick Bostrom</EntityLink>
- <R id="Y2VkYzZlNj"><EntityLink id="E439" name="alignment">AI Alignment</EntityLink>: Why It's Hard, and Where to Start</R> by <EntityLink id="E114" name="eliezer-yudkowsky">Eliezer Yudkowsky</EntityLink>
- <R id="OGFlNWM2Yz">What Failure Looks Like</R> by <EntityLink id="E220" name="paul-christiano">Paul Christiano</EntityLink>
- <R id="MDlhOTdmMT">AGI Ruin: A List of Lethalities</R> by Eliezer Yudkowsky

### Technical Arguments
- <R id="M2JlZDZhMj">Concrete Problems in AI Safety</R>
- <R id="ZWM1MWQ0MW">Risks from Learned Optimization</R>
- <R id="NDU5ODk3NT">Is <EntityLink id="E226" name="power-seeking">Power-Seeking AI</EntityLink> an Existential Risk?</R>

### Strategic Analysis
- <R id="ZGNmNTU0OD">Racing Through a Minefield</R>
- <R id="OTFjNWI3Mz">Without specific countermeasures, the easiest path to transformative AI likely leads to AI takeover</R>

### Governance Perspective
- <R id="OWI2ZmNjMG">Pausing AI Development Isn't Enough. We Need to Shut it All Down</R>
