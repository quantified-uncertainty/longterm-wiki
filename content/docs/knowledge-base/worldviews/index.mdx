...
### <EntityLink id="E504" name="doomer">Doomer</EntityLink>
...
- Often associated with: <EntityLink id="E202" name="miri">MIRI</EntityLink>, <EntityLink id="E114" name="eliezer-yudkowsky">Eliezer Yudkowsky</EntityLink>, some AI safety researchers

### <EntityLink id="E505" name="long-timelines">Long Timelines</EntityLink>
...
### <EntityLink id="E397" name="governance-focused">Governance Focused</EntityLink>
Prioritizes policy and institutional solutions:
- Technical alignment is necessary but insufficient
- <EntityLink id="E239" name="racing-dynamics">Racing dynamics</EntityLink> are the key problem
- International coordination is critical
- Associated with: <EntityLink id="E153" name="govai">GovAI</EntityLink>, policy researchers, some EA organizations

### <EntityLink id="E506" name="optimistic">Optimistic</EntityLink>
