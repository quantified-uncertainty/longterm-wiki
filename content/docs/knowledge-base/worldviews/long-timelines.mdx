...
- <R id="YWE5MDI3Ym">AI Impacts: Likelihood of Discontinuous Progress</R>
- <R id="M2FkZWVkZG"><EntityLink id="E148" name="gary-marcus">Gary Marcus</EntityLink>: Deep Learning Alone Won't Get Us to AGI</R>
- <R id="NTA3MGU3ZW">Melanie Mitchell: Why AI Is Harder Than We Think</R>
...
- <R id="M2ExZTU4OW">On the Measure of Intelligence</R> - François Chollet
- <R id="MjU3ZDBhZD">Shortcut Learning in Deep Neural Networks</R>
- <R id="M2JlNTYxN2">Underspecification in Machine Learning</R>
...
- <R id="YjFlZTJlMW">Building Machines That Learn and Think Like People</R>
- [Melanie Mitchell: Abstraction and Analogy in AI](https://arxiv.org/abs/2102.10717) - ArXiv paper on fundamental gaps

### Foundational Research

- <R id="NzQxOWIyMT">Agent Foundations for Aligning Machine Intelligence</R>
- <R id="NGZiNWY2NW">Embedded Agency</R>
...
- <R id="ZTg5NWU0MT">A Guide to Writing High-Quality LessWrong Posts</R>
