...
|-----------|------------|----------|
| **Current Consensus** | Minority position among AI researchers | <EntityLink id="E199">Metaculus</EntityLink> median AGI prediction: 2031; industry leaders predict 2-5 years |
...
| **Research Priority** | Foundational theory | <EntityLink id="E584">Agent foundations</EntityLink>, interpretability theory, <EntityLink id="E483">formal verification</EntityLink> |
...
| Industry leaders (<EntityLink id="E218">OpenAI</EntityLink>, <EntityLink id="E22">Anthropic</EntityLink>) | 2027-2030 | Internal capability assessment | Shortest estimates, potential bias |
...
### P(AI <EntityLink id="E130">existential catastrophe</EntityLink> by 2100)
