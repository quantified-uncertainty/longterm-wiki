...
|-----------|------------|----------|
| **Current Consensus** | Minority position among AI researchers | <EntityLink id="E199" name="metaculus">Metaculus</EntityLink> median AGI prediction: 2031; industry leaders predict 2-5 years |
...
| **Research Priority** | Foundational theory | <EntityLink id="E584" name="agent-foundations">Agent foundations</EntityLink>, interpretability theory, <EntityLink id="E483" name="formal-verification">formal verification</EntityLink> |
...
| Industry leaders (<EntityLink id="E218" name="openai">OpenAI</EntityLink>, <EntityLink id="E22" name="anthropic">Anthropic</EntityLink>) | 2027-2030 | Internal capability assessment | Shortest estimates, potential bias |
...
> "Current AI is like a high school student who crammed for the test - impressive performance on specific tasks, but lacking deep understanding." - <EntityLink id="E148" name="gary-marcus">Gary Marcus</EntityLink>
...
- <R id="sid_a7fMNgLayR">AI Impacts: Likelihood of Discontinuous Progress</R>
- <R id="sid_X3ntJAluu2"><EntityLink id="E148" name="gary-marcus">Gary Marcus</EntityLink>: Deep Learning Alone Won't Get Us to AGI</R>
- <R id="sid_mYWFNgYvOj">Melanie Mitchell: Why AI Is Harder Than We Think</R>
...
- <R id="sid_Nyg5BA6cTq">On the Measure of Intelligence</R> - François Chollet
- <R id="sid_KwHTG9QoZu">Shortcut Learning in Deep Neural Networks</R>
- <R id="sid_7x4leu0X5k">Underspecification in Machine Learning</R>
...
- <R id="sid_94Nj8qlsUd">Building Machines That Learn and Think Like People</R>
- [Melanie Mitchell: Abstraction and Analogy in AI](https://arxiv.org/abs/2102.10717) - ArXiv paper on fundamental gaps

### Foundational Research

- <R id="sid_H6xjufEsJk">Agent Foundations for Aligning Machine Intelligence</R>
- <R id="sid_CXneSlzNlf">Embedded Agency</R>
...
- <R id="sid_lgBnxWAub4">A Guide to Writing High-Quality LessWrong Posts</R>
