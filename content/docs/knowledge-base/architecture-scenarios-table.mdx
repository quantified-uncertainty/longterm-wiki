...
update_frequency: 30
summary: An interactive sortable table comparing 12+ architecture scenarios across dimensions including likelihood, safety outlook, whitebox access, modularity, and formal verifiability. Supports grouped/unified views by category.
clusters:
  - ai-safety
---
