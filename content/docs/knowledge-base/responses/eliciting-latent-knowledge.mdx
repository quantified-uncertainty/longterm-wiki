...
|-----------|------------|----------|
| **Research Investment** | Low (\$1-5M/year) | ARC Theory team has 3 permanent researchers; received \$265K from <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink> (2022); returned \$1.25M FTX grant |
