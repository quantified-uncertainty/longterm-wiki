...
| Nuno Sempere | <EntityLink id="E560" name="samotsvety">Samotsvety</EntityLink>, <EntityLink id="E238" name="quri">QURI</EntityLink>, <EntityLink id="E566" name="sentinel">Sentinel</EntityLink> founder |
...
- **Anthony Aguirre** - President of FLF, Executive Director of <EntityLink id="E528" name="fli">Future of Life Institute</EntityLink>
- **Andreas Stuhlmüller** - Founder of <EntityLink id="E526" name="elicit">Elicit</EntityLink>
