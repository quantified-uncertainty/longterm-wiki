...
- **<EntityLink id="E252" name="responsible-scaling-policies">Responsible Scaling</EntityLink>**: Provides safety thresholds for deployment decisions
