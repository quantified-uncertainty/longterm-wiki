...
Org Watch is a tracking website created by <EntityLink id="issa-rice">Issa Rice</EntityLink> that monitors various organizations, with a likely focus on effective altruism and AI safety organizations.[^rc-96f3] The site is part of Rice's broader ecosystem of tracking and research tools, which includes <EntityLink id="ai-watch">AI Watch</EntityLink> and <EntityLink id="timelines-wiki">Timelines Wiki</EntityLink>, all aimed at providing structured data about the AI safety and effective altruism communities.
