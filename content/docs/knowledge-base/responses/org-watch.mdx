...
| **Related Tools** | <EntityLink id="E386">AI Watch</EntityLink>, <EntityLink id="E387">Timelines Wiki</EntityLink> (also by <EntityLink id="E576">Issa Rice</EntityLink>) |
| **Access** | Web-based |
...
Org Watch is a tracking website created by <EntityLink id="E576">Issa Rice</EntityLink> that monitors various organizations, with a likely focus on effective altruism and AI safety organizations.[^1] The site is part of Rice's broader ecosystem of tracking and research tools, which includes <EntityLink id="E386">AI Watch</EntityLink> and <EntityLink id="E387">Timelines Wiki</EntityLink>, all aimed at providing structured data about the AI safety and effective altruism communities.
...
The <EntityLink id="E538">LessWrong</EntityLink> and EA Forum communities maintain their own forms of organizational tracking through community posts, annual reviews, and discussion threads. These platforms provide more narrative and qualitative information compared to Org Watch's likely more structured data approach.
...
[^2]: <EntityLink id="E521">Coefficient Giving</EntityLink> (formerly Open Philanthropy) - Inside Philanthropy profile
