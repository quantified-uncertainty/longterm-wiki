...
|-----------|------------|----------|
| **Tractability** | Medium-High | <EntityLink id="E127" name="eu-ai-act">EU AI Act</EntityLink> provides binding framework; UK AISI tested 30+ models since 2023; NIST AI RMF adopted by federal contractors |
...
| **Key Proponents** | Multiple | EU AI Office (enforcement authority), UK AISI (30+ model evaluations), <EntityLink id="E201" name="metr">METR</EntityLink> (GPT-5 and DeepSeek-V3 evals), NIST (TEVV framework) |
...
The landscape of <EntityLink id="E447" name="evaluation">AI evaluation</EntityLink> governance is rapidly evolving, with different jurisdictions and organizations taking distinct approaches. The following table compares major frameworks:
...
| **[Anthropic RSP](https://www.anthropic.com/index/anthropics-responsible-scaling-policy)** | Industry (<EntityLink id="E22" name="anthropic">Anthropic</EntityLink>) | Internal models | Self-binding | Internal governance | ASL thresholds, capability evaluations |
| **[OpenAI Preparedness](https://openai.com/preparedness)** | Industry (<EntityLink id="E218" name="openai">OpenAI</EntityLink>) | Internal models | Self-binding | Internal governance | Capability tracking, risk categorization |
...
| Lab <EntityLink id="E252" name="responsible-scaling-policies">RSPs</EntityLink> | Varies by lab | Varies by lab | Partial (METR, Apollo) | Varies by lab | Limited |
