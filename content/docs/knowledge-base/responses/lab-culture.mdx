...
entityType: approach
---
import {Mermaid, R, EntityLink, DataExternalLinks, F} from '@components/wiki';
...
- **Board accountability:** Board is accountable to shareholders (Google and Amazon have invested approximately <F e="anthropic" f="revenue-early-2025">\$1 billion</F> combined)
