...
- **<EntityLink id="E461" name="responsible-scaling-policies">Responsible Scaling Policies</EntityLink>**: Framework pioneered by Anthropic tying safety requirements to capability levels
