...
- **<EntityLink id="E67" name="compute-thresholds">Compute Thresholds</EntityLink>**: Using training compute as a measurable threshold for regulatory triggers
- **<EntityLink id="E66" name="compute-monitoring">Compute Monitoring</EntityLink>**: Approaches to tracking and verifying AI training runs
- **Hardware-Enabled Governance**: Technical mechanisms in AI hardware for monitoring and enforcement
- **<EntityLink id="E170" name="international-compute-regimes">International Compute Regimes</EntityLink>**: Proposals for international coordination on compute governance
...
- **<EntityLink id="E252" name="responsible-scaling-policies">Responsible Scaling Policies</EntityLink>**: Framework pioneered by Anthropic tying safety requirements to capability levels
