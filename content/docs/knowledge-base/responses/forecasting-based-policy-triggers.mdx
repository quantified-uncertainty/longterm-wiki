...
Wilkinson et al., writing around 2018, further refined the typology of trigger mechanisms. Around the same time, the FbF model was being stress-tested across a wider range of hazards, including droughts—a particularly challenging case given the slow-onset and high-variability nature of drought dynamics.[^8]

The World Meteorological Organization's 2020 guidelines on impact-based forecasting provided significant institutional validation, emphasizing that forecast-based services should prioritize protection of vulnerable populations and recommending the kind of forecast-action linkages that triggers embody.[^9]

### Post-2020 Expansion

Following the WMO's 2020 endorsement, the FbF model expanded in scope and geography. Applications have included DREF activations using heatwave thresholds in Kenya—where the Kenya Meteorological Department (KMD) developed rainfall forecasts with 3-day lead times using the Weather Research and Forecasting model, with political engagement at the cabinet level securing adoption. Parametric variants have been explored in Peru (cold-wave forecasts linked to social protection payouts) and Uganda (flood forecasts linked to veterinary kits and cash transfers). In October 2025, Willis partnered with Swiss Re to launch a parametric insurance product triggered by red weather warnings rather than actual event occurrence, extending the trigger concept into commercial insurance markets.[^10]
...
[^1]: IFRC Climate Centre - Menu of Triggers for Forecast-Based Financing (methodological framework document)
[^2]: German Red Cross (DRK) - Forecast-based Financing policy overview, 2017
[^3]: WMO - Guidelines on impact-based forecasting, 2020
[^4]: IFRC, FAO, WFP, Save the Children, Oxfam - Joint report defining triggers as key changes in indicators in early warning systems, 2014
[^5]: IFRC, FAO, WFP, Save the Children, Oxfam - Joint report on trigger typology (objective vs. subjective), 2014
[^6]: Research on action-based flood forecasting defining danger levels and probabilistic triggers, 2016
[^7]: German Red Cross (DRK) - Forecast-based Financing policy overview, 2017
[^8]: Wilkinson et al. - Refinement of trigger types for FbF, circa 2018
[^9]: WMO - Guidelines on impact-based forecasting emphasizing protection of vulnerable populations, 2020
[^10]: Willis/Swiss Re - Parametric insurance product triggered by red weather warnings, October 2025; GlobalAgRisk - Peru Extreme El Niño Insurance Product, 2011; UN Famine Action Mechanism launch, 2018
[^11]: IFRC Climate Centre - Menu of Triggers for Forecast-Based Financing (four-step development process)
[^12]: German Red Cross (DRK) - Forecast-based Financing policy overview detailing EAP activation mechanics, 2017
[^13]: IFRC Climate Centre - Menu of Triggers for Forecast-Based Financing (stop mechanism description)
[^14]: IFRC, FAO, WFP, Save the Children, Oxfam - Joint report on objective vs. subjective trigger distinction, 2014
[^15]: IFRC Climate Centre and partner organizations - case studies on Uganda, Kenya, and Peru applications; UN Famine Action Mechanism, 2018
[^16]: Willis/Swiss Re - Parametric insurance product announcement, October 2025
[^17]: CFTC - Chairman Michael Selig statements on prediction market regulation, January–February 2026; prediction market trading volume data, 2025
[^18]: Czech Priorities and Metaculus - FORPOL tournament write-up and materials, EAIF-funded
[^19]: EA Forum and LessWrong community discussions on forecasting for policy decisions
[^20]: EA Forum and LessWrong - discussions on LLM-based forecasting systems and risks, including epistemic and misuse concerns
[^21]: IFRC Climate Centre - Menu of Triggers for Forecast-Based Financing (lead time vs. accuracy trade-off)
[^22]: Research on FbF drought trigger challenges and false alarm costs
[^23]: Kansas tax cut forecast analysis; research on RCT forecaster overoptimism (Eva Vivalt and colleagues)
[^24]: General forecasting methodology literature on overfitting and black-swan events
[^25]: Kenya Meteorological Department FbF partnership case study; WMO 2020 guidelines on partnership requirements
[^26]: FbF implementation literature on political dynamics of EAP design
[^27]: Czech Priorities and Metaculus - FORPOL tournament analysis of decision-linkage bottlenecks
[^28]: Large-scale forecasting study comparing 14,076 forecasts from 1,181 forecasters on policy intervention effectiveness
