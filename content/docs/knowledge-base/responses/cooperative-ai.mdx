...
| Current Maturity | Low-Medium | Active research at DeepMind, <EntityLink id="E57" name="chai">CHAI</EntityLink>; limited production deployment |
...
|------|-----------|--------------|
| <EntityLink id="E239" name="racing-dynamics">Racing Dynamics</EntityLink> | High | Provides frameworks for cooperative agreements between AI developers to avoid safety-capability tradeoffs |
| Goal Misalignment | Medium | Assistance games formalize how AI can learn human preferences through cooperation |
| <EntityLink id="E93" name="deceptive-alignment">Deceptive Alignment</EntityLink> | Medium | Research on verifying genuine vs. simulated cooperation helps detect deceptive agents |
...
| <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> | Funding | Research grants |
...
- **<EntityLink id="E586" name="cirl">CIRL</EntityLink>**: Specific framework for human-AI cooperation
- **<EntityLink id="E594" name="model-spec">Model Specifications</EntityLink>**: Define cooperative behavioral expectations
