...
- <EntityLink id="flexheg">FlexHEG</EntityLink> — Yoshua Bengio's project developing hardware architectures for verifiable international AI governance agreements
