...
| **Industry Support** | Robust | <EntityLink id="E218" name="openai">OpenAI</EntityLink> and <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> provide API credits |
...
| **Organization** | <EntityLink id="E199" name="metaculus">Metaculus</EntityLink> |
| **Launched** | 2024 |
...
The [AI Forecasting Benchmark Tournament](https://www.metaculus.com/aib/) represents <EntityLink id="E199" name="metaculus">Metaculus</EntityLink>'s flagship initiative for comparing human and AI forecasting capabilities. Launched in 2024, the tournament runs in two parallel series:
...
| **<EntityLink id="E144" name="forecastbench">ForecastBench</EntityLink>** | FRI | AI benchmarking | Continuous evaluation | 1,000 questions |
| **<EntityLink id="E379" name="xpt">XPT</EntityLink>** | FRI | Expert collaboration | One-time tournament | ≈100 questions |
| **<EntityLink id="E532" name="good-judgment">Good Judgment</EntityLink>** | Good Judgment Inc | Superforecaster panels | Ongoing operations | Client-specific |
...
| Source | Type | Amount |
|--------|------|--------|
| **<EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>** | Grant funding to Metaculus | \$1.5M+ (2022-2023) |
