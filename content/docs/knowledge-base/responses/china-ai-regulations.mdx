...
| **International Coordination** | Limited on frontier AI risks | [Geneva talks in May 2024](https://carnegieendowment.org/research/2024/08/china-artificial-intelligence-ai-safety-regulation); signed <EntityLink id="E469">Bletchley Declaration</EntityLink> but limited follow-through |
...
|--------|-----------|--------|
| <EntityLink id="E60" /> | <EntityLink id="E249" /> | 5+ major regulations affecting 50,000+ companies; 1,400+ algorithms registered with enhanced enforcement |
| <EntityLink id="E60" /> | <EntityLink id="E171" /> | Different priorities (social stability vs individual rights) create barriers, but CnAISDA launch and bilateral nuclear AI agreement show emerging cooperation |
| <EntityLink id="E358" /> | <EntityLink id="E242" /> | Content control focus with recent safety institute development; \$100B+ investment suggests continued development prioritization |
