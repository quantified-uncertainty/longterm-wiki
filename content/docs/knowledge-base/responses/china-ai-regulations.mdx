...
| **International Coordination** | Limited on frontier AI risks | [Geneva talks in May 2024](https://carnegieendowment.org/research/2024/08/china-artificial-intelligence-ai-safety-regulation); signed <EntityLink id="E469" name="bletchley-declaration">Bletchley Declaration</EntityLink> but limited follow-through |
