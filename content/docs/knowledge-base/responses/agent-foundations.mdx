...
<DataExternalLinks pageId="agent-foundations" client:load />
...
The <R id="db5e810911f924b1">MIRI/Open Philanthropy exchange on decision theory</R> reveals ongoing disagreement about whether this research direction is productive or has generated more puzzles than solutions.
...
- **MIRI/Open Philanthropy Exchange on Decision Theory**: <R id="db5e810911f924b1">AI Alignment Forum</R>
