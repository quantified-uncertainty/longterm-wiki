...
The field crystallized rapidly between 2024 and 2026. The <EntityLink id="E1189">CNAS</EntityLink> report (January 2024) established the policy framework. A November 2024 report from <EntityLink id="E202">MIRI</EntityLink> outlined a taxonomy of verification mechanisms. <EntityLink id="E1185">RAND</EntityLink> published working papers on hardware-enabled mechanisms and convened workshops with chip manufacturers, policymakers, and researchers.[^rc-959c] <EntityLink id="E380" name="yoshua-bengio">Yoshua Bengio</EntityLink>'s <EntityLink id="E2087" name="flexheg">FlexHEG</EntityLink> project received \$4.1M from the Survival and Flourishing Fund in 2024 to develop flexible hardware-enabled guarantees with an open-source "Guarantee Processor" architecture.[^rc-e524] Subsequent arXiv work (2025) and an Oxford Martin AI Governance Initiative report (2025) elaborated specific mechanism types, mapped them to governance objectives, and assessed their readiness.
...
**Active developers:** NVIDIA (commercial NRAS service, [go-nvtrust](https://github.com/NVIDIA/go-nvtrust) open-source attestation); UK AISI + Anthropic + [OpenMined](https://openmined.org/blog/secure-enclaves-for-ai-evaluation/) (governance pilot); Intel Trust Authority (composite CPU+GPU attestation); <EntityLink id="lucid-computing">Lucid Computing</EntityLink> (commercial TEE-based verification platform using Intel TDX and NVIDIA CC); Oxford Martin AIGI researchers; O'Gara, Kulp, et al.; <EntityLink id="E380" name="yoshua-bengio">Yoshua Bengio</EntityLink>'s [FlexHEG project](https://yoshuabengio.org/wp-content/uploads/2024/09/FlexHEG-Interim-Report_2024.pdf) (\$4.1M SFF-funded, developing an open-source "Guarantee Processor" that monitors accelerator usage and a "Secure Enclosure" providing physical tamper protection).[^rc-e524] [Caliptra 2.1](https://www.chipsalliance.org/news/caliptra2-1/) (AMD/Google/Microsoft/Nvidia under CHIPS Alliance)—an open-source silicon root of trust with quantum-resilient cryptography—is the most promising standardization effort and could become the cross-vendor governance foundation.
...
The CNAS *Secure, Governable Chips* report introduced a three-level threat model that has become standard in the HEM literature.[^rc-9309] Different mechanisms are appropriate at different levels, and the staged implementation roadmap reflects this:
...
A series of attacks published in October 2025 demonstrated that every major TEE platform has exploitable physical-access vulnerabilities. These findings are significant because nearly all HEM proposals rely on TEE-based remote attestation as a foundation.[^rc-6ad0]
...
**Industry opposition:** The Semiconductor Industry Association stated it "cannot support blanket mandates for new, untested, and potentially infeasible on-chip mechanisms" and warned of "undermining global trust in American semiconductor technologies."[^rc-e6c5]
...
The CNAS *Secure, Governable Chips* report proposed a **staged implementation roadmap** reflecting increasing technical difficulty:[^rc-9309]
...
CNAS estimated that implementing hardened on-chip governance would require "moderate development effort" extending existing chip functionality, with a timeline of 18 months to 4 years.[^rc-9309] IAPS estimated the location verification infrastructure—firmware updates plus a network of 100–500 landmark servers—could be deployed for under \$1M in development costs and \$2.5–12.5M/year in operating costs.[^rc-2fe4] These are modest sums relative to the scale of the problem, suggesting that the binding constraint is not cost but policy commitment and commercial incentives.

The CNAS report proposed that the US government create "advance export market commitments"—offering future export market access in exchange for implementing specific security features—as a way to align chip manufacturer incentives without requiring public spending.[^rc-9309] This approach would leverage the lost revenue from existing export restrictions rather than adding new costs.
...
- **Pass the Chip Security Act.** Location verification is the lowest-hanging fruit: it can be implemented via firmware update with no hardware changes, at under \$1M development cost, and would immediately address the \$5–7B annual chip smuggling problem.[^rc-2fe4][^rc-e6c5]
- **Create advance export market commitments.** Offer chip manufacturers future export market access in exchange for implementing specific security features, leveraging lost revenue from current export restrictions rather than requiring new spending.[^rc-9309]
- **Fund R&D through existing channels.** The Federation of American Scientists recommends ≈\$40M/year for an AI Assurance and Security R&D Consortium jointly led by DARPA and NSF, plus NSF EAGER/RAPID fast-grant programs for hardware security.[^rc-724c]
- **Establish red-teaming programs.** DHS/CISA should create bug bounty and red-teaming programs for AI chip hardware security, starting with a public prize for finding vulnerabilities in current implementations.[^rc-9309]

### For Funders and Philanthropists

- **Apply to Longview Philanthropy's HEM RFP** (\$2–10M available) for prototype development, secure enclosure designs, and red-teaming.[^rc-4592]
...
[^rc-4f3e]: Baker et al. — *Six Layers of Verification* ([RAND WRA4077-1](https://www.rand.org/pubs/working_papers/WRA4077-1.html), July 2025) - proposes layered hardware + personnel verification for international AI agreements

[^rc-3908]: Petrie, James — *Near-Term Enforcement of AI Chip Export Controls Using Firmware-Based Design for Offline Licensing* ([arXiv:2404.18308](https://arxiv.org/abs/2404.18308), April 2024) - foundational design for cryptographic licensing on existing H100 chips

[^rc-2fe4]: IAPS — *Location Verification for AI Chips* ([iaps.ai](https://www.iaps.ai/research/location-verification-for-ai-chips)) - working prototype on H100 chips demonstrating delay-based verification

[^rc-f7be]: OpenMined — *Secure Enclaves for AI Evaluation* ([openmined.org](https://openmined.org/blog/secure-enclaves-for-ai-evaluation/)) - UK AISI + Anthropic pilot using H100 TEEs for privacy-preserving AI safety evaluations

[^rc-9309]: Aarne, Onni; Fist, Tim; Withers, Caleb — *Secure, Governable Chips: Using On-Chip Mechanisms to Manage National Security Risks from AI & Advanced Computing* ([CNAS, January 2024](https://www.cnas.org/publications/reports/secure-governable-chips)) - foundational policy framework proposing on-chip governance (TEEs, remote attestation, operating licenses, tamper-evidence) as alternatives to blanket export bans; proposes staged rollout and "advance export market commitments"

[^rc-959c]: RAND Corporation — *Hardware-Enabled Governance Mechanisms* ([rand.org WRA3056-1](https://www.rand.org/pubs/working_papers/WRA3056-1.html)) and *Workshop Insights on HEMs* ([rand.org CFA3056-1](https://www.rand.org/pubs/conf_proceedings/CFA3056-1.html)) - working papers and multi-stakeholder workshop findings on hardware-enabled mechanisms for export controls and AI governance

[^rc-e524]: Bengio, Yoshua et al. — *FlexHEG Interim Report* ([yoshuabengio.org, September 2024](https://yoshuabengio.org/wp-content/uploads/2024/09/FlexHEG-Interim-Report_2024.pdf)); *FlexHEG Technical Options* ([arXiv:2506.03409](https://arxiv.org/abs/2506.03409)); *International Security Applications of FlexHEGs* ([arXiv:2506.15100](https://arxiv.org/abs/2506.15100)) - \$4.1M SFF-funded project developing open-source Guarantee Processor architecture for flexible hardware-enabled guarantees

[^rc-3f4f]: Lucid Computing — [lucidcomputing.ai](https://lucidcomputing.ai/) - hardware-rooted zero-trust AI verification platform using TEEs, latency-based location proofs, and cryptographic audit ledgers; founded 2025 in San Francisco

[^rc-4592]: Longview Philanthropy — *Request for Proposals on Hardware-Enabled Mechanisms (HEMs) for AI Verification* ([longview.org](https://www.longview.org/request-for-proposals-on-hardware-enabled-mechanisms-hems-for-ai-verification/)) - expects to award \$2–10M in grants for HEM prototype development

[^rc-95a1]: Burga, Tao; Fist, Tim — *Technology to Secure the AI Chip Supply Chain: A Primer* ([CNAS, December 2024](https://www.cnas.org/publications/reports/technology-to-secure-the-ai-chip-supply-chain-a-primer)) - technical primer on supply chain verification mechanisms for AI chips

[^rc-6ad0]: BatteringRAM ([batteringram.eu](https://batteringram.eu/), October 2025), WireTap ([wiretap.fail](https://wiretap.fail/), October 2025), TEE.fail ([tee.fail](https://tee.fail/), October 2025) - three attacks demonstrating physical-access vulnerabilities in Intel SGX, AMD SEV-SNP, and Intel TDX confidential computing; \$50–\$1,000 hardware interposers extract attestation signing keys and enable attestation replay

[^rc-e6c5]: Semiconductor Industry Association — [statement on the Chip Security Act](https://www.semiconductors.org/sia-statement-on-chip-security-act/) - opposes "blanket mandates for new, untested, and potentially infeasible on-chip mechanisms"; see also [Atlantic Council analysis](https://www.atlanticcouncil.org/blogs/geotech-cues/how-the-chip-security-act-could-usher-in-an-era-of-trusted-trade-with-us-partners/), [Center for Cybersecurity Policy critique](https://www.centerforcybersecuritypolicy.org/insights-and-research/congress-proposed-chip-security-act-threatens-to-create-new-cyber-vulnerabilities-in-u-s-semiconductors)

[^rc-a193]: Stop Stealing Our Chips Act (S.1473 / H.R.6322) — [Congress.gov](https://www.congress.gov/bill/119th-congress/senate-bill/1473/text); [IAPS issue brief](https://www.iaps.ai/research/issue-brief-the-stop-stealing-our-chips-act); whistleblower incentive program modeled after SEC program

[^rc-724c]: Federation of American Scientists — *Accelerating R&D for Critical AI* ([fas.org, 2025](https://fas.org/publication/accelerating-rd-for-critical-ai/)) - recommends ≈\$40M/year for AI Assurance and Security R&D Consortium led by DARPA and NSF

[^rc-2efd]: Shavit, Yonadav — *What does it take to catch a Chinchilla? Verifying Rules on Large-Scale Neural Network Training via Compute Monitoring* ([arXiv:2303.11341](https://arxiv.org/abs/2303.11341), March 2023) - first major compute monitoring framework proposing on-chip firmware snapshots and supply chain monitoring

[^rc-0ecf]: Heim, Lennart — *Considerations and Limitations for AI Hardware-Enabled Mechanisms* ([blog.heim.xyz](https://blog.heim.xyz/considerations-and-limitations-for-ai-hardware-enabled-mechanisms/), March 2024) - cautions against premature advocacy; identifies circumvention risks, prolonged hardware rollout lead times, and governance framework challenges

[^rc-65ef]: *Distributed and Decentralised Training: Technical Governance Challenges* ([arXiv](https://arxiv.org/html/2507.07765)) - analysis of decentralized training (DiLoCo, INTELLECT-1) as evasion vector; currently ~1,000x smaller than frontier models but rapidly progressing; \$145M+ raised by startups since 2024