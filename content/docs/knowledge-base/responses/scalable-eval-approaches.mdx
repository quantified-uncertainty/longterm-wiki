...
<DataExternalLinks pageId="scalable-eval-approaches" client:load />
...
| **<EntityLink id="apollo-research">Apollo Research</EntityLink>** | <EntityLink id="scheming-detection">Scheming detection</EntityLink> and reduction | 15-30 staff; funded by Open Philanthropy, SFF | Anti-scheming training with OpenAI (covert actions: 13% → 0.4%) |
