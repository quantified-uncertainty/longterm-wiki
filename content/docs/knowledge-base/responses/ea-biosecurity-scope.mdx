...
|-----------|------------|----------|
| **Total EA Biosecurity Funding** | \$230M+ from <EntityLink id="open-philanthropy">Coefficient Giving</EntityLink> alone | 140+ grants across Biosecurity & Pandemic Preparedness fund[^rc-a3d2] |
...
<EntityLink id="open-philanthropy">Coefficient Giving</EntityLink> (renamed Coefficient Giving in November 2025) is the dominant funder. Key biosecurity grants:
