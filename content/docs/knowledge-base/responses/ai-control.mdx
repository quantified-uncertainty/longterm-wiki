...
---
import {DataInfoBox, KeyPeople, Section, Backlinks, DisagreementMap, KeyQuestions, R, EntityLink, DataExternalLinks, Mermaid} from '@components/wiki';

<DataExternalLinks pageId="ai-control" client:load />
