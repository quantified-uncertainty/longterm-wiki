...
<EntityLink id="ajeya-cotra">Ajeya Cotra</EntityLink> has argued that AI Control techniques are foundational to the "crunch time" strategy adopted (at least nominally) by all major frontier labs. The strategy envisions using early transformative AI systems --- which may be powerful but potentially misaligned --- for defensive work during the narrow window between AI automating AI R&D and the arrival of uncontrollable superintelligence.
