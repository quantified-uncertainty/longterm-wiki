...
| **Adoption** | Widespread (2025) | Anthropic, OpenAI, <EntityLink id="E98" name="deepmind">Google DeepMind</EntityLink>, Meta all publish model documentation |
...
Anthropic's approach embeds the specification directly into model weights during supervised learning, making it more fundamental than a system prompt. Technical staff member <EntityLink id="amanda-askell" name="amanda-askell">Amanda Askell</EntityLink> [confirmed](https://futurism.com/artificial-intelligence/anthropic-claude-soul) the document "is based on a real document and we did train Claude on it."
...
- **<EntityLink id="E451" name="constitutional-ai">Constitutional AI</EntityLink>**: Specs inform constitutional principles
- **<EntityLink id="E259" name="rlhf">RLHF</EntityLink>**: Specs guide rater instructions
...
|------------|-----------|
| **<EntityLink id="E451" name="constitutional-ai">Constitutional AI</EntityLink>** | Specs inform constitutional principles for training |
| **<EntityLink id="E259" name="rlhf">RLHF</EntityLink>** | Specs guide human rater instructions |
| **<EntityLink id="E128" name="evals">AI Evaluation</EntityLink>** | Specs define test criteria for verification |
| **<EntityLink id="E461" name="rsp">Responsible Scaling Policies</EntityLink>** | Specs integrate with capability thresholds |
