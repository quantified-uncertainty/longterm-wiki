...
|------|---------|-------------------|
| **<EntityLink id="E286">Squiggle</EntityLink>** | Probabilistic language | SquiggleAI generates Squiggle code |
| **Squiggle Hub** | Model hosting platform | SquiggleAI integrated directly |
| **<EntityLink id="E200">Metaforecast</EntityLink>** | Forecast aggregation | SquiggleAI could use Metaforecast data as inputs |
| **<EntityLink id="E385">RoastMyPost</EntityLink>** | LLM blog evaluation | Shared LLM integration experience |
