...
<DataExternalLinks pageId="alignment" client:load />
...
|------|-----------|---------------------|----------------|
| <EntityLink id="deceptive-alignment" /> | Critical | Detects and prevents models from pursuing hidden goals while appearing aligned during evaluation | Interpretability, debate, AI control |
| <EntityLink id="reward-hacking" /> | High | Identifies misspecified rewards and specification gaming through oversight and decomposition | RLHF iteration, Constitutional AI, recursive reward modeling |
| <EntityLink id="goal-misgeneralization" /> | High | Trains models on diverse distributions and uses robust value specification | Weak-to-strong generalization, adversarial training |
| <EntityLink id="mesa-optimization" /> | High | Monitors for emergent optimizers with different objectives than intended | Mechanistic interpretability, behavioral evaluation |
| <EntityLink id="power-seeking" /> | High | Constrains instrumental goals that could lead to resource acquisition | Constitutional principles, corrigibility training |
| <EntityLink id="scheming" /> | Critical | Detects strategic deception and hidden planning against oversight | AI control, interpretability, red-teaming |
| <EntityLink id="sycophancy" /> | Medium | Trains models to provide truthful feedback rather than user-pleasing responses | Constitutional AI, RLHF with diverse feedback |
| <EntityLink id="corrigibility-failure" /> | High | Instills preferences for maintaining human oversight and control | Debate, amplification, shutdown tolerance training |
| <EntityLink id="distributional-shift" /> | Medium | Develops robustness to novel deployment conditions | Adversarial training, uncertainty estimation |
| <EntityLink id="treacherous-turn" /> | Critical | Prevents capability-triggered betrayal through early alignment and monitoring | Scalable oversight, interpretability, control |
...
| Scaling Risk | High | 2-5 years | <EntityLink id="why-alignment-hard">Alignment difficulty increases</EntityLink> with capability | Medium |
...
|----------|----------|--------------|----------------|--------------|
| **AI Control** | Early | Works with misaligned models | <EntityLink id="deceptive-alignment" /> detection | <EntityLink id="redwood-research" /> |
| **Interpretability** | Growing | Understanding model internals | <R id="303088a4cbe03fad">Scale limitations</R>, <EntityLink id="steganography" /> | <R id="5083d746c2728ff2">Anthropic</R>, <EntityLink id="chris-olah" /> |
| **Formal Verification** | Limited | Mathematical guarantees | Computational complexity, specification gaps | Academic labs |
| **Monitoring** | Developing | Behavioral detection | <EntityLink id="sandbagging" />, capability evaluation | <EntityLink id="arc" />, <EntityLink id="metr" /> |
...
|----------------|---------------|-----------------|----------------|
| <EntityLink id="language-models" /> | Rapid | Moderate | Widening |
| <EntityLink id="reasoning" /> | Fast | Low | Critical |
| <EntityLink id="agentic-ai" /> | Accelerating | Minimal | Severe |
| <EntityLink id="scientific-research" /> | Early | Very Low | Unknown |
...
| **Evaluation** | Limited to observable behaviors | Current evals detect 85% of obvious misalignment, 40-60% of sophisticated deception; <EntityLink id="sandbagging" /> undetectable in 70%+ cases | Advanced AI could strategically underperform on evaluations; alignment faking observed in Claude 3 Opus | Adversarial testing, <EntityLink id="interpretability" />, mechanistic anomaly detection | 30-50% for detecting deception |
...
- **<EntityLink id="pause-debate">Pause vs. proceed</EntityLink>**: Should capability development slow?
...
|------|---------------|-------------|
| **AI Labs** | <EntityLink id="openai" />, <EntityLink id="anthropic" />, <EntityLink id="deepmind" /> | Applied alignment research |
| **Safety Orgs** | <EntityLink id="chai" />, <EntityLink id="miri" />, <EntityLink id="redwood-research" /> | Fundamental alignment research |
| **Evaluation** | <EntityLink id="arc" />, <EntityLink id="metr" /> | Capability assessment, control |

### Policy & Governance Resources

| Resource Type | Links | Description |
|---------------|-------|-------------|
| **Government** | <R id="54dbc15413425997">NIST AI RMF</R>, <EntityLink id="uk-aisi" /> | Policy frameworks |
...
AI alignment research is the primary intervention for reducing <EntityLink id="misalignment-potential" /> in the <EntityLink id="ai-transition-model" />:

| Factor | Parameter | Impact |
|--------|-----------|--------|
| <EntityLink id="misalignment-potential" /> | <EntityLink id="alignment-robustness" /> | Core objective: ensure AI systems pursue intended goals reliably |
| <EntityLink id="misalignment-potential" /> | <EntityLink id="safety-capability-gap" /> | Research must keep pace with capability advances to maintain safety margins |
| <EntityLink id="misalignment-potential" /> | <EntityLink id="human-oversight-quality" /> | Scalable oversight extends human control to superhuman systems |
| <EntityLink id="misalignment-potential" /> | <EntityLink id="interpretability-coverage" /> | Understanding model internals enables verification of alignment |
