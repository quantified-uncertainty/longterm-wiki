...
<DataExternalLinks pageId="constitutional-ai" client:load />
...
| **Generalizability** | Under evaluation | Limited third-party replication | <R id="132aaa63c43beb04">OpenAI <EntityLink id="rlhf">RLHF</EntityLink> comparisons</R> |
...
|------|-----------|--------------|
| <EntityLink id="scheming">Scheming/Deceptive Alignment</EntityLink> | Medium | Explicit principles create auditable constraints; Constitutional Classifiers detect hidden intent |
...
| <EntityLink id="reward-hacking">Reward Hacking</EntityLink> | Medium | Constitutional principles provide interpretable reward signal vs. opaque human preferences |
