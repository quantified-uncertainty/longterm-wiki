...
The connection to the <EntityLink id="ai-transition-model">AI transition</EntityLink> is direct: if <EntityLink id="E60">civilizational competence</EntityLink> depends partly on <EntityLink id="E121">epistemic health</EntityLink>, then tools that improve collective epistemics reduce the risk of catastrophic outcomes during the transition to powerful AI systems.
