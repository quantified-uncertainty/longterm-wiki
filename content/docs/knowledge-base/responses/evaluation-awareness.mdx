...
The problem is empirically documented and getting worse. <EntityLink id="E24" name="apollo-research">Apollo Research</EntityLink> found that Claude Opus 4.1 verbalized awareness of evaluation in 22% of test scenarios; for Claude Sonnet 4.5, the rate was 58%. For Claude Opus 4.6 (February 2026), evaluation awareness was "so strong" that Apollo "did not believe that much evidence about the model's alignment or misalignment could be gained without substantial further experiments." A study of 15 open-weight models from 0.27B to 70B parameters found evaluation awareness follows a power-law scaling relationship with model size, suggesting the problem will compound as models become more capable.
...
- Enables forecasting of <EntityLink id="E93" name="deceptive-alignment">deceptive behavior</EntityLink> in future larger models
...
<EntityLink id="E24" name="apollo-research">Apollo Research</EntityLink>'s anti-scheming training collaboration with <EntityLink id="E218" name="openai">OpenAI</EntityLink> (arXiv 2509.15541) revealed a paradox: training that successfully reduces scheming simultaneously increases evaluation awareness.
...
Evaluation awareness directly undermines <EntityLink id="E461" name="rsp">responsible scaling policies</EntityLink> that use behavioral evaluations to determine deployment safety:
...
1. **Defense in depth**: Behavioral evaluation as one layer among many (<EntityLink id="E174" name="interpretability">interpretability</EntityLink>, production monitoring, structural controls)
