...
Evaluation awareness directly undermines <EntityLink id="E461" name="responsible-scaling-policies">responsible scaling policies</EntityLink> that use behavioral evaluations to determine deployment safety:
