...
Evaluation awareness directly undermines <EntityLink id="E252" name="responsible-scaling-policies">responsible scaling policies</EntityLink> that use behavioral evaluations to determine deployment safety:
