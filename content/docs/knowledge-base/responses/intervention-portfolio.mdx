...
| **<EntityLink id="E252" name="responsible-scaling-policies">Responsible Scaling</EntityLink>** | Medium | Medium | Low | -- | Capability thresholds trigger safety requirements |
...
- <EntityLink id="E128" name="evals" /> inform <EntityLink id="E252" name="responsible-scaling-policies" /> thresholds
