...
| Funding Concentration | 85% from 5 sources | [Coefficient Giving](https://www.openphilanthropy.org/): \$63.6M (60%); <EntityLink id="jaan-tallinn">Jaan Tallinn</EntityLink>: \$20M; Eric Schmidt: \$10M; [AI Safety Fund](https://www.frontiermodelforum.org/ai-safety-fund/): \$10M; FLI: \$5M |
...
- <EntityLink id="interpretability" /> enables verification for 
