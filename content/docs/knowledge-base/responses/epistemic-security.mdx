...
| **Human Detection Accuracy** | Near-chance (55.5%) | Meta-analysis of 56 studies found humans detect <EntityLink id="E96">deepfakes</EntityLink> at 55.5% accuracy; high-quality videos only 24.5% (<R id="5c1ad27ec9acc6f4">ScienceDirect</R>) |
...
| **Content Authentication Adoption** | Early stage, growing | C2PA market \$1.29B in 2024, growing 26% CAGR; 5,000+ CAI members; Meta, Google, <EntityLink id="E218">OpenAI</EntityLink> joined 2024 (<R id="ff89bed1f7960ab2">C2PA</R>) |
| **Inoculation Effectiveness** | Moderate (10-24% reduction) | Bad News game reduces susceptibility to <EntityLink id="E102">disinformation</EntityLink> by 10-24% across tactics; effects last 3+ months (<R id="82f99c43d60a4fa2">Cambridge</R>) |
...
Epistemic security improves the <EntityLink id="ai-transition-model" /> through <EntityLink id="E60" />:

| Factor | Parameter | Impact |
|--------|-----------|--------|
| <EntityLink id="E60" /> | <EntityLink id="E121" /> | Maintains society's ability to distinguish truth from AI-generated falsehood |
| <EntityLink id="E60" /> | <EntityLink id="E285" /> | Authentication and verification preserve trust in institutions and media |
| <EntityLink id="E60" /> | <EntityLink id="E164" /> | Technical defenses (C2PA, watermarking) protect content provenance |
| <EntityLink id="E207" /> | | Reduces harm from deepfakes, voice cloning fraud, and AI-enabled manipulation |
