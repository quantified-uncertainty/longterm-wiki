...
| **Human Detection Accuracy** | Near-chance (55.5%) | Meta-analysis of 56 studies found humans detect <EntityLink id="E96" name="deepfakes">deepfakes</EntityLink> at 55.5% accuracy; high-quality videos only 24.5% (<R id="5c1ad27ec9acc6f4">ScienceDirect</R>) |
...
| **Content Authentication Adoption** | Early stage, growing | C2PA market \$1.29B in 2024, growing 26% CAGR; 5,000+ CAI members; Meta, Google, <EntityLink id="E218" name="openai">OpenAI</EntityLink> joined 2024 (<R id="ff89bed1f7960ab2">C2PA</R>) |
| **Inoculation Effectiveness** | Moderate (10-24% reduction) | Bad News game reduces susceptibility to <EntityLink id="E102" name="disinformation">disinformation</EntityLink> by 10-24% across tactics; effects last 3+ months (<R id="82f99c43d60a4fa2">Cambridge</R>) |
