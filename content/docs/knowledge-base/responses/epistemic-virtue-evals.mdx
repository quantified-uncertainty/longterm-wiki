...
- **<EntityLink id="E295" name="sycophancy">Sycophancy</EntityLink> measurement**: Directly addresses a known risk where AI systems reinforce user biases
- **Deception detection**: Evaluating whether AI systems can avoid being misleading connects to <EntityLink id="E93" name="deceptive-alignment">deceptive alignment</EntityLink> concerns
