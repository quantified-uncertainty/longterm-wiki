...
| **Research access** | Tiered researcher programs | <EntityLink id="E153">GovAI</EntityLink> framework enables safety research while limiting proliferation |
...
| Parameter | Impact |
|-----------|--------|
| <EntityLink id="E207" /> | Enables monitoring and intervention to reduce misuse |
| <EntityLink id="E160" /> | Maintains human control point over AI capabilities |
| <EntityLink id="E264" /> | Demonstrates commitment to responsible deployment |
