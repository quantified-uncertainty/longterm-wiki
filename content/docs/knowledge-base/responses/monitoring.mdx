...
This page covers **compute monitoring**—one approach within the broader Compute Governance framework. See also: <EntityLink id="E136">Export Controls</EntityLink>, <EntityLink id="E465">Thresholds</EntityLink>, <EntityLink id="E473">International Regimes</EntityLink>.
:::
...
Compute monitoring improves the <EntityLink id="ai-transition-model" /> through <EntityLink id="E60" />:

| Factor | Parameter | Impact |
|--------|-----------|--------|
| <EntityLink id="E60" /> | <EntityLink id="E249" /> | Visibility into training runs enables enforcement of safety requirements |
| <EntityLink id="E60" /> | <EntityLink id="E171" /> | Shared monitoring facilitates verification of international agreements |
| <EntityLink id="E358" /> | <EntityLink id="E242" /> | Transparency may reduce secretive racing by exposing capability timelines |
