...
[^rc-8ad8]: Official summit page — French Delegation to the UN: [onu.delegfrance.org](https://onu.delegfrance.org/ai-action-summit-10-and-11-february-2025)
[^rc-c7bc]: Wikipedia article on AI Action Summit: [en.wikipedia.org/wiki/AI_Action_Summit](https://en.wikipedia.org/wiki/AI_Action_Summit)
