...
| <EntityLink id="E93" name="deceptive-alignment">Deceptive Alignment</EntityLink> | None | Does not address internal model goals or hidden objectives |
| <EntityLink id="E151" name="goal-misgeneralization">Goal Misgeneralization</EntityLink> | None | Targets external inputs, not internal learned representations |
...
| **<EntityLink id="E449" name="red-teaming">Red Teaming</EntityLink>** | Attack discovery | Supplies adversarial examples |
