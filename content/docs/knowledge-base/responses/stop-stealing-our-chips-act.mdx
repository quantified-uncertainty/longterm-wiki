...
description: A bipartisan U.S. bill introduced in December 2025 to combat AI chip smuggling to China and other adversaries by establishing a whistleblower incentive program at the Bureau of Industry and Security.
sidebar:
  order: 50
quality: 70
readerImportance: 62
...
summary: The Stop Stealing Our Chips Act (Dec. 2025) creates an SEC-modeled whistleblower incentive program at BIS to enforce AI chip export controls against smuggling to China and other adversaries, funded entirely through violation fines; it is indirectly relevant to AI safety through compute governance but makes no explicit AI safety claims. The article is well-structured, appropriately caveated, and includes a genuine criticisms section, though sourcing relies heavily on sponsor press materials.
ratings:
  novelty: 7
  rigor: 7
  actionability: 6
...
The **Stop Stealing Our Chips Act** is a bipartisan U.S. congressional bill introduced in December 2025 to strengthen enforcement of export controls on advanced AI chips by creating a whistleblower incentive program at the Bureau of Industry and Security (BIS). The bill amends the Export Control Reform Act of 2018 and targets the smuggling of American-made semiconductors to adversaries including China, Russia, Iran, and North Korea.
...
| **Related Legislation** | <EntityLink id="chip-security-act">Chip Security Act</EntityLink> |
...
- The extent to which the bill, if enacted, would complement or overlap with the <EntityLink id="chip-security-act">Chip Security Act</EntityLink>'s technical verification approach
