...
summary: The Stop Stealing Our Chips Act (Dec. 2025) creates an SEC-modeled whistleblower incentive program at BIS to enforce AI chip export controls against smuggling to China and other adversaries, funded entirely through violation fines; it is indirectly relevant to AI safety through compute governance but makes no explicit AI safety claims.
clusters:
  - governance
---
