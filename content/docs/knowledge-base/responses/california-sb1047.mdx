...
SB 1047 represented the most direct engagement of the EA-aligned AI safety community with state-level legislation. Zvi Mowshowitz's [comprehensive guide to SB 1047](https://thezvi.substack.com/p/guide-to-sb-1047) became the single most widely-read analysis in the AI safety community, while Scott Alexander's [post-veto account of the campaign](https://www.astralcodexten.com/p/sb-1047-our-side-of-the-story) provided an inside perspective on the advocacy effort:
