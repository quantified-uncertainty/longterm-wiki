...
<DataExternalLinks pageId="formal-verification" client:load />
...
|------|-----------|--------------|
| <EntityLink id="misalignment-potential" /> | High | Could mathematically prove that system objectives align with specified goals |
| <EntityLink id="deceptive-alignment" /> | Very High | Proofs are immune to deception—a deceptive AI cannot fake a valid proof |
