...
|--------------|------------|-----------|
| **<EntityLink id="E174" name="interpretability" />** | Understanding enables specification | Interpretation guides what to verify |
| **<EntityLink id="E484" name="provably-safe" />** | Verification is core component | davidad agenda relies on verification |
| **<EntityLink id="E451" name="constitutional-ai" />** | Principles could become specifications | Bridge informal to formal |
...
| <EntityLink id="E93" name="deceptive-alignment" /> | Very High | Proofs are immune to deception—a deceptive AI cannot fake a valid proof |
