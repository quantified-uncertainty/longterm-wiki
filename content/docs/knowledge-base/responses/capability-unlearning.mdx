...
|------|-----------|---------------------|-------------|
| <EntityLink id="E42" name="bioweapons" /> | **High** | Removes pathogen synthesis, enhancement knowledge | Dual-use biology knowledge entangled |
