...
<DataExternalLinks pageId="whistleblower-protections" client:load />
...
| **EU Status** | Advancing | <EntityLink id="eu-ai-act">EU AI Act</EntityLink> Article 87 provides explicit whistleblower protections from August 2026; AI Office launched anonymous reporting tool November 2025 |
...
The stakes became concrete in 2024. [Leopold Aschenbrenner](https://en.wikipedia.org/wiki/Leopold_Aschenbrenner), an <EntityLink id="openai">OpenAI</EntityLink> safety researcher, was [fired after writing an internal memo](https://www.transformernews.ai/p/openai-employee-says-he-was-fired) warning that the company's security protocols were "egregiously insufficient" to protect against foreign adversaries stealing model weights. In June 2024, [thirteen current and former employees](https://righttowarn.ai/) from OpenAI, <EntityLink id="anthropic">Anthropic</EntityLink>, and <EntityLink id="deepmind">Google DeepMind</EntityLink> published ["A Right to Warn about Advanced Artificial Intelligence"](https://time.com/6985504/openai-google-deepmind-employees-letter/), stating that confidentiality agreements and fear of retaliation prevented them from raising legitimate safety concerns. Microsoft engineer [Shane Jones reported to the FTC](https://www.cnbc.com/2024/03/06/microsoft-ai-engineer-says-copilot-designer-creates-disturbing-images.html) that Copilot Designer was producing harmful content including sexualized violence and images of minors—and alleged Microsoft's legal team blocked his attempts to alert the public.
...
|------|-----------|---------------|
| <EntityLink id="racing-dynamics">Racing Dynamics</EntityLink> | Employees can expose corner-cutting | Medium |
...
- <EntityLink id="lab-culture">Lab Culture</EntityLink> - Internal safety culture foundations
- <EntityLink id="ai-safety-institutes">AI Safety Institutes</EntityLink> - External bodies to receive disclosures
- Third-Party Auditing - Independent verification
- <EntityLink id="responsible-scaling-policies">Responsible Scaling Policies</EntityLink> - Commitments that whistleblowers can verify
...
|--------|-----------|--------|
| <EntityLink id="civilizational-competence" /> | <EntityLink id="regulatory-capacity" /> | Addresses information asymmetry between companies and external observers |
| <EntityLink id="misalignment-potential" /> | <EntityLink id="safety-culture-strength" /> | Enables safety concerns to surface before catastrophic deployment |
| <EntityLink id="misalignment-potential" /> | <EntityLink id="human-oversight-quality" /> | Provides check on internal governance failures |
