...
<DataExternalLinks pageId="voluntary-commitments" client:load />
...
|-----------|------------|----------|
| **Compliance Rate** | 53% mean (range: 13-83%) | <R id="cf3efa764186024d">Research tracking 30 indicators</R> finds <EntityLink id="openai">OpenAI</EntityLink> (83%), <EntityLink id="anthropic">Anthropic</EntityLink> (80%), Google (77%), Microsoft (73%) leading; Apple lowest (13%) |
| **Behavioral Change** | Low-Moderate | Better red-teaming and watermarking adopted; "nowhere near where we need them" on governance per <R id="c1a25dd9fbd20112">CAIDP</R> |
| **Enforcement** | None (de jure) | Purely voluntary; no penalties for non-compliance; [FTC Section 5](https://www.ftc.gov/policy/advocacy-research/tech-at-ftc/2024/01/ai-companies-uphold-your-privacy-confidentiality-commitments) only potential accountability mechanism |
| **Coverage** | 16 companies | Original 7 (July 2023) expanded to 16 including Apple (July 2024); 16 at [Seoul Summit](https://www.gov.uk/government/publications/frontier-ai-safety-commitments-ai-seoul-summit-2024) (May 2024) |
| **International Scope** | 28+ countries | <R id="243fa770c13b0c44"><EntityLink id="bletchley-declaration">Bletchley Declaration</EntityLink></R> (Nov 2023): 28 countries + EU; <R id="944fc2ac301f8980">Seoul Commitments</R> (May 2024): 27 countries |
| **Durability** | Uncertain | No company has achieved 100% compliance; [MIT Technology Review](https://www.technologyreview.com/2024/07/22/1095193/ai-companies-promised-the-white-house-to-self-regulate-one-year-ago-whats-changed/) notes companies can "always just opt back out again" |
| **First Cohort vs. Second** | 69% vs. 45% compliance | [AIES 2024](https://ojs.aaai.org/index.php/AIES/article/download/36743/38881/40818): First cohort (Jul 2023) mean 69.0% ± 15.6%; second cohort (Sep 2023) mean 44.6% ± 6.4% |

## Overview

<Mermaid client:load chart={`
flowchart TD
    subgraph International["International Frameworks"]
        BLETCH[Bletchley Declaration<br/>28 countries + EU<br/>Nov 2023]
        SEOUL[Seoul Summit Commitments<br/>16 companies<br/>May 2024]
    end

    subgraph USFramework["US Voluntary Framework"]
        WH[White House Commitments<br/>July 2023]
        EIGHT[8 Core Commitments]
        WH --> EIGHT
    end

    subgraph Companies["Company Participation"]
        C1[Cohort 1: 7 companies<br/>Jul 2023]
        C2[Cohort 2: 8 companies<br/>Sep 2023]
        C3[Cohort 3: Apple<br/>Jul 2024]
    end

    subgraph Implementation["Implementation Mechanisms"]
        RSP[Responsible Scaling<br/>Policies]
        EVAL[Internal Evaluations<br/>& Red-teaming]
        REPORT[Public Reporting<br/>& Model Cards]
    end

    subgraph Outcomes["Observed Outcomes"]
        HIGH[High Compliance<br/>Security, Testing<br/>70-85%]
        MED[Moderate Compliance<br/>Reporting, Research<br/>50-65%]
        LOW[Low Compliance<br/>Info Sharing<br/>20-35%]
    end
    ...
    style BLETCH fill:#e6f3ff
    style SEOUL fill:#e6f3ff
    style WH fill:#fff2cc
...
*Compliance rates based on <R id="cf3efa764186024d">AIES 2024 research</R> tracking 30 indicators across companies.*
...
*Scores from <R id="cf3efa764186024d">Do AI Companies Make Good on Voluntary Commitments?</R> (2024).*
...
| Company | Framework | First Published | Current Version | Key Thresholds | SaferAI Grade |
|---------|-----------|-----------------|-----------------|----------------|---------------|
| **Anthropic** | [RSP (ASL System)](https://www.anthropic.com/news/announcing-our-updated-responsible-scaling-policy) | Sep 2023 | Oct 2024 (v2) | ASL-1 through ASL-4; CBRN, autonomy | 1.9 (Weak) |
| **OpenAI** | [Preparedness Framework](https://openai.com/preparedness) | Dec 2023 | Dec 2023 | Low/Medium/High/Critical per domain | 1.8 (Weak) |
| **Google DeepMind** | [Frontier Safety Framework](https://deepmind.google/discover/blog/introducing-the-frontier-safety-framework/) | May 2024 | May 2024 | Critical capability levels | 1.7 (Weak) |
...
*Grades from [SaferAI RSP Tracker](https://www.safer-ai.org/anthropics-responsible-scaling-policy-update-makes-a-step-backwards). Scale: 0-4, where higher is better. All major labs currently rated "Weak" (less than 2.0).*

**Key criticism:** SaferAI notes that [Anthropic's October 2024 update](https://www.safer-ai.org/anthropics-responsible-scaling-policy-update-makes-a-step-backwards) "makes a step backwards" by replacing quantitative benchmarks with qualitative assessments, creating "susceptibility to shifting goalposts as capabilities advance."
...
| Framework | Date | Signatories | Key Focus | Enforcement | Notable Outcomes |
|-----------|------|-------------|-----------|-------------|------------------|
| **White House Commitments** | Jul 2023 | 7 → 16 companies | 8 safety practices | None (voluntary) | Created industry baseline; 53% mean compliance ([AIES 2024](https://ojs.aaai.org/index.php/AIES/article/download/36743/38881/40818)) |
| **[Bletchley Declaration](https://www.gov.uk/government/publications/ai-safety-summit-2023-the-bletchley-declaration)** | Nov 2023 | 28 countries + EU | Frontier AI risks | Moral commitment | First intl. acknowledgment of catastrophic risk; included China |
| **[Seoul Frontier Commitments](https://www.gov.uk/government/publications/frontier-ai-safety-commitments-ai-seoul-summit-2024)** | May 2024 | 16 companies | Risk thresholds | Reputational | First cross-border company commitments; US/China/UAE firms |
...
*Sources: [UK Government](https://www.gov.uk/government/publications/ai-safety-summit-2023-the-bletchley-declaration), [techUK](https://www.techuk.org/resource/key-outcomes-of-the-ai-seoul-summit.html)*
...
| Mechanism | Authority | Scope | Strength | Status (2025) |
|-----------|-----------|-------|----------|---------------|
| **FTC Section 5** | Federal Trade Commission | Deceptive practices | Moderate | Active; [Operation AI Comply](https://www.ftc.gov/business-guidance/blog/2024/09/operation-ai-comply-continuing-crackdown-overpromises-ai-related-lies) launched Sep 2024 |
| **Reputational pressure** | Market/media | Public perception | Weak-Moderate | Effective for consumer-facing companies |
| **Enterprise procurement** | Corporate customers | B2B contracts | Growing | [Frontier Model Forum](https://www.frontiermodelforum.org/) established 2023 |
...
*The [FTC has stated](https://www.ftc.gov/policy/advocacy-research/tech-at-ftc/2024/01/ai-companies-uphold-your-privacy-confidentiality-commitments) it will pursue enforcement where companies fail to honor their privacy and safety commitments, including requiring deletion of models trained on improperly obtained data.*
...
| Commitment Area | Compliance Rate | Best Performer | Worst Performer | Key Gap |
|-----------------|-----------------|----------------|-----------------|---------|
...
*Data from [AIES 2024](https://ojs.aaai.org/index.php/AIES/article/download/36743/38881/40818) and [MIT Technology Review](https://www.technologyreview.com/2024/07/22/1095193/ai-companies-promised-the-white-house-to-self-regulate-one-year-ago-whats-changed/) analysis.*
...
*Sources: [MIT Technology Review](https://www.technologyreview.com/2024/07/22/1095193/ai-companies-promised-the-white-house-to-self-regulate-one-year-ago-whats-changed/), [Carnegie Endowment](https://carnegieendowment.org/research/2024/10/the-ai-governance-arms-race-from-summit-pageantry-to-progress)*
...
Research on voluntary environmental and safety commitments provides insights into when self-regulation succeeds or fails:
...
*Framework based on [ScienceDirect analysis](https://www.sciencedirect.com/science/article/abs/pii/S0160791X21003183) of voluntary safety commitments.*
...
Voluntary commitments affect the <EntityLink id="ai-transition-model" /> through multiple factors:

| Factor | Parameter | Impact |
|--------|-----------|--------|
| <EntityLink id="misalignment-potential" /> | <EntityLink id="safety-culture-strength" /> | Establish safety testing as industry norm (53% mean compliance) |
| <EntityLink id="transition-turbulence" /> | <EntityLink id="racing-intensity" /> | May reduce race to bottom if competitors coordinate |
| <EntityLink id="civilizational-competence" /> | <EntityLink id="institutional-quality" /> | Create precedents and templates for eventual mandatory requirements |
