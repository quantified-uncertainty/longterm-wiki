...
|-----------|------------|----------|
| **Compliance Rate** | 53% mean (range: 13-83%) | <R id="cf3efa764186024d">Research tracking 30 indicators</R> finds <EntityLink id="E218" name="openai">OpenAI</EntityLink> (83%), <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> (80%), Google (77%), Microsoft (73%) leading; Apple lowest (13%) |
...
| **International Scope** | 28+ countries | <R id="243fa770c13b0c44"><EntityLink id="E469" name="bletchley-declaration">Bletchley Declaration</EntityLink></R> (Nov 2023): 28 countries + EU; <R id="944fc2ac301f8980">Seoul Commitments</R> (May 2024): 27 countries |
