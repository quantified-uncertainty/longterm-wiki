...
|-----------|------------|----------|
| **Compliance Rate** | 53% mean (range: 13-83%) | <R id="MzMwZDY4Yj">Research tracking 30 indicators</R> finds <EntityLink id="E218" name="openai">OpenAI</EntityLink> (83%), <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> (80%), Google (77%), Microsoft (73%) leading; Apple lowest (13%) |
| **Behavioral Change** | Low-Moderate | Better red-teaming and watermarking adopted; "nowhere near where we need them" on governance per <R id="YTU2YmI5ZT">CAIDP</R> |
...
| **International Scope** | 28+ countries | <R id="NTJiM2ZhM2"><EntityLink id="E469" name="bletchley-declaration">Bletchley Declaration</EntityLink></R> (Nov 2023): 28 countries + EU; <R id="YmVmM2UwNW">Seoul Commitments</R> (May 2024): 27 countries |
...
*Compliance rates based on <R id="MzMwZDY4Yj">AIES 2024 research</R> tracking 30 indicators across companies.*
...
*Scores from <R id="MzMwZDY4Yj">Do AI Companies Make Good on Voluntary Commitments?</R> (2024).*
