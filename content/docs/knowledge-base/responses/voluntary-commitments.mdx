...
|-----------|------------|----------|
| **Compliance Rate** | 53% mean (range: 13-83%) | <R id="cf3efa764186024d">Research tracking 30 indicators</R> finds <EntityLink id="E218">OpenAI</EntityLink> (83%), <EntityLink id="E22">Anthropic</EntityLink> (80%), Google (77%), Microsoft (73%) leading; Apple lowest (13%) |
...
| **International Scope** | 28+ countries | <R id="243fa770c13b0c44"><EntityLink id="E469">Bletchley Declaration</EntityLink></R> (Nov 2023): 28 countries + EU; <R id="944fc2ac301f8980">Seoul Commitments</R> (May 2024): 27 countries |
...
|--------|-----------|--------|
| <EntityLink id="E205" /> | <EntityLink id="E264" /> | Establish safety testing as industry norm (53% mean compliance) |
| <EntityLink id="E358" /> | <EntityLink id="E242" /> | May reduce race to bottom if competitors coordinate |
| <EntityLink id="E60" /> | <EntityLink id="E167" /> | Create precedents and templates for eventual mandatory requirements |
