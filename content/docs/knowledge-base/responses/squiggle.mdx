...
<EntityLink id="E287">SquiggleAI</EntityLink> integrates LLMs for:
...
While <EntityLink id="E200">Metaforecast</EntityLink> doesn't directly use Squiggle, it complements the ecosystem by aggregating forecasts that can inform Squiggle model inputs.
