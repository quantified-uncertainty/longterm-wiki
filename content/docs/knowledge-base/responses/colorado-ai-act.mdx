...
update_frequency: 7
summary: "Colorado's AI Act (SB 205) is the first comprehensive US state AI regulation targeting algorithmic discrimination in employment, housing, and other consequential decisions, with enforcement beginning June 2026 and penalties up to \\$20,000 per violation. The law faces federal challenge via Trump's December 2025 executive order directing DOJ litigation, while serving as a template for 5-10 other states considering similar legislation."
clusters:
  - governance
  - ai-safety
---
...
## Comparison with <EntityLink id="E127" name="eu-ai-act">EU AI Act</EntityLink>
