...
| **Key Proponents** | <EntityLink id="E218" name="openai">OpenAI</EntityLink>, <EntityLink id="E22" name="anthropic">Anthropic</EntityLink>, Google | Part of standard safety training |
...
| <EntityLink id="E42" name="bioweapons" /> | Medium | Refuses synthesis instructions | Information often available elsewhere |
| Cyberattacks | Medium | Declines to write malware | Determined attackers can jailbreak |
| <EntityLink id="E93" name="deceptive-alignment" /> | None | No protection | Deceptive models would pass refusal training |
| <EntityLink id="E274" name="scheming" /> | None | No protection | Scheming models optimize for passing training |
| <EntityLink id="E151" name="goal-misgeneralization" /> | None | No protection | Addresses outputs, not goals |
