...
| **Key Proponents** | <EntityLink id="E218">OpenAI</EntityLink>, <EntityLink id="E22">Anthropic</EntityLink>, Google | Part of standard safety training |
...
|------|-----------|---------------------------|-------------|
| <EntityLink id="E207" /> | High | Blocks obvious harmful requests | Bypassed by sophisticated users |
| <EntityLink id="E42" /> | Medium | Refuses synthesis instructions | Information often available elsewhere |
| <EntityLink id="cyberattacks" /> | Medium | Declines to write malware | Determined attackers can jailbreak |
| <EntityLink id="E93" /> | None | No protection | Deceptive models would pass refusal training |
| <EntityLink id="E274" /> | None | No protection | Scheming models optimize for passing training |
| <EntityLink id="E151" /> | None | No protection | Addresses outputs, not goals |
...
Refusal training affects the <EntityLink id="ai-transition-model" /> primarily through <EntityLink id="E207" />:

| Parameter | Impact |
|-----------|--------|
| <EntityLink id="E207" /> | Moderate reduction in casual misuse |
| <EntityLink id="E20" /> | No meaningful improvement |
