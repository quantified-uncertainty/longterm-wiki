...
| **Research Investment** | High | Active area across <EntityLink id="E22" name="anthropic">Anthropic</EntityLink>, <EntityLink id="E218" name="openai">OpenAI</EntityLink>, Meta, DeepSeek; multiple variants published in 2024-2025 |
...
|------|-----------|---------------|
| <EntityLink id="E253" name="reward-hacking">Reward Hacking</EntityLink> | Implicit rewards harder to hack | Medium |
| <EntityLink id="E124" name="epistemic-sycophancy">Sycophancy</EntityLink> | Better preference data can reduce | Medium |
| <EntityLink id="E151" name="goal-misgeneralization">Goal Misgeneralization</EntityLink> | More stable training may help | Low-Medium |

## Complementary Interventions

- <EntityLink id="E259" name="rlhf">RLHF & Constitutional AI</EntityLink> - The baseline these methods improve upon
- <EntityLink id="E128" name="evals">Evaluations</EntityLink> - Essential for validating preference learning
- <EntityLink id="E271" name="scalable-oversight">Scalable Oversight</EntityLink> - Better human feedback for preferences
- <EntityLink id="E479" name="representation-engineering">Representation Engineering</EntityLink> - Verify alignment beyond behavioral preferences
