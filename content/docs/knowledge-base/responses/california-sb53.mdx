...
The path to SB 53 began with the more ambitious SB 1047, authored by Senator <EntityLink id="E1471" name="scott-wiener">Scott Wiener</EntityLink> and passed by the California Legislature in 2024. That bill included stricter requirements such as pre-training safety protocols, third-party audits, "kill switch" capabilities, 72-hour incident reporting deadlines, and penalties of up to 30% of compute costs. However, Governor Newsom vetoed SB 1047, calling instead for an approach "informed by an empirical trajectory analysis of AI systems and capabilities."[^rc-9ca2]
