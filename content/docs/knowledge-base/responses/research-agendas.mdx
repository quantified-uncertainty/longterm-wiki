...
entityType: approach
---
import {ComparisonTable, DataInfoBox, DisagreementMap, KeyQuestions, Mermaid, R, EntityLink, DataExternalLinks, F} from '@components/wiki';
