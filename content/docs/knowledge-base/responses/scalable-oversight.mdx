...
<DataExternalLinks pageId="scalable-oversight" client:load />
...
|-----------|------------|----------|
| **Tractability** | Medium | <EntityLink id="process-supervision">Process supervision</EntityLink> shows 10-30% accuracy gains; debate shows 60-80% on factual questions but 50-65% on complex reasoning |
...
| **Investment** | \$10-60M/year, 50-100 FTE researchers | Major labs (<EntityLink id="openai">OpenAI</EntityLink>, <EntityLink id="anthropic">Anthropic</EntityLink>, DeepMind) have dedicated teams |
...
**Debate shows promise for adversarial settings** but faces concerning challenges with sophisticated deception. Recent findings on <R id="1b51b366182d416d">confidence escalation in debates</R> reveal that LLMs become overconfident when facing opposition, potentially undermining the truth-seeking properties that make debate theoretically attractive. Research on <R id="876ff73c8dabecf8">controversial claims assessment</R> found debate significantly improves human accuracy on COVID-19 and climate change topics compared to single-advisor consultancy, even when judges hold strong prior beliefs.
...
**Hybrid approaches combining multiple techniques** represent a promising direction, potentially overcoming individual limitations. <R id="72d83671b5f929a1">Anthropic's research program</R> explores combinations of Constitutional AI (RLAIF), debate variants, process supervision, and AI-assisted evaluation to create more robust oversight systems.
...
The field benefits from relatively strong institutional support within the AI safety community. Scalable oversight is recognized as a core technical challenge by most major AI safety research agendas. Funding organizations including <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> (then Open Philanthropy), FTX Future Fund (before its closure), and various government agencies have provided substantial support for research in this area. However, the pace of empirical validation remains slow relative to the urgency of the challenge, with most studies taking 6-12 months to complete and often focusing on toy problems rather than realistic deployment scenarios.
...
- **Irving et al. (2018):** <R id="61da2f8e311a2bbf">AI safety via debate</R> - Original debate proposal by Geoffrey Irving, Paul Christiano, and Dario Amodei
- **Christiano et al. (2018):** <R id="50127ce5fac4e84b">New safety research agenda: scalable agent alignment via reward modeling</R> - Paul Christiano's framework for recursive reward modeling
- **OpenAI (2018):** <R id="ca07d6bcd57e7027">Learning complex goals with iterated amplification</R> - Practical implementation of recursive decomposition

### Process Supervision

- **Lightman et al. (2023):** <R id="eea50d24e41938ed">Let's Verify Step by Step</R> - OpenAI's influential process supervision paper showing 78.2% vs 72.4% accuracy
- **OpenAI (2023):** <R id="eccb4758de07641b">PRM800K dataset</R> - 800,000 step-level correctness labels for mathematical reasoning
- **Mistry (2024):** <R id="48af4178dfb735bd">Let's Verify Step by Step: How OpenAI o1 was created</R> - Process supervision influence on o1 models

### Debate Research (2024)

- **Khan et al. (2024):** <R id="5bf590d69438a2f2">Training Language Models to Win Debates with Self-Play Improves Judge Accuracy</R> - Shows +4% judge accuracy from debate training
- **Khan et al. (2024):** <R id="876ff73c8dabecf8">AI Debate Aids Assessment of Controversial Claims</R> - Debate improves accuracy on COVID-19 and climate topics
- **Debate Competition (2024):** <R id="1b51b366182d416d">When Two LLMs Debate, Both Think They'll Win</R> - Confidence escalation challenges
- **Chen et al. (2024):** <R id="c0aa2a41806c68b4">Debate, Deliberate, Decide (D3): Cost-Aware Adversarial Framework</R> - Adversarial multi-agent evaluation framework
- **Du et al. (2023):** <R id="992190a4815d67ed">Improving Factuality and Reasoning through Multiagent Debate</R> - Multi-agent debate benefits

### Scalable Oversight Frameworks

- **Bowman et al. (2022):** <R id="b0f6f129f201e4dc">Measuring Progress on Scalable Oversight for Large Language Models</R> - Anthropic's framework paper
- **Anthropic (2022):** <R id="72d83671b5f929a1">Measuring Progress on Scalable Oversight</R> - Blog post overview
- **Anthropic (2025):** <R id="7ae6b3be2d2043c1">Recommendations for Technical AI Safety Research Directions</R> - Current research priorities including scalable oversight
- **Piskala (2024):** <R id="7302eddb7b84605e">Scalable Oversight in AI: Beyond Human Supervision</R> - Overview of approaches

### Advanced Topics

- **Recent Research (2025):** <R id="7d37015995295bb2">Scalable Oversight for Superhuman AI via Recursive Self-Critiquing</R> - Cutting-edge recursive approaches
- **Recent Research (2024):** <R id="c6b9542a053d41e1">Scalable Oversight via Partitioned Human Supervision</R> - Novel supervision partitioning
- **Recent Research (2024):** <R id="08c92819cc0fc2dd">Scaling Laws For Scalable Oversight</R> - Theoretical scaling analysis

### Related Frameworks

- **Alignment Survey:** <R id="14d1c8e3a3ef284b">Scalable Oversight | AI Alignment</R> - Educational resource
- **Jan Leike:** <R id="2a84eb0982d4de6a">Personal website</R> - Key researcher in scalable oversight

---

## AI Transition Model Context

Scalable oversight improves the <EntityLink id="ai-transition-model" /> through <EntityLink id="misalignment-potential" />:

| Factor | Parameter | Impact |
|--------|-----------|--------|
| <EntityLink id="misalignment-potential" /> | <EntityLink id="human-oversight-quality" /> | Extends human supervision to tasks beyond direct evaluation capability |
| <EntityLink id="misalignment-potential" /> | <EntityLink id="alignment-robustness" /> | Process supervision helps verify alignment properties persist at scale |
| <EntityLink id="misalignment-potential" /> | <EntityLink id="safety-capability-gap" /> | Maintains safety margin as AI capabilities grow beyond human-level |
