...
- **Irving et al. (2018):** <R id="OTU2YWU4MW">AI safety via debate</R> - Original debate proposal by Geoffrey Irving, <EntityLink id="E220" name="paul-christiano">Paul Christiano</EntityLink>, and <EntityLink id="E91" name="dario-amodei">Dario Amodei</EntityLink>
- **Christiano et al. (2018):** <R id="MTFhNDhhYm">New safety research agenda: scalable agent alignment via reward modeling</R> - Paul Christiano's framework for recursive reward modeling
- **OpenAI (2018):** <R id="MzI2YWRhZW">Learning complex goals with iterated amplification</R> - Practical implementation of recursive decomposition

### Process Supervision

- **Lightman et al. (2023):** <R id="NjkxZmYyYT">Let's Verify Step by Step</R> - OpenAI's influential process supervision paper showing 78.2% vs 72.4% accuracy
- **OpenAI (2023):** <R id="YTZhN2Q5Yj">PRM800K dataset</R> - 800,000 step-level correctness labels for mathematical reasoning
- **Mistry (2024):** <R id="ZGU3OWU1ZG">Let's Verify Step by Step: How OpenAI o1 was created</R> - Process supervision influence on o1 models

### Debate Research (2024)

- **Khan et al. (2024):** <R id="MjlhZWEwMD">Training Language Models to Win Debates with Self-Play Improves Judge Accuracy</R> - Shows +4% judge accuracy from debate training
- **Khan et al. (2024):** <R id="MmY5ZjczMW">AI Debate Aids Assessment of Controversial Claims</R> - Debate improves accuracy on COVID-19 and climate topics
- **Debate Competition (2024):** <R id="NTQzN2FlYm">When Two LLMs Debate, Both Think They'll Win</R> - Confidence escalation challenges
- **Chen et al. (2024):** <R id="YzdhMjllNj">Debate, Deliberate, Decide (D3): Cost-Aware Adversarial Framework</R> - Adversarial multi-agent evaluation framework
- **Du et al. (2023):** <R id="ZWFmOTA5NG">Improving Factuality and Reasoning through Multiagent Debate</R> - Multi-agent debate benefits

### Scalable Oversight Frameworks

- **Bowman et al. (2022):** <R id="NTZjNGJkMj">Measuring Progress on Scalable Oversight for Large Language Models</R> - Anthropic's framework paper
- **Anthropic (2022):** <R id="MjM2MWUzMm">Measuring Progress on Scalable Oversight</R> - Blog post overview
- **Anthropic (2025):** <R id="YTNhM2JjOT">Recommendations for Technical AI Safety Research Directions</R> - Current research priorities including scalable oversight
- **Piskala (2024):** <R id="MjMwNzRkMG">Scalable Oversight in AI: Beyond Human Supervision</R> - Overview of approaches

### Advanced Topics

- **Recent Research (2025):** <R id="MjM5MzhlYm">Scalable Oversight for Superhuman AI via Recursive Self-Critiquing</R> - Cutting-edge recursive approaches
- **Recent Research (2024):** <R id="YmQxNTBhNj">Scalable Oversight via Partitioned Human Supervision</R> - Novel supervision partitioning
- **Recent Research (2024):** <R id="NmZhMjNiMT">Scaling Laws For Scalable Oversight</R> - Theoretical scaling analysis

### Related Frameworks

- **Alignment Survey:** <R id="MWViNmVmY2">Scalable Oversight | AI Alignment</R> - Educational resource
- **<EntityLink id="E182" name="jan-leike">Jan Leike</EntityLink>:** <R id="NWNjNGViNm">Personal website</R> - Key researcher in scalable oversight
