...
update_frequency: 90
summary: Process supervision achieves 78.2% accuracy on MATH benchmarks (vs 72.4% outcome-based) and is deployed in OpenAI's o1 models, while debate shows 60-80% accuracy on factual questions with +4% improvement from self-play training. However, effectiveness against sophisticated deception remains unproven, with debate accuracy dropping to 50-65% on complex reasoning tasks.
clusters:
  - ai-safety
todos:
...
|-----------|------------|----------|
| **Tractability** | Medium | <EntityLink id="E455" name="process-supervision">Process supervision</EntityLink> shows 10-30% accuracy gains; debate shows 60-80% on factual questions but 50-65% on complex reasoning |
...
| **Investment** | \$10-60M/year, 50-100 FTE researchers | Major labs (<EntityLink id="E218" name="openai">OpenAI</EntityLink>, <EntityLink id="E22" name="anthropic">Anthropic</EntityLink>, DeepMind) have dedicated teams |
...
**Debate shows promise for adversarial settings** but faces concerning challenges with sophisticated deception. Recent findings on <R id="sid_UP9W9uxqqn">confidence escalation in debates</R> reveal that LLMs become overconfident when facing opposition, potentially undermining the truth-seeking properties that make debate theoretically attractive. Research on <R id="sid_kiPSnDBVBJ">controversial claims assessment</R> found debate significantly improves human accuracy on COVID-19 and climate change topics compared to single-advisor consultancy, even when judges hold strong prior beliefs.
...
The field benefits from relatively strong institutional support within the AI safety community. Scalable oversight is recognized as a core technical challenge by most major AI safety research agendas. Funding organizations including <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> (then Open Philanthropy), FTX Future Fund (before its closure), and various government agencies have provided substantial support for research in this area. However, the pace of empirical validation remains slow relative to the urgency of the challenge, with most studies taking 6-12 months to complete and often focusing on toy problems rather than realistic deployment scenarios.
...
- **Irving et al. (2018):** <R id="sid_1BBwauxc4c">AI safety via debate</R> - Original debate proposal by Geoffrey Irving, <EntityLink id="E220" name="paul-christiano">Paul Christiano</EntityLink>, and <EntityLink id="E91" name="dario-amodei">Dario Amodei</EntityLink>
- **Christiano et al. (2018):** <R id="sid_DO9cxnAnZk">New safety research agenda: scalable agent alignment via reward modeling</R> - Paul Christiano's framework for recursive reward modeling
- **OpenAI (2018):** <R id="sid_QyoXbdo9sZ">Learning complex goals with iterated amplification</R> - Practical implementation of recursive decomposition

### Process Supervision

- **Lightman et al. (2023):** <R id="sid_pvULRtMndL">Let's Verify Step by Step</R> - OpenAI's influential process supervision paper showing 78.2% vs 72.4% accuracy
- **OpenAI (2023):** <R id="sid_xcnS5dcMHy">PRM800K dataset</R> - 800,000 step-level correctness labels for mathematical reasoning
- **Mistry (2024):** <R id="sid_bkREEv60no">Let's Verify Step by Step: How OpenAI o1 was created</R> - Process supervision influence on o1 models

### Debate Research (2024)

- **Khan et al. (2024):** <R id="sid_VIvIyeu3Iv">Training Language Models to Win Debates with Self-Play Improves Judge Accuracy</R> - Shows +4% judge accuracy from debate training
- **Khan et al. (2024):** <R id="sid_kiPSnDBVBJ">AI Debate Aids Assessment of Controversial Claims</R> - Debate improves accuracy on COVID-19 and climate topics
- **Debate Competition (2024):** <R id="sid_UP9W9uxqqn">When Two LLMs Debate, Both Think They'll Win</R> - Confidence escalation challenges
- **Chen et al. (2024):** <R id="sid_h9pTf6A1vu">Debate, Deliberate, Decide (D3): Cost-Aware Adversarial Framework</R> - Adversarial multi-agent evaluation framework
- **Du et al. (2023):** <R id="sid_jOhmmQyz7R">Improving Factuality and Reasoning through Multiagent Debate</R> - Multi-agent debate benefits

### Scalable Oversight Frameworks

- **Bowman et al. (2022):** <R id="sid_ggnwDaNX9I">Measuring Progress on Scalable Oversight for Large Language Models</R> - Anthropic's framework paper
- **Anthropic (2022):** <R id="sid_aS6NS4rvu0">Measuring Progress on Scalable Oversight</R> - Blog post overview
- **Anthropic (2025):** <R id="sid_gN4b0hOdEP">Recommendations for Technical AI Safety Research Directions</R> - Current research priorities including scalable oversight
- **Piskala (2024):** <R id="sid_Kb15hiynl4">Scalable Oversight in AI: Beyond Human Supervision</R> - Overview of approaches

### Advanced Topics

- **Recent Research (2025):** <R id="sid_n6jcq4DLCC">Scalable Oversight for Superhuman AI via Recursive Self-Critiquing</R> - Cutting-edge recursive approaches
- **Recent Research (2024):** <R id="sid_gXdrz8dv5R">Scalable Oversight via Partitioned Human Supervision</R> - Novel supervision partitioning
- **Recent Research (2024):** <R id="sid_hdjfuHL9PA">Scaling Laws For Scalable Oversight</R> - Theoretical scaling analysis

### Related Frameworks

- **Alignment Survey:** <R id="sid_TiZ99vmH4O">Scalable Oversight | AI Alignment</R> - Educational resource
- **<EntityLink id="E182" name="jan-leike">Jan Leike</EntityLink>:** <R id="sid_GlLngss3oh">Personal website</R> - Key researcher in scalable oversight
