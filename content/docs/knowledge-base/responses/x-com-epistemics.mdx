...
flowchart TD
    ...
    subgraph Negative["Negative Epistemic Features"]
...
The research consensus on X's algorithm is clear. A preregistered algorithmic audit published in [PNAS Nexus (March 2025)](https://www.science.org/doi/10.1126/science.adu5584) found that X's engagement-based algorithm amplifies emotionally charged, out-group hostile content that makes users feel worse about their political opponents. Users reported they did not prefer the political tweets selected by the algorithm.
