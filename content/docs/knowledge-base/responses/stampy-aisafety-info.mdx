...
- Forums: Alignment Forum, <EntityLink id="E538">LessWrong</EntityLink>, EA Forum
- Organizational blogs: <EntityLink id="E202">MIRI</EntityLink>, DeepMind, <EntityLink id="E218">OpenAI</EntityLink>
- Individual blogs: <EntityLink id="E114">Eliezer Yudkowsky</EntityLink>, <EntityLink id="E574">Gwern Branwen</EntityLink>
...
| **<EntityLink id="E547">Manifund</EntityLink>** | Project funding platform |
