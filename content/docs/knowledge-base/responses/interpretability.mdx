...
---
import {DataInfoBox, KeyPeople, Section, Backlinks, DisagreementMap, KeyQuestions, Mermaid, R, EntityLink, DataExternalLinks, KeyTakeaways} from '@components/wiki';
...
<Backlinks entityId="interpretability" />
