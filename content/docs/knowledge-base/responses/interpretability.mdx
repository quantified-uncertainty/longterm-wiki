...
---
import {DataInfoBox, KeyPeople, Section, Backlinks, DisagreementMap, KeyQuestions, Mermaid, R, EntityLink, DataExternalLinks} from '@components/wiki';

<DataExternalLinks pageId="interpretability" client:load />
