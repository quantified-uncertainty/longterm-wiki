...
| Pre-deployment Testing | Basic | Extensive | Moderate | <R id="45370a5153534152"><EntityLink id="E201" name="metr">METR</EntityLink></R> evaluations |
...
| <R id="a306e0b63bdedbd5"><EntityLink id="E47" name="cais">Center for AI Safety</EntityLink></R> | Industry safety practices | Significant gaps between commitments and implementation |
...
|---------------|-------------|---------|
| Government Reports | <EntityLink id="E216" name="nist-ai-rmf">NIST AI Risk Management Framework</EntityLink> | <R id="54dbc15413425997">NIST.gov</R> |
