...
|--------------|------------------|---------------|-----------------|
| <EntityLink id="openai">OpenAI</EntityLink> | ≈100-150 | \$10-100M | Alignment, <EntityLink id="red-teaming">red teaming</EntityLink>, policy |
| <EntityLink id="anthropic">Anthropic</EntityLink> | ≈80-120 | \$40-80M | <EntityLink id="constitutional-ai">Constitutional AI</EntityLink>, interpretability |
...
**Industry Forums:** The <EntityLink id="frontier-model-forum">Frontier Model Forum</EntityLink> and Partnership on AI facilitate collaboration on safety research, common definitions, and best practices, though critics note these lack binding authority.
...
| Pre-deployment Testing | Basic | Extensive | Moderate | <R id="45370a5153534152"><EntityLink id="metr">METR</EntityLink></R> evaluations |
...
**Skeptical Assessment** (<EntityLink id="eliezer-yudkowsky">Eliezer Yudkowsky</EntityLink>, <EntityLink id="miri">MIRI</EntityLink>):
...
| Source | Focus Area | Key Findings |
|--------|------------|--------------|
| <R id="0532c540957038e6">RAND Corporation</R> | Corporate <EntityLink id="ai-governance">AI governance</EntityLink> | Mixed effectiveness of voluntary approaches |
| <R id="a306e0b63bdedbd5"><EntityLink id="cais">Center for AI Safety</EntityLink></R> | Industry safety practices | Significant gaps between commitments and implementation |
...
|---------------|-------------|---------|
| Government Reports | <EntityLink id="nist-ai-rmf">NIST AI Risk Management Framework</EntityLink> | <R id="54dbc15413425997">NIST.gov</R> |
