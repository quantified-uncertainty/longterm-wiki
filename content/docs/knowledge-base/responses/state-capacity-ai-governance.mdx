...
The challenge is acute: if governments cannot build functional IT systems—as seen in Healthcare.gov's initial collapse and state unemployment systems crashing during COVID—they face even greater challenges overseeing AI systems. <EntityLink id="E64" name="compute-governance">Compute governance</EntityLink>, algorithmic auditing, safety evaluations, and transparency requirements all require government staff who understand the technology. Without that capacity, regulation risks being either toothless or counterproductive.[^3]
...
[^6]: [Ezra Klein on AI and Washington DC](https://80000hours.org/podcast/episodes/ezra-klein-ai-and-dc/) - <EntityLink id="E510" name="80000-hours">80,000 Hours</EntityLink> Podcast
...
[^14]: [Holden Karnofsky on Concrete AI Safety at Frontier AI Companies](https://80000hours.org/podcast/episodes/holden-karnofsky-concrete-ai-safety-frontier-ai-companies/) - <EntityLink id="E510" name="80000-hours">80,000 Hours</EntityLink> Podcast
...
<References
  pageId="state-capacity-ai-governance"
  ids={[
    "df46edd6fa2078d1",
  ]}
/>
