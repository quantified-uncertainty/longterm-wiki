...
The Department of Government Efficiency (DOGE) initiative in 2025-2026 provides a cautionary example of what happens when technology is deployed without state capacity. DOGE fired or scattered much of the civic tech workforce, dismantled 18F entirely (~85 employees laid off via 1 AM email on February 28, 2025), and reduced USDS from ~230 to ~50-89 employees through a combination of firings and protest resignations. It then used AI tools (the "DOGE AI Deregulation Decision Tool") to scan 200,000 federal rules for elimination—precisely the kind of crude, capacity-poor approach that Pahlka's framework warns against.[^rc-fc7c] In total, 317,000+ federal employees left government service in 2025—the largest peacetime workforce cut on record—including 17,000+ IT and telecommunications workers.
