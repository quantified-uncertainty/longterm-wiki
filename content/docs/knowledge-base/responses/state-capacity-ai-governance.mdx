...
| **Current Status** | Deteriorating—DOGE initiative significantly reduced federal civic tech capacity |
...
The challenge is acute: if governments cannot build functional IT systems—as seen in Healthcare.gov's initial collapse and state unemployment systems crashing during COVID—they face even greater challenges overseeing AI systems. <EntityLink id="E64" name="compute-governance">Compute governance</EntityLink>, algorithmic auditing, safety evaluations, and transparency requirements all require government staff who understand the technology.[^rc-a227]
...
The Department of Government Efficiency (DOGE) initiative in 2025-2026 provides a cautionary example of what happens when technology is deployed without state capacity. DOGE reduced USDS from ~230 to ~50 employees through a combination of firings and protest resignations (it later recovered to ~89 by September 2025).[^rc-fc7c] In total, 317,000+ federal employees left government service in 2025—the largest peacetime workforce cut on record—including 17,000+ IT and telecommunications workers.[^rc-fc7c]
