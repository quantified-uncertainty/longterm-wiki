...
|-----------|------------|----------|
| Tractability | **Moderate** | Wikipedia achieved 60M+ articles with volunteer model; C2PA standard adoption accelerating with Google, Meta, <EntityLink id="E218">OpenAI</EntityLink> joining in 2024 |
...
| Governance Readiness | **Low** | No <EntityLink id="E171">international coordination</EntityLink> on epistemic standards; fragmented national approaches |
...
Epistemic infrastructure improves the <EntityLink id="ai-transition-model" /> through <EntityLink id="E60" />:

| Factor | Parameter | Impact |
|--------|-----------|--------|
| <EntityLink id="E60" /> | <EntityLink id="E121" /> | AI fact-checking at 85-87% accuracy enables scaled verification |
| <EntityLink id="E60" /> | <EntityLink id="E285" /> | Community Notes reduces misinformation engagement by 33-35% |
| <EntityLink id="E60" /> | <EntityLink id="E164" /> | Knowledge preservation systems protect against epistemic collapse |
