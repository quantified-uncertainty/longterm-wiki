...
| **Misinformation** | <EntityLink id="E96" name="deepfakes">Deepfakes</EntityLink>, manipulation | AI-generated <EntityLink id="E102" name="disinformation">disinformation</EntityLink> |
| **Malicious Actors & Misuse** | Cyberattacks, weapons | <EntityLink id="E35" name="autonomous-weapons">Autonomous weapons</EntityLink> |
| **Human-Computer Interaction** | Overreliance, manipulation | <EntityLink id="E32" name="automation-bias">Automation bias</EntityLink> |
| **Socioeconomic & Environmental** | Job displacement, energy use | Labor market disruption |
| **AI System Safety** | Failures, alignment issues | <EntityLink id="E151" name="goal-misgeneralization">Goal misgeneralization</EntityLink> |
...
| **<EntityLink id="E127" name="eu-ai-act">EU AI Act</EntityLink> Categories** | Regulatory compliance | Regulatory risks | Legislative cycle |
| **<EntityLink id="E382" name="stampy-aisafety-info">AISafety.info</EntityLink>** | <EntityLink id="E598" name="public-education">Public education</EntityLink> | Conceptual | Community-driven |
