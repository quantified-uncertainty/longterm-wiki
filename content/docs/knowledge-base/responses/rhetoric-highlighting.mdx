...
**Author rhetoric profiles**: Aggregate rhetoric patterns across an author's or organization's body of work. "This author uses emotional language 3x more than the domain average" or "This organization's press releases consistently use absolute safety claims." This connects rhetoric highlighting to <EntityLink id="E599" name="reliability-tracking">reliability tracking</EntityLink>.
