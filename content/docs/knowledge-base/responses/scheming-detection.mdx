...
| **Research Investment** | Growing | Apollo, <EntityLink id="E22" name="anthropic">Anthropic</EntityLink>, OpenAI, UK AISI, <EntityLink id="E201" name="metr">METR</EntityLink> all actively researching; renewed partnerships in 2025 |
| **Key Proponents** | <EntityLink id="E24" name="apollo-research">Apollo Research</EntityLink>, Anthropic, OpenAI | Apollo leads evals; Anthropic leads interpretability; OpenAI leads deliberative alignment |
...
|------|-----------|---------------|
| <EntityLink id="E93" name="deceptive-alignment">Deceptive Alignment</EntityLink> | Direct detection of deceptive behavior | Medium |
| <EntityLink id="E274" name="scheming">Scheming</EntityLink> | Behavioral and internal monitoring | Medium |
| <EntityLink id="E197" name="mesa-optimization">Mesa-Optimization</EntityLink> | Detection of goal-directed behavior | Low-Medium |
| Treacherous turn | Early warning of capability for defection | Medium |

## Complementary Interventions

- <EntityLink id="E174" name="interpretability">Mechanistic Interpretability</EntityLink> - Deeper understanding to detect internal deception
- <EntityLink id="E479" name="representation-engineering">Representation Engineering</EntityLink> - Probe for deception-related representations
- <EntityLink id="E6" name="ai-control">AI Control</EntityLink> - Design systems safe even if scheming occurs
- <EntityLink id="E128" name="evals">Evaluations</EntityLink> - Behavioral tests for scheming
- <EntityLink id="E271" name="scalable-oversight">Scalable Oversight</EntityLink> - Maintain human oversight that scheming can't circumvent
