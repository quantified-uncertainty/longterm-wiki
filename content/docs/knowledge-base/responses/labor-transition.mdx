...
| <EntityLink id="E239" name="racing-dynamics">Racing dynamics</EntityLink> | Reduces cost-cutting pressure | Low-Medium |

## Complementary Interventions

- <EntityLink id="E123" name="epistemic-security">Epistemic Security</EntityLink> - Maintaining social trust during transition
- AI Governance - Regulatory frameworks that include worker protections
- <EntityLink id="E598" name="public-education">Public Education</EntityLink> - Building understanding of AI impacts
