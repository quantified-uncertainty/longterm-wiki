...
---
import {DataInfoBox, DisagreementMap, KeyQuestions, Backlinks, R, EntityLink, DataExternalLinks, Mermaid} from '@components/wiki';

<DataExternalLinks pageId="governance-policy" client:load />
