...
According to <R id="NjhmMTZjMG">Fortune Asia</R>, NVIDIA's China sales dropped to a "mid-single-digit percentage" of data center revenue by early 2024. CEO Jensen Huang stated that NVIDIA's market share for restricted AI GPUs in China fell from 95% to "zero" following export controls.
