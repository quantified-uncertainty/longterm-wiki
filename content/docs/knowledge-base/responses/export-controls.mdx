...
---
import {DataInfoBox, KeyQuestions, Backlinks, DisagreementMap, Mermaid, R, EntityLink, DataExternalLinks} from '@components/wiki';

<DataExternalLinks pageId="export-controls" client:load />
...
This page covers **export controls**—one approach within the broader Compute Governance framework. See also: <EntityLink id="thresholds">Thresholds</EntityLink>, <EntityLink id="monitoring">Monitoring</EntityLink>, <EntityLink id="international-regimes">International Regimes</EntityLink>.
:::
...
According to <R id="7d8aca0fa386ccab">Fortune Asia</R>, NVIDIA's China sales dropped to a "mid-single-digit percentage" of data center revenue by early 2024. CEO Jensen Huang stated that NVIDIA's market share for restricted AI GPUs in China fell from 95% to "zero" following export controls.

Chinese technology companies have publicly acknowledged the impact while announcing alternative strategies. Baidu has increased investment in its domestic Kunlun chip development, while Alibaba has accelerated development of its Yitian processors. China launched <R id="c9e18a9761bb4d7d">Big Fund III</R> in May 2024 with \$47.5 billion in registered capital—the largest phase of China's semiconductor investment program—bringing total state-backed investment across all three phases to approximately \$188 billion.

### Circumvention and Adaptation

Despite these impacts, substantial circumvention activity has been documented. According to <R id="c22de86eabd0fc37">CNAS</R>, an estimated **140,000 high-performance GPUs worth billions of dollars were smuggled into China in 2024 alone**. <R id="949bc1bb26c234b0">The Information</R> identified at least eight Chinese AI chip-smuggling networks, each engaged in transactions valued at more than \$100 million.
...
Semiconductor manufacturing equipment controls likely impose longer delays than chip controls, as building advanced fabrication capabilities requires 3-7 years even with unlimited resources and access to foreign talent. <R id="dfda5c53f10364b3">CSIS analysis</R> notes that SMIC has struggled to achieve consistent 7nm production yields comparable to TSMC's mature processes. According to <R id="a554ce016d832ca3">American Affairs Journal</R>, SMIC uses "double patterning" with DUV equipment to achieve 7nm, but this process is "time consuming and expensive, making it difficult to manufacture at volume scale." It is "increasingly clear that SMIC will not be able to get to something that can be called a 3 nanometer process using its existing DUV tools."
...
The case of <R id="46d731b94de59e3f">DeepSeek</R> illustrates both the limitations and unintended consequences of export controls. Despite hardware restrictions, DeepSeek trained models achieving GPT-4 parity using:
...
Dutch participation through ASML's EUV restrictions represents the most critical international cooperation, as no alternative suppliers exist for the most advanced lithography equipment. According to <R id="d9fa76035eb88c7b">TrendForce</R>, the Netherlands expanded controls on September 7, 2024 to require licenses for ASML's 1970i and 1980i DUV machines—with the Dutch government taking "full control" rather than deferring to US authority. ASML must now also apply for licenses to service, provide spare parts, and software updates for previously sold immersion lithography systems.
...
The <R id="f36b479499caf062">CSIS Mismatch report</R> highlights a fundamental gap between strategic ambitions and enforcement capacity:
...
- <R id="409aff2720d97129">U.S. Export Controls and China: Advanced Semiconductors</R> — Congressional Research Service comprehensive analysis
- <R id="58bf458c4de920d0">Commerce Strengthens Export Controls</R> — BIS December 2024 press release
- <R id="723ffe2c01da7245">U.S. Authorities Shut Down Major China-Linked AI Tech Smuggling Network</R> — DOJ enforcement action

### Think Tank Analysis

- <R id="29ac309acdbb54b4">Understanding the Biden Administration's Updated Export Controls</R> — CSIS December 2024 analysis by Gregory C. Allen
- <R id="dfda5c53f10364b3">The Limits of Chip Export Controls in Meeting the China Challenge</R> — CSIS effectiveness assessment
- <R id="c0a950eadfd8fcec">Where the Chips Fall: U.S. Export Controls Under the Biden Administration</R> — CSIS comprehensive timeline
- <R id="f36b479499caf062">Mismatch of Strategy and Budgets in AI Chip Export Controls</R> — CSIS enforcement capacity analysis
- <R id="c22de86eabd0fc37">Countering AI Chip Smuggling Has Become a National Security Priority</R> — CNAS smuggling assessment
- <R id="6d999627fe0848e6">Technology to Secure the AI Chip Supply Chain</R> — CNAS hardware-enabled mechanisms proposal
- <R id="18895f59591774a5">DeepSeek Shows the Limits of US Export Controls on AI Chips</R> — Brookings analysis
- <R id="fe41a8475bafc188">China's AI Chip Deficit: Why Huawei Can't Catch Nvidia</R> — Council on Foreign Relations

### Industry and Market Analysis

- <R id="46d731b94de59e3f">How Chinese company DeepSeek released a top AI reasoning model despite US sanctions</R> — MIT Technology Review
- <R id="a554ce016d832ca3">The Evolution of China's Semiconductor Industry under U.S. Export Controls</R> — American Affairs Journal
- <R id="c9e18a9761bb4d7d">China Creates \$47.5 Billion Chip Fund to Fuel Self-Resilience</R> — Bloomberg Big Fund III coverage
- <R id="d9fa76035eb88c7b">Netherlands Expands Export Control over ASML's DUV Machines</R> — TrendForce
- <R id="7d8aca0fa386ccab">NVIDIA China Revenue Analysis</R> — Fortune Asia

### Academic and Research Perspectives

- <R id="87e132ccb0722909">DeepSeek, Huawei, Export Controls, and the Future of the U.S.-China AI Race</R> — CSIS
- <R id="b193d0cfd04f2b86">The Rise of DeepSeek: What the Headlines Miss</R> — RAND Corporation
- <R id="b6aef595043ef9df">China's Quest for Semiconductor Self-Sufficiency</R> — Alan Turing Institute CETaS

---

## Related Approaches

- <EntityLink id="thresholds">Compute Thresholds</EntityLink> — Regulatory triggers rather than restrictions
- <EntityLink id="monitoring">Compute Monitoring</EntityLink> — Visibility into who's training what
- <EntityLink id="international-regimes">International Regimes</EntityLink> — Multilateral coordination

---

## AI Transition Model Context

Export controls affect the <EntityLink id="ai-transition-model" /> through multiple factors:

| Factor | Parameter | Impact |
|--------|-----------|--------|
| <EntityLink id="transition-turbulence" /> | <EntityLink id="racing-intensity" /> | May reduce or intensify competition depending on response |
| <EntityLink id="civilizational-competence" /> | <EntityLink id="international-coordination" /> | Strains cooperation needed for global AI governance |
| <EntityLink id="transition-turbulence" /> | <EntityLink id="ai-control-concentration" /> | Concentrates frontier capabilities in US and allies |
