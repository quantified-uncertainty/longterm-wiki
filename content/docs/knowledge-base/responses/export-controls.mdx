...
This page covers **export controls**—one approach within the broader Compute Governance framework. See also: <EntityLink id="E465">Thresholds</EntityLink>, <EntityLink id="E464">Monitoring</EntityLink>, <EntityLink id="E473">International Regimes</EntityLink>.
:::
...
- <EntityLink id="E465">Compute Thresholds</EntityLink> — Regulatory triggers rather than restrictions
- <EntityLink id="E464">Compute Monitoring</EntityLink> — Visibility into who's training what
- <EntityLink id="E473">International Regimes</EntityLink> — Multilateral coordination
...
|--------|-----------|--------|
| <EntityLink id="E358" /> | <EntityLink id="E242" /> | May reduce or intensify competition depending on response |
| <EntityLink id="E60" /> | <EntityLink id="E171" /> | Strains cooperation needed for global AI governance |
| <EntityLink id="E358" /> | <EntityLink id="E7" /> | Concentrates frontier capabilities in US and allies |
