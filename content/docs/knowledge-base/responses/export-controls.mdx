...
- <EntityLink id="chip-security-act">Chip Security Act</EntityLink> — Bipartisan U.S. bill requiring location verification on advanced AI chips to detect export control evasion, with estimates of \$5-7B in smuggled chips (140K units in 2024)
- <EntityLink id="stop-stealing-our-chips-act">Stop Stealing Our Chips Act</EntityLink> — Whistleblower incentive program offering 10-30% of fines for reporting chip smuggling, modeled on SEC enforcement
