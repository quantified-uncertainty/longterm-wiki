...
---
import { DataInfoBox, DisagreementMap, Mermaid, R, EntityLink } from '@components/wiki';
...
This page covers **export controls**—one approach within the broader Compute Governance framework. See also: <EntityLink id="E465" name="thresholds">Thresholds</EntityLink>, <EntityLink id="E464" name="monitoring">Monitoring</EntityLink>, <EntityLink id="E473" name="international-regimes">International Regimes</EntityLink>.
:::
...
According to <R id="sid_iILllzIeus">Fortune Asia</R>, NVIDIA's China sales dropped to a "mid-single-digit percentage" of data center revenue by early 2024. CEO <EntityLink id="E1292" name="jensen-huang">Jensen Huang</EntityLink> stated that NVIDIA's market share for restricted AI GPUs in China fell from 95% to "zero" following export controls.

Chinese technology companies have publicly acknowledged the impact while announcing alternative strategies. Baidu has increased investment in its domestic Kunlun chip development, while Alibaba has accelerated development of its Yitian processors. China launched <R id="sid_QrVwpQb5nM">Big Fund III</R> in May 2024 with \$47.5 billion in registered capital—the largest phase of China's semiconductor investment program—bringing total state-backed investment across all three phases to approximately \$188 billion.

### Circumvention and Adaptation

Despite these impacts, substantial circumvention activity has been documented. According to <R id="sid_npIt9c74MW">CNAS</R>, an estimated **140,000 high-performance GPUs worth billions of dollars were smuggled into China in 2024 alone**. <R id="sid_GJZKgV5nBz">The Information</R> identified at least eight Chinese AI chip-smuggling networks, each engaged in transactions valued at more than \$100 million.
...
Semiconductor manufacturing equipment controls likely impose longer delays than chip controls, as building advanced fabrication capabilities requires 3-7 years even with unlimited resources and access to foreign talent. <R id="sid_9fKjlsGCr0">CSIS analysis</R> notes that <EntityLink id="E2608">SMIC</EntityLink> has struggled to achieve consistent 7nm production yields comparable to TSMC's mature processes. According to <R id="sid_NkhYjXq4Ko">American Affairs Journal</R>, SMIC uses "double patterning" with DUV equipment to achieve 7nm, but this process is "time consuming and expensive, making it difficult to manufacture at volume scale." It is "increasingly clear that SMIC will not be able to get to something that can be called a 3 nanometer process using its existing DUV tools."
...
The case of <R id="sid_4dU0Vb0tSI">DeepSeek</R> illustrates both the limitations and unintended consequences of export controls. Despite hardware restrictions, DeepSeek trained models achieving GPT-4 parity using:
...
Dutch participation through ASML's EUV restrictions represents the most critical international cooperation, as no alternative suppliers exist for the most advanced lithography equipment. According to <R id="sid_1SpMks4VKH">TrendForce</R>, the Netherlands expanded controls on September 7, 2024 to require licenses for ASML's 1970i and 1980i DUV machines—with the Dutch government taking "full control" rather than deferring to US authority. ASML must now also apply for licenses to service, provide spare parts, and software updates for previously sold immersion lithography systems.
...
The <R id="sid_Jkay9J4nIz">CSIS Mismatch report</R> highlights a fundamental gap between strategic ambitions and enforcement capacity:
...
- <R id="sid_AFIvcyBFGn">U.S. Export Controls and China: Advanced Semiconductors</R> — Congressional Research Service comprehensive analysis
- <R id="sid_mkvmeW9qnc">Commerce Strengthens Export Controls</R> — BIS December 2024 press release
- <R id="sid_4LxolOc2gi">U.S. Authorities Shut Down Major China-Linked AI Tech Smuggling Network</R> — DOJ enforcement action

### Think Tank Analysis

- <R id="sid_1mJDVKD8Ux">Understanding the Biden Administration's Updated Export Controls</R> — CSIS December 2024 analysis by Gregory C. Allen
- <R id="sid_9fKjlsGCr0">The Limits of Chip Export Controls in Meeting the China Challenge</R> — CSIS effectiveness assessment
- <R id="sid_RRick19AfR">Where the Chips Fall: U.S. Export Controls Under the Biden Administration</R> — CSIS comprehensive timeline
- <R id="sid_Jkay9J4nIz">Mismatch of Strategy and Budgets in AI Chip Export Controls</R> — CSIS enforcement capacity analysis
- <R id="sid_npIt9c74MW">Countering AI Chip Smuggling Has Become a National Security Priority</R> — CNAS smuggling assessment
- <R id="sid_50qRMxrVQu">Technology to Secure the AI Chip Supply Chain</R> — CNAS hardware-enabled mechanisms proposal
- <R id="sid_C8FnD1P5Um">DeepSeek Shows the Limits of US Export Controls on AI Chips</R> — Brookings analysis
- <R id="sid_YeE2b8B0B2">China's AI Chip Deficit: Why Huawei Can't Catch Nvidia</R> — Council on Foreign Relations

### Industry and Market Analysis

- <R id="sid_4dU0Vb0tSI">How Chinese company DeepSeek released a top AI reasoning model despite US sanctions</R> — MIT Technology Review
- <R id="sid_NkhYjXq4Ko">The Evolution of China's Semiconductor Industry under U.S. Export Controls</R> — American Affairs Journal
- <R id="sid_QrVwpQb5nM">China Creates \$47.5 Billion Chip Fund to Fuel Self-Resilience</R> — Bloomberg Big Fund III coverage
- <R id="sid_1SpMks4VKH">Netherlands Expands Export Control over ASML's DUV Machines</R> — TrendForce
- <R id="sid_iILllzIeus">NVIDIA China Revenue Analysis</R> — Fortune Asia

### Academic and Research Perspectives

- <R id="sid_MxkZdZmqGR">DeepSeek, Huawei, Export Controls, and the Future of the U.S.-China AI Race</R> — CSIS
- <R id="sid_dGZ0fHATft">The Rise of DeepSeek: What the Headlines Miss</R> — RAND Corporation
- <R id="sid_hEs9g04MS3">China's Quest for Semiconductor Self-Sufficiency</R> — Alan Turing Institute CETaS

---

## Related Approaches

- <EntityLink id="E465" name="thresholds">Compute Thresholds</EntityLink> — Regulatory triggers rather than restrictions
- <EntityLink id="E464" name="monitoring">Compute Monitoring</EntityLink> — Visibility into who's training what
- <EntityLink id="E473" name="international-regimes">International Regimes</EntityLink> — Multilateral coordination
- <EntityLink id="E2085" name="chip-security-act">Chip Security Act</EntityLink> — Bipartisan U.S. bill requiring location verification on advanced AI chips to detect export control evasion, with estimates of \$5-7B in smuggled chips (140K units in 2024)
- <EntityLink id="E2086" name="stop-stealing-our-chips-act">Stop Stealing Our Chips Act</EntityLink> — Whistleblower incentive program offering 10-30% of fines for reporting chip smuggling, modeled on SEC enforcement
- <EntityLink id="E2053">Hardware Mechanisms for International AI Agreements</EntityLink> — Technical analysis of hardware-enabled enforcement mechanisms
