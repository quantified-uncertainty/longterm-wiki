...
**TSMC** (Taiwan Semiconductor Manufacturing Company) is the critical chokepoint in global AI chip fabrication. Its geographic concentration in Taiwan creates both geopolitical fragility and governance leverage: any chip requiring TSMC's most advanced nodes must pass through Taiwan. TSMC has cooperated with U.S. export control enforcement by declining orders from sanctioned entities and is expanding fabrication capacity in Arizona under CHIPS Act incentives.
...
**SMIC** (Semiconductor Manufacturing International Corporation), China's leading foundry, has reportedly manufactured 5nm electronic circuits, challenging earlier assumptions about the effectiveness of export controls on manufacturing equipment. This development is cited as evidence that controls must be continuously updated as Chinese domestic capability grows.
...
The primary instrument of AI chip governance is the U.S. Export Administration Regulations (EAR), administered by the Bureau of Industry and Security (BIS) within the Department of Commerce. The core tools include:
...
**The Biden Administration's AI Diffusion Rule** (early 2025) introduced a tiered country framework, imposing worldwide licensing requirements and a "rebuttable presumption" of control on third-party assembly and test firms. This extended compliance obligations to server manufacturers and data center operators.

**The Trump Administration's Modifications** (2025) included eliminating certain Validated End-User (VEU) authorizations for semiconductor manufacturing equipment producers, introducing a 25% tariff on advanced AI chips not intended for the U.S. supply chain, and codifying conditional export policies for chips like the Nvidia H200 to China—requiring that TPP exports to China remain below 50% of U.S. shipments and that no U.S. supply be delayed.

### Proposed Legislation

Several pieces of legislation have been introduced in the U.S. Congress to strengthen chip governance:

- **The Chip Security Act** proposes a two-phase framework: an initial 180-day mandate for location verification on exported chips, followed by a feasibility assessment within two years for anti-tamper features or functionality throttling. It grants the Commerce Secretary post-export monitoring authority.
- **The AI Overwatch Act** (introduced December 2025) requires congressional review of advanced AI chip export licenses to China.
...
The CNAS research recommends coordinating HEM development through a NIST-led working group, with input from chip designers (AMD, Apple, Intel, Nvidia), the CHIPS Program Office, and allied governments (Netherlands, Taiwan, South Korea, Japan, UK, EU). The National Advanced Packaging Manufacturing Program has been identified as a venue for R&D on tamper-proof encasing, though no specific funding amounts have been allocated.
...
**Nvidia** has piloted customer tracking software and cooperated with export control compliance at the sales stage. However, the company has resisted proposals for hardware kill-switches or hard functionality throttles. Nvidia's Vice President of Government Affairs has argued that restricting access to critical technology would stifle global collaboration and innovation, ultimately weakening the U.S. economy and its technological edge. The company also fears export limitations will shrink its addressable market, particularly given revenue exposure to hyperscalers whose orders have at times been delayed.
...
Global chip revenue reached approximately \$630 billion in 2024 and is projected to reach \$910 billion by 2026. U.S. private investment catalyzed by the CHIPS and Science Act totals over \$630 billion. The four major hyperscalers (Google, Amazon, Microsoft, Meta) have projected combined capital expenditure of \$650 billion in the AI infrastructure build-out. OpenAI has signed agreements for 900,000 wafers per month by 2029 for its Stargate project.
...
Experts working in this space have noted that the gap between the scale of industry investment and the scale of governance R&D investment is a structural problem. Hardware governance requires deep technical expertise—in chip architecture, secure enclaves, firmware, and supply chain logistics—that is expensive to develop and in short supply outside industry. Philanthropic funders and governments considering where marginal dollars have most impact might consider direct support for technical HEM research, capacity-building at BIS and allied export control agencies, and multi-stakeholder convenings to develop governance standards before the next generation of chips is designed.
...
The Megaspeed case illustrates how intermediaries can exploit regulatory gaps: the Singapore-based firm allegedly diverted \$2 billion in restricted Nvidia AI chips to Chinese entities through a Malaysian subsidiary, including a June 2024 shipment of \$25.4 million in H800 servers. U.S. federal prosecutors unsealed documents in December 2025 on a separate ring that exported \$160 million in Nvidia H100 and H200 GPUs to China between October 2024 and May 2025. New controls specifically targeting Malaysia and Thailand as diversion routes were anticipated under the Trump administration's framework.
