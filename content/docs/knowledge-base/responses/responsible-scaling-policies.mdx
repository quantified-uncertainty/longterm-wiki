...
<DataExternalLinks pageId="responsible-scaling-policies" client:load />
...
|-----------|------------|---------|
| Coverage | **60-70%** of frontier development | 3-4 major labs (<EntityLink id="anthropic">Anthropic</EntityLink>, <EntityLink id="openai">OpenAI</EntityLink>, DeepMind, plus Microsoft, Meta, Amazon) |
