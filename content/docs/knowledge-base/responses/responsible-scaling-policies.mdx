...
|-----------|------------|---------|
| Coverage | **60-70%** of frontier development | 3-4 major labs (<EntityLink id="E22">Anthropic</EntityLink>, <EntityLink id="E218">OpenAI</EntityLink>, <EntityLink id="E98">Google DeepMind</EntityLink>, plus <EntityLink id="E550">Microsoft</EntityLink>, <EntityLink id="E549">Meta</EntityLink>, Amazon) |
