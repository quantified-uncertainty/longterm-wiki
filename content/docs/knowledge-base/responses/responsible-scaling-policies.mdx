...
<DataInfoBox entityId="E461" />

## Quick Assessment

| Dimension | Assessment | Evidence |
|-----------|------------|----------|
| Coverage | **60-70%** of frontier development | 3-4 major labs (<EntityLink id="E22" name="anthropic">Anthropic</EntityLink>, <EntityLink id="E218" name="openai">OpenAI</EntityLink>, <EntityLink id="E98" name="deepmind">Google DeepMind</EntityLink>, plus <EntityLink id="E550" name="microsoft">Microsoft</EntityLink>, <EntityLink id="E549" name="meta-ai">Meta</EntityLink>, Amazon) |
...
| Durability | **Low-Medium** confidence | <EntityLink id="E239" name="racing-dynamics">Racing dynamics</EntityLink> create 20-60% abandonment probability under competitive pressure |
...
<EntityLink id="E461" name="rsp">Responsible Scaling Policies</EntityLink> (RSPs) represent the primary current approach by leading AI laboratories to manage catastrophic risks from increasingly capable AI systems. These voluntary frameworks establish capability thresholds that trigger mandatory safety evaluations and safeguards before continuing development or deployment. [Introduced by Anthropic in September 2023](https://metr.org/blog/2023-09-26-rsp/) and subsequently adopted by OpenAI, <EntityLink id="E98" name="deepmind">Google DeepMind</EntityLink>, and others, RSPs mark a significant shift toward structured, proactive risk management in frontier AI development. The [UK AI Security Institute](https://www.aisi.gov.uk/blog/early-lessons-from-evaluating-frontier-ai-systems) has now evaluated over 30 frontier AI models since November 2023, providing independent government assessment of these frameworks' implementation.
...
| **Evaluation Frequency** | Before training above <EntityLink id="E465" name="thresholds">compute thresholds</EntityLink>; at checkpoints; post-training | Capabilities Reports + Safeguards Reports for each covered system | Comprehensive evaluations before training and deployment decisions |
| **<EntityLink id="E449" name="red-teaming">Red Teaming</EntityLink>** | Extensive red-teaming for ASL-3+; demonstrated in deployment standard | Required for High/Critical assessments | Required for CCL systems; expert adversarial testing |
...
|------|-----------|---------------|
| <EntityLink id="E42" name="bioweapons">Bioweapons</EntityLink> | CBRN capability evaluations before deployment | Medium |
| <EntityLink id="E86" name="cyberweapons">Cyberweapons</EntityLink> | Cyber capability evaluations | Medium |
| <EntityLink id="E93" name="deceptive-alignment">Deceptive Alignment</EntityLink> | Autonomy and deception evaluations | Low-Medium |

## Sources

### Lab Policy Documents

- <R id="YjQzY2NkNG">Anthropic's Responsible Scaling Policy Version 2.2</R> (May 14, 2025)
- <R id="NzJkZWFhMW">Anthropic: Announcing our updated Responsible Scaling Policy</R> (October 2024)
- <R id="YmFkZjUwMz">Anthropic: Activating AI Safety Level 3 protections</R> (2025)
- <R id="YTFkNjM1Mz">OpenAI: Preparedness Framework Version 2</R> (April 15, 2025)
- <R id="OTU2ZjU2MD">OpenAI: Our updated Preparedness Framework</R> (April 2025)
- <R id="ZDk3MjIyZT">Google DeepMind: Frontier Safety Framework Version 3.0</R>
- <R id="ZjZhZjE5OT">Google DeepMind: Strengthening our Frontier Safety Framework</R> (2025)
- <R id="MWQzOTZiZW">Google DeepMind: Introducing the Frontier Safety Framework</R> (May 2024)

### Analysis and Evaluation

- <R id="ZTYyZGVlNz">METR: Common Elements of Frontier AI Safety Policies</R>
- <R id="NTI2OGFjZG">METR: Responsible Scaling Policies</R> (September 2023)
- <R id="ZDc1NmRhZj">Federation of American Scientists: Can Preparedness Frameworks Pull Their Weight?</R>
- <R id="ZGQ2Yzc5OG">Institute for AI Policy and Strategy: Responsible Scaling — Comparing Government Guidance and Company Policy</R>
- <R id="MGQyMDAzZD">Centre for Long-Term Resilience: AI Safety Frameworks Risk Governance</R> (February 2025)
- <R id="ZDZhYTk5Nj">EA Forum: I read every major AI lab's safety plan so you don't have to</R>
- <R id="NjhiNzhhZD">EA Forum: What are Responsible Scaling Policies (RSPs)?</R>

### International Governance

- <R id="ZjdiMDdkNW">International AI Safety Report 2025</R>
- <R id="Y2Q1MTUwY2">Future of Life Institute: 2025 AI Safety Index</R>
- <R id="MmU5MTEyNm">AGILE Index on Global AI Safety Readiness</R> (February 2025)
