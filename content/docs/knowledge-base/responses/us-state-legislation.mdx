...
Compliance costs are becoming prohibitive for smaller companies. According to the [U.S. Chamber of Commerce analysis](https://www.uschamber.com/technology/the-hidden-cost-of-50-state-ai-laws-a-data-driven-breakdown)[^4], California's requirements will cost small businesses nearly \$16,000 annually, while Colorado's SB-205 is projected to cost 40,000 jobs and \$7 billion in economic output by 2030. [Harvard research](https://finance.yahoo.com/news/america-ai-regulatory-patchwork-crushing-120000009.html)[^5] identifies a "compliance trap" where startup resources are consumed faster than revenue generation, with 200% compliance cost increases transforming startup margins from +13% to -7%.
...
| 2024 | 635 | 99 | 16% | Colorado AI Act, Tennessee ELVIS Act, <EntityLink id="E48">California SB 1047</EntityLink> vetoed |
...
|----------|-----------------|---------------|-------|
| <EntityLink id="E96">Deepfakes</EntityLink> | 301 | 68 | Highest passage rate; mostly criminal/civil penalties for sexual deepfakes |
...
|---------------------|---------------|---------------|
| **Supporters** | <EntityLink id="E47">Center for AI Safety</EntityLink>, <EntityLink id="E22">Anthropic</EntityLink> (initially), <EntityLink id="E116">Elon Musk</EntityLink>, 113+ AI lab employees, LA Times editorial board | Safety testing requirements modest; potential catastrophic risks justify precaution |
| **Opponents** | <EntityLink id="E218">OpenAI</EntityLink>, Meta, House Speaker Pelosi, 8 congressional Democrats | Would stifle innovation; drive development offshore; create compliance burdens |
...
The employment AI enforcement landscape is evolving rapidly through private litigation. In [Mobley v. Workday](https://www.cdflaborlaw.com/blog/federal-court-grants-preliminary-certification-in-landmark-ai-hiring-bias-case)[^25], Judge Rita Lin granted preliminary certification in May 2025, finding evidence of Workday's involvement in AI hiring processes for algorithmic bias claims. This landmark case marks a significant moment in AI and employment law evolution, establishing precedent for class action challenges to AI hiring systems.
...
US state AI legislation affects the Ai Transition Model through <EntityLink id="E60" />:

| Factor | Parameter | Impact |
|--------|-----------|--------|
| <EntityLink id="E60" /> | <EntityLink id="E249" /> | 1,080+ bills in 2025 (up from ≈40 in 2019) serve as policy laboratories |
| <EntityLink id="E60" /> | <EntityLink id="E167" /> | States like Colorado and Texas pioneer risk-based frameworks |
| <EntityLink id="E358" /> | <EntityLink id="E242" /> | Patchwork regulation may drive industry demand for federal uniformity |
