...
| Key Proponents | Many | [MATS](https://www.matsprogram.org/), [BlueDot Impact](https://bluedot.org/), <EntityLink id="anthropic">Anthropic</EntityLink>, <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> |
| Estimated Impact | Medium-High | Produces 100-200 new safety researchers annually |

## Overview

The AI safety field faces a critical talent bottleneck. While funding has increased substantially—with <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> committing roughly \$50 million to <EntityLink id="technical-research">technical AI safety research</EntityLink> in 2024—the supply of researchers capable of doing high-quality technical safety work remains constrained. Training programs represent the primary pipeline for addressing this gap, offering structured pathways from general ML expertise to safety-specific research skills.
