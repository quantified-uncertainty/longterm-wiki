...
| Key Proponents | Many | [MATS](https://www.matsprogram.org/), [BlueDot Impact](https://bluedot.org/), <EntityLink id="anthropic">Anthropic</EntityLink>, <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> |
