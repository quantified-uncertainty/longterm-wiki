...
update_frequency: 45
summary: "Comprehensive guide to AI safety training programs including MATS (78% alumni in alignment work, 100+ scholars annually), Anthropic Fellows (\\$2,100/week stipend, 40%+ hired full-time), LASR Labs (5 NeurIPS papers in 2024), and academic pathways. BlueDot Impact has trained 7,000+ people since 2022, with hundreds now working in AI safety. Provides concrete application criteria, timing recommendations, and structured self-study pathways with 1-5 year timeline to research contribution."
clusters:
  - community
  - ai-safety
---
...
| **ARENA** | 5 weeks | In-person (London) | Housing/travel | Moderate | Alumni at Apollo, <EntityLink id="E201" name="metr">METR</EntityLink>, UK AISI |
...
| **Partners** | CHAI (Berkeley), <EntityLink id="E70" name="conjecture">Conjecture</EntityLink>, FAR.AI, UK AISI |
...
- <EntityLink id="E290" name="stuart-russell">Stuart Russell</EntityLink> (Berkeley/CHAI) - Human-compatible AI
- <EntityLink id="E1299" name="jacob-steinhardt">Jacob Steinhardt</EntityLink> (Berkeley) - ML safety and robustness
- Vincent Conitzer (CMU) - <EntityLink id="E439" name="alignment">AI alignment</EntityLink> theory
...
|----------|----------|----------|-----------------|
| **AI Safety Syllabus** | <EntityLink id="E510" name="80000-hours">80,000 Hours</EntityLink> | Comprehensive reading list | 40-100+ hours |
...
| **ML Safety Course** | <EntityLink id="E89" name="dan-hendrycks">Dan Hendrycks</EntityLink> | Technical foundations | Semester |
...
| **Neglectedness** | Medium | \$50M+ annually from <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> but scaling gaps |
...
| <EntityLink id="E239" name="racing-dynamics">Racing dynamics</EntityLink> | Safety talent at labs can advocate | Medium |
| Field capture | Diverse training reduces groupthink | Medium |

## Complementary Interventions

- <EntityLink id="E476" name="field-building-analysis">Field Building</EntityLink> - Broader ecosystem development
- <EntityLink id="E78" name="corporate-influence">Corporate Influence</EntityLink> - Placing trained researchers at labs
- <EntityLink id="E13" name="ai-safety-institutes">AI Safety Institutes</EntityLink> - Employers for trained researchers
...
- **<EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>:** 2024 Progress and 2025 Plans - \$50M committed to technical AI safety in 2024
- **<EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>:** Technical AI Safety RFP - \$40M+ available
