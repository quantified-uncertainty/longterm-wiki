...
<EntityLink id="E156" name="holden-karnofsky">Holden Karnofsky</EntityLink>, co-founder of <EntityLink id="E521" name="coefficient-giving" >Coefficient Giving</EntityLink>, has argued that "there's no way to get to an actual low-level risk from AI without government policy playing an important role."[^rc-b8b2] The book's analysis of government institutional failures and the separation of policy from implementation speaks directly to the challenge of building the technical capacity that AI governance requires.[^rc-9000]
