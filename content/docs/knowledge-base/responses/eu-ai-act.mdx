...
| **Limited** | Chatbots, <EntityLink id="E96" name="deepfakes">deepfakes</EntityLink>, emotion recognition systems | Transparency obligations (label AI-generated content, disclose AI interaction) | August 2, 2026[^rc-27b6] |
...
Designated based on <EntityLink id="E465" name="thresholds">compute thresholds</EntityLink> (>10²⁵ FLOPs for training) or Commission assessment of capabilities, market impact, and potential for widespread harm:[^rc-d399][^rc-7bbf]
...
| **<EntityLink id="E380" name="yoshua-bengio">Yoshua Bengio</EntityLink>** | Chair | Turing Award winner; Professor at Université de Montréal; Founder of Mila |
...
| **<EntityLink id="markus-anderljung" name="markus-anderljung">Markus Anderljung</EntityLink>** | Vice-Chair | Director of Policy & Research, <EntityLink id="E153" name="govai">Centre for the Governance of AI</EntityLink> |
...
- No requirements for **<EntityLink id="E439" name="alignment">AI alignment</EntityLink> research** (ensuring advanced systems' goals match human values)
