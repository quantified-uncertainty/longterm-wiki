...
This page examines these legal authorities, their historical precedents, current military-commercial AI integration, constraints on government action, and implications for both domestic companies and international stakeholders. The analysis intersects with <EntityLink id="compute-concentration">compute concentration</EntityLink>, geopolitics, and <EntityLink id="export-controls">export controls</EntityLink>.
...
However, <EntityLink id="export-controls">US export controls</EntityLink> on advanced chips have been only partially effective — an estimated 140,000 GPUs were smuggled to China in 2024.[^rc-76e4]
