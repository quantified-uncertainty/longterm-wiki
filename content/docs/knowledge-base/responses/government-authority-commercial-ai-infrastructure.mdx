---
title: Government Authority Over Commercial AI Infrastructure
...
- **Title I (Priorities and Allocations)**: The President can require companies to accept and prioritize government contracts over all other orders. Applied to AI, this could mean directing <EntityLink id="microsoft">Microsoft</EntityLink>, <EntityLink id="amazon">Amazon</EntityLink>, or <EntityLink id="meta">Meta</EntityLink> to dedicate specific GPU clusters to government AI workloads before serving commercial customers.
