...
|--------------|------------------|------------|
| **<EntityLink id="govai">[GovAI](https://www.governance.ai/)</EntityLink>** | [Training Compute Thresholds](https://www.governance.ai/research-paper/training-compute-thresholds-features-and-functions-in-ai-regulation), [Inference Scaling Governance](https://www.governance.ai/research-paper/inference-scaling-and-ai-governance), [Risk Thresholds](https://www.governance.ai/research-paper/risk-thresholds-for-frontier-ai) | Threshold design, alternative approaches |
| **<EntityLink id="cset">[CSET Georgetown](https://cset.georgetown.edu/)</EntityLink>** | [AI Governance at the Frontier](https://cset.georgetown.edu/publication/ai-governance-at-the-frontier/), preparedness frameworks | Policy implementation, US context |
| **<EntityLink id="epoch-ai">[Epoch AI](https://epoch.ai/)</EntityLink>** | [Compute trends](https://epoch.ai/trends), [training cost analysis](https://epoch.ai/data-insights/cost-trend-large-scale) | Empirical compute data, forecasting |
| **<EntityLink id="uk-aisi">[UK AI Security Institute](https://www.aisi.gov.uk/)</EntityLink>** | [Frontier AI Trends Report](https://www.aisi.gov.uk/frontier-ai-trends-report), capability evaluations | Empirical capability assessment |
