...
This page covers **compute thresholds**—one approach within the broader Compute Governance framework. See also: <EntityLink id="E136" name="export-controls">Export Controls</EntityLink>, <EntityLink id="E464" name="monitoring">Monitoring</EntityLink>, <EntityLink id="E473" name="international-regimes">International Regimes</EntityLink>.
:::
...
|-----------|------------|----------|
| **Regulatory Adoption** | High | <EntityLink id="E127" name="eu-ai-act">EU AI Act</EntityLink> (10^25 FLOP, effective Aug 2025), US EO 14110 (10^26 FLOP, active since Oct 2023) |
...
|------|-----------|---------------|
| <EntityLink id="E239" name="racing-dynamics">Racing Dynamics</EntityLink> | Forces safety testing before deployment | Medium |
| <EntityLink id="E42" name="bioweapons">Bioweapons</EntityLink> | Lower thresholds for bio-sequence models | Medium |
| <EntityLink id="E93" name="deceptive-alignment">Deceptive Alignment</EntityLink> | Requires evaluation before deployment | Low-Medium |
...
|--------------|------------------|------------|
| **<EntityLink id="E153" name="govai">[GovAI](https://www.governance.ai/)</EntityLink>** | [Training Compute Thresholds](https://www.governance.ai/research-paper/training-compute-thresholds-features-and-functions-in-ai-regulation), [Inference Scaling Governance](https://www.governance.ai/research-paper/inference-scaling-and-ai-governance), [Risk Thresholds](https://www.governance.ai/research-paper/risk-thresholds-for-frontier-ai) | Threshold design, alternative approaches |
| **<EntityLink id="E524" name="cset">[CSET Georgetown](https://cset.georgetown.edu/)</EntityLink>** | [AI Governance at the Frontier](https://cset.georgetown.edu/publication/ai-governance-at-the-frontier/), preparedness frameworks | Policy implementation, US context |
| **<EntityLink id="E125" name="epoch-ai">[Epoch AI](https://epoch.ai/)</EntityLink>** | [Compute trends](https://epoch.ai/trends), [training cost analysis](https://epoch.ai/data-insights/cost-trend-large-scale) | Empirical compute data, forecasting |
| **<EntityLink id="E364" name="uk-aisi">[UK AI Security Institute](https://www.aisi.gov.uk/)</EntityLink>** | [Frontier AI Trends Report](https://www.aisi.gov.uk/frontier-ai-trends-report), capability evaluations | Empirical capability assessment |
...
- <EntityLink id="E136" name="export-controls">Export Controls</EntityLink> — Restricting access rather than triggering requirements
- <EntityLink id="E464" name="monitoring">Compute Monitoring</EntityLink> — Ongoing visibility into training
- <EntityLink id="E473" name="international-regimes">International Regimes</EntityLink> — Multilateral threshold coordination
