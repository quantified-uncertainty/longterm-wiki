...
| **Creator** | <EntityLink id="E581">Vipul Naik</EntityLink>, with significant contributions from <EntityLink id="E576">Issa Rice</EntityLink> |
...
- Aggregation of EA Forum and <EntityLink id="E538">LessWrong</EntityLink> discussions about specific donations
...
- **Good Ventures/<EntityLink id="E552">Coefficient Giving</EntityLink>** - EA-aligned funding across multiple cause areas
...
- <EntityLink id="E552">Open Philanthropy Project</EntityLink> grants, which include substantial AI safety funding[^3]
- Donations to organizations like the <EntityLink id="E202">Machine Intelligence Research Institute</EntityLink> (MIRI)[^2]
...
While comprehensive AI safety funding data would require integration with specialized resources like <EntityLink id="E552">Coefficient Giving</EntityLink>'s grants database and the Long-Term Future Fund, DLW captures major contributions from:[^2][^3]
