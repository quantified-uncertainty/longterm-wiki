...
**Compute monitoring** refers to the systematic tracking, measurement, and analysis of computational resources used in <EntityLink id="ai-training">AI training</EntityLink> and inference workloads. This includes monitoring hardware utilization, energy consumption, costs, and performance metrics to optimize resource allocation and manage the substantial computational demands of modern <EntityLink id="machine-learning">machine learning</EntityLink> systems.
...
- Debug performance issues in <EntityLink id="distributed-training">distributed training</EntityLink> systems
...
Compute monitoring integrates with broader <EntityLink id="mlops">MLOps</EntityLink> workflows:
...
- <EntityLink id="ai-training">AI Training</EntityLink>
- <EntityLink id="distributed-training">Distributed Training</EntityLink>
- <EntityLink id="mlops">MLOps</EntityLink>
- <EntityLink id="gpu-computing">GPU Computing</EntityLink>
- <EntityLink id="cloud-computing">Cloud Computing</EntityLink>
- <EntityLink id="energy-efficiency">Energy Efficiency</EntityLink>