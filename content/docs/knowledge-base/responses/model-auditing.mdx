...
|-----------|------------|----------|
| **Maturity** | Growing (2023-present) | <EntityLink id="E201" name="metr">METR</EntityLink> spun off Dec 2023; UK AISI Nov 2023; US AISI Feb 2024; formal MOUs signed Aug 2024 |
...
| **Regulatory Status** | Voluntary (US/UK) to mandatory (EU) | <EntityLink id="E127" name="eu-ai-act">EU AI Act</EntityLink> requires third-party conformity assessment for high-risk systems by Aug 2026 |
...
| **<EntityLink id="E24" name="apollo-research">Apollo Research</EntityLink>** | ≈\$5M | o1, Claude 3.5 Sonnet, Claude 3 Opus, Gemini 1.5 Pro, Llama 3.1 405B, Claude Opus 4 | <EntityLink id="E274" name="scheming">Scheming</EntityLink>, deception |
...
- **[METR](https://metr.org/)**: Model Evaluation and Threat Research - founded Dec 2023 (spun off from ARC Evals); CEO <EntityLink id="E39" name="beth-barnes">Beth Barnes</EntityLink>; [task horizon research](https://arxiv.org/html/2503.14499v1) shows AI capabilities doubling every 7 months; [evaluated GPT-4.5](https://metr.org/blog/2025-02-27-gpt-4-5-evals/), [GPT-5](https://evaluations.metr.org/gpt-5-report/), o3, Claude models
