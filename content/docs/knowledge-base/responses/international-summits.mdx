...
| **Institutional Output** | 10+ <EntityLink id="E13" name="ai-safety-institutes">AI Safety Institutes</EntityLink> established | Combined budgets of \$100-400M annually; UK AISI leads with ≈\$65M/year |
...
|--------|------|----------|--------------|-------------|------------------------|
| **Bletchley Park** | Nov 1-2, 2023 | UK | 100+ delegates | <EntityLink id="E469" name="bletchley-declaration">Bletchley Declaration</EntityLink> on AI risks | 28 countries + EU |
...
Beyond symbolic recognition, Bletchley produced concrete institutional commitments. The UK announced creation of its AI Safety Institute with an initial £100 million investment in the Frontier AI Taskforce—the largest funding for AI safety by any country at that time. The United States committed to establishing its own AI Safety Institute, formalized shortly after in President Biden's October 30, 2023 Executive Order. Most significantly for the AI industry, major companies including <EntityLink id="E218" name="openai">OpenAI</EntityLink>, <EntityLink id="E98" name="deepmind">Google DeepMind</EntityLink>, <EntityLink id="E22" name="anthropic">Anthropic</EntityLink>, Microsoft, and Meta pledged to provide pre-deployment access to their most advanced models for safety testing by government institutes—marking the first formal agreement for government oversight of frontier AI development.
...
| **France** | Within AI Office | 2024 | ≈\$8M | 15-25 | <EntityLink id="E127" name="eu-ai-act">EU AI Act</EntityLink> implementation |
...
- <R id="sid_BbZiXx9vZV">The Bletchley Declaration</R> - UK Government (November 2023)
- <R id="sid_gbVUT7JlzS">Seoul Declaration for Safe, Innovative and Inclusive AI</R> - UK Government (May 2024)
- <R id="sid_B33odUbJUQ">Frontier AI Safety Commitments</R> - UK Government (May 2024)

### AI Safety Institute Reports
- <R id="sid_n2lcyMgNlv">Frontier AI Trends Report</R> - UK AI Security Institute (December 2025)
- <R id="sid_peJnCBcxL9">Pre-deployment evaluation of OpenAI's o1 model</R> - UK AISI
- <R id="sid_0iP9XlmUtA">Inspect AI Framework</R> - Open-source AI safety testing platform

### Analysis and Commentary
- <R id="sid_M3kI7OE9sY">The AI Seoul Summit</R> - CSIS analysis
- <R id="sid_SLInX5Q7zw">France's AI Action Summit</R> - CSIS analysis
- <R id="sid_AeOSEpiJ6u">AI Safety Summits Overview</R> - Future of Life Institute
- <R id="sid_YnsPayzoKl">Common Elements of Frontier AI Safety Policies</R> - METR (December 2025)
- <R id="sid_KSADn0D3js">The Paris Summit: Au Revoir, global AI Safety?</R> - European Policy Centre

### Industry Frameworks
- <R id="sid_96geMqeZUr">AI Lab Watch: Company Commitments</R> - Tracking industry safety commitments
- <R id="sid_PG2I2f7boq">Google DeepMind Partnership with UK AISI</R> - DeepMind blog
