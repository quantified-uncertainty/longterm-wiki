...
- <R id="NzI1ODRjMD">The Bletchley Declaration</R> - UK Government (November 2023)
- <R id="NzVhODRjNj">Seoul Declaration for Safe, Innovative and Inclusive AI</R> - UK Government (May 2024)
- <R id="YmVmM2UwNW">Frontier AI Safety Commitments</R> - UK Government (May 2024)

### AI Safety Institute Reports
- <R id="ZTBiMDIwZD">Frontier AI Trends Report</R> - UK AI Security Institute (December 2025)
- <R id="ZGZiYWFjNm">Pre-deployment evaluation of OpenAI's o1 model</R> - UK AISI
- <R id="MjExZWM4Mz">Inspect AI Framework</R> - Open-source AI safety testing platform

### Analysis and Commentary
- <R id="M2UxNTRiZj">The AI Seoul Summit</R> - CSIS analysis
- <R id="N2FjZjg5NT">France's AI Action Summit</R> - CSIS analysis
- <R id="YjI2YjYwOT">AI Safety Summits Overview</R> - Future of Life Institute
- <R id="OTE0ZWY2Nm">Common Elements of Frontier AI Safety Policies</R> - METR (December 2025)
- <R id="ODY1YjM3ND">The Paris Summit: Au Revoir, global AI Safety?</R> - European Policy Centre

### Industry Frameworks
- <R id="NWE5ZmZmZm">AI Lab Watch: Company Commitments</R> - Tracking industry safety commitments
- <R id="YWIwZjE4Yz">Google DeepMind Partnership with UK AISI</R> - DeepMind blog
