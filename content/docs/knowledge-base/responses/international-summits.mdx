...
International AI Safety Summits improve the <EntityLink id="ai-transition-model" /> through <EntityLink id="E60" name="civilizational-competence" />:

| Factor | Parameter | Impact |
|--------|-----------|--------|
| <EntityLink id="E60" name="civilizational-competence" /> | <EntityLink id="E171" name="international-coordination" /> | Achieved first formal recognition of catastrophic AI risks from 28+ countries including US and China |
| <EntityLink id="E60" name="civilizational-competence" /> | <EntityLink id="E167" name="institutional-quality" /> | Established 10+ AI Safety Institutes with \$100-400M combined budgets |
| <EntityLink id="E358" name="transition-turbulence" /> | <EntityLink id="E242" name="racing-intensity" /> | 16 companies signed Frontier AI Safety Commitments (though non-binding) |
