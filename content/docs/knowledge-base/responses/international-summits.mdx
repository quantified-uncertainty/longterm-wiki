...
description: Global diplomatic and scientific initiatives bringing together 28+ countries and major AI companies to establish international coordination on AI safety, producing non-binding declarations and institutional capacity building through AI Safety Institutes. Bletchley (2023), Seoul (2024), Paris (2025), and the researcher-driven Singapore SCAI (2025) have achieved formal recognition of catastrophic AI risks, 16 companies signing Frontier AI Safety Commitments, and a defence-in-depth research consensus from 88 experts across 11 countries.
sidebar:
  order: 8
quality: 63
llmSummary: Three diplomatic AI safety summits (Bletchley 2023, Seoul 2024, Paris 2025) plus the researcher-driven Singapore SCAI conference (April 2025) achieved first formal recognition of catastrophic AI risks from 28+ countries, established 10+ AI Safety Institutes with $100-400M combined budgets, secured voluntary commitments from 16 companies covering ~80% of frontier AI development, and produced a defence-in-depth research consensus (Assessment, Development, Control) from 88 experts across 11 countries. However, all commitments remain non-binding with no enforcement mechanisms, and the diplomatic coalition is fracturing (US/UK refused Paris 2025 declaration), with estimated 15-30% probability of binding frameworks by 2030.
...
| **Institutional Output** | 10+ <EntityLink id="ai-safety-institutes">AI Safety Institutes</EntityLink> established | Combined budgets of \$100-400M annually; UK AISI leads with ≈\$65M/year |
...
|--------|------|----------|--------------|-------------|------------------------|
| **Bletchley Park** | Nov 1-2, 2023 | UK | 100+ delegates | <EntityLink id="bletchley-declaration">Bletchley Declaration</EntityLink> on AI risks | 28 countries + EU |
...
| **Singapore (SCAI)** | Apr 26, 2025 | Singapore | 100+ experts | Singapore Consensus on AI Safety Research Priorities | 88 co-authors from 11 countries |
...
Beyond symbolic recognition, Bletchley produced concrete institutional commitments. The UK announced creation of its AI Safety Institute with an initial £100 million investment in the Frontier AI Taskforce—the largest funding for AI safety by any country at that time. The United States committed to establishing its own AI Safety Institute, formalized shortly after in President Biden's October 30, 2023 Executive Order. Most significantly for the AI industry, major companies including <EntityLink id="openai">OpenAI</EntityLink>, <EntityLink id="deepmind">Google DeepMind</EntityLink>, <EntityLink id="anthropic">Anthropic</EntityLink>, Microsoft, and Meta pledged to provide pre-deployment access to their most advanced models for safety testing by government institutes—marking the first formal agreement for government oversight of frontier AI development.
...
## Singapore Conference on AI Safety Research Priorities (April 2025)

The **Singapore Conference on AI: International Scientific Exchange on AI Safety (SCAI)**, held on April 26, 2025, alongside ICLR 2025, represented a distinct complement to the diplomatic summit series. Unlike the government-led Bletchley, Seoul, and Paris summits, SCAI was a researcher-driven convening focused specifically on identifying consensus technical research priorities for AI safety. The conference produced the **Singapore Consensus on Global AI Safety Research Priorities**, authored by <EntityLink id="yoshua-bengio">Yoshua Bengio</EntityLink>, <EntityLink id="stuart-russell">Stuart Russell</EntityLink>, <EntityLink id="max-tegmark">Max Tegmark</EntityLink>, Dawn Song, Tegan Maharaj, Luke Ong, Lan Xue, Ya-Qin Zhang, and 80 additional co-authors from 11 countries (Australia, Canada, Chile, China, France, Japan, Korea, Netherlands, Singapore, UK, US).

Building on the 2025 International AI Safety Report, the Singapore Consensus organized AI safety research into a **defence-in-depth framework** with three areas:

| Area | Focus | Key Research Priorities |
|------|-------|------------------------|
| **Assessment** | Understanding severity and likelihood of AI harms | Standardized risk measurement methods, enhanced metrology for quantitative risk assessment, infrastructure for third-party audits, loss-of-control risk assessment |
| **Development** | Creating trustworthy, secure, and reliable systems | Specification and validation of desired behavior, training and design for robustness against jailbreaks and tampering, formal verification |
| **Control** | Post-deployment monitoring and intervention | System-level monitoring, ecosystem-wide oversight, societal resilience research, AI control setups that work even against actively subversive AI |

The Consensus introduced several notable concepts. It proposed limiting AGI risk by deliberately constraining one or more of three dimensions—autonomy, generality, and intelligence—rather than trying to make fully general autonomous superintelligence safe. It also advocated for "non-agentic guardrails" where non-agentic AI systems monitor and intervene on agentic systems' proposed actions.

Unlike previous safety reports, the Singapore Consensus explicitly identified **areas of mutual interest** where even competing actors benefit from cooperation—shared risk thresholds, evaluation protocols, and safety benchmarks—drawing parallels to aviation safety where fierce competitors collaborate on accident prevention.

The Consensus was presented to digital ministers at the Asia Tech x Singapore Summit (ATxSummit) from May 28-29, 2025, bridging the gap between AI researchers and policymakers. Tegmark expressed increased optimism about future summits following SCAI, noting that "OpenAI, Anthropic, and all these companies sent people to the Singapore conference."

## Institutional Infrastructure and AI Safety Institutes

The summit series has catalyzed unprecedented institutional capacity building for AI safety governance. The **<EntityLink id="uk-aisi">UK AI Safety Institute</EntityLink>** (renamed AI Security Institute in February 2025), operational since late 2023, has conducted pre-deployment evaluations of frontier models including OpenAI's o1 and Anthropic's Claude 3.5 Sonnet. In May 2024, AISI released the open-source **Inspect AI Framework** for standardized safety evaluations.
...
| **France** | Within AI Office | 2024 | ≈\$8M | 15-25 | <EntityLink id="eu-ai-act">EU AI Act</EntityLink> implementation |
...
flowchart TD
    ...
    subgraph SINGAPORE["Singapore SCAI (Apr 2025)"]
        SG1[88 Researchers from 11 Countries]
        SG2[Defence-in-Depth Safety Framework]
        SG3[Areas of Mutual Interest Identified]
    end
...
The diagram illustrates the evolution from broad consensus at Bletchley to emerging divergence at Paris, with China abstaining at Seoul and the US/UK refusing to sign at Paris. The Singapore SCAI conference then re-established researcher-driven consensus on safety priorities across geopolitical lines.
...
| **Singapore SCAI 2025** | 0 | Research consensus document (88 co-authors, 11 countries) | None; scientific consensus mechanism |
...
International AI Safety Summits improve the <EntityLink id="ai-transition-model" /> through <EntityLink id="civilizational-competence" />:

| Factor | Parameter | Impact |
|--------|-----------|--------|
| <EntityLink id="civilizational-competence" /> | <EntityLink id="international-coordination" /> | Achieved first formal recognition of catastrophic AI risks from 28+ countries including US and China |
| <EntityLink id="civilizational-competence" /> | <EntityLink id="institutional-quality" /> | Established 10+ AI Safety Institutes with \$100-400M combined budgets |
| <EntityLink id="transition-turbulence" /> | <EntityLink id="racing-intensity" /> | 16 companies signed Frontier AI Safety Commitments (though non-binding) |
