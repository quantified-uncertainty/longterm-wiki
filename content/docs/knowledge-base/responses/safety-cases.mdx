...
| Interpretability for safety cases | \$10-50M/year | Critical if feasible - Only path to robust deception resistance | 5-10+ years | Anthropic leads (≈600 FTEs total AI safety); [Open Philanthropy RFP](https://www.openphilanthropy.org/request-for-proposals-technical-ai-safety-research/) expected to spend ≈\$40M/5 months on AI safety research |
