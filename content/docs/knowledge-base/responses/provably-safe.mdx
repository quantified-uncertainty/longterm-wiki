...
| Aspect | Detail |
|--------|--------|
| **Total Funding** | [<FBF entity="XqjV4mbMXQ" property="total-funding">£59 million</FBF>](https://www.aria.org.uk/opportunity-spaces/mathematics-for-safe-ai/safeguarded-ai/funding/) over 3-5 years |
...
| **ARIA Funding** | Active (pivoted) | <FBF entity="XqjV4mbMXQ" property="total-funding">£59M</FBF> programme launched; [Nov 2025 pivot](https://www.aria.org.uk/insights/ai-progress-and-a-safeguarded-ai-pivot/) expanded TA1 scope, cancelled TA3 Phase 2, abandoned TA2 Phase 2. Kathleen Fisher (former DARPA HACMS lead) incoming as ARIA CEO. |
...
| [ARIA Safeguarded AI Programme](https://www.aria.org.uk/programme-safeguarded-ai/) | ARIA | Official <FBF entity="XqjV4mbMXQ" property="total-funding">£59M</FBF> programme description |
...
|--------------|------|--------------|
| [ARIA](https://www.aria.org.uk/) | Funding body | <FBF entity="XqjV4mbMXQ" property="total-funding">£59M</FBF> Safeguarded AI programme |
