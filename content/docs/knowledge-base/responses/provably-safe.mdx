...
clusters:
  ...
  - governance
---
import {Mermaid, R, EntityLink, FBF} from '@components/wiki';
...
The foundational paper <R id="sid_OzRSAhYciX">Towards Guaranteed Safe AI</R>, published in May 2024 by Dalrymple, Joar Skalse, and co-authors including <EntityLink id="E380" name="yoshua-bengio">Yoshua Bengio</EntityLink>, <EntityLink id="E290" name="stuart-russell">Stuart Russell</EntityLink>, <EntityLink id="E433" name="max-tegmark">Max Tegmark</EntityLink>, and Sanjit Seshia, introduces the core framework of "guaranteed safe (GS) AI." The approach requires three components: a **world model** (mathematical description of how the AI affects the outside world), a **safety specification** (mathematical description of acceptable effects), and a **verifier** (auditable proof certificate that the AI satisfies the specification relative to the world model).
...
| Aspect | Detail |
|--------|--------|
| **Total Funding** | [<FBF entity="sid_XqjV4mbMXQ" property="total-funding">£59 million</FBF>](https://www.aria.org.uk/opportunity-spaces/mathematics-for-safe-ai/safeguarded-ai/funding/) over 3-5 years |
| **Lead** | David "davidad" Dalrymple (Programme Director) |
| **Focus** | Guaranteed safe AI through formal methods |
| **TA1 (Theory)** | £18M for core research agenda (Phase 2); scope expanded in Nov 2025 pivot to "mathematical assurance and auditability" |
| **TA3 (Applications)** | Original £5.4M Phase 1 continuing; Phase 2 (£8.4M) cancelled in Nov 2025 pivot, replaced by cybersecurity focus |
...
|----------|------------|----------------|
| **<EntityLink id="E483" name="formal-verification" />** | Both use proofs | Provably safe designs from scratch |
| **<EntityLink id="E451" name="constitutional-ai" />** | Both specify rules | Mathematical vs natural language |
| **<EntityLink id="E6" name="ai-control" />** | Both aim for safety | Internal guarantees vs external constraints |
| **<EntityLink id="E174" name="interpretability" />** | Both seek understanding | Formal specification vs empirical analysis |
...
|------|-----------|--------------|
|  | High | Safety specification formally encodes human values; verifier proves actions satisfy specification |
| <EntityLink id="E93" name="deceptive-alignment" /> | High | Proofs preclude deception by construction---no gap between training and deployment behavior |
| <EntityLink id="E226" name="power-seeking" /> | High | Actions mathematically constrained to proven-safe subset; cannot acquire unauthorized resources |
| <EntityLink id="E151" name="goal-misgeneralization" /> | High | Formal world model and specification prevent unintended optimization targets |
| <EntityLink id="E274" name="scheming" /> | Medium | Bounded agent cannot pursue hidden agendas if all actions must pass verification |

## Current State

As of early 2026, provably safe AI remains in the early research phase with no working prototypes. In November 2025, ARIA [announced a significant pivot](https://www.aria.org.uk/insights/ai-progress-and-a-safeguarded-ai-pivot/): TA2 Phase 2 (the £18M "AI Production Facility") was abandoned as frontier AI advances made dedicated ML capability development less valuable; TA3 Phase 2 (£8.4M) was cancelled and replaced by a cybersecurity focus on formally-verified firewalls for critical infrastructure; and TA1's scope was expanded to broader "mathematical assurance and auditability."

| Milestone | Status | Details |
|-----------|--------|---------|
| **Foundational Theory** | Published | <R id="sid_OzRSAhYciX" /> outlines the framework (May 2024) |
| **ARIA Funding** | Active (pivoted) | <FBF entity="sid_XqjV4mbMXQ" property="total-funding">£59M</FBF> programme launched; [Nov 2025 pivot](https://www.aria.org.uk/insights/ai-progress-and-a-safeguarded-ai-pivot/) expanded TA1 scope, cancelled TA3 Phase 2, abandoned TA2 Phase 2. Kathleen Fisher (former DARPA HACMS lead) incoming as ARIA CEO. |
...
|----------|--------|--------------|
| <R id="sid_OzRSAhYciX">Towards Guaranteed Safe AI</R> | Dalrymple et al. (2024) | Foundational agenda paper with Bengio, Russell, Tegmark, Seshia |
| [ARIA Safeguarded AI Programme](https://www.aria.org.uk/programme-safeguarded-ai/) | ARIA | Official <FBF entity="sid_XqjV4mbMXQ" property="total-funding">£59M</FBF> programme description |
| [davidad's Programme Thesis](https://www.lesswrong.com/posts/qweXJ6v9heSn4wvdk/davidad-s-provably-safe-ai-architecture-aria-s-programme) | <EntityLink id="E1998" name="david-dalrymple">David Dalrymple</EntityLink> | Comprehensive technical exposition on LessWrong |
...
|--------------|------|--------------|
| [ARIA](https://www.aria.org.uk/) | Funding body | <FBF entity="sid_XqjV4mbMXQ" property="total-funding">£59M</FBF> Safeguarded AI programme |
