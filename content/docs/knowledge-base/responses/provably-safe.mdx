...
|-----------|--------|---------|
| **Foundational Theory** | Published | <R id="MTRhNTAwYj" /> outlines the framework (May 2024) |
...
|----------|--------|--------------|
| <R id="MTRhNTAwYj">Towards Guaranteed Safe AI</R> | Dalrymple et al. (2024) | Foundational agenda paper with Bengio, Russell, Tegmark, Seshia |
