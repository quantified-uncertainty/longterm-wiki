...
- <EntityLink id="chips-alliance">CHIPS Alliance</EntityLink> / Caliptra - Open-source silicon Root of Trust with cross-vendor support from AMD, Google, Microsoft, NVIDIA
