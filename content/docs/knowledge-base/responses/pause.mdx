...
---
import {DataInfoBox, Backlinks, KeyQuestions, DisagreementMap, Mermaid, R, EntityLink, DataExternalLinks} from '@components/wiki';

<DataExternalLinks pageId="pause" client:load />
