...
| **International Coordination** | Very Low (10-20%) | China developing own <R id="4f75d2d6d47e8531"><EntityLink id="E608">AI governance</EntityLink> framework</R>; US-China competition intense |
...
|------|-----------|---------------|
| <EntityLink id="E239">Racing Dynamics</EntityLink> | Reduces competitive pressure, creates coordination window | High if achieved |
...
| <EntityLink id="E189">Lock-in</EntityLink> | Provides time for governance frameworks | Medium |
| Epistemic Risks | Reduces rushed deployment of unreliable systems | Medium |

## Overview

Pause advocacy represents one of the most controversial interventions in AI safety: calling for the deliberate slowing or temporary halting of frontier AI development until adequate safety measures can be implemented. This approach gained significant attention following the March 2023 open letter organized by the <EntityLink id="E528">Future of Life Institute</EntityLink>, which called for a six-month pause on training AI systems more powerful than GPT-4 and garnered over 30,000 signatures including prominent technologists and researchers.
...
|--------|-------|--------|----------------------|
| U.S. AI Investment (2024) | \$109 billion | <EntityLink id="E550">Microsoft AI</EntityLink> Economy Institute | Massive economic interests opposing pause |
...
| **<EntityLink id="E47">CAIS</EntityLink> Statement** | May 2023 | Risk acknowledgment | 350+ researchers | Recognition of extinction risk | Influenced discourse |
...
Complementary approaches include compute governance initiatives that could enable pause enforcement, international coordination efforts that could make pauses stable, and <EntityLink id="E252">responsible scaling policies</EntityLink> that implement conditional pause-like mechanisms. Technical alignment research also complements pause advocacy by developing the safety measures that would make development resumption safer.
...
|--------|-----------|--------|
| <EntityLink id="E358" /> | <EntityLink id="E242" /> | Coordinated slowdown reduces race to bottom on safety |
| <EntityLink id="E205" /> | <EntityLink id="E261" /> | Provides 2-5 additional years for safety research if achieved |
| <EntityLink id="E60" /> | <EntityLink id="E171" /> | Requires unprecedented global coordination to be effective |
