...
update_frequency: 7
summary: Comprehensive analysis of Canada's failed Artificial Intelligence and Data Act (AIDA), which died in Parliament in January 2025 after three years of development. Documents specific failure modes including framework legislation problems, exclusionary consultation (9 of 300+ meetings with civil society), and provides scenario analysis with probability estimates for future Canadian AI regulation approaches.
clusters:
  - governance
  - ai-safety
---
