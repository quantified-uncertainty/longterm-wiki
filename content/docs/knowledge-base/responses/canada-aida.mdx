...
| <EntityLink id="E60">Civilizational Competence</EntityLink> | Democratic Oversight | Exclusionary consultation process (9 of 300+ meetings with civil society) undermined democratic legitimacy |
| <EntityLink id="E60">Civilizational Competence</EntityLink> | Technical Standards Development | Risk assessment requirements exceeded current AI interpretability capabilities, revealing gaps between regulatory ambition and technical reality |
