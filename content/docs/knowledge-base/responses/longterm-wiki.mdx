...
|----------|--------------|---------|
| **Intervention comparison** | Side-by-side pages with explicit uncertainty | Compare <EntityLink id="interpretability">interpretability</EntityLink> vs governance approaches |
