...
<DataInfoBox entityId="deepfakes-authentication-crisis" ratings={frontmatter.ratings} />
...
- <EntityLink id="disinformation-detection-race" label="Disinformation Detection Race" /> - Why detection is failing
- <EntityLink id="disinformation-electoral-impact" label="Electoral Impact Assessment" /> - Political consequences
...
<Backlinks entityId="deepfakes-authentication-crisis" />
