...
- <EntityLink id="E103" name="disinformation-detection-race" label="Disinformation Detection Race" /> - Why detection is failing
- <EntityLink id="E104" name="disinformation-electoral-impact" label="Electoral Impact Assessment" /> - Political consequences
