...
- **Projections assume continued scaling**: The 2030 projections assume current investment trajectories continue. An AI investment correction (see <EntityLink id="E700">Pre-TAI Capital Deployment</EntityLink>) could significantly alter these figures.
