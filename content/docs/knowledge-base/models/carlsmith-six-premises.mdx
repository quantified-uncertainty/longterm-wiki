...
In 2023, Carlsmith worked with [Good Judgment's superforecasters](https://goodjudgment.com/superforecasting-ai/) to test his estimates. The project ran from August to October 2022, with a follow-up round in spring 2023, funded by <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>. Key findings from <R id="8d9f2fea7c1b4e3a">the comparison study</R>:
