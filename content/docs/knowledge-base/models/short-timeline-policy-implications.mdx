...
|--------------|-----------------|---------------------|
| <EntityLink id="E6" name="ai-control">AI control techniques</EntityLink> | Prevents catastrophic outcomes from deployed systems | Weeks to months |
| Internal red-teaming | Catches dangerous capabilities before deployment | Already possible |
| Security protocols (weights, training details) | Prevents <EntityLink id="E232" name="proliferation">proliferation</EntityLink> during critical period | Months |
...
### <EntityLink id="E464" name="monitoring">Compute Monitoring</EntityLink> and Thresholds

<EntityLink id="E64" name="compute-governance">Compute governance</EntityLink> becomes particularly important under short timelines because:
...
- <EntityLink id="E174" name="interpretability">Interpretability</EntityLink> tools for detecting deception/misalignment
- <EntityLink id="E128" name="evals">Dangerous capability evaluations</EntityLink>
- <EntityLink id="E6" name="ai-control">Control techniques</EntityLink> (monitoring, sandboxing, tripwires)
- <EntityLink id="E271" name="scalable-oversight">Scalable oversight</EntityLink> methods that work with current architectures
...
Individual hiring and placement decisions may matter more than institutional reforms that won't complete in time. Programs like <EntityLink id="E548" name="mats">MATS</EntityLink> that place alignment researchers become especially valuable.
...
|--------------|---------------|---------------------------|
| New international AI governance body | 5-10 years | Won't exist in time |
...
Major legislation like the <EntityLink id="E127" name="eu-ai-act">EU AI Act</EntityLink> takes years to pass and more years to implement. Under short timelines:
...
1. **Implement <EntityLink id="E461" name="rsp">responsible scaling policies</EntityLink> with teeth** - Not just commitments but operational procedures
...
4. **Coordinate with other labs on safety standards** - The <EntityLink id="E427" name="frontier-model-forum">Frontier Model Forum</EntityLink> and similar bodies
