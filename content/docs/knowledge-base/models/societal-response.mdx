...
description: "This model quantifies societal response capacity to AI developments, finding that public concern (50%), institutional capacity (20-25%), and international coordination (~30% effective) are currently inadequate, with a critical 3-5 year institutional gap."
...
flowchart TD
    subgraph Signals["Early Warning Signals"]
        ACC["AI Accidents"]
        EXP["Expert Warnings<br/>consensus: 0.6"]
        MED["Media Coverage"]
        ECON["Economic Disruption<br/>15% workforce affected"]
    end

    subgraph Opinion["Public Opinion"]
        CONCERN["Public Concern<br/>~50%"]
        TRUST["Trust in Institutions<br/>30-35%"]
        POLAR["Political Polarization"]
    end

    subgraph Institutional["Institutional Capacity"]
        GOV["Government Understanding<br/>25% adequate"]
        LEG["Legislative Speed<br/>24+ months"]
        REG["Regulatory Capacity<br/>20%"]
        SELF["Industry Self-Regulation<br/>35% effective"]
    end

    subgraph Research["Research Ecosystem"]
        PIPE["Safety Pipeline<br/>500 researchers/yr"]
        FUND["Safety Funding<br/>~\\$1B/yr"]
    end

    subgraph Outcomes["Response Outcomes"]
        INST["Institutional Response<br/>25% adequate"]
        COORD["Coordination<br/>30% effective"]
        RESIL["Civilizational Resilience"]
        GOVADQ["Governance Adequacy<br/>25%"]
    end

    SAFETY["Existential Safety<br/>P safe ~75%"]
    ...
    style Opinion fill:#dae8fc
    style Institutional fill:#d5e8d4
    style Research fill:#e1d5e7
...
| Safety research funding | \$1-2B/year | \$0.5-3B | Medium | <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>, government budgets |
