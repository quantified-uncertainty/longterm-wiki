...
- <EntityLink id="E240" name="racing-dynamics-impact" label="Racing Dynamics Impact" /> - Why speed pressure increases
- <EntityLink id="E135" name="expertise-atrophy-progression" label="Expertise Atrophy Progression" /> - Human capacity degradation
- <EntityLink id="E36" name="autonomous-weapons-escalation" /> - Military flash dynamics
- <EntityLink id="E63" name="compounding-risks-analysis" label="Compounding Risks Analysis" /> - Flash dynamics interactions
