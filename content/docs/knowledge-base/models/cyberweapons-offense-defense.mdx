...
- <EntityLink id="E87" name="cyberweapons-attack-automation" /> - Projects when attacks achieve full autonomy, directly affecting the speed dimension of offense advantage
- <EntityLink id="E143" name="flash-dynamics-threshold" /> - Analyzes when machine-speed operations prevent human intervention, relevant to autonomous attack and defense
