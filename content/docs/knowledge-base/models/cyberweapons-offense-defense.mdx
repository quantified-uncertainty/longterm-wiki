...
- <EntityLink id="E87" /> - Projects when attacks achieve full autonomy, directly affecting the speed dimension of offense advantage
- <EntityLink id="E143" /> - Analyzes when machine-speed operations prevent human intervention, relevant to autonomous attack and defense
