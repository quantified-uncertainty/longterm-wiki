...
---
import {DataInfoBox, Backlinks, KeyQuestions, EntityLink, Mermaid} from '@components/wiki';

<DataInfoBox entityId="institutional-adaptation-speed" ratings={frontmatter.ratings} />
...
<Backlinks entityId="institutional-adaptation-speed" />
