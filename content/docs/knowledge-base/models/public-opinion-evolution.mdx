...
- <EntityLink id="E196" name="media-policy-feedback-loop" label="Media-Policy Feedback Loop" /> - Cycle between coverage, opinion, and policy
- <EntityLink id="E120" name="epistemic-collapse-threshold" label="Epistemic Collapse Threshold" /> - How trust in information breaks down
- <EntityLink id="E296" name="sycophancy-feedback-loop">Sycophancy Feedback Loop</EntityLink> - AI validation and opinion reinforcement
- <EntityLink id="E104" name="disinformation-electoral-impact" label="Disinformation Electoral Impact" /> - AI influence on elections
