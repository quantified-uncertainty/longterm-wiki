...
|--------|------------|----------|--------|
| **Current Underinvestment** | High | 100:1 capabilities vs safety ratio | <R id="342acf7e721544e6"><EntityLink id="E125" name="epoch-ai">Epoch AI</EntityLink> (2024)</R> |
| **Marginal Returns** | Medium-High | 2-5x potential in neglected areas | <R id="2aa20a88a0b0cbcf"><EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink></R> |
| **Timeline Sensitivity** | High | Value drops 50%+ if timelines \<5 years | <R id="38eba87d0a888e2e"><EntityLink id="E512" name="ai-impacts">AI Impacts</EntityLink> Survey</R> |
