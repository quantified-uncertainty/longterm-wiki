...
| **Marginal Returns** | Medium-High | 2-5x potential in neglected areas | <R id="2aa20a88a0b0cbcf"><EntityLink id="open-philanthropy">Open Philanthropy</EntityLink></R> |
...
*Key organizations: <R id="dd0cf0ff290cc68e">Open Philanthropy</R>, <R id="1593095c92d34ed8">Future of Humanity Institute</R>, <R id="9baa7f54db71864d">Long-Term Future Fund</R>*
...
|--------|------------|------------------|-------------------|
| <R id="dd0cf0ff290cc68e">Open Philanthropy</R> | Technical research, policy | \$100M+ | LOI system |
