...
| P(racing dynamics dominate) | 60-75% | 40-85% | Medium | [Armstrong et al. 2016](https://web.archive.org/web/2024/https://www.fhi.ox.ac.uk/wp-content/uploads/Racing-to-the-precipice-a-model-of-artificial-intelligence-development.pdf) |
...
The team was disbanded in May 2024 after co-leads <EntityLink id="E163" name="ilya-sutskever">Ilya Sutskever</EntityLink> and <EntityLink id="E182" name="jan-leike">Jan Leike</EntityLink> resigned. Leike publicly stated that "over the past years, safety culture and processes have taken a backseat to shiny products." This case demonstrates how commercialization pressures can create and deepen tradeoff dynamics between rapid productization and safety research, even at organizations with stated safety commitments.
...
- <EntityLink id="E177" name="intervention-effectiveness-matrix" /> - Which interventions address which risks
- <EntityLink id="E239" name="racing-dynamics">Racing Dynamics Model</EntityLink> - Competitive pressures in AI development
- <EntityLink id="E99" name="defense-in-depth-model" /> - How safety measures combine
