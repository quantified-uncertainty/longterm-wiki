...
| **Policy Influence** | Positive (RSP framework adopted industry-wide) | <EntityLink id="E461" name="responsible-scaling-policies">RSP</EntityLink> adoption |
...
The <EntityLink id="E461" name="responsible-scaling-policies">RSP framework</EntityLink> has influenced industry practices:
