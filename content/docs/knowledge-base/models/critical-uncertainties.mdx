...
| **Forecasting Platforms** | <R id="bb81f2a99fdba0ec">Metaculus</R>, <EntityLink id="E546" name="manifold">Manifold</EntityLink>, <EntityLink id="E555" name="polymarket">Polymarket</EntityLink> | AGI timelines, capability milestones, policy outcomes | Continuous |
...
| **Governance Tracking** | <R id="d5796bc00a131872">IAPP AI Governance</R>, regulatory databases | Policy stringency, compliance rates, enforcement actions | Quarterly |
