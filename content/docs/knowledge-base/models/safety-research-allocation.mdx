...
*Sources: <R id="MTBlNzJiZT"><EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink></R> funding data, <R id="MmI4MGUzYm">RAND</R> workforce analysis*
...
*Data from <R id="NjdhYjAxMj">AI Index Report 2024</R>*
...
*Source: <R id="NDNlZDhjZT"><EntityLink id="E510" name="80000-hours">80,000 Hours</EntityLink></R> career tracking*
...
*Analysis based on <R id="YWQ5NzdiZD">Anthropic</R> and <R id="NjQzNmMyMz">OpenAI</R> research portfolios*
...
- <R id="NGEyYTllZD"><EntityLink id="E57" name="chai">CHAI</EntityLink> Berkeley</R>: 15-20 FTE researchers
- <R id="ZmUzMzhhYz">Stanford HAI</R>: 25-30 FTE safety-focused
...
- Compute grants: <R id="NmJkN2ViNG">NSF NAIRR</R> pilot program
...
| <R id="NjVlOWM5MD">NIST AI</R> | 30-50 | \$30-60M | Risk frameworks |
...
|--------|------------------|-------------|-------------------|
| <R id="MWExMWE0YT">Coefficient Giving</R> | \$50-80M | All areas | Research-driven |
...
*Analysis combining <R id="NWJjMjA0YT">FHI</R> research priorities and expert elicitation*
...
*Estimates from <R id="ODM0MTY2OW">Georgetown <EntityLink id="E524" name="cset">CSET</EntityLink></R> analysis*
...
|--------|-------------|-------------|
| <R id="OWYyZWEyNW">Dafoe (2018)</R> | AI governance research agenda | Expert consultation |
| <R id="MzcwMDRkZW">Zhang et al. (2021)</R> | AI research workforce analysis | Survey data |
| <R id="NzQyNGViND">Anthropic (2023)</R> | Industry safety research priorities | Internal analysis |

### Government Reports

| Organization | Report | Year | Focus |
|-------------|--------|------|-------|
| <R id="N2EzYzdjMD">NIST</R> | AI Risk Management Framework | 2023 | Standards |
| <R id="M2NlYWZjMD">RAND</R> | AI Workforce Analysis | 2024 | Talent mapping |
| <R id="YmI3OThkZD">UK Government</R> | Frontier AI Capabilities | 2024 | Research needs |

### Industry Resources

| Organization | Resource | Description |
|-------------|----------|-------------|
| <R id="YWQ5NzdiZD">Anthropic</R> | Safety Research | Current priorities |
| <R id="NjQzNmMyMz">OpenAI</R> | Safety Overview | Research areas |
| <R id="NTQ1NjVmNz">DeepMind</R> | Safety Research | Technical approaches |

### Data Sources

| Source | Data Type | Coverage |
|--------|-----------|----------|
| <R id="ZGYwNjFmZG">AI Index</R> | Funding trends | Global, annual |
| <R id="ZmNlODAzMD">80,000 Hours</R> | Career tracking | Individual transitions |
| <R id="MWVmMzgyMW">Coefficient Giving</R> | Grant databases | Foundation funding |
