...
Current allocation shows stark imbalances: industry controls 60-70% of resources while academia receives only 15-20%, creating systematic gaps in independent research. <R id="sid_nlss9GitVm">Expert analysis</R> suggests this distribution leads to 30-50% efficiency losses compared to optimal allocation, with critical areas like <EntityLink id="E488" name="multi-agent">multi-agent safety</EntityLink> receiving 3-5x less attention than warranted by their risk contribution.
...
*Sources: <R id="sid_SMkFZQFHUR"><EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink></R> funding data, <R id="sid_9U6bQ9UjOm">RAND</R> workforce analysis*

### Geographic Concentration Analysis

| Location | Research FTE | % of Total | Major Organizations |
|----------|-------------|------------|-------------------|
| **SF Bay Area** | 700-900 | 45% | <EntityLink id="E218" name="openai">OpenAI</EntityLink>, <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> |
| **London** | 250-350 | 20% | <EntityLink id="E98" name="deepmind">DeepMind</EntityLink>, <EntityLink id="E364" name="uk-aisi">UK AISI</EntityLink> |
| **Boston/NYC** | 200-300 | 15% | MIT, Harvard, NYU |
| **Other** | 300-400 | 20% | Distributed globally |

*Data from <R id="sid_hyp70JOzvy">AI Index Report 2024</R>*
...
*Source: <R id="sid_J0qi6a7isb"><EntityLink id="E510" name="80000-hours">80,000 Hours</EntityLink></R> career tracking*
...
*Analysis based on <R id="sid_Nnq9NTGRWv">Anthropic</R> and <R id="sid_9k9WnU6s2E">OpenAI</R> research portfolios*
...
- <R id="sid_gByt1Q4XL3"><EntityLink id="E57" name="chai">CHAI</EntityLink> Berkeley</R>: 15-20 FTE researchers
- <R id="sid_gBxYsLMdjQ">Stanford HAI</R>: 25-30 FTE safety-focused
...
- Compute grants: <R id="sid_1RU8GuRF5M">NSF NAIRR</R> pilot program
...
|-------------|-------|--------|-------------|
| <EntityLink id="E365" name="us-aisi">US AISI</EntityLink> | 50-80 | \$50-100M | Evaluation, standards |
| <R id="sid_VULyXZMVSt">NIST AI</R> | 30-50 | \$30-60M | Risk frameworks |
| <EntityLink id="E364" name="uk-aisi">UK AISI</EntityLink> | 40-60 | £30-50M | Frontier evaluation |
...
|--------|------------------|-------------|-------------------|
| <R id="sid_0CLSSqitA0">Coefficient Giving</R> | \$50-80M | All areas | Research-driven |
...
| <EntityLink id="E528" name="fli">Future of Life Institute</EntityLink> | \$5-10M | Governance | Public engagement |
...
|---------------|-----------|-----------|-------------|
| **<EntityLink id="E259" name="rlhf">RLHF</EntityLink>/Training** | 25% | 15% | Over-funded |
...
*Analysis combining <R id="sid_mzRmSZ2dkg">FHI</R> research priorities and expert elicitation*
...
- Research orgs: <EntityLink id="E202" name="miri">MIRI</EntityLink>, academic game theorists

**<EntityLink id="E79" name="corrigibility">Corrigibility Research</EntityLink>:**
...
*Estimates from <R id="sid_WG9PIf8j8s">Georgetown <EntityLink id="E524" name="cset">CSET</EntityLink></R> analysis*
...
- <EntityLink id="E239" name="racing-dynamics">Racing dynamics</EntityLink> intensify
...
|--------|-------------|-------------|
| <R id="sid_MI4pSpCcAQ">Dafoe (2018)</R> | AI governance research agenda | Expert consultation |
| <R id="sid_UxYG9HrJtk">Zhang et al. (2021)</R> | AI research workforce analysis | Survey data |
| <R id="sid_ikeY9aQNVz">Anthropic (2023)</R> | Industry safety research priorities | Internal analysis |

### Government Reports

| Organization | Report | Year | Focus |
|-------------|--------|------|-------|
| <R id="sid_qnIHCbws2b">NIST</R> | AI Risk Management Framework | 2023 | Standards |
| <R id="sid_V6wuykyClO">RAND</R> | AI Workforce Analysis | 2024 | Talent mapping |
| <R id="sid_mDv4S1qHdu">UK Government</R> | Frontier AI Capabilities | 2024 | Research needs |

### Industry Resources

| Organization | Resource | Description |
|-------------|----------|-------------|
| <R id="sid_Nnq9NTGRWv">Anthropic</R> | Safety Research | Current priorities |
| <R id="sid_9k9WnU6s2E">OpenAI</R> | Safety Overview | Research areas |
| <R id="sid_ucxXRiaDNP">DeepMind</R> | Safety Research | Technical approaches |

### Data Sources

| Source | Data Type | Coverage |
|--------|-----------|----------|
| <R id="sid_Rsuz0BPSf9">AI Index</R> | Funding trends | Global, annual |
| <R id="sid_pqfi6VdUxf">80,000 Hours</R> | Career tracking | Individual transitions |
| <R id="sid_IoH3nYIf5l">Coefficient Giving</R> | Grant databases | Foundation funding |
