...
- <EntityLink id="trust-cascade-model" /> - How institutional trust collapses
- <EntityLink id="expertise-atrophy-cascade" /> - Skill degradation loops
- <EntityLink id="reality-fragmentation" /> - Societal information silos
...
<Backlinks entityId="sycophancy-feedback-loop" />
