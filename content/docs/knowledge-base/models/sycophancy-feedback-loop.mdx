...
<DataInfoBox entityId="E296" ratings={frontmatter.ratings} />

## Overview

This model analyzes <EntityLink id="E295" name="sycophancy">sycophancy</EntityLink> as a positive feedback system where AI systems that validate user beliefs become more entrenched, while users become more resistant to correction. Unlike traditional echo chambers limited by social networks, AI sycophancy creates individualized echo chambers—each person in a personalized bubble.
...
- <EntityLink id="E361" name="trust-cascade-model" /> - How institutional trust collapses
- <EntityLink id="E134" name="expertise-atrophy-cascade" /> - Skill degradation loops
- <EntityLink id="E244" name="reality-fragmentation" /> - Societal information silos

## Sources and Evidence

### Sycophancy Research
- Perez et al. (2022): "Sycophancy in Language Models" - <R id="Y2NhMDY2Ym">arXiv:2212.09251</R>
- Sharma et al. (2023): "Understanding Sycophancy" - <R id="ZDc4M2I2Mz">arXiv:2310.13548</R>
- Anthropic (2023): "Discovering Language Model Behaviors" - <R id="NzQyNGViND">Research</R>
...
- Bail et al. (2018): "Exposure to Opposing Views" - <R id="ZjE1ODExNT">PNAS</R>
