...
- The [Stargate partnership (<F e="openai" f="valuation-2025">\$500B</F> committed)](https://www.whitehouse.gov/briefing-room/statements-releases/2025/01/21/fact-sheet-president-donald-j-trump-announces-the-stargate-project/)[^13] shifts infrastructure costs partially off-balance-sheet through joint venture structure.
...
- Valuation at 39x revenue (<F e="anthropic" f="valuation-nov-2025">\$350B</F>/<F e="anthropic" f="revenue-arr-2025">\$9B</F>) exceeds OpenAI's 25x, indicating high market expectations for growth.[^22]
