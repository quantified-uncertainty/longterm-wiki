...
- <EntityLink id="E36" name="autonomous-weapons-escalation" /> - Analyzes conflict dynamics and escalation risks when autonomous weapons become widespread
- <EntityLink id="E143" name="flash-dynamics-threshold" /> - Examines speed implications and machine-timescale decision-making at scale
