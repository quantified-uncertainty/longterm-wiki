...
- <EntityLink id="E36" /> - Analyzes conflict dynamics and escalation risks when autonomous weapons become widespread
- <EntityLink id="E143" /> - Examines speed implications and machine-timescale decision-making at scale
