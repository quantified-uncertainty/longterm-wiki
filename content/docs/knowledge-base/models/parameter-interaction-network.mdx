...
update_frequency: 90
summary: Maps causal relationships between 22 AI safety parameters, identifying 7 feedback loops and 4 clusters. Finds epistemic-health and institutional-quality as highest-leverage intervention points with net influence scores of +5 and +3 respectively.
clusters:
  - ai-safety
  - governance
todos:
...
- <EntityLink id="E258" name="risk-interaction-network" label="Risk Interaction Network" /> - Similar network approach for risks
- <EntityLink id="E256" name="risk-cascade-pathways" label="Risk Cascade Pathways" /> - How risks propagate
- <EntityLink id="E120" name="epistemic-collapse-threshold" label="Epistemic Collapse Threshold" /> - Deep dive on epistemic parameters
- <EntityLink id="E361" name="trust-cascade-model" label="Trust Cascade Model" /> - Trust dynamics in detail
