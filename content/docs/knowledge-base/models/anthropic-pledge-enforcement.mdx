...
| <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> | Fund + coordinate | <EntityLink id="dustin-moskovitz">Moskovitz</EntityLink> connection to Anthropic | Moskovitz may already be doing this informally |
