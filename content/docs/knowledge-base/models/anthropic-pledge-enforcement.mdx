...
:::note[Page Context]
This page evaluates interventions to increase the probability that <EntityLink id="anthropic-investors">Anthropic co-founders' 80% donation pledges</EntityLink> are fulfilled. Inspired by [SiebeRozendal's EA Forum comment](https://forum.effectivealtruism.org/posts/rRBaP7YbXfZibSn3C/front-load-giving-because-of-anthropic-donors) suggesting it would be "worthwhile to ask/pressure Anthropic's founders to make their pledges legally binding." All cost-effectiveness estimates are rough. The "critical" estimates attempt to correct for common biases in this type of analysis (see [Why These Numbers Are Probably Still Wrong](#why-these-numbers-are-probably-still-wrong)).
:::
...
- <EntityLink id="dario-amodei">Dario Amodei</EntityLink>'s essay framing suggests genuine conviction, not performative pledging.

**Case that "enforcement" is adversarial and unwelcome:**
- Founders deliberately chose non-binding pledges. They could have created irrevocable trusts or followed the <EntityLink id="openai-foundation">OpenAI Foundation</EntityLink> model. They didn't. This was a choice, not an oversight.
...
| 7 | **LTBT governance** | Advocate for the <EntityLink id="long-term-benefit-trust">Long-Term Benefit Trust</EntityLink> to include pledge monitoring in its governance mandate. The LTBT already has mission-accountability powers (board appointment). **Honest concern**: The LTBT governs the *company*, not founders' *personal wealth*. Expanding its mandate to police personal financial commitments raises serious overreach questions. P(Adoption) is very low (2-8%). | \$300K-1.5M | \$10-100M |
...
|--------------|----------|-----|---------|
| <EntityLink id="longview-philanthropy">Longview Philanthropy</EntityLink> | Lead advisory + advocacy | Already advises AI safety donors; may have founder access | Opportunity cost of senior staff time |
| <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> | Fund + coordinate | <EntityLink id="dustin-moskovitz">Moskovitz</EntityLink> connection to Anthropic | Moskovitz may already be doing this informally |
...
| GiveWell | Advise on allocation | <EntityLink id="dario-amodei">Dario Amodei</EntityLink>'s early involvement; trusted brand | GiveWell focuses on global health, not meta-philanthropy |

## Why This Matters

All seven Anthropic co-founders have pledged to donate 80% of their equity (\$39-59B at current \$350B valuation), but these pledges are non-binding. Only 36% of deceased <EntityLink id="giving-pledge">Giving Pledge</EntityLink> signatories met even a 50% threshold, and living pledgers have grown 166% wealthier since signing. [IPS](https://ips-dc.org/report-giving-pledge-at-15/) Only 2 of 7 Anthropic founders (<EntityLink id="dario-amodei">Dario</EntityLink> and <EntityLink id="daniela-amodei">Daniela Amodei</EntityLink>) have documented strong connections to the effective giving community; the other 5 founders' cause priorities are unknown. For the full capital analysis, see <EntityLink id="anthropic-investors">Anthropic (Funder)</EntityLink>. For comparison with the <EntityLink id="openai-foundation">OpenAI Foundation</EntityLink>'s legally binding model, see that page.
...
The founders most likely to engage with pledge-enforcement interventions are Dario and Daniela Amodei—who are also by far the most likely to fulfill their pledges *regardless* of any intervention. Dario is the 43rd GWWC signatory and early GiveWell fan. Daniela is married to <EntityLink id="holden-karnofsky">Holden Karnofsky</EntityLink>. The counterfactual impact of "encouraging" them to give is probably near zero.
...
**What**: Advocate for the <EntityLink id="long-term-benefit-trust">Long-Term Benefit Trust</EntityLink> to add pledge monitoring to its mandate.
...
- <EntityLink id="anthropic-investors">Anthropic (Funder)</EntityLink> — Full analysis of EA-aligned capital at Anthropic
- <EntityLink id="giving-pledge">Giving Pledge</EntityLink> — Historical fulfillment rates and patterns
- <EntityLink id="long-term-benefit-trust">Long-Term Benefit Trust</EntityLink> — Anthropic's governance structure
- <EntityLink id="openai-foundation">OpenAI Foundation</EntityLink> — Contrasting legally binding model
- <EntityLink id="longview-philanthropy">Longview Philanthropy</EntityLink> — Potential lead organization
- <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> — Potential funder/coordinator
