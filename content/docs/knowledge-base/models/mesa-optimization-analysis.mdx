...
**Evaluation Protocols** (<R id="45370a5153534152">METR</R>, <EntityLink id="E24" name="apollo-research">Apollo Research</EntityLink>):
...
| <EntityLink id="E202" name="miri">**MIRI**</EntityLink> | Formal alignment theory | <R id="ee872736d7fbfcd5">Agent Foundations</R> |
