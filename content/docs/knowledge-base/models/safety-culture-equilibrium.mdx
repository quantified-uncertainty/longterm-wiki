...
- <EntityLink id="E240" name="racing-dynamics-impact" label="Racing Dynamics Impact" /> - Racing dynamics consequences
- <EntityLink id="E210" name="multipolar-trap-dynamics" label="Multipolar Trap Dynamics" /> - Coordination failure mechanisms
- <EntityLink id="E219" name="parameter-interaction-network" label="Parameter Interaction Network" /> - How safety-culture-strength interacts with other parameters
