...
| **Total** | **\$700M-1.25B** | **+35-50%/year** | |[^rc-1efc]
...
Approximately 2,000-3,500 people globally work full-time on AI safety research as of 2025.[^rc-138d]
...
| **Governance & institutions** | 10% | \$500M-1B | <EntityLink id="E470" name="coordination-mechanisms">International coordination mechanisms</EntityLink>; regulatory capacity building |
...
| **Post-TMI (1979+)** | \$5-10B | 15,000+ | Containment standards; probabilistic risk assessment | ≈1:5 |[^rc-6dbb]
...
| **Time to maturity** | ≈50 years (1938-1990s) | ≈5 years so far | Unknown |[^rc-c137]
...
**Examples**: <EntityLink id="E26" name="arc-evals">ARC Evaluations</EntityLink>, <EntityLink id="E201" name="metr">METR</EntityLink>, <EntityLink id="E461" name="rsp">Responsible Scaling Policies</EntityLink>
