...
| **Tier 4: Video <EntityLink id="E96">Deepfakes</EntityLink>** | Synthetic video calls, face swapping | Deepfake tools, training data | High-profile cases (2024) |
...
| Video <EntityLink id="E591">deepfake detection</EntityLink> rate | 45% | 30-65% | Medium | Academic benchmarks |
...
- <EntityLink id="E97" /> - Focuses specifically on synthetic media and identity verification challenges that underpin Tiers 4-6 of this model
- <EntityLink id="E103" /> - Analyzes analogous dynamics in content authenticity, with parallel attack-defense cycles
