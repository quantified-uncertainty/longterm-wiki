...
| <EntityLink id="E98" name="deepmind">DeepMind</EntityLink> | Mixed signals | <R id="d564401cd5e38340">Future of Life Institute</R> gave C grade (improved from C-) | Moderate - depends on Google priorities |
| <EntityLink id="E378" name="xai">xAI</EntityLink> | Concerning | <R id="21118f4612db1855">Researchers decry</R> "reckless" and "completely irresponsible" culture | Very Low - Grok 4 launched without safety documentation |
