...
[^1]: Stanford HAI AI Index Report 2025 - data on model production, investment figures, and regulatory output
[^2]: Knight Columbia AI Power Disparity Index (AI-PDI) research - framework for measuring power distributions in the AI ecosystem
[^3]: Carnegie Endowment for International Peace research on AI and democracy - mapping AI's influence through elections, deliberation, and governance
[^4]: Data Center Watch Q2 2025 report - tracking grassroots opposition to AI infrastructure projects
[^5]: AI Now Institute reporting on AI industry power concentration
[^6]: LSE Grantham Research Institute and MIT research on AI energy consumption and environmental impact