...
**Timeline:** <R id="YmQyZDAyMz">RAND analysis</R> suggests cascade initiation within 2-4 years if authentication tech lags deepfake advancement by >18 months.
...
**Expert assessment:** <R id="NTQwYmRjYW">Anthropic research</R> indicates 35-55% probability of concerning concentration by 2030 without intervention.
...
|------|----------|------------------|-------------------|
| Interaction modeling | Early-Maturing | <R id="MTY0YjA3MT">RAND</R>, <R id="ODM0MTY2OW">CSET</R>, [MIT AI Risk Repository](https://airisk.mit.edu/) | 15-25 systematic analyses published (2024-2025) |
...
| Policy applications | Developing | <EntityLink id="E153" name="govai">GovAI</EntityLink>, <R id="OTc2ODExMz">CNAS</R>, [International AI Safety Report](https://internationalaisafetyreport.org/) | Framework adoption by 30+ countries |
...
| **Research papers** | <R id="YmQyZDAyMz">RAND AI Risk Interactions</R> | Foundational interaction framework |
...
| **Policy frameworks** | <R id="N2EzYzdjMD">NIST AI RMF</R> | Government risk management approach |
...
| **Academic work** | <R id="NWJjMjA0YT">Future of Humanity Institute</R> | Existential risk interaction models |
| **Catastrophic risks** | [CAIS AI Risk Overview](https://safe.ai/ai-risk) | Four interacting risk categories |
| **Think tanks** | <R id="ODM0MTY2OW">Centre for Security and Emerging Technology</R> | Technology risk assessment |
...
| **Industry analysis** | <R id="NzQyNGViND">Anthropic Safety Research</R> | Commercial risk interaction studies |
