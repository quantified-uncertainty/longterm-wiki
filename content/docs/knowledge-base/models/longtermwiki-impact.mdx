...
:::note[Page Scope]
This page models **LongtermWiki's potential impact** using rigorous Fermi estimation grounded in base rates. For strategic analysis and pathways, see [LongtermWiki Value Proposition](/wiki/E764).
...
The [value proposition document](/wiki/E764) suggested \$15-40M/yr central estimate. Why is this Fermi model 50-100x lower?
