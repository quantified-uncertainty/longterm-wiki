...
:::note[Page Scope]
This page models **LongtermWiki's potential impact** using rigorous Fermi estimation grounded in base rates. For strategic analysis and pathways, see <EntityLink id="E764" name="longtermwiki-value-proposition">LongtermWiki Value Proposition</EntityLink>.
...
The <EntityLink id="E764" name="longtermwiki-value-proposition">value proposition document</EntityLink> suggested \$15-40M/yr central estimate. Why is this Fermi model 50-100x lower?
