...
- <EntityLink id="E44" name="bioweapons-attack-chain">Bioweapons Attack Chain Model</EntityLink> - Decomposes current-day attack pathways and bottlenecks
- <EntityLink id="E43" name="bioweapons-ai-uplift">AI-Bioweapons Uplift Model</EntityLink> - Analyzes how AI contributes to each attack phase currently
- <EntityLink id="E37" name="autonomous-weapons-proliferation" label="Autonomous Weapons Proliferation" /> - Parallel analysis for weapons automation dynamics
