...
- <EntityLink id="bioweapons-attack-chain">Bioweapons Attack Chain Model</EntityLink> - Decomposes current-day attack pathways and bottlenecks
- <EntityLink id="bioweapons-ai-uplift">AI-Bioweapons Uplift Model</EntityLink> - Analyzes how AI contributes to each attack phase currently
- <EntityLink id="autonomous-weapons-proliferation" label="Autonomous Weapons Proliferation" /> - Parallel analysis for weapons automation dynamics
...
<Backlinks entityId="bioweapons-timeline" />
