...
- <EntityLink id="E104" name="disinformation-electoral-impact" /> - Impact assessment even if detection fails
- <EntityLink id="E97" name="deepfakes-authentication-crisis" /> - Specific to synthetic media
- <EntityLink id="E361" name="trust-cascade-model" /> - Institutional trust erosion dynamics
