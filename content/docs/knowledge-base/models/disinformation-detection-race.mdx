...
- <EntityLink id="disinformation-electoral-impact" /> - Impact assessment even if detection fails
- <EntityLink id="deepfakes-authentication-crisis" /> - Specific to synthetic media
- <EntityLink id="trust-cascade-model" /> - Institutional trust erosion dynamics
...
<Backlinks entityId="disinformation-detection-race" />
