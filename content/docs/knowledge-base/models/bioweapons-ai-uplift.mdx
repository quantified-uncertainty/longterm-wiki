...
|-------|------|--------|-------------|-----------------|------------|
| <R id="YmM4YmE2NG">RAND Corporation</R> | 2024 | Red team exercise (n=45) | No significant difference AI vs. internet-only for attack planning | Knowledge: 1.0-1.2x | High |
...
| <R id="MGFiMDU2ND">Gryphon Scientific/Anthropic</R> | 2023 | 150+ hour red team | "Post-doc level" knowledge provision | Knowledge: 1.5-2.5x | Medium |
...
- <R id="YmM4YmE2NG">RAND Corporation</R>. "The Operational Risks of AI in Large-Scale Biological Attacks: Results of a Red-Team Study" (January 2024) - Systematic empirical assessment of LLM uplift for attack planning
...
- <R id="MGFiMDU2ND">Gryphon Scientific</R>. Red-team evaluation of Claude (November 2023) - 150+ hour assessment finding "post-doc level" knowledge provision
...
- <R id="MmIzYWZmYT">CNAS</R>. "AI and the Evolution of Biological National Security Risks" (August 2024)
...
- <R id="NGU0MjEyN2">Anthropic</R>. Responsible Scaling Policy and CBRN evaluations (2024-2025)
- <R id="OTU2ZjU2MD">OpenAI</R>. [Preparedness Framework Version 2](https://openai.com/index/updating-our-preparedness-framework/) (April 15, 2025) - Streamlined to "High" and "Critical" thresholds; biological capabilities prioritized
...
- <R id="ZTU2ZDQ0NW">White House OSTP</R>. Framework for Nucleic Acid Synthesis Screening (April 2024)
