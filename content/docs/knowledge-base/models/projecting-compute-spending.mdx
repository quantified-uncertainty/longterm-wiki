...
The magnitude and pace of AI infrastructure investment creates several dynamics relevant to <EntityLink id="E608">AI governance</EntityLink> and <EntityLink id="ai-safety">AI safety</EntityLink>:
