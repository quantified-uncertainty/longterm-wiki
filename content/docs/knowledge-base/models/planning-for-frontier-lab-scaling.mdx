...
[^phil-spend]: Rough estimate based on known grants from <EntityLink id="E521" name="coefficient-giving" >Open Philanthropy</EntityLink>, <EntityLink id="E517" name="cea">CEA</EntityLink>, and other major funders; actual total may vary
