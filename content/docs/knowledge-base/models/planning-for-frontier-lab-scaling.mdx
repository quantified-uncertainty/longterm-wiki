...
[^phil-spend]: Rough estimate based on known grants from <EntityLink id="coefficient-giving" >Open Philanthropy</EntityLink>, <EntityLink id="E517" name="cea">CEA</EntityLink>, and other major funders; actual total may vary
