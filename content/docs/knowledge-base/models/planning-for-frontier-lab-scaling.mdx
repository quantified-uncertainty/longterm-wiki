...
[^phil-spend]: Rough estimate based on known grants from <EntityLink id="E521" name="coefficient-giving" >Coefficient Giving</EntityLink>, <EntityLink id="E517" name="cea">CEA</EntityLink>, and other major funders; actual total may vary
...
| **<EntityLink id="E465" name="thresholds">Compute thresholds</EntityLink>** | 1-2 years | Medium | Medium-High | Export control framework |
