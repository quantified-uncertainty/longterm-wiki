...
- <EntityLink id="irreversibility-threshold" label="Lock-in Irreversibility Model" /> - Provides deeper analysis of the specific mechanisms through which technological and institutional lock-in occurs, complementing this model's focus on threshold dynamics
- <EntityLink id="proliferation-risk-model" label="Proliferation Risk Model" /> - Analyzes how dangerous capabilities spread between actors, representing the technical irreversibility dimension
- <EntityLink id="expertise-atrophy-cascade" label="Expertise Atrophy Cascade" /> - Models the skills loss dynamics that drive social irreversibility as workforces become AI-dependent
...
<Backlinks entityId="irreversibility-threshold" />
