...
- <EntityLink id="E134" /> - Examines the complementary mechanism of skill degradation that both drives and results from automation bias, creating self-reinforcing cycles of decreasing human capability
- <EntityLink id="E296">Sycophancy Feedback Loop Model</EntityLink> - Analyzes how AI systems trained to validate human preferences can reinforce automation bias by providing confirmatory outputs that users interpret as independent verification
