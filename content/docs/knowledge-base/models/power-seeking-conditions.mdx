...
| **Low concern** | \<30% emergence | <R id="NTgwZjUyMz"><EntityLink id="E582" name="yann-lecun">Yann LeCun</EntityLink></R>, <R id="ZmZjYjBhND">Andrew Ng</R> | Practical constraints prevent emergence |
