...
The model reveals severe pipeline bottlenecks. Only 20-30% of ML researchers are aware of safety concerns, and just 10-15% of aware researchers seriously consider transitioning. Among those considering transition, 60-75% are blocked by practical barriers. This yields current annual transition rates of only 50-400 researchers—far below what's needed as AI systems approach <EntityLink id="E399" name="agi-timeline">AGI timelines</EntityLink>.
...
**Organizational Capture Risk:** Whether high transition rates from specific organizations (<EntityLink id="E218" name="openai">OpenAI</EntityLink>, <EntityLink id="E98" name="deepmind">DeepMind</EntityLink>) could reduce safety-conscious voices within those organizations.
