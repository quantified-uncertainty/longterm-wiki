...
---
import {DataInfoBox, Backlinks, KeyQuestions, EntityLink} from '@components/wiki';

<DataInfoBox entityId="media-policy-feedback-loop" ratings={frontmatter.ratings} />
...
- <EntityLink id="public-opinion-evolution" label="Public Opinion Evolution" /> - Drivers of AI risk opinion change
- <EntityLink id="epistemic-collapse-threshold" label="Epistemic Collapse Threshold" /> - When shared reality breaks down
- <EntityLink id="disinformation-electoral-impact" label="Disinformation Electoral Impact" /> - AI influence on democratic processes
- <EntityLink id="racing-dynamics">Racing Dynamics</EntityLink> - Competitive pressures in AI development
...
<Backlinks client:load entityId="media-policy-feedback-loop" />
