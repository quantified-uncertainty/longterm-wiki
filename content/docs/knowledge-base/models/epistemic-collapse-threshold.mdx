...
- <EntityLink id="E361" /> — Models the institutional trust dynamics that drive the I component
- <EntityLink id="E28" label="Authentication Collapse Timeline" /> — Detailed analysis of verification capacity degradation
- <EntityLink id="E296">Sycophancy Feedback Loop Model</EntityLink> — Models AI-driven update capacity degradation
- <EntityLink id="E134" /> — Analysis of decision capacity loss through expertise erosion
