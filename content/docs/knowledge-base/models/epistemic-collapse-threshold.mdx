...
- <EntityLink id="trust-cascade-model" /> — Models the institutional trust dynamics that drive the I component
- <EntityLink id="authentication-collapse-timeline" label="Authentication Collapse Timeline" /> — Detailed analysis of verification capacity degradation
- <EntityLink id="sycophancy-feedback-loop">Sycophancy Feedback Loop Model</EntityLink> — Models AI-driven update capacity degradation
- <EntityLink id="expertise-atrophy-cascade" /> — Analysis of decision capacity loss through expertise erosion
