...
- <EntityLink id="E361" name="trust-cascade-model" /> — Models the institutional trust dynamics that drive the I component
- <EntityLink id="E28" name="authentication-collapse-timeline" label="Authentication Collapse Timeline" /> — Detailed analysis of verification capacity degradation
- <EntityLink id="E296" name="sycophancy-feedback-loop">Sycophancy Feedback Loop Model</EntityLink> — Models AI-driven update capacity degradation
- <EntityLink id="E134" name="expertise-atrophy-cascade" /> — Analysis of decision capacity loss through expertise erosion
