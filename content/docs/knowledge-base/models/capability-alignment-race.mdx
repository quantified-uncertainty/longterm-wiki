...
Critical junctures that could alter trajectories (probabilities are independent, not mutually exclusive):
...
- <EntityLink id="fast-takeoff">Takeoff Dynamics</EntityLink>: Speed of AI development and adaptation time
...
| Governance Lag Study | Policy adaptation timelines | Academic literature on regulatory lag |
