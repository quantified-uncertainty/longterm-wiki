...
|-----------|---------------|-------------|------------------|--------|
| Training compute | 10²⁶ FLOP | 4x/year | 10²⁸ FLOP | <R id="sid_z8vF0WmCSR"><EntityLink id="E125" name="epoch-ai">Epoch AI</EntityLink></R> |
| Algorithmic efficiency | 2x 2024 baseline | 1.5x/year | 3.4x baseline | <R id="sid_Ta7Dt5xU7K">Erdil & Besiroglu (2023)</R> |
| Performance (MMLU) | 89% | +8pp/year | >95% | <R id="sid_ljD2IrnbEc">Anthropic</R> |
| Frontier lab lead | 6 months | Stable | 3-6 months | <R id="sid_9zIIlD7Zvh">RAND</R> |
...
Quote from <R id="sid_oxUOxtXEEq"><EntityLink id="E220" name="paul-christiano">Paul Christiano</EntityLink></R>: "The core challenge is that capabilities are advancing faster than our ability to align them. If this gap continues to widen, we'll be in serious trouble."
...
Based on <R id="sid_LFX5qhnvuG"><EntityLink id="E199" name="metaculus">Metaculus</EntityLink> forecasts</R> and expert surveys from <R id="sid_yIvZzwAhIS"><EntityLink id="E512" name="ai-impacts">AI Impacts</EntityLink></R>.
...
- **Regulatory capture**: Will AI labs co-opt government oversight? <R id="sid_azwyqg019n">CNAS analysis</R> suggests 40% risk. Technology laggards willing to cut corners can gamble for advantage when highly adversarial and capability-close to leaders.[^rc-112f]
...
- **Democratic response**: Will public concern drive effective policy? Polling shows <R id="sid_9iS1eoDzaM">growing awareness</R> but uncertain translation to action.
...
Based on <R id="sid_LFX5qhnvuG">Metaculus community predictions</R> and <R id="sid_TwcpOJtfFz"><EntityLink id="E140" name="fhi">Future of Humanity Institute</EntityLink> surveys</R>.
...
|-------|------------|----------|
| Scaling Laws | Compute-capability relationship | <R id="sid_AnJXaIj5sg">Kaplan et al. (2020)</R> |
| Alignment Tax Analysis | Safety overhead quantification | <R id="sid_XNnrcRYmOF">Kenton et al. (2021)</R> |
