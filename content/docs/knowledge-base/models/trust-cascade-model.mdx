...
- <EntityLink id="E28" name="authentication-collapse-timeline" label="Authentication Collapse Timeline" /> - Verification failure cascade
- <EntityLink id="E296" name="sycophancy-feedback-loop">Sycophancy Feedback Loop Model</EntityLink> - Echo chamber reinforcement
- <EntityLink id="E120" name="epistemic-collapse-threshold" /> - Society-wide knowledge failure

## Sources and Evidence

### Trust Data
- <R id="sid_O44PDoUOQf">Edelman Trust Barometer</R> (annual, global) - [2025 edition](https://www.edelman.com/trust/2025/trust-barometer) finds 61% globally have moderate/high grievance
- <R id="sid_8P04z3Fh6R">Pew Research: Public Trust in Government</R> - [2024 data](https://www.pew.org/en/trend/archive/fall-2024/americans-deepening-mistrust-of-institutions) shows only 22% trust federal government
