...
The discovery of these patterns in 2020 fundamentally changed AI development strategy, leading labs to prioritize scaling as a primary path to capability improvements. <EntityLink id="E91" name="dario-amodei">Dario Amodei</EntityLink> and Ilya Sutskever have stated that the discovery of scaling laws led them to pursue the current large language model paradigm.[^ea-forum-scaling]
