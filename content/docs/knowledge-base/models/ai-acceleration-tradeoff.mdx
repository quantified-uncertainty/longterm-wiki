...
The model implies that capabilities organizations creating acceleration should account for the marginal x-risk created. At current readiness levels, pulling TAI forward by 1 year creates roughly 1-4 percentage points of additional x-risk. If the long-term future is worth quadrillions of dollars or more in expected value, this represents an enormous externality.
