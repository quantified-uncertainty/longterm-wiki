...
- **Broader Context**: <EntityLink id="open-philanthropy">Coefficient Giving</EntityLink> has an ongoing RFP (open until April 15, 2025) offering \$40M+ for technical AI safety across 21 research directions, including adversarial testing and alignment faking.[^49]
