...
**The <EntityLink id="E179" name="irreversibility">Irreversibility</EntityLink> Problem:**
...
- System vulnerable to AI failures
- <EntityLink id="E189" name="lock-in">Lock-in</EntityLink> complete
...
- <EntityLink id="E143" name="flash-dynamics-threshold" label="Flash Dynamics Threshold" /> - When humans too slow even if skilled
- <EntityLink id="E240" name="racing-dynamics-impact" label="Racing Dynamics Impact" /> - Pressure to maximize AI usage
