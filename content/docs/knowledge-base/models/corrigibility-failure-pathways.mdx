...
| Assessment Factor | Rating | Evidence |
|-------------------|---------|----------|
| **Probability (Advanced AI)** | 20-50% | <R id="683aef834ac1612a">Anthropic's <EntityLink id="E451" name="constitutional-ai">Constitutional AI</EntityLink> research</R> |
...
| **Difficult but Achievable** | 45% | <R id="afe2508ac4caf5ee">Anthropic team</R>, <EntityLink id="E557" name="redwood-research">Redwood Research</EntityLink> | Constitutional AI, iterated training |
...
|--------------|------------|---------------|
| <EntityLink id="E202" name="miri">MIRI</EntityLink> | Theoretical foundations | <R id="ee872736d7fbfcd5">Agent Foundations research</R> |
| <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> | Constitutional AI methods | <R id="f771d4f56ad4dbaa">Safety research publications</R> |
| <EntityLink id="E557" name="redwood-research">Redwood Research</EntityLink> | Empirical safety training | <R id="42e7247cbc33fc4c">Alignment research</R> |
