...
<DataInfoBox entityId="surveillance-chilling-effects" ratings={frontmatter.ratings} />
...
- <EntityLink id="surveillance-authoritarian-stability" label="AI Surveillance and Regime Durability" /> - How chilling enables regime stability
- <EntityLink id="expertise-atrophy-progression" label="Expertise Atrophy Progression" /> - Parallel mechanism of capability loss
...
<Backlinks client:load entityId="surveillance-chilling-effects" />
