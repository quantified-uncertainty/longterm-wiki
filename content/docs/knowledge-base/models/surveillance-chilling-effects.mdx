...
- <EntityLink id="E293" name="surveillance-authoritarian-stability" label="AI Surveillance and Regime Durability" /> - How chilling enables regime stability
- <EntityLink id="E135" name="expertise-atrophy-progression" label="Expertise Atrophy Progression" /> - Parallel mechanism of capability loss
