...
**Quantitative estimate**: A [2026 PNAS study](https://www.pnas.org/doi/10.1073/pnas.2519944123) tracked 10,000+ participants who installed an app capturing every ad viewed for six weeks before the 2016 election. Key findings:
...
- ["Targeted digital voter suppression efforts likely decrease voter turnout."](https://www.pnas.org/doi/10.1073/pnas.2519944123) *PNAS* (2026). 10,000+ participants tracked over 6 weeks; found 1.9% turnout reduction from suppression ads, 14.2% for nonwhite voters in battleground minority counties. Estimated ~4.7 million kept from voting in 2016.
...
- ProPublica. ["Six Right-Wing Activists Filed 89,000 Georgia Voter Roll Challenges."](https://www.propublica.org/article/right-wing-activists-georgia-voter-challenges) (2023). Documenting approximately 100,000 automated voter challenges in Georgia by a small network of activists.
- NPR. ["Voter registration mass challenges fueled by EagleAI."](https://www.npr.org/2024/06/04/nx-s1-4991945/voter-registration-mass-challenges-georgia) (2024). Documenting EagleAI-driven voter challenges in Georgia counties.
