...
[^1]: TRENDS Research & Advisory — Study by Dr. Sayed Ali Abu Farha and Abdullah Al-Khaja on AI methods for predicting political stability, examining NLP, machine learning, and deep neural networks for political risk analysis. No URL available.

[^2]: US Department of Defense AI Strategy (2018) — Framed China's and Russia's military AI investments as threats to international order; established foundational strategic competition framing for AI governance. No URL available.

[^3]: Georgetown Center for Security and Emerging Technology (CSET) — Policy brief on AI safety and security among great powers, evaluating bilateral and multilateral engagement measures and their trade-offs. No URL available.

[^4]: TNSR Roundtable on AI and Strategic Stability (2023) — Discussion of AI risks to strategic stability including autocratic AI-nuclear delegation, automation bias, and the implications of AI-enabled robotic forces. No URL available.

[^5]: CNAS AI Security and Stability Project — Reports by Jacob Stokes, Alexander Sullivan, and Noah Greene outlining five pathways through which military AI could undermine US-China stability; commentary on Biden-Harris voluntary AI safety commitments. No URL available.

[^6]: OpenAI analysis on AI and international security — PDF examining how AI reshapes international balance of power, with discussion of authoritarian AI risks in surveillance and warfare contexts. No URL available.

[^7]: Anton Leicht — Analysis critiquing AI safety advocates' emphasis on global governance, arguing for national strategies in middle powers and a pivot from development constraints to deployment resilience. No URL available.

[^8]: Edelman AI Trust Survey (2025) — US AI trust at 35%, down from 50% in 2019, with bipartisan mistrust documented. No URL available.

[^9]: Change Research Compass Survey (March 2025) — Found 62% of US voters support strict AI rules even at cost to innovation; 20% prefer fewer rules for competitiveness. No URL available.

[^10]: AIRAS Whitepaper (February 2, 2026) — Methodology for assessing political viability of AI safety interventions, distinguishing raw public support from cost-framed "hard support." No URL available.

[^11]: Gallup-SCSP Research (2025) — Found 88% of Democrats and 79% of Republicans/independents favor maintaining AI safety rules; 42% favor multilateral AI development with allies. No URL available.

[^12]: European Union AI Act (full effect 2025) — Mandates human oversight, documentation, and safety assessments for high-risk AI systems; enforcement concerns noted by analysts. No URL available.

[^13]: PMC exploratory surveys in Germany and Spain (combined n=2,864) — Found majority public support for strict AI safety oversight. No URL available.

[^14]: NSCAI Report (2021) — National Security Commission on Artificial Intelligence report securitizing China's and Russia's AI integration ambiguities as threats to US strategic interests. No URL available.

[^15]: Istomin analysis (2023) — Links AI tensions in US-Russia relations to political distrust and securitization cycles intensified by Ukraine invasion. No URL available.

[^16]: International Dialogues on AI Safety (IDAIS, 2024) — Proposed red lines for AI including prohibitions on autonomous replication, self-preservation behaviors, weapon development assistance, and deception. No URL available.
