...
Critical dependencies include <EntityLink id="E399">capabilities development timelines</EntityLink> that determine available coordination windows, alignment difficulty that sets stakes for cooperation versus racing, and takeoff speeds that influence whether coordination can adapt to rapid capability changes.
