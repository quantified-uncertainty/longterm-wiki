...
Critical dependencies include <EntityLink id="agi-timeline">capabilities development timelines</EntityLink> that determine available coordination windows, alignment difficulty that sets stakes for cooperation versus racing, and <EntityLink id="__index__/ai-transition-model">takeoff speeds</EntityLink> that influence whether coordination can adapt to rapid capability changes.
