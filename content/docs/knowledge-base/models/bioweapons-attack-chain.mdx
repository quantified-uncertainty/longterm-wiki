...
This model decomposes AI-assisted bioweapons attacks into seven sequential bottlenecks, revealing that catastrophic biological terrorism requires success across multiple independent failure modes. The framework draws on <R id="YmM4YmE2NG">RAND Corporation's 2024 red-team study</R> finding no statistically significant AI uplift for biological attacks, combined with historical analysis of state bioweapons programs and terrorist attempts.

**Key findings:** Overall attack probability ranges from 0.02–3.6%, with state actors posing the highest estimated risk (3.0%) due to superior laboratory access. The multiplicative probability structure means moderate interventions at any step provide substantial protection. <R id="YWQ3MDBlM2">DNA synthesis screening</R> offers 5–15% modeled risk reduction for \$1–20M annually, while <R id="NDdjY2NhMT">metagenomic surveillance</R> provides 15–25% reduction for \$500M. This mathematical structure is consistent with defense-in-depth strategies against <EntityLink id="E42" name="bioweapons">bioweapons risks</EntityLink>.
...
Historical evidence is consistent with high synthesis failure rates. The Soviet <R id="ZTY1OTRmOD">Biopreparat program</R>, despite substantial resources and expert personnel, required years to develop reliable production methods for select agents. <R id="NTA0YTgzMj">Aum Shinrikyo's biological weapons program</R> did not achieve effective biological weapons deployment despite investment in laboratory facilities.
...
The <R id="YzViYjhkND">CDC's BioWatch program</R> provides continuous aerosol monitoring in major U.S. cities, while <R id="MjA4MWQ3Yz">WHO's Disease Outbreak News</R> coordinates global surveillance. Coverage remains more limited in lower-resource regions, creating geographic asymmetries in detection probability.
...
|-------------|----------|--------------|--------|
| **Government study** | <R id="YmM4YmE2NG">RAND Corporation Bioweapons Red Team (2024)</R> | No significant AI uplift detected for information retrieval tasks in study design | Public |
| **Academic analysis** | <R id="OWE3MWQ4MW">Esvelt - Delay, Detect, Defend (2022)</R> | Synthesis barriers persist; layered defense framework | Open access |
| **Industry report** | <R id="ZmMwZTQ0NG">Anthropic Frontier Threats Assessment (2023)</R> | Current model limitations; biosecurity evaluation methodology | Public |
| **Policy analysis** | <R id="NDcxYzgwZT">NTI Synthetic Biology Report (2024)</R> | Governance recommendations for synthetic biology | Public |

### Technical Resources

| Organization | Resource | Focus Area | URL |
|--------------|----------|------------|-----|
| **CDC** | BioWatch Program | Aerosol detection | <R id="NzFkYzFhMD">cdc.gov/biowatch</R> |
| **WHO** | Disease Outbreak News | Global surveillance | <R id="MjA4MWQ3Yz">who.int/emergencies</R> |
| **NIST** | Cybersecurity Framework | Critical infrastructure | <R id="MjdkMDAxN2">nist.gov/cyberframework</R> |
| **Harvard** | Global Health Institute | Biosecurity research | <R id="NzQ0YTUyOT">globalhealth.harvard.edu</R> |

### Expert Organizations

| Type | Organization | Specialty | Contact |
|------|--------------|-----------|---------|
| **Research** | <R id="ZTZjMGFkMz">Nuclear Threat Initiative</R> | WMD prevention | nti.org |
| **Academic** | <R id="NTNmZDRlOG"><EntityLink id="E423" name="johns-hopkins-center-for-health-security">Johns Hopkins Center for Health Security</EntityLink></R> | Biosecurity research | centerforhealthsecurity.org |
| **Government** | <R id="YjJhNWIwND">CISA</R> | Critical infrastructure | cisa.gov |
| **International** | <R id="NjYyMjIxYm">Australia Group</R> | Export controls | australiagroup.net |
