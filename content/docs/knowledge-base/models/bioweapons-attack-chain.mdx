...
| **Reversibility** | None | High | Permanent knowledge <EntityLink id="proliferation">proliferation</EntityLink> |
...
However, this finding may not persist as AI capabilities advance toward <EntityLink id="scientific-research">scientific research</EntityLink> capabilities. The critical question is whether future AI systems will bridge the gap between information access and laboratory execution.
...
1. **Immediate (2025-2026)**: Implement mandatory <EntityLink id="monitoring">DNA synthesis screening</EntityLink> with international coordination
...
- <EntityLink id="bioweapons-ai-uplift">AI Uplift Assessment</EntityLink> — Detailed quantitative analysis of Step 3 parameters
- <EntityLink id="bioweapons-timeline">Bioweapons Timeline Model</EntityLink> — Temporal evolution of attack chain probabilities  
- <EntityLink id="defense-in-depth-model" /> — General framework for layered security strategies
- Misuse Risks — Broader category including <EntityLink id="bioweapons">bioweapons</EntityLink> and <EntityLink id="autonomous-weapons">autonomous weapons</EntityLink>
...
<References
  pageId="bioweapons-attack-chain"
  ids={[
    "0fe4cfa7ca5f2270",
    "204e04a1029682f7",
    "e11e97a0bf3d3587",
