...
|----------|-------|----------|----------|-----------------|-------------|
| **Compute Infrastructure** | 50-65% | <F e="anthropic" f="f8f3c9a7">\$50-65B</F> | \$150-195B | Power, land, TSMC capacity | 40-60%/year |
...
Training costs scale with each model generation, though <EntityLink id="E65" name="compute-hardware">algorithmic efficiency improvements</EntityLink> (approximately doubling every 8 months according to [Epoch AI's analysis](https://epoch.ai/blog/algorithmic-progress)) partially offset raw compute scaling:
...
flowchart LR
    ...
    TOTAL --> OTHER[R&D + Other<br/>15-<F e="anthropic" f="fac5b934">25%</F>]
...
2. <EntityLink id="E65" name="compute-hardware">Scaling laws</EntityLink> continue at historical rates (uncertain, 2-3 year resolution)
...
[^13]: See <EntityLink id="E405" name="anthropic-valuation">Anthropic Valuation Analysis</EntityLink> for customer concentration details
