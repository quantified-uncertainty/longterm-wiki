...
**Power Requirements**: Frontier AI data centers require 100MW-1GW+ of power each. Current U.S. data center power consumption is approximately 200 TWh/year, projected by Goldman Sachs to reach 945 TWh by 2030.[^rc-70ef] This is driving investment in dedicated power generation, including nuclear small modular reactors (SMRs), natural gas plants, and large-scale solar/battery installations.
...
- [OpenAI guiding toward positive free cash flow in 2030](https://blog.carnegieinvest.com/the-risks-facing-openai-and-its-1.4t-in-spending-commitments)[^rc-2838]
