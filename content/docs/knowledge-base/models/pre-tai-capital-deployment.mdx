...
*Sources: Philanthropic funding estimates from [Open Philanthropy grants database](https://www.openphilanthropy.org/grants/) and <EntityLink id="E510" name="80000-hours">80,000 Hours</EntityLink> [analysis](https://80000hours.org/problem-profiles/artificial-intelligence/).*
