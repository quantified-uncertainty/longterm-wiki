...
| **Institutional Safety** | Governance and oversight | <EntityLink id="E252" name="responsible-scaling-policies">Responsible scaling</EntityLink>, audits, regulation | 40-60% |
...
|-----------|-------------------|----------------|---------------|
| **<EntityLink id="E252" name="responsible-scaling-policies">Responsible scaling policies</EntityLink>** | Medium | <R id="MWRkOTFhMm">Anthropic</R>, <R id="ZWE4ZTJlZW">OpenAI</R> implementing | Unproven at scale |
...
- <EntityLink id="E252" name="responsible-scaling-policies">Responsible Scaling Policies</EntityLink> - Institutional layer implementation
