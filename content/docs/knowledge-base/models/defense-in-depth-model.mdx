...
|-------|-----------------|------------------|-------------------|
| **Training Safety** | Build aligned goals during development | <R id="1098fc60be7ca2b0"><EntityLink id="E259" name="rlhf">RLHF</EntityLink></R>, <EntityLink id="E451" name="constitutional-ai">Constitutional AI</EntityLink>, data curation | 20-40% |
...
|-----------|-------------------|----------------|---------------|
| **<EntityLink id="E252" name="responsible-scaling-policies">Responsible scaling policies</EntityLink>** | Medium | <R id="afe2508ac4caf5ee">Anthropic</R>, <R id="04d39e8bd5d50dd5">OpenAI</R> implementing | Unproven at scale |
...
> "Defense in depth is essential, but we must be realistic about correlation. Deceptive alignment could defeat multiple technical layers simultaneously." - <R id="f771d4f56ad4dbaa"><EntityLink id="E129" name="evan-hubinger">Evan Hubinger</EntityLink></R> on correlated failures
