...
---
import { DataInfoBox, Backlinks , EntityLink, Mermaid} from '@components/wiki';

<DataInfoBox entityId="trust-erosion-dynamics" ratings={frontmatter.ratings} />
...
- <EntityLink id="trust-cascade-model" label="Trust Cascade Model" /> - Cascade dynamics in detail
- <EntityLink id="epistemic-collapse-threshold" label="Epistemic Collapse Threshold" /> - Information trust failure
- <EntityLink id="deepfakes-authentication-crisis" label="Deepfakes Authentication Crisis" /> - Visual evidence trust
...
<Backlinks entityId="trust-erosion-dynamics" />
