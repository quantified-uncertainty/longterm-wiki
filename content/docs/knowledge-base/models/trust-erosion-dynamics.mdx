...
update_frequency: 90
summary: Analyzes how AI systems erode institutional trust through deepfakes, disinformation, and authentication collapse, finding trust erodes 3-10x faster than it builds, with US institutional trust at 18-30% approaching critical governance failure thresholds below 20%. Finds 46% global AI trust rate, 245% YoY deepfake misinformation growth, and 61% high-grievance population globally, with estimated 5-10 years to critical media trust threshold.
clusters:
  - ai-safety
  - epistemics
---
...
- <EntityLink id="E361" name="trust-cascade-model" label="Trust Cascade Model" /> - Cascade dynamics in detail
- <EntityLink id="E120" name="epistemic-collapse-threshold" label="Epistemic Collapse Threshold" /> - Information trust failure
- <EntityLink id="E97" name="deepfakes-authentication-crisis" label="Deepfakes Authentication Crisis" /> - Visual evidence trust
