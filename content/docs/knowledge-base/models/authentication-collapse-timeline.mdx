...
- Kirchner et al. (2023): "Detection of AI-generated text" - <R id="sid_QAbfcD4650">arXiv:2303.11156</R>
- Nightingale et al. (2021): "AI-synthesized faces are indistinguishable" - <R id="sid_CG2af6zjSM">PNAS</R>

### Technical Research
- C2PA Specification: <R id="sid_k9hxyGlMc9">c2pa.org</R>
- DARPA MediFor: <R id="sid_lEK4CNdryL">Media Forensics Program</R>
- Farid (2022): "Detecting Deepfakes" - <R id="sid_ckYGasN0An">Digital forensics</R>
