...
<DataInfoBox entityId="E28" ratings={frontmatter.ratings} />
...
- <EntityLink id="E361" name="trust-cascade-model" /> - How authentication failure triggers trust collapse
- <EntityLink id="E296" name="sycophancy-feedback-loop">Sycophancy Feedback Loop Model</EntityLink> - Truth becomes what feels right
...
- Kirchner et al. (2023): "Detection of AI-generated text" - <R id="NTIwOTBkMj">arXiv:2303.11156</R>
- Nightingale et al. (2021): "AI-synthesized faces are indistinguishable" - <R id="MDYzY2NiY2">PNAS</R>

### Technical Research
- C2PA Specification: <R id="N2ViOGYzZT">c2pa.org</R>
- DARPA MediFor: <R id="NWZhMjI2MT">Media Forensics Program</R>
- Farid (2022): "Detecting Deepfakes" - <R id="ZjE0YWQ2ZG">Digital forensics</R>
