...
- <EntityLink id="trust-cascade-model" /> - How authentication failure triggers trust collapse
- <EntityLink id="sycophancy-feedback-loop">Sycophancy Feedback Loop Model</EntityLink> - Truth becomes what feels right
...
<Backlinks entityId="authentication-collapse-timeline" />
