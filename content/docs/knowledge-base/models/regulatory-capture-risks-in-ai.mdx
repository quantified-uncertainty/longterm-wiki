...
The most direct form of capture occurs when regulatory text is substantially drafted by or in close collaboration with the regulated industry. The EU AI Act consultation process received thousands of submissions from technology firms, and critics have argued that provisions covering foundation models were substantially influenced by established European players (including Mistral) and U.S. tech firms with EU operations.[^6] The risk-based categorization in the EU AI Act—dividing AI into unacceptable, high, limited, and minimal risk tiers—was welcomed by frontier labs partly because the framework's complexity favors those with resources to navigate it, and because the high-risk thresholds were drawn in ways that often excluded general-purpose models from the most demanding requirements.

### A Regulatory Game Framework

Recent political economy analysis models AI regulation as a strategic interaction between governments and firms, predicting several distinct equilibrium outcomes depending on the degree of capture. This framework, developed by researchers including Filippo Lancieri and Stefan Bechtold, identifies three canonical scenarios:[^6]
...
Source: AI policy expert interviews, reported in academic analysis.[^4]

### Regulatory Budget Asymmetries: The Irish DPC Precedent

The clearest historical case of AI-adjacent regulatory capture through resource asymmetry is Ireland's Data Protection Commission (DPC). With a budget of approximately €5 million in 2016, the DPC was responsible for overseeing GDPR compliance for virtually all major U.S. technology platforms with European headquarters in Ireland. Enforcement was effectively paralyzed. Only after the budget rose to €23 million by 2022 did the DPC issue two-thirds of all EU and UK GDPR fines.[^2] The lesson is that even well-designed regulatory frameworks can be captured through systematic under-resourcing, and that closing the funding gap can rapidly change enforcement outcomes.
...
The LessWrong community discussion reflects a genuine tension here: some AI safety advocates support stricter regulation as a mechanism for slowing deployment of potentially dangerous systems, while others worry that capture makes regulation net-negative—protecting large incumbents who may be less safety-conscious than they claim while burdening the academic and open-source communities better positioned to do independent safety research.[^5]
...
Regulations that impose evaluation, reporting, and liability requirements primarily on closed commercial models may leave open-source deployments in a "massive gaping hole" of oversight.[^5] Conversely, regulations that sweep in open-source models may effectively ban their development while only modestly inconveniencing frontier labs. Getting this balance right requires technical expertise and independence from commercial incentives that captured regulatory bodies are unlikely to possess.
...
[^1]: Deric Cheng, Convergence Analysis - Analysis of OpenAI's DeepSeek proposal and Microsoft FUD parallels, March 2025 (no URL available)
[^2]: Analysis of Biden AI Safety Institute funding and Irish DPC capture history - Multiple sources, 2024–2025 (no URL available)
[^3]: Analysis of Trump Executive Order 14179 and Stargate Project - January 2025 policy reporting (no URL available)
[^4]: AI policy expert interviews on regulatory capture channels - Academic research, 2024–2025 (no URL available)
[^5]: LessWrong community discussions on regulatory capture and AI safety - Multiple posts, 2023 (no URL available)
[^6]: Filippo Lancieri and Stefan Bechtold - Oxford analyses of AI regulation as political economy game, 2025 (no URL available)
[^7]: Frontier Model Forum AI Safety Fund announcement - Industry reporting, 2023–2024 (no URL available)
[^8]: EU AI Act - Official legislative text, effective August 2024 onward (no URL available)
[^9]: Analysis of Meta and large tech firms' preference for federal AI legislation over state fragmentation - Policy analysis, 2024–2025 (no URL available)
[^10]: Regulatory sandbox analysis including Utah fintech model - Policy analysis, 2025 (no URL available)
