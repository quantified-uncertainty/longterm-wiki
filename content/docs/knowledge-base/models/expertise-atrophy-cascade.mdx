...
**Central Question:** At what rate does AI-assisted work degrade human expertise, through what mechanisms do these effects cascade across skill dependencies and generations, and which interventions can preserve critical capabilities before <EntityLink id="irreversibility">irreversibility</EntityLink> thresholds are crossed?
