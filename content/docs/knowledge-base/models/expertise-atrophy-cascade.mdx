...
**Central Question:** At what rate does AI-assisted work degrade <EntityLink id="E159">human expertise</EntityLink>, through what mechanisms do these effects cascade across skill dependencies and generations, and which interventions can preserve critical capabilities before <EntityLink id="E179">irreversibility</EntityLink> thresholds are crossed?
...
- <EntityLink id="E296">Sycophancy Feedback Loop Model</EntityLink> — How AI validation reinforces dependency and accelerates atrophy
- <EntityLink id="E361" /> — Institutional expertise loss and organizational fragility
- <EntityLink id="E120" /> — Society-wide capability loss and knowledge system failure
