...
**Central Question:** At what rate does AI-assisted work degrade human expertise, through what mechanisms do these effects cascade across skill dependencies and generations, and which interventions can preserve critical capabilities before <EntityLink id="E179" name="irreversibility">irreversibility</EntityLink> thresholds are crossed?
...
- <EntityLink id="E296" name="sycophancy-feedback-loop">Sycophancy Feedback Loop Model</EntityLink> — How AI validation reinforces dependency and accelerates atrophy
- <EntityLink id="E361" name="trust-cascade-model" /> — Institutional expertise loss and organizational fragility
- <EntityLink id="E120" name="epistemic-collapse-threshold" /> — Society-wide capability loss and knowledge system failure
