...
| **Institutional Response** | Foundational | DeepMind Safety Team (2016), <EntityLink id="openai">OpenAI</EntityLink> founded (2015), "Concrete Problems" paper (2016) |
...
**Time**: Surpassed Stockfish (world champion engine) in 4 hours of self-play training; full training completed in 9 hours.
...
**Paul Christiano**: PhD from UC Berkeley, moved to OpenAI (2016)
