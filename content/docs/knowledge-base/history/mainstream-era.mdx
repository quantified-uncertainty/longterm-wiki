...
Notable signatories included Turing Award winner Yoshua Bengio, AI textbook author Stuart Russell, <EntityLink id="E116" name="elon-musk">Elon Musk</EntityLink>, Steve Wozniak, Yuval Noah Harari, Emad Mostaque (CEO of Stability AI), and many academic AI researchers. The letter's publication one week after GPT-4's release referenced research describing "Sparks of AGI" in GPT-4's capabilities.
