...
| **Government Response** | First comprehensive regulations (<EntityLink id="E127">EU AI Act</EntityLink>); international summits |
| **<EntityLink id="E261">Safety-Capability Gap</EntityLink>** | Widening despite increased investment |
