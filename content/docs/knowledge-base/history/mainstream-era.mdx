...
The mainstream era saw AI safety transform from a small, somewhat marginalized field to a professionalized discipline with growing institutional support. The number of dedicated researchers grew from approximately 1,000 in 2020 to several thousand by 2024. Funding estimates suggest growth from roughly \$50M/year to approximately \$200M+/year, though <R id="80125fcaf04609b8">some analyses</R> put "trustworthy AI research" funding at only \$10-130M annually. For context, philanthropic funding for climate risk mitigation was approximately \$1-15 billion in 2023, roughly 20 times the funding for AI safety and security.
