...
- Formation of online community (<EntityLink id="E538">LessWrong</EntityLink>)
...
**Founders**: <EntityLink id="E114">Eliezer Yudkowsky</EntityLink>, Brian Atkins, Sabine Atkins

**Original name**: Singularity Institute for Artificial Intelligence (SIAI)

**Later renamed**: <EntityLink id="E202">Machine Intelligence Research Institute</EntityLink> (MIRI) in 2013
...
**2006**: Overcoming Bias blog (Yudkowsky and <EntityLink id="E260">Robin Hanson</EntityLink>)
...
## <EntityLink id="E215">Nick Bostrom</EntityLink>: Academic Legitimacy
...
### <EntityLink id="E140">Future of Humanity Institute</EntityLink> (2005)
...
**The <EntityLink id="E168">Instrumental Convergence</EntityLink> Thesis**
...
**The <EntityLink id="E359">Treacherous Turn</EntityLink>**
...
**Positive**:
- Endorsements from <EntityLink id="E116">Elon Musk</EntityLink>, Bill Gates, Stephen Hawking
...
**Elon Musk**:
- \$10M to <EntityLink id="E528">Future of Life Institute</EntityLink> (2015)
- Funding for AI safety research grants
- Support for multiple organizations

**<EntityLink id="E521">Coefficient Giving</EntityLink>** (then <EntityLink id="E552">Open Philanthropy</EntityLink>, formerly Good Ventures + GiveWell Labs):
...
**Attendees**:
- Elon Musk
- <EntityLink id="E290">Stuart Russell</EntityLink>
- <EntityLink id="E101">Demis Hassabis</EntityLink>
- Nick Bostrom
- <EntityLink id="E433">Max Tegmark</EntityLink>
...
Less attention to governance, policy, <EntityLink id="E171">international coordination</EntityLink>.
...
|--------------|---------|-------|
| **MIRI** (originally SIAI) | 2000 | <EntityLink id="E584">Agent foundations</EntityLink>, decision theory |
...
| **<EntityLink id="E218">OpenAI</EntityLink>** | 2015 | AI research "for the benefit of humanity" |
