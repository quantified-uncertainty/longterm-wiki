...
<DataExternalLinks pageId="miri-era" client:load />
...
- Formation of online community (<EntityLink id="lesswrong">LessWrong</EntityLink>)
...
**Founders**: <EntityLink id="eliezer-yudkowsky">Eliezer Yudkowsky</EntityLink>, Brian Atkins, Sabine Atkins

**Original name**: Singularity Institute for Artificial Intelligence (SIAI)

**Later renamed**: <EntityLink id="miri">Machine Intelligence Research Institute</EntityLink> (MIRI) in 2013
...
**2006**: Overcoming Bias blog (Yudkowsky and <EntityLink id="robin-hanson">Robin Hanson</EntityLink>)
...
## <EntityLink id="nick-bostrom">Nick Bostrom</EntityLink>: Academic Legitimacy
...
### <EntityLink id="fhi">Future of Humanity Institute</EntityLink> (2005)
...
**The <EntityLink id="instrumental-convergence">Instrumental Convergence</EntityLink> Thesis**
...
**The <EntityLink id="treacherous-turn">Treacherous Turn</EntityLink>**
...
**Positive**:
- Endorsements from <EntityLink id="elon-musk">Elon Musk</EntityLink>, Bill Gates, Stephen Hawking
...
**Elon Musk**:
- \$10M to <EntityLink id="fli">Future of Life Institute</EntityLink> (2015)
- Funding for AI safety research grants
- Support for multiple organizations

**<EntityLink id="coefficient-giving">Coefficient Giving</EntityLink>** (then <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink>, formerly Good Ventures + GiveWell Labs):
...
**Attendees**:
- Elon Musk
- <EntityLink id="stuart-russell">Stuart Russell</EntityLink>
- <EntityLink id="demis-hassabis">Demis Hassabis</EntityLink>
- Nick Bostrom
- <EntityLink id="max-tegmark">Max Tegmark</EntityLink>
...
Less attention to governance, policy, <EntityLink id="international-coordination">international coordination</EntityLink>.
...
|--------------|---------|-------|
| **MIRI** (originally SIAI) | 2000 | <EntityLink id="agent-foundations">Agent foundations</EntityLink>, decision theory |
...
| **<EntityLink id="openai">OpenAI</EntityLink>** | 2015 | AI research "for the benefit of humanity" |
