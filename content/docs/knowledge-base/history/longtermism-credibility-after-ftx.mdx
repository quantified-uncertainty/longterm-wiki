...
- [EA Epistemic Failures in the FTX Era](/knowledge-base/history/ea-epistemic-failures-in-the-ftx-era) — Community-level governance and epistemic critiques
- [EA Institutions' Response to the FTX Collapse](/knowledge-base/history/ea-institutions-response-to-the-ftx-collapse) — Survey data on community trust damage
- [Earning to Give: The EA Strategy and Its Limits](/knowledge-base/history/earning-to-give) — The fundraising strategy that fueled longtermism's rapid growth
- [FTX Future Fund](/knowledge-base/organizations/ftx-future-fund) — The collapsed funding vehicle that financed longtermist research
