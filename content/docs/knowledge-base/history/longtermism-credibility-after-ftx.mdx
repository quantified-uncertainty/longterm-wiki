...
A central objection to longtermism concerns its treatment of present versus future welfare. Because longtermist calculations assign equal moral weight to future individuals, and because the potential future human population vastly outnumbers those alive today—potentially by ratios of thousands to one if humanity persists for millions of years—longtermist reasoning systematically tends to direct resources toward speculative future risks rather than concrete contemporary suffering.[^18] Critics argue that when this logic is applied consistently, it renders nearly every immediate problem less important than existential risk mitigation, effectively licensing the neglect of poverty, climate change, and other present injustices.[^19]

A 2025 discussion hosted by the American Philosophical Association examined the limits of strong longtermism, arguing that while care for the future is warranted, the framework imposes demands on present resources that cannot be plausibly justified, and that future people vastly outnumbering the living does not straightforwardly imply their interests should dominate moral decision-making in the ways longtermists suggest.[^20]
...
[^18]: [Longtermism and Its Limits - APA Blog](https://blog.apaonline.org/2025/10/09/longtermism-and-its-limits/)
...
[^20]: [Longtermism and Its Limits - APA Blog](https://blog.apaonline.org/2025/10/09/longtermism-and-its-limits/)
...
[^26]: [Why Haven't We Seen a Promising Longtermist Intervention Yet? - EA Forum](https://forum.effectivealtruism.org/posts/LSfZKPFHzwJgdhF5f/why-haven-t-we-seen-a-promising-longtermist-intervention-yet)
