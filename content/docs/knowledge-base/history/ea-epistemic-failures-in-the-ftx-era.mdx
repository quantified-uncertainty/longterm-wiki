...
- [EA Institutions' Response to the FTX Collapse](/knowledge-base/history/ea-institutions-response-to-the-ftx-collapse) — How EA organizations responded operationally and what survey data showed
- [Longtermism's Philosophical Credibility After FTX](/knowledge-base/history/longtermism-credibility-after-ftx) — Broader philosophical consequences for the longtermist project
- [FTX Red Flags: Pre-Collapse Warning Signs](/knowledge-base/history/ftx-red-flags-pre-collapse-warning-signs-that-were-overlooked) — The specific governance and financial warning signs that were missed
- [Earning to Give: The EA Strategy and Its Limits](/knowledge-base/history/earning-to-give) — The fundraising philosophy at the center of the controversy
