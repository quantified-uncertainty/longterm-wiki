...
- **November 2022 (late)**: <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink> launched a dedicated application program for organizations affected by the FTX Future Fund collapse, seeking to provide emergency support to longtermist and biosecurity grantees who had not received committed funds.[^rc-6848]
