...
The <EntityLink id="ftx-future-fund">FTX Future Fund</EntityLink>, which had committed over \$160 million in grants by end of June 2022 before its dissolution, left numerous grantees without committed funding and the community acutely aware of its dependence on a concentrated source.[^rc-c374]
...
- **<EntityLink id="cea">Centre for Effective Altruism</EntityLink> (2016–2019)**: Inadequate record-keeping, rapid executive turnover, and insufficient board oversight.[^rc-6a9f]
- **<EntityLink id="80000-hours">80,000 Hours</EntityLink> (2018)**: Inadequate financial record-keeping.[^rc-6a9f]
- **<EntityLink id="miri">MIRI</EntityLink> and CFAR (2015–2017)**: Insufficient oversight, unhealthy power dynamics, and harmful organizational practices as described in EA Forum analyses.[^rc-6a9f]
