...
**Modern connection**: This anticipates concerns about <EntityLink id="E197">mesa-optimization</EntityLink> and emergent goals.
...
- Speed and <EntityLink id="E179">irreversibility</EntityLink> concerns
...
## The Transition to the <EntityLink id="E202">MIRI</EntityLink> Era
