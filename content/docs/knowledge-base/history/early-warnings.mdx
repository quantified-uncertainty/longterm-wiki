...
todos:
  - Add more concrete examples of how these early warnings directly influenced specific modern research programs; include discussion of other early voices from Soviet/non-Western contexts
readerImportance: 80
tacticalValue: 22
