...
description: An overview of Jeffrey Epstein's financial and professional relationships with AI researchers and organizations, including funding for AGI projects, academic symposia, and institutional connections at MIT, Harvard, Oxford, and the University of Tennessee.
sidebar:
  order: 50
subcategory: ea-history
lastEdited: 2026-03-13
update_frequency: 365
summary: "A well-documented reference page cataloging Jeffrey Epstein's financial relationships with AI researchers and institutions (2001–2019), including \\$850K to MIT, \\$6.5M to Harvard's PED, \\$50K to MIRI, and various AGI-focused grants totaling millions; the page is notable for explicitly flagging uncorroborated claims from single sources. The content is historically informative but has minimal actionability for AI prioritization work."
clusters:
  - community
  - ai-safety
  - history
...
| UT/WUOT Reporting | [Epstein Files: Former UT Professor Used Students to Develop AI Tools for Epstein](https://www.wuot.org/news/2026-02-05/epstein-files-show-former-ut-professor-used-students-to-develop-ai-tools-for-predatory-billionaire) |
...
| Byline Times | [Epstein's AI Network](https://bylinetimes.com) |
...
The <EntityLink id="E140" name="fhi">Future of Humanity Institute</EntityLink> closed in 2024 amid separate controversies. Whether Epstein's funding relationships had any influence on the intellectual development of longtermism as a movement is not established by the available documents.

### MIRI (Machine Intelligence Research Institute)

In 2009, <EntityLink id="E202" name="miri">MIRI</EntityLink> — then known as the Singularity Institute for Artificial Intelligence (SIAI), the early AI safety organization later renamed MIRI — received \$50,000 from Epstein's COUQ Foundation. MIRI is one of the earliest dedicated AI safety organizations, focused on ensuring beneficial AGI. The donation is documented in public records, though no further Epstein donations to MIRI have been reported.
...
- **Scope of AI safety community exposure**: The <EntityLink id="E202" name="miri">MIRI</EntityLink> donation and Humanity+ connections indicate Epstein had documented contact with the early AI safety community, but the extent of any intellectual or financial influence on that community's development is not established.
