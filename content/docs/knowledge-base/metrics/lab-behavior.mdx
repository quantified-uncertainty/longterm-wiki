...
|--------|-----------|-----------------|-------|
| First (July 2023) | Amazon, <EntityLink id="anthropic">Anthropic</EntityLink>, Google, Inflection, <EntityLink id="meta">Meta</EntityLink>, Microsoft, OpenAI | 69.0% | 50-83% |
...
**Grade Decline:** According to [SaferAI's analysis](https://www.safer-ai.org/anthropics-responsible-scaling-policy-update-makes-a-step-backwards), Anthropic's safety grade dropped from 2.2 to 1.9, placing them in the "weak" category alongside OpenAI and <EntityLink id="google-deepmind">Google DeepMind</EntityLink>. The primary concern is the shift away from precisely defined, quantitative thresholds.[^4]
...
**Parliamentary Response:** The [UK politicians' letter](https://www.parliament.uk/business/committees/committees-a-z/commons-select/science-and-technology-committee/) accused <EntityLink id="google-deepmind">Google DeepMind</EntityLink> of "a troubling breach of trust with governments and the public" and a "failure to honour" international commitments.[^12]
...
| <EntityLink id="google-deepmind">Google DeepMind</EntityLink> | Frontier Safety Framework | Current version | Multi-stage assessment |
...
| <EntityLink id="meta">Meta</EntityLink> | 2+ open models | Llama improvements | Brief model cards |
