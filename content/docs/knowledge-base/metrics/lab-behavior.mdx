...
| External <EntityLink id="red-teaming">Red Teaming</EntityLink> | **Standard but Limited** | 750+ researchers engaged via <EntityLink id="hackerone">HackerOne</EntityLink>; 15-30 day engagement windows may be insufficient |
