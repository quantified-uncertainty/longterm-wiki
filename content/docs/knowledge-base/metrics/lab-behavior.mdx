...
|-----------|------------|----------|
| Overall Compliance | **Mixed (53% average)** | August 2025 study of 16 companies found significant variation; <EntityLink id="openai">OpenAI</EntityLink> scored 83%, average was 53% |
...
| External <EntityLink id="red-teaming">Red Teaming</EntityLink> | **Standard but Limited** | 750+ researchers engaged via HackerOne; 15-30 day engagement windows may be insufficient |
| Whistleblower Protection | **Underdeveloped** | Only OpenAI has published full policy (after media pressure); <EntityLink id="california-sb53">California SB 53</EntityLink> protections start 2026 |
...
| Safety Evaluations | Third-party evaluators (<EntityLink id="metr">METR</EntityLink>, <EntityLink id="uk-aisi">UK AISI</EntityLink>, <EntityLink id="us-aisi">US AISI</EntityLink>) | Peer review, government validation | Limited access, short evaluation windows |
...
|--------|-----------|-----------------|-------|
| First (July 2023) | Amazon, <EntityLink id="anthropic">Anthropic</EntityLink>, Google, Inflection, <EntityLink id="meta-ai">Meta</EntityLink>, Microsoft, OpenAI | 69.0% | 50-83% |
...
As of [December 2025, twelve companies have published frontier AI safety policies](https://metr.org/blog/2025-12-09-common-elements-of-frontier-ai-safety-policies/), with four additional companies joining since May 2024: <EntityLink id="xai">xAI</EntityLink>, Meta, Amazon, and Nvidia.[^2]
...
<EntityLink id="anthropic">Anthropic</EntityLink> [announced the first publicly confirmed ASL-3 activation](https://www.anthropic.com/news/announcing-our-updated-responsible-scaling-policy) for Claude Opus 4 in 2025, representing a milestone in <EntityLink id="responsible-scaling-policies">responsible scaling policy</EntityLink> implementation:
...
**Grade Decline:** According to [SaferAI's analysis](https://www.safer-ai.org/anthropics-responsible-scaling-policy-update-makes-a-step-backwards), Anthropic's safety grade dropped from 2.2 to 1.9, placing them in the "weak" category alongside OpenAI and <EntityLink id="deepmind">Google DeepMind</EntityLink>. The primary concern is the shift away from precisely defined, quantitative thresholds.[^4]
...
Research by <EntityLink id="apollo-research">Apollo Research</EntityLink> and others demonstrates that small improvements in elicitation methodology can dramatically increase scores on evaluation benchmarks. This creates uncertainty about whether reported threshold crossings reflect genuine capability increases or improved evaluation techniques.[^5]
...
<EntityLink id="anthropic">Anthropic</EntityLink>'s [partnership with HackerOne](https://www.anthropic.com/news/jailbreak-challenge) to test Constitutional Classifiers on Claude 3.5 Sonnet yielded significant findings:
...
**Parliamentary Response:** The [UK politicians' letter](https://www.parliament.uk/business/committees/committees-a-z/commons-select/science-and-technology-committee/) accused <EntityLink id="deepmind">Google DeepMind</EntityLink> of "a troubling breach of trust with governments and the public" and a "failure to honour" international commitments.[^12]
...
| <EntityLink id="deepmind">Google DeepMind</EntityLink> | Frontier Safety Framework | Current version | Multi-stage assessment |
| <EntityLink id="anthropic">Anthropic</EntityLink> | [<EntityLink id="responsible-scaling-policies">Responsible Scaling Policy</EntityLink>](https://www.anthropic.com/news/announcing-our-updated-responsible-scaling-policy) | Version 2.2 (May 2025) | ASL-based thresholds |
...
|-----------|-------------|-----------------|-------------|
| <EntityLink id="uk-aisi">UK AISI</EntityLink> | Pre-deployment | "Limited period" | Resource constraints |
| <EntityLink id="us-aisi">US AISI</EntityLink> | Government evaluation | Variable | Classified findings |
| <EntityLink id="metr">METR</EntityLink> | Third-party assessment | Days to weeks | Company-controlled access |
| <EntityLink id="apollo-research">Apollo Research</EntityLink> | Specialized testing | Project-specific | Limited model access |
...
|------|---------|-------|-----------------|------------------------|
| November 17 | <EntityLink id="xai">xAI</EntityLink> | Grok 4.1 | Advanced reasoning | Not disclosed |
...
| <EntityLink id="meta-ai">Meta</EntityLink> | 2+ open models | Llama improvements | Brief model cards |
...
DeepSeek's [R1 release on January 20, 2025](https://c3.unu.edu/blog/deepseek-r1-pioneering-open-source-thinking-model-and-its-impact-on-the-llm-landscape) represented a watershed moment:
...
AI safety researchers from multiple organizations publicly criticized <EntityLink id="xai">xAI</EntityLink>'s safety culture, describing practices as ["reckless" and "completely irresponsible"](https://www.techpolicypress.com/ai-safety-researchers-criticize-xai/) following internal scandals.[^22]
...
[^1]: [2025 AI Safety Index (Future of Life Institute, Summer 2025)](https://futureoflife.org/ai-safety-index-summer-2025/)

[^2]: [Common Elements of Frontier AI Safety Policies (December 2025 Update) (METR, December 9, 2025)](https://metr.org/blog/2025-12-09-common-elements-of-frontier-ai-safety-policies/)

[^3]: OpenAI Preparedness Framework changelog analysis, April 2025

[^4]: [Anthropic's Responsible Scaling Policy Update Makes a Step Backwards (SaferAI, 2025)](https://www.safer-ai.org/anthropics-responsible-scaling-policy-update-makes-a-step-backwards)
...
[^7]: [Pre-Deployment Evaluation of OpenAI's o1 Model (NIST, December 2024)](https://www.nist.gov/news-events/news/2024/12/nist-releases-pre-deployment-safety-evaluation-openais-o1-model)

[^8]: [AI models can be dangerous before public deployment (METR, November 13, 2024)](https://metr.org/blog/2024-11-13-ai-models-can-be-dangerous-before-public-deployment/)

[^9]: [AI Red Teaming | Offensive Testing for AI Models (HackerOne, 2025)](https://www.hackerone.com/ai-red-teaming)

[^10]: [Jailbreak Challenge Results (Anthropic, 2025)](https://www.anthropic.com/news/jailbreak-challenge)

[^11]: [AI Red Teaming: Applying Software TEVV for AI Evaluations (CISA, November 2024)](https://www.cisa.gov/sites/default/files/2024-11/CISA_AI_Red_Teaming_Guide.pdf)
...
[^14]: [New York Enacts RAISE Act for AI Transparency Amid Federal Preemption Debate (Davis Wright Tremaine, December 19, 2025)](https://www.dwt.com/blogs/artificial-intelligence-law-advisor/2025/12/new-york-raise-act-ai-safety-rules-developers)

[^15]: [Ensuring a National Policy Framework for Artificial Intelligence (The White House, December 11, 2025)](https://www.whitehouse.gov/presidential-actions/2025/12/eliminating-state-law-obstruction-of-national-artificial-intelligence-policy/)
...
[^18]: [GPT 5.1 vs Claude 4.5 vs Gemini 3: 2025 AI Comparison (PassionFruit, 2025)](https://www.getpassionfruit.com/blog/gpt-5-1-vs-claude-4-5-sonnet-vs-gemini-3-pro-vs-deepseek-v3-2-the-definitive-2025-ai-model-comparison)

[^19]: [The Open Model Convergence: How the Frontier Gap Collapsed to 6 Months (FourWeekMBA, 2025)](https://fourweekmba.com/the-open-model-convergence-how-the-frontier-gap-collapsed-to-6-months/)

[^20]: Various news sources tracking OpenAI departures, compiled December 2024

[^21]: [AI Safety Field Growth Analysis 2025 (LessWrong, 2025)](https://www.lesswrong.com/posts/8QjAnWyuE9fktPRgS/ai-safety-field-growth-analysis-2025)

[^22]: Tech Policy Press, "AI Safety Researchers Criticize xAI Safety Culture," 2025

[^23]: [S.1792 - AI Whistleblower Protection Act (U.S. Congress, May 2025)](https://www.congress.gov/bill/119th-congress/senate-bill/1792/text)

[^24]: [California AI Law Created Illusion of Whistleblower Protections (SF Public Press, 2025)](https://www.sfpublicpress.org/californias-new-ai-safety-law-created-the-illusion-of-whistleblower-protections/)