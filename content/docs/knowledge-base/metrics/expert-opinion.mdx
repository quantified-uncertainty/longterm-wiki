...
---
import {DataInfoBox, DisagreementMap, KeyQuestions, Backlinks, EntityLink, DataExternalLinks, Mermaid} from '@components/wiki';

<DataExternalLinks pageId="expert-opinion" client:load />
