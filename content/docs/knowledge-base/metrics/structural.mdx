...
| Source | Link |
|--------|------|
| Wikipedia | [en.wikipedia.org](https://en.wikipedia.org/wiki/Metadata) |
...
- **<EntityLink id="disinformation">Disinformation</EntityLink> prevalence**: 138/180 countries report political actors involved in disinformation campaigns
...
- **Proxy**: Mixed signals—<EntityLink id="eu-ai-act">EU AI Act</EntityLink> implemented, US executive order, but critiques of regulatory lag
...
- **AI company <EntityLink id="trust-decline">trust decline</EntityLink>**: From 62% (5 years ago) to 54% (2024)
...
**<EntityLink id="us-executive-order">US Executive Order on AI</EntityLink>**
- **GPT-4 release**: March 2023
...
**<EntityLink id="ai-safety-institutes">AI Safety Institutes</EntityLink>**
...
## 5. Coordination Failure Rate on <EntityLink id="ai-governance">AI Governance</EntityLink>
...
- **<EntityLink id="anthropic">Anthropic</EntityLink>**: 32% usage share, 40% revenue share
- **<EntityLink id="openai">OpenAI</EntityLink>**: 25% usage share, 27% revenue share (down from 50% in 2023)
...
## 8. <EntityLink id="societal-resilience">Societal Resilience</EntityLink> to AI Disruption
...
**<EntityLink id="economic-disruption">Economic Disruption</EntityLink> Preparedness**
...
4. **Attribution**: Hard to isolate AI's contribution to <EntityLink id="institutional-quality">institutional quality</EntityLink> or societal resilience
...
- <R id="f7ea8fb78f67f717"><EntityLink id="fli">Future of Life Institute</EntityLink>: AI Safety Index 2024</R>
