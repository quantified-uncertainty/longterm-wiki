...
- **<EntityLink id="E102">Disinformation</EntityLink> prevalence**: 138/180 countries report political actors involved in disinformation campaigns
...
- **Proxy**: Mixed signals—<EntityLink id="E127">EU AI Act</EntityLink> implemented, US executive order, but critiques of regulatory lag
...
- **AI company <EntityLink id="E362">trust decline</EntityLink>**: From 62% (5 years ago) to 54% (2024)
...
**<EntityLink id="E366">US Executive Order on AI</EntityLink>**
- **GPT-4 release**: March 2023
...
**<EntityLink id="E13">AI Safety Institutes</EntityLink>**
...
## 5. Coordination Failure Rate on <EntityLink id="E608">AI Governance</EntityLink>
...
- **<EntityLink id="E22">Anthropic</EntityLink>**: 32% usage share, 40% revenue share
- **<EntityLink id="E218">OpenAI</EntityLink>**: 25% usage share, 27% revenue share (down from 50% in 2023)
...
## 8. <EntityLink id="E284">Societal Resilience</EntityLink> to AI Disruption
...
**<EntityLink id="E108">Economic Disruption</EntityLink> Preparedness**
...
4. **Attribution**: Hard to isolate AI's contribution to <EntityLink id="E167">institutional quality</EntityLink> or societal resilience
...
- <R id="f7ea8fb78f67f717"><EntityLink id="E528">Future of Life Institute</EntityLink>: AI Safety Index 2024</R>
