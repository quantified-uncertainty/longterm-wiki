...
The geopolitical dimension of AI development significantly shapes both capability trajectories and risk profiles. International competition can accelerate development timelines and reduce safety standards, while effective <EntityLink id="international-coordination">international coordination</EntityLink> could enable shared safety measures and governance frameworks.
