...
<DataExternalLinks pageId="economic-labor" client:load />
...
- Major rounds: <EntityLink id="openai">OpenAI</EntityLink> (\$40 billion at \$300B valuation), <EntityLink id="anthropic">Anthropic</EntityLink> (\$13 billion)
