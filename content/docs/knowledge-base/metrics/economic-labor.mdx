...
---
import {R, EntityLink, DataExternalLinks, F} from '@components/wiki';
...
- Major rounds: <EntityLink id="openai">OpenAI</EntityLink> (\$40 billion at \$300B valuation), <EntityLink id="anthropic">Anthropic</EntityLink> (<F e="openai" f="microsoft-total-investment">\$13 billion</F>)
...
- **Anthropic**: \$183 billion → <F e="anthropic" f="valuation-nov-2025">\$350 billion</F> range (2025)
...
*Sources: <R id="e331256e28403b8d">BLS <EntityLink id="ai-impacts">AI Impacts</EntityLink></R>, <R id="fced7006cd38a439">Final Round AI</R>*
