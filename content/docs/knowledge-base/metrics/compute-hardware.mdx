...
|-----------|------------|----------|
| **Data Completeness** | High for public metrics | <R id="b029bfc231e620cc"><EntityLink id="E125">Epoch AI</EntityLink></R>, <R id="a2dfd6cfecb65be8">IEA reports</R>, company filings |
...
| **Market Concentration** | NVIDIA holds 80-90% share | Data center GPU revenue, CUDA ecosystem <EntityLink id="E189">lock-in</EntityLink> |
