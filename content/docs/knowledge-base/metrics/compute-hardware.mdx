...
Hardware availability directly constrains AI capabilities development. Training compute determines which models can be built, efficiency improvements affect economic viability of deployment, and supply chain dynamics influence geopolitical competition. These metrics inform policy decisions including export controls, compute governance proposals, and infrastructure planning.
...
- OpenAI: approximately 250k average, ramping to 460k H100-equivalents by year-end (5% of global supply)
- Anthropic: approximately 360k H100-equivalents (4% of global supply), including 400k Amazon Trainium2
