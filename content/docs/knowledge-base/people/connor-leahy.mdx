...
<DataExternalLinks pageId="connor-leahy" client:load />

<DataInfoBox entityId="connor-leahy" />

## Background

Connor Leahy is the CEO and co-founder of <EntityLink id="conjecture">Conjecture</EntityLink>, an AI safety company focused on interpretability and "prosaic" approaches to AGI alignment. He represents a new generation of AI safety researchers who are building organizations specifically to tackle alignment.
...
- <EntityLink id="emergent-capabilities">Emergent capabilities</EntityLink> make prediction hard
