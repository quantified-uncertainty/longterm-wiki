...
| Alignment Approach | Prosaic alignment, stress-testing | Influenced by <EntityLink id="E220" name="paul-christiano">Paul Christiano</EntityLink> |
...
| Previous Positions | Research Fellow, MIRI (2019-2023); Intern, <EntityLink id="E218" name="openai">OpenAI</EntityLink> (2019) |
| Notable Creation | Coconut programming language (2,300+ GitHub stars) |
| Online Presence | <EntityLink id="E439" name="alignment">AI Alignment</EntityLink> Forum (evhub), GitHub (evhub), X (@EvanHub) |
...
| 2019 | Intern, OpenAI | Theoretical safety research under <EntityLink id="E220" name="paul-christiano">Paul Christiano</EntityLink> |
...
| Prosaic alignment | Good default assumption | Aligned with <EntityLink id="E220" name="paul-christiano">Paul Christiano</EntityLink> |
...
| <EntityLink id="E59" name="chris-olah">Chris Olah</EntityLink> | Mechanistic interpretability | Understanding models vs. stress-testing them |
| <EntityLink id="E182" name="jan-leike">Jan Leike</EntityLink> | Scalable oversight | Similar concerns, different methodologies |
| <EntityLink id="E114" name="eliezer-yudkowsky">Eliezer Yudkowsky</EntityLink> | Agent foundations | More pessimistic, less prosaic-focused |
| <EntityLink id="E46" name="buck-shlegeris">Buck Shlegeris</EntityLink> | AI control | Complementary—control vs. alignment |
