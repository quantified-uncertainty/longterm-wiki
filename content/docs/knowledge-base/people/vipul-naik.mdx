...
Through his contract work portal, Naik has funded research on AI safety and global catastrophic risks.[^39] He maintains tracking of donations to AI safety organizations including the AI Safety Camp (which received \$3,667 from Simon Möller in 2022 for technical AI safety projects)[^40] and the <EntityLink id="chai">Center for Human-Compatible AI</EntityLink> at UC Berkeley, which focuses on value alignment research.[^41]
