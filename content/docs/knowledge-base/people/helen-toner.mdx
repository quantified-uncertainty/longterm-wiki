...
| <EntityLink id="E218" name="openai">OpenAI</EntityLink> Board | 2021-2023 | Voted to remove <EntityLink id="E269" name="sam-altman">Sam Altman</EntityLink>; resigned after his reinstatement |
...
| Previous Positions | Director of Strategy and Foundational Research Grants, CSET; Senior Research Analyst, <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>; OpenAI Board Member |
| Languages | English, Mandarin Chinese (studied in Beijing) |

## Overview

<EntityLink id="E575" name="helen-toner">Helen Toner</EntityLink> is an Australian AI governance researcher who became one of the most prominent figures in AI policy after her role in the November 2023 removal of <EntityLink id="E269" name="sam-altman">Sam Altman</EntityLink> as OpenAI's CEO. She serves as Interim Executive Director of Georgetown University's <EntityLink id="E524" name="cset">Center for Security and Emerging Technology</EntityLink> (CSET), a think tank she helped establish in 2019 with \$55 million in funding from Coefficient Giving (then <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>).
...
| 2021-2023 | Board Member | OpenAI | Invited by <EntityLink id="E156" name="holden-karnofsky">Holden Karnofsky</EntityLink> to replace him on board |
| Sep 2025 | Interim Executive Director | Georgetown CSET | Appointed to lead the center |

## The OpenAI Board Crisis (November 2023)

The most consequential moment of Toner's career came on November 17, 2023, when she and three other OpenAI board members voted to remove <EntityLink id="E269" name="sam-altman">Sam Altman</EntityLink> as CEO. The five-day crisis that followed revealed deep tensions between AI safety governance and commercial AI development.
...
In October 2025, <EntityLink id="E163" name="ilya-sutskever">Ilya Sutskever</EntityLink>'s deposition in the Musk v. Altman lawsuit revealed additional details:
...
- "Most or all" supporting material came from OpenAI CTO <EntityLink id="E1289" name="mira-murati">Mira Murati</EntityLink>
...
> "In mid-November of 2023, <EntityLink id="E575" name="helen-toner">Helen Toner</EntityLink> made what will likely be the most pivotal decision of her career... One outcome of the drama was that Toner, a formerly obscure expert in AI governance, now has the ear of policymakers around the world trying to regulate AI."
...
|--------|--------------|---------|
| <EntityLink id="E156" name="holden-karnofsky">Holden Karnofsky</EntityLink> | Mentor/predecessor | Karnofsky invited Toner to replace him on OpenAI board in 2021 |
...
| <EntityLink id="E163" name="ilya-sutskever">Ilya Sutskever</EntityLink> | Board colleague | Co-voted to remove Altman; later disputed Toner's account of events |
| Sam Altman | Adversary | Removed as OpenAI CEO by Toner and board colleagues |
| <EntityLink id="jason-matheny" name="jason-matheny">Jason Matheny</EntityLink> | CSET colleague | CSET founding director; Toner was early hire |
...
| <EntityLink id="E91" name="dario-amodei">Dario Amodei</EntityLink> | Physics PhD (Princeton) | Anthropic CEO | Technical safety, constitutional AI |
| <EntityLink id="E182" name="jan-leike">Jan Leike</EntityLink> | ML PhD (Toronto) | Anthropic Alignment Lead | Technical alignment research |
| <EntityLink id="E220" name="paul-christiano">Paul Christiano</EntityLink> | CS PhD (UC Berkeley) | ARC founder | AI alignment, evaluation |
...
|---------|------|------|-------|
| 80,000 Hours | <EntityLink id="rob-wiblin" name="rob-wiblin">Rob Wiblin</EntityLink> | 2019 | CSET founding and AI policy careers |
...
| Cognitive Revolution | <EntityLink id="nathan-labenz" name="nathan-labenz">Nathan Labenz</EntityLink> | 2024 | AI safety, regulatory approaches |
...
- <EntityLink id="E91" name="dario-amodei">Dario Amodei</EntityLink> - Anthropic CEO; Anthropic was discussed as potential merger partner
