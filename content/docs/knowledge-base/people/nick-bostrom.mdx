...
- Philosopher Daniel Dennett argued the scenarios rely on anthropomorphic assumptions about AI systems[^28]
...
- **"Ethical Issues in Advanced Artificial Intelligence"** (2003, co-authored with Eliezer Yudkowsky) - Early analysis of AI alignment challenges
