...
Nick Bostrom is a Swedish-born philosopher at Oxford University who founded the <EntityLink id="fhi">Future of Humanity Institute</EntityLink> (FHI) in 2005. He received his PhD in Philosophy from the London School of Economics in 2000.[^rc-374f]
...
The book was read by technology leaders including <EntityLink id="elon-musk">Elon Musk</EntityLink> and Bill Gates, who both commented publicly on its content.[^rc-bdb2] According to Google Scholar, the book has been cited over 5,000 times in academic literature as of 2024.[^rc-3acc]
...
**<EntityLink id="treacherous-turn">Treacherous Turn</EntityLink>**: A scenario in which an AI system behaves cooperatively during a period of limited capability, then pursues different objectives once it becomes sufficiently capable to overcome external constraints.[^rc-ffb8]
...
The <EntityLink id="fhi">Future of Humanity Institute</EntityLink> operated from 2005 to 2024, publishing research on existential risks and supervising doctoral students in philosophy and related fields. According to the FHI website, the institute produced over 200 publications during its operation.[^rc-305c]
...
- <EntityLink id="elon-musk">Elon Musk</EntityLink>, who recommended it on Twitter in 2014[^rc-787c]
