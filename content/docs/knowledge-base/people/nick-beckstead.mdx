...
| **Affiliated Organizations** | Secure AI Project, formerly <EntityLink id="E521" name="coefficient-giving" >Open Philanthropy</EntityLink>, FTX Future Fund, <EntityLink id="E140" name="fhi">Future of Humanity Institute</EntityLink>, <EntityLink id="E517" name="cea">Centre for Effective Altruism</EntityLink> |
