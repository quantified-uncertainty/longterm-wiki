...
---
import {DataInfoBox, Backlinks, DataExternalLinks, EntityLink, Mermaid} from '@components/wiki';

<DataExternalLinks pageId="elon-musk" client:load />
...
<Backlinks client:load entityId="elon-musk" />
