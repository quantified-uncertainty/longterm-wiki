...
Research data notes that a Tom Brown is listed as the 1,214th member of the Giving What We Can Pledge, a commitment associated with the Effective Altruism community to donate a significant portion of income to effective charities. This is mentioned alongside the pledge membership numbers of <EntityLink id="E91">Dario Amodei</EntityLink> (43rd) and <EntityLink id="E1248" name="jack-clark">Jack Clark</EntityLink> (4,002nd). It is not confirmed in the research data whether this refers to the same Tom B. Brown who co-authored GPT-3, and this detail should be treated with appropriate uncertainty.
