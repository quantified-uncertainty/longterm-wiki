...
| **<EntityLink id="E399" name="agi-timeline">AGI Timeline</EntityLink> Estimate** | ≈5 years (stated February 2025 Paris AI Summit); 5-10 years (stated December 2024) |
...
| 2010 | Co-founds DeepMind | With <EntityLink id="E280" name="shane-legg">Shane Legg</EntityLink> and Mustafa Suleyman; mission to "solve intelligence" |
...
| 2025 | Gemini 2.5 released | Outperforms <EntityLink id="E218" name="openai">OpenAI</EntityLink> and <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> models on many benchmarks |
...
DeepMind introduced the <R id="sid_niN8zAcmnY">Frontier Safety Framework</R> in May 2024, establishing protocols for identifying future AI capabilities that could cause severe harm. The framework has evolved through multiple versions:
...
- <R id="sid_Gzvtcfbnuq">Nobel Prize in Chemistry 2024 - NobelPrize.org</R>
- <R id="sid_OY2eq9vSKf"><EntityLink id="E101" name="demis-hassabis">Demis Hassabis</EntityLink> - Google DeepMind</R>
- <R id="sid_QRdLlT0USm">Isomorphic Labs</R>
...
- <R id="sid_vSdWfX4Dxe">Demis Hassabis - Wikipedia</R>
- <R id="sid_FoQEGCXJNd">Demis Hassabis - Britannica</R>
- <R id="sid_NTvs9ISxUc">Academy of Achievement Profile</R>
- <R id="sid_M55t4dhiZn">UCL News: DeepMind co-founder and UCL alumnus</R>
...
- <R id="sid_Wg96V2aRVU">Axios: Some AI dangers are already real, DeepMind's Hassabis says (Dec 2025)</R>
- <R id="sid_5RBZ6TNt3d">Axios: Transformative AI is coming, and so are the risks (Dec 2025)</R>
...
- <R id="sid_7kyEx1e5Bv">Fortune: Google DeepMind 145-page paper predicts AGI by 2030 (Apr 2025)</R>
- <R id="sid_DNHZELtXLE">Futurism: Google AI Boss Says AI Is an Existential Threat</R>
- <R id="sid_syIFvl6XNu">DeepMind: An Approach to Technical AGI Safety and Security</R> - April 2025

### Safety Framework

- <R id="sid_niN8zAcmnY">Google DeepMind: Introducing the Frontier Safety Framework</R> - May 2024
- <R id="sid_XOO1bHptdb">Google DeepMind: Frontier Safety Framework Version 3.0</R>
- <R id="sid_g9YSva17yH">Google DeepMind: Strengthening our Frontier Safety Framework</R>

### Technical Achievements

- <R id="sid_vY4pRGNX83">Axios: Gemini 2.0 launch puts Google on road to AI agents (Dec 2024)</R>
- <R id="sid_VMZavPTUXW">Google Blog: Introducing Gemini 2.0</R>
- <R id="sid_GkcCry04hs">CNBC: Inside Isomorphic Labs (Apr 2025)</R>
- <R id="sid_Wmnyydi0pP">JCI: AlphaFold developers share 2023 Lasker Award</R>
