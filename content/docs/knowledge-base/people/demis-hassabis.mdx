...
| **<EntityLink id="E399">AGI Timeline</EntityLink> Estimate** | ≈5 years (stated February 2025 Paris AI Summit); 5-10 years (stated December 2024) |
...
| 2025 | Gemini 2.5 released | Outperforms <EntityLink id="E218">OpenAI</EntityLink> and <EntityLink id="E22">Anthropic</EntityLink> models on many benchmarks |
