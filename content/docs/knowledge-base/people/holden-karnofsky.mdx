...
|---------------|----------------------|----------|----------|
| Transformative AI | ~15% by 2036, ≈50% by 2060 | <R id="MjY1NGQ2N2">Bio anchors framework</R> | This century |
...
|--------|------|------------------|
| 2007-2011 | Co-founder, <R id="OWMzODkyN2">GiveWell</R> | Pioneered rigorous charity evaluation methodology |
...
- 2021: <R id="YWI4ZjBiMj">\$580M investment in Anthropic</R> to create safety-focused lab
- 2022: Establishment of <R id="NGFiNDc1YW">AI safety university programs</R>
...
**Supporting evidence:**
- <R id="MjY1NGQ2N2">Biological anchors methodology</R> for AI timelines
- Historical analysis of technological transitions
- Economic modeling of AI impact potential

### Bio Anchors Framework

Developed with <R id="ODBlNDVkZG"><EntityLink id="E864" name="ajeya-cotra">Ajeya Cotra</EntityLink></R>, this framework estimates AI development timelines by comparing required computation to biological systems:
...
| AI governance | \$80M+ | <R id="ODM0MTY2OW"><EntityLink id="E524" name="cset">Center for Security and Emerging Technology</EntityLink></R>, policy fellowships | Institutional responses to AI development |
...
- <R id="YWI4ZjBiMj">Anthropic investment</R>: \$580M to create safety-focused competitor to OpenAI
...
| 2024 | Accelerated timelines concern | <R id="NTAxYjY3YT">Shorter timelines than bio anchors suggested</R> |
...
**Academic legitimacy:**
- Funding enabled <R id="NDZkNGVlNj">AI safety courses</R> at major universities
...
- Supported research informing <R id="NzJjNjNjZG"><EntityLink id="E127" name="eu-ai-act">EU AI Act</EntityLink></R>
...
- Others prefer <R id="OWMzODkyN2">global health and development</R> emphasis
...
- <R id="Zjk2NzY2OT">"The Most Important Century"</R> series (>100k views)
- <R id="NTAxYjY3YT">"AI Timelines: Where the Arguments Stand"</R> (policy reference)
- <R id="MjY1NGQ2N2">"Bio Anchors" explanation</R> (research methodology)
...
|------|--------|-------------|
| Blog | <R id="MjViMjRmND">Cold Takes</R> | Karnofsky's strategic thinking and analysis |
| Organization | <R id="MWExMWE0YT">Coefficient Giving</R> | Grant database and reasoning |
| Research | <R id="ZTliZDgxYT">Bio Anchors Report</R> | Technical forecasting methodology |
| Testimony | <R id="YjFiZWUxY2">Congressional Hearing</R> | Policy positions and recommendations |

### Secondary Analysis

| Type | Source | Focus |
|------|--------|-------|
| Academic | <R id="ZWU0ZTZhNW">EA Research</R> | Critical analysis of funding decisions |
| Journalistic | <R id="ODZjNDVjOD">MIT Technology Review</R> | External perspective on influence |
| Policy | <R id="MTY0YjA3MT">RAND Corporation</R> | Government research on philanthropic AI funding |
