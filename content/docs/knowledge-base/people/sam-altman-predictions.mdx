...
This page documents <EntityLink id="E269" name="sam-altman">Sam Altman</EntityLink>'s public predictions and testable claims to assess his forecasting accuracy. For biographical information, communication patterns, and credibility context, see the main <EntityLink id="E269" name="sam-altman">Sam Altman</EntityLink> page.
...
| **2021** | AI development would need massive capital | Essay | <EntityLink id="E218" name="openai">OpenAI</EntityLink> raised \$20+ billion; compute costs enormous | ✅ Correct | Same |
...
### <EntityLink id="E399" name="agi-timeline">AGI Timeline</EntityLink> Evolution
...
**Pattern**: Rhetoric shifted from "probably lead to end of world" (2015) → "lights out for all of us" (2023) → "will matter much less than people think" (2024-2025). For detailed analysis of this shift, see the <EntityLink id="E269" name="sam-altman">main Sam Altman page</EntityLink>.
...
- **Vague language as hedge**: Uses "few thousand days" (5.5-14 year range), "AGI as we have traditionally understood it" (no clear definition provided)
