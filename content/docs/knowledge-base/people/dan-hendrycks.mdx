...
Hendrycks grew up in Missouri, where he graduated as valedictorian from Marshfield High School in 2014.[^rc-8fed] He received a B.S. with Honors in Computer Science from the University of Chicago in 2018.[^rc-8fed] He then enrolled in the Computer Science doctoral program at UC Berkeley, completing his PhD in 2022 under advisors Jacob Steinhardt and Dawn Song.[^rc-61bb][^rc-022d] His doctoral work was supported by an NSF Graduate Research Fellowship and an Open Philanthropy AI Fellowship.[^rc-61bb]
...
The organization has received general support grants from <EntityLink id="E521" name="coefficient-giving" >Open Philanthropy</EntityLink> in 2022 and 2023, as well as a grant of \$1,433,000 from Open Philanthropy to support its Philosophy Fellowship program.[^rc-1975][^rc-52e1][^rc-8825] As of early 2025, the Survival and Flourishing Fund (SFF) has provided additional funding — \$1.1 million to CAIS and \$1.6 million to the affiliated CAIS Action Fund — while Open Philanthropy grants to CAIS were not continuing at that time.[^rc-e259] A sister organization, the CAIS Action Fund (a 501(c)(4)), was formally launched in Washington D.C. in July 2024 and reported spending \$270,000 on federal lobbying in 2024.[^rc-991c]
