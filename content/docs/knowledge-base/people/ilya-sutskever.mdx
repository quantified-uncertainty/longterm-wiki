...
On November 17, 2023, the OpenAI board voted to remove <EntityLink id="E269" name="sam-altman">Sam Altman</EntityLink> as CEO, stating he had not been "consistently candid in his communications with the board."[^rc-4042] The board at the time consisted of Sutskever, Adam D'Angelo (CEO of Quora), Tasha McCauley, and Helen Toner (strategy director at Georgetown's Center for Security and Emerging Technology).[^rc-4042]
