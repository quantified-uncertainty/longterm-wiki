...
| **Primary Vehicle** | <EntityLink id="sff">Survival and Flourishing Fund</EntityLink> | S-process algorithmic allocation; \$34.33M distributed in 2025 round |
...
| **Primary Giving Vehicles** | <EntityLink id="sff">Survival and Flourishing Fund</EntityLink>, [Lightspeed Grants](https://lightspeedgrants.org/) |
...
For analysis of Tallinn's Anthropic investment, see <EntityLink id="anthropic-investors">Anthropic Investors</EntityLink>.
...
Tallinn is the primary funder of <EntityLink id="sff">SFF</EntityLink>, which has become one of the largest sources of AI safety funding:
...
| **Current Stake Value** | Estimated \$2-6B (conservative) to \$5-14B (optimistic) at \$350B valuation; see <EntityLink id="anthropic-investors">Anthropic Investors</EntityLink> for detailed modeling |
