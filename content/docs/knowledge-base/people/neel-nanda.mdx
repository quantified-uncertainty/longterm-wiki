...
[^3]: [A Mathematical Framework for Transformer Circuits (Elhage, N., Nanda, N., et al. (2021), Transformer Circuits Thread)](https://transformer-circuits.pub/2021/framework/index.html)
[^4]: [200 Concrete Open Problems in Mechanistic Interpretability (Nanda, N. (2022), LessWrong)](https://www.lesswrong.com/posts/LbrPTJ4fmABEdEnLf/200-concrete-open-problems-in-mechanistic-interpretability)
