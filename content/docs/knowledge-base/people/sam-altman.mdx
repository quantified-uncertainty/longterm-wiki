...
| **Influence Level** | Very High | Oversees company valued at <F e="openai" f="39d6868e" />; ChatGPT reached <F e="openai" f="599b42cc">100M</F> users faster than any product in history |
...
| **Key Controversy** | November 2023 Firing | Board cited lack of candor; reinstated after <F e="sam-altman" f="6783fa6c">95%</F> of employees threatened to quit |
| **Net Worth** | ≈<F e="sam-altman" f="7da0d60e">\$2.8 billion</F> | From venture investments (Reddit, Stripe, Helion); holds no OpenAI equity |
...
| 2012 | Loopt acquired | Sold to Green Dot Corporation for <F e="sam-altman" f="a73016c2">\$43 million</F> |
...
| **Companies Funded** | ≈<F e="sam-altman" f="c9b9b3d2">1,900</F> during tenure |
...
| **Notable Returns** | Reddit (9% stake pre-IPO, ≈\$1.4B value); Stripe (<F e="sam-altman" f="7a1f98d6">\$15K for 2%</F> in 2009) |
...
The organization was structured as a nonprofit with a stated mission to ensure artificial general intelligence benefits "all of humanity." Co-founders pledged <F e="openai" f="931278d9">\$1 billion</F>, though actual donations fell far short; by 2019, only \$130 million had been collected.
...
| November 20 | Employee letter | <F e="sam-altman" f="6783fa6c">738 of 770 employees</F> sign letter threatening to quit |
...
- Most of the announced \$1 billion in founding commitments never materialized; Musk provided nearly all early capital (<F e="elon-musk" f="d81eea20">\$38-44M</F> by 2018)
...
| August 2024 | Expanded lawsuit | Accused OpenAI of racketeering; claimed <F e="elon-musk" f="e766c30f">\$134.5B</F> in damages |
...
|---------|------|------------|------|
| Helion Energy | Nuclear fusion | <F e="sam-altman" f="0872e650">\$375 million</F> personal investment | Chairman |
...
| **Foundation stake** | ≈26% of OpenAI Group (<F e="openai" f="6ce1d805">≈\$130B</F> value) |
| **Microsoft stake** | ≈27% (<F e="openai" f="6ce1d805">≈\$135B</F> value) |
| **Profit caps** | Removed; unlimited investor returns now possible |
| **Altman equity** | None (controversial decision not to grant equity) |
| **Foundation commitment** | <F e="openai" f="6ce1d805">\$25 billion</F> for healthcare, disease research, AI resilience |
...
| <EntityLink id="ilya-sutskever">Ilya Sutskever</EntityLink> | Co-founder; departed May 2024 |
| Greg Brockman | Co-founder; President |
| <EntityLink id="microsoft">Microsoft</EntityLink> | Major investor (≈27% stake) |
