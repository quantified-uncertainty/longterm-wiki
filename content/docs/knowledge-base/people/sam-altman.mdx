...
| 2015 | OpenAI co-founded | Co-founded with <EntityLink id="E116" name="elon-musk">Elon Musk</EntityLink>, Greg Brockman, <EntityLink id="E163" name="ilya-sutskever">Ilya Sutskever</EntityLink>, and others |
...
- Dario and <EntityLink id="E90" name="daniela-amodei">Daniela Amodei</EntityLink> (former VP of Research and VP of Safety) described Altman's tactics as "gaslighting" and "psychological abuse" after leaving to found <EntityLink id="E22" name="anthropic">Anthropic</EntityLink>, according to Karen Hao's book *Empire of AI* ([Fortune](https://fortune.com/2025/06/20/openai-files-sam-altman-leadership-concerns-safety-failures-ai-lab/))
