...
<DataExternalLinks pageId="stuart-russell" client:load />
...
Founded in 2016 with a \$5.6M grant from <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> (then <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink>), CHAI focuses on:
