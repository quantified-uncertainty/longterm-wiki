...
Founded in 2016 with a \$5.6M grant from <EntityLink id="E552" name="open-philanthropy">Open Philanthropy</EntityLink> (now <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>), CHAI focuses on:
...
- **Provable safety properties**: <EntityLink id="E483" name="formal-verification">Formal verification</EntityLink> where possible
- **Human oversight**: Systems that remain under human control
- **Cautious development**: Don't deploy systems we don't understand
- **<EntityLink id="E171" name="international-coordination">International coordination</EntityLink>**: Need global agreements on safe AI development
...
- Influenced <EntityLink id="E127" name="eu-ai-act">EU AI Act</EntityLink> discussions
