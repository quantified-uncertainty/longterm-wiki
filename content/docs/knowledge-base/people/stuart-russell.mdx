...
Founded in 2016 with a \$5.6M grant from <EntityLink id="E552">Open Philanthropy</EntityLink> (now <EntityLink id="E521">Coefficient Giving</EntityLink>), CHAI focuses on:
