...
Russell founded CHAI in 2016 at UC Berkeley, initially with a grant of \$5,555,550 over five years recommended by the Open Philanthropy Project (now <EntityLink id="E521">Coefficient Giving</EntityLink>) to Good Ventures.[^rc-9a30] As of 2022, CHAI had received over \$17.1 million in cumulative funding from Open Philanthropy, approximately \$780,000 from the Survival and Flourishing Fund, and over \$120,000 from <EntityLink id="E517">Centre for Effective Altruism</EntityLink>.[^rc-f271] A 2021 Open Philanthropy grant of \$11,955,246 over five years enabled CHAI to expand its research and student training.[^rc-bb33]
...
In 2017, Russell collaborated with the Future of Life Institute to produce the short film *Slaughterbots*, which was presented to a UN meeting on the Convention on Certain Conventional Weapons and has been viewed more than 70 million times.[^rc-50e2] He also co-authored a follow-up response with <EntityLink id="E433">Max Tegmark</EntityLink> and Toby Walsh, "Why We Really Should Ban Autonomous Weapons: A Response," published in IEEE Spectrum on August 3, 2015.[^rc-cf82]
