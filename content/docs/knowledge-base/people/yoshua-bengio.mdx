...
Yoshua Bengio is one of the three "Godfathers of AI" who won the 2018 Turing Award alongside <EntityLink id="E149" name="geoffrey-hinton">Geoffrey Hinton</EntityLink> and <EntityLink id="E582" name="yann-lecun">Yann LeCun</EntityLink> for foundational work in deep learning. His transformation from pure capabilities researcher to AI safety advocate represents one of the most significant shifts in the field, bringing immense credibility to AI risk concerns.
...
- Advocates for <EntityLink id="E171" name="international-coordination">international coordination</EntityLink> on <EntityLink id="E608" name="ai-governance">AI governance</EntityLink>
