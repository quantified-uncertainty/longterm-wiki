...
**Gwern Branwen** is a pseudonymous independent researcher and writer who maintains gwern.net, a comprehensive website featuring long-form essays on artificial intelligence, psychology, statistics, genetics, and rationality.[^2][^3] Active on English Wikipedia since January 2004 with over 90,000 edits,[^4] Gwern has become a prominent figure in rationalist and <EntityLink id="E538">LessWrong</EntityLink> communities, though his mainstream influence in AI/ML research remains contested.
