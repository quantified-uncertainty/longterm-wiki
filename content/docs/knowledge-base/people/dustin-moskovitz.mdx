...
flowchart TD
    ...
    AI --> RESE<EntityLink id="E25" name="arc">ARC</EntityLink>H[Research Orgs<br/><EntityLink id="E202" name="miri">MIRI</EntityLink>, <EntityLink id="E247" name="redwood">Redwood Research</EntityLink>, <EntityLink id="E47" name="cais">CAIS</EntityLink>]
    AI --> EVALS[Evaluations<br/>ARC/METR, Epoch]
    AI --> GOV[Governance<br/><EntityLink id="E153" name="govai">GovAI</EntityLink>, RAND]
