...
**Anthropic stake not included**: Most net worth estimates likely do not fully reflect Moskovitz's <EntityLink id="anthropic-investors">Anthropic stake</EntityLink>, estimated at 0.8-2.5% of the company (\$3-9B at Anthropic's <F e="anthropic" f="valuation-nov-2025">\$350B</F> January 2026 valuation). He participated in both seed and Series A rounds (estimated \$20-50M invested). In November 2025, he moved a \$500M portion of this stake into a nonprofit vehicle. If this stake were fully valued, his total wealth would be substantially higher than reported figures suggest.
