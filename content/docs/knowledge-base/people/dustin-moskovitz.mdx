...
| **Primary Vehicle** | <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> | Formerly <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> |
...
*Annual Giving figures are grants recommended by <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> (formerly <EntityLink id="coefficient-giving" >Open Philanthropy</EntityLink>), funded primarily by Good Ventures. Figures from Open Phil annual reports use approximate language ("over \$X million"); values shown are midpoint estimates. Sources: [Coefficient Giving annual reports](https://coefficientgiving.org/research/), [ProPublica 990s](https://projects.propublica.org/nonprofits/organizations/461008520).*
...
In December 2010, Dustin Moskovitz and Cari Tuna signed the <EntityLink id="giving-pledge">Giving Pledge</EntityLink>, the philanthropic commitment launched by Warren Buffett and Bill and Melinda Gates asking billionaires to give away at least half their wealth.[^rc-17ba] At the time of signing, Tuna was reportedly 25 and Moskovitz was 26, making them among the youngest signatories in the Pledge's history.[^rc-ce92] (See the <EntityLink id="giving-pledge">Giving Pledge</EntityLink> page for analysis of historical fulfillment rates and criticisms.)
...
| **2017** | Open Philanthropy reportedly becomes independent LLC[^rc-46ee] |
| **2019** | Reportedly shortened to "Open Philanthropy"[^rc-46ee] |
...
| **<EntityLink id="metr">METR</EntityLink>** | reportedly \$10M+ | Evaluations | reportedly \$265K (2022); reportedly \$10M to RAND/METR Canary project[^rc-ce92] |
| **<EntityLink id="epoch-ai">Epoch AI</EntityLink>** | reportedly \$5M+ | AI forecasting | Multiple grants[^rc-ce92] |
...
| **Coefficient Connection** | Holden Karnofsky (Coefficient co-founder) reportedly joined Anthropic in early 2025[^rc-73d2] |
...
| **Mid-2010s** | Began funding AI safety through what was then Coefficient (later Open Philanthropy)[^rc-ce92] |
