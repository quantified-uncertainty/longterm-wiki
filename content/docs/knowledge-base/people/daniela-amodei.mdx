...
<EntityLink id="E90" name="daniela-amodei">Daniela Amodei</EntityLink> is Co-Founder and President of <EntityLink id="E22" name="anthropic">Anthropic</EntityLink>, an AI safety company she co-founded in <FBF entity="sid_mK9pX3rQ7n" property="founded-date">January 2021</FBF>[^fact:f_8kX2pQ7mNr] with her brother <EntityLink id="E91" name="dario-amodei">Dario Amodei</EntityLink> and several other former <EntityLink id="E218" name="openai">OpenAI</EntityLink> employees who departed OpenAI in late 2020.[^rc-ef89] As President, she oversees Anthropic's business operations, commercial strategy, enterprise partnerships, and policy engagement. <EntityLink id="E91" name="dario-amodei">Dario Amodei</EntityLink> serves as CEO and leads the technical research side of the organization.
...
As of February 2026, Anthropic's post-money valuation stands at <FBF entity="sid_mK9pX3rQ7n" property="valuation">\$380 billion</FBF> following a Series G round,[^rc-6cce] and the company reports a run-rate revenue of <FBF entity="sid_mK9pX3rQ7n" property="revenue" asOf="2026-02">\$14 billion</FBF>.[^rc-6cce] Approximately 85% of Anthropic's revenue derives from business customers.[^rc-f3fe]
...
Amodei co-founded <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> in <FBF entity="sid_mK9pX3rQ7n" property="founded-date">January 2021</FBF>[^fact:f_8kX2pQ7mNr] alongside <EntityLink id="E91" name="dario-amodei">Dario Amodei</EntityLink> and several other former OpenAI colleagues, after the founding team departed OpenAI in December 2020.[^rc-ef89] She serves as President and as a member of Anthropic's Board of Directors.[^rc-543c]

## Professional Background

| Role | Organization | Period | Notes |
|------|-------------|--------|-------|
| Co-Founder & President; Board Member | <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> | Jan 2021–present | Oversees commercial operations, enterprise partnerships, fundraising |
...
| Series G | Feb 2026 | \$30B | GIC, Coatue, D.E. Shaw Ventures, Founders Fund, ICONIQ, MGX | <FBF entity="sid_mK9pX3rQ7n" property="valuation">\$380B</FBF> |
...
Anthropic's business customer base grew from under 1,000 to more than 300,000 over two years, with approximately 85% of revenue derived from business customers.[^rc-f3fe] Run-rate revenue grew from approximately <FBF entity="sid_mK9pX3rQ7n" property="revenue" asOf="2024-12">\$1 billion</FBF> at the start of 2025[^rc-7ff9] to <FBF entity="sid_mK9pX3rQ7n" property="revenue" asOf="2026-02">\$14 billion</FBF> by February 2026.[^rc-6cce]
...
These criticisms are directed at Anthropic as an institution rather than at <EntityLink id="E90" name="daniela-amodei">Daniela Amodei</EntityLink> specifically. Her responses to them — beyond the general public statements cited above — are not separately documented in public sources.
...
| Policy documents | <R id="sid_icE7fLiJWG">Anthropic's Responsible Scaling Policy</R> | Framework development |
