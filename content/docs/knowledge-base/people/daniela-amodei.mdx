...
Amodei co-founded <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> in December 2020 alongside <EntityLink id="E91" name="dario-amodei">Dario Amodei</EntityLink> and several other former OpenAI colleagues.[^rc-ef89] She serves as President and as a member of Anthropic's Board of Directors.[^rc-543c]
