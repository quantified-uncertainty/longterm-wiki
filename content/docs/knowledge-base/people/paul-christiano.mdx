...
|-----------|---------------|---------|
| <EntityLink id="E583" name="adversarial-training">Adversarial Training</EntityLink> | Two AIs argue for different positions | Deployed at <R id="1000c5dea784ef64">Anthropic</R> |
...
- **<R id="2e0c662574087c2a"><EntityLink id="E439" name="alignment">AI Alignment</EntityLink> Forum</R>**: Primary venue for technical alignment discourse
