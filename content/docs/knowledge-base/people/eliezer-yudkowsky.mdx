...
clusters: ["ai-safety"]
---
import {DataInfoBox, Section, DisagreementMap, Backlinks, DataExternalLinks, EntityLink} from '@components/wiki';
...
<DataExternalLinks pageId="eliezer-yudkowsky" client:load />

<DataInfoBox entityId="eliezer-yudkowsky" />
...
<Backlinks client:load entityId="eliezer-yudkowsky" />
