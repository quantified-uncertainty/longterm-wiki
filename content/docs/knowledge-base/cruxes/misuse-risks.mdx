...
|-----------|------------|----------|
| **Overall Severity** | High | AI misuse incidents rose 8x since 2022; <EntityLink id="E96">deepfakes</EntityLink> responsible for 6.5% of all fraud ([AI Incident Database](https://incidentdatabase.ai/)) |
| **Current Uplift Evidence** | Mixed | RAND 2024 <EntityLink id="E42">bioweapons</EntityLink> study found no significant uplift; <EntityLink id="E218">OpenAI</EntityLink> cyber CTF scores improved 27% to 87% in 4 months ([RAND](https://www.rand.org/pubs/research_reports/RRA2977-2.html), [OpenAI](https://openai.com/index/strengthening-cyber-resilience/)) |
...
| **<EntityLink id="E102">Disinformation</EntityLink> Risk** | High | Deepfake fraud up 2,137% since 2022; human detection accuracy only 24.5% ([UNESCO](https://www.unesco.org/en/articles/deepfakes-and-crisis-knowing)) |
...
| <EntityLink id="E538">LessWrong</EntityLink> | [lesswrong.com](https://www.lesswrong.com/posts/DJB82jKwgJE5NsWgT/some-cruxes-on-impactful-alternatives-to-ai-policy-work) |
...
- **Governance Infrastructure**: <EntityLink id="E464">Compute monitoring</EntityLink> systems deployed, international agreements on <EntityLink id="E35">autonomous weapons</EntityLink> 
