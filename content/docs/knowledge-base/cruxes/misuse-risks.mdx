...
| **Current Uplift Evidence** | Mixed | RAND 2024 <EntityLink id="bioweapons">bioweapons</EntityLink> study found no significant uplift; <EntityLink id="openai">OpenAI</EntityLink> cyber CTF scores improved 27% to 76% in 3 months ([RAND](https://www.rand.org/pubs/research_reports/RRA2977-2.html), [OpenAI](https://openai.com/index/strengthening-cyber-resilience/)) |
