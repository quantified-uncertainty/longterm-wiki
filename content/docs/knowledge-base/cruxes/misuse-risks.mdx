...
---
import {Crux, CruxList, DataInfoBox, Backlinks, R, EntityLink, DataExternalLinks, Mermaid} from '@components/wiki';

<DataExternalLinks pageId="misuse-risks" client:load />
...
| **Current Uplift Evidence** | Mixed | RAND 2024 <EntityLink id="bioweapons">bioweapons</EntityLink> study found no significant uplift; <EntityLink id="openai">OpenAI</EntityLink> cyber CTF scores improved 27% to 87% in 4 months ([RAND](https://www.rand.org/pubs/research_reports/RRA2977-2.html), [OpenAI](https://openai.com/index/strengthening-cyber-resilience/)) |
...
| **<EntityLink id="disinformation">Disinformation</EntityLink> Risk** | High | Deepfake fraud up 2,137% since 2022; human detection accuracy only 24.5% ([UNESCO](https://www.unesco.org/en/articles/deepfakes-and-crisis-knowing)) |
...
In cybersecurity, [OpenAI's threat assessment](https://openai.com/index/strengthening-cyber-resilience/) (December 2025) notes that AI cyber capabilities improved from 27% to 87% on capture-the-flag benchmarks between August and December 2025, with [GPT-5.2-Codex](https://openai.com/index/introducing-gpt-5-2-codex/) achieving the highest scores. According to [Deepstrike's 2025 analysis](https://deepstrike.io/blog/ai-cybersecurity-threats-2025), 68% of cyber threat analysts report AI-generated phishing is harder to detect than ever, with a 703% increase in credential phishing attacks in H2 2024. Deepfake incidents grew from 500,000 files in 2023 to a projected 8 million in 2025 ([Keepnet Labs](https://keepnetlabs.com/blog/deepfake-statistics-and-trends)), with businesses losing an average of \$100,000 per deepfake-related fraud incident and the [\$25.6 million Hong Kong deepfake fraud case](https://sqmagazine.co.uk/deepfake-statistics/) serving as a landmark incident.
...
flowchart TD
    ...
    subgraph Domains["Risk Domains"]
        ...
        CYBER[Cyberweapons<br/>CTF: 27% to 87%]
