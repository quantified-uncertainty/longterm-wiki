...
|----------|-----------------|--------------|---------------------|-------------|
| AI Detection | \$100M+ annually | 85-95% (academic) | Limited | <R id="sid_KmSAPmjTZI">OpenAI</R>, <R id="sid_yHiRsUbn03">Originality.ai</R> |
| Content Provenance | \$50M+ annually | N/A (adoption metric) | Early stage | <R id="sid_5WloFhHKVS">Adobe</R>, <R id="sid_9Pe4EogvPz">Microsoft</R> |
| Watermarking | \$25M+ annually | Variable | Pilot programs | <R id="sid_z2P9fh4IAW">Google DeepMind</R> |
| Verification Systems | \$75M+ annually | Context-dependent | Research phase | <R id="sid_lZJh5C8xHb">DARPA</R>, VERA-MH (domain-specific) |
...
The <R id="sid_cMRsnGFGws">shallow review of technical AI safety (2024)</R> notes that increasing reasoning depth can raise latency and energy consumption, posing challenges for real-time applications. Scaling alignment mechanisms to larger models or eventual AGI systems remains an open research question.
