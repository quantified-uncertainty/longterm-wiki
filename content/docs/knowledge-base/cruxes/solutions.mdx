...
| <EntityLink id="E252" name="responsible-scaling-policies">Responsible Scaling Policies</EntityLink> | Contested (see analysis below) | Indirect compliance costs | Deployed; structural critiques active | Threshold specification, external accountability |
