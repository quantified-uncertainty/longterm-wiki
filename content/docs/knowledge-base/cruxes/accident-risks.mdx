...
|-------------|----------|------------|----------|-------------------|-------------|
| **Mesa-optimization emergence** | Critical | 15-55% | 2-5 years | Theoretical | <R id="c2babc67e1fad58b"><EntityLink id="E129" name="evan-hubinger">Evan Hubinger</EntityLink></R>, MIRI researchers |
