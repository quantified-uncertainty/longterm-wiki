...
|----------|-------------|-------------|----------------------|
| **Mesa-optimizers likely in advanced systems** | 35-55% | <R id="MmQ2ZmY5Nz"><EntityLink id="E129" name="evan-hubinger">Evan Hubinger</EntityLink></R>, some <EntityLink id="E202" name="miri">MIRI</EntityLink> researchers | Prioritize inner alignment research, interpretability for detecting mesa-optimizers |
