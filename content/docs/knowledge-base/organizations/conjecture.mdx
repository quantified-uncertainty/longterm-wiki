...
<FBRecordTable entity="0u4J70VqFY" collection="research-areas" title="Research Areas" columns={["name", "description", "started"]} />
...
<FBRecordTable entity="0u4J70VqFY" collection="key-persons" title="Key People" columns={["person", "title", "start", "is_founder"]} />
