...
<KBRecordTable entity="conjecture" collection="research-areas" title="Research Areas" columns={["name", "description", "started"]} />
...
<KBRecordTable entity="conjecture" collection="key-persons" title="Key People" columns={["person", "title", "start", "is_founder"]} />
