...
[^1]: General background on defense and military AI history — DARPA founding, DART deployment, Third Offset Strategy. Drawn from multiple defense policy sources.
[^2]: Project Maven program documentation and expansion — DoD Algorithmic Warfare Cross-Functional Team records (primary).
[^3]: General background on Maven Smart System operational use, drawing on conflict journalism reporting covering deployments in Iran, Iraq, Syria, Ukraine, and Yemen, 2024–2025.
[^4]: GAMECHANGER program — Brookings Institution case study on DoD business AI adoption.
[^5]: Defense Innovation Unit elevation (2023) — DoD organizational announcements (primary).
[^6]: General background on U.S. military AI shift to operational use in 2025, drawn from military news coverage.
[^7]: Replicator Initiative — DoD official announcements on autonomous systems fielding (primary).
[^8]: General background on Anthropic–Pentagon discussions and <EntityLink id="E91">Dario Amodei</EntityLink> public statements, drawing on reporting around early 2026. Claims should be read as reported rather than confirmed.
[^9]: General background on TurbineOne contract and Palantir/Anduril revenue figures, drawn from 2025 defense contracting records and secondary reporting.
[^10]: U.S. Navy Overmatch initiative — service program documentation (primary).
[^11]: General background on the Thunderforge program, drawn from DoD/Anduril/Microsoft announcements.
[^12]: General background on PLA intelligentized warfare doctrine, drawn from PLA Daily and academic analyses.
[^13]: General background on PLA DeepSeek and generative AI adoption, drawn from early-2025 reporting and PLA Daily (April 2023).
[^14]: UK Dstl research activities — MOD and Dstl program documentation (primary).
[^15]: General background on IDF Lavender and Gospel systems, drawn from investigative reporting 2024–2025.
[^16]: UN General Assembly Resolution 79/239 (December 24, 2024) — UN documentation (primary).
[^17]: General background on DoD Directive 3000.09 and black-box system acknowledgments, drawn from Pentagon and Army records.
[^18]: Defense AI market projections — Mordor Intelligence market research (analyst estimates; treat as indicative).
[^19]: Missy Cummings public statements on AI unreliability — named-expert commentary cited via interviews and op-eds.
[^20]: General background on Gaza and Ukraine AI targeting failures, drawn from advocacy-organization analyses and journalism 2024–2025.
[^21]: ASU Center for Human, AI, and Robot Teaming (Nancy Cook, Director) — overtrust research (primary institutional source).
[^22]: General background on non-state drone deployments, citing aggregated case documentation (400+ cases).
[^23]: General background on commentary from Harvard Medical School researchers on military AI ethics.
