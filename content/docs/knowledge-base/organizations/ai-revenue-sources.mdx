...
---
import {DataInfoBox, Mermaid, EntityLink, R, SquiggleEstimate, F} from '@components/wiki';
...
**1. Revenue growth is real and unprecedented.** OpenAI went from \$200M to <F e="openai" f="microsoft-total-investment">\$13B</F> in two years. Anthropic went from \$87M to <F e="anthropic" f="revenue-arr-2025">\$9B</F> ARR in 18 months. These are among the fastest revenue trajectories in technology history—faster than Google, Facebook, or AWS at comparable stages. [Visual Capitalist](https://www.visualcapitalist.com/charted-the-soaring-revenues-of-ai-companies-2023-2025/)
