...
subcategory: finance
---
import { DataInfoBox, Backlinks, Mermaid, EntityLink, R, SquiggleEstimate } from '@components/wiki';
...
Consumer subscriptions were OpenAI's primary revenue source through 2024 (~85% of ARR), but API revenue has now surpassed it. ChatGPT Plus has strong retention: 89% after one quarter, ~74% beyond nine months. [Sacra](https://sacra.com/c/openai/) <EntityLink id="anthropic">Anthropic</EntityLink> earns ~80% from enterprise/developer workloads, making consumer subscriptions a smaller share.

### 5. API and Inference Revenue (≈\$15B+)

<EntityLink id="openai">OpenAI</EntityLink>'s API revenue surged to over **\$1 billion per month**, eclipsing ChatGPT as the growth engine. Reasoning token usage increased 320x YoY. [WebProNews](https://www.webpronews.com/openai-api-surges-to-1b-monthly-revenue-eclipsing-chatgpt-growth/)

<EntityLink id="anthropic">Anthropic</EntityLink>'s API revenue is expected to hit **\$3.8 billion** in 2025—reportedly doubling OpenAI's \$1.8B in API revenue for the same period. [Tom's Hardware](https://www.tomshardware.com/tech-industry/anthropic-targets-gigantic-usd26-billion-in-revenue-by-the-end-of-2026-eye-watering-sum-is-more-than-double-openais-projected-2025-earnings) Major API customers include Cursor and GitHub Copilot.
...
|---------|------|-------------|-------------|-----------|
| **<EntityLink id="openai">OpenAI</EntityLink>** | \$13B | \$29.4B | \$125B by 2029 | \$500B (targeting \$750-830B) |
...
- <EntityLink id="anthropic-valuation">Anthropic Valuation Analysis</EntityLink> — Company-specific financial analysis
- <EntityLink id="anthropic-investors">Anthropic (Funder)</EntityLink> — EA-aligned capital analysis
- <EntityLink id="openai">OpenAI</EntityLink> — Primary AI revenue generator
- <EntityLink id="economic-disruption">Economic Disruption</EntityLink> — Labor market impacts
- <EntityLink id="concentration-of-power">Concentration of Power</EntityLink> — Market concentration dynamics
- <EntityLink id="racing-dynamics">Racing Dynamics</EntityLink> — Competitive pressures
