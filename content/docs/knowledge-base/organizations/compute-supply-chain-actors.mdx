...
[^1]: Semiconductor Industry Association and various industry analyses - Market share and supply chain concentration data for AI compute, including TSMC, NVIDIA, ASML, SK Hynix, and cloud hyperscaler positions, drawn from publicly available industry reports and company disclosures (2022–2024)

[^2]: Yoshua Bengio - Compute governance as an AI safety lever; arguments that chip supply constraints represent a meaningful mechanism for slowing or redirecting dangerous AI development, articulated in public statements and policy submissions (2023–2024)

[^3]: Andrew Critch - Multipolar failure risks in AI development; analysis of how fragmented, miscoordinated supply chains could enable uncoordinated AI scaling without safety checks, from AI safety research publications and talks

[^4]: Keith Oliver, Booz Allen Hamilton - Origin of the term "supply chain management" (1982); historical development of semiconductor supply chain economics under Moore's Law and the fabless design model from the 1990s onward