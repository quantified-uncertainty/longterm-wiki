...
CAIS is legally structured as a nonprofit. Its primary disclosed funder is <EntityLink id="E521" name="coefficient-giving" >Open Philanthropy</EntityLink>, which has made grants to CAIS as part of its AI safety grantmaking portfolio.{/* NEEDS CITATION */} Exact annual budget figures are not publicly confirmed by CAIS; estimates of approximately \$5M annually have circulated but have not been verified against IRS Form 990 filings, which would be the authoritative source for nonprofit financials.

## Funding

CAIS's primary disclosed funder is <EntityLink id="E521" name="coefficient-giving" >Open Philanthropy</EntityLink>, a philanthropic organization closely associated with the effective altruism movement.{/* NEEDS CITATION */} This funding relationship is material context for interpreting the organization's research agenda: Open Philanthropy has historically prioritized long-run catastrophic and extinction-level AI risk over near-term AI harms, and CAIS's framing broadly reflects this prioritization.
...
The common thread across CAIS-adjacent organizations is EA-aligned funding, primarily from <EntityLink id="E521" name="coefficient-giving" >Open Philanthropy</EntityLink>, which has led to criticisms that the AI safety field as constituted reflects the priorities of a relatively narrow philanthropic and ideological community rather than a broad scientific consensus.
...
- **Funders**: <EntityLink id="E521" name="coefficient-giving" >Open Philanthropy</EntityLink>
