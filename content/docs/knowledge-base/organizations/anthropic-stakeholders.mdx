...
All seven co-founders have pledged to donate 80% of their equity. [Fortune](https://fortune.com/2026/01/27/anthropic-billionaire-cofounders-ceo-dario-amodei-giving-away-80-percent-of-wealth-fighting-inequality-ai-revolution/) At current valuations, that's <KBF entity="anthropic" property="founder-pledge-total">\$43–64B</KBF> if fully honored — derived from <KBF entity="anthropic" property="founder-equity-value">\$53–80B</KBF> in combined founder equity.
...
| Series G | Feb 2026 | <KBF entity="anthropic" property="funding-round" /> | <KBF entity="anthropic" property="valuation" /> | GIC, Coatue (co-leads) |
...
**Google** has invested <KBF entity="anthropic" property="google-total-invested" /> across 3 rounds for approximately <KBF entity="anthropic" property="equity-stake-percent">~14%</KBF> of equity. **Amazon** has invested <KBF entity="anthropic" property="amazon-total-invested" /> and serves as Anthropic's primary cloud partner; its exact stake is undisclosed.
