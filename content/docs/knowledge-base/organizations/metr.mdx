...
| **Founder & CEO** | <R id="f895b1f8c1806c5e"><EntityLink id="E39" name="beth-barnes">Beth Barnes</EntityLink></R> (formerly OpenAI, DeepMind) |
...
| **MALT Dataset** | October 2025 | 10,919 reviewed transcripts for studying <EntityLink id="E253" name="reward-hacking">reward hacking</EntityLink> and <EntityLink id="E270" name="sandbagging">sandbagging</EntityLink>; best monitors achieve 0.96 AUROC for detecting reward hacking | <R id="3ee11b82b7e1fd68">metr.org</R> |
...
| **Anthropic** | <EntityLink id="E252" name="responsible-scaling-policies">Responsible Scaling Policy</EntityLink> | ASL threshold assessments, independent verification |
