...
| **Anthropic** | <EntityLink id="E461" name="responsible-scaling-policies">Responsible Scaling Policy</EntityLink> | ASL threshold assessments, independent verification |
