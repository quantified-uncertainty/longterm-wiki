...
clusters:
  ...
  - governance
---
import { DataInfoBox, DisagreementMap, KeyQuestions, Section, R, EntityLink, Mermaid } from '@components/wiki';
...
| **Notable Staff** | <EntityLink id="ajeya-cotra">Ajeya Cotra</EntityLink> (joined late 2025, formerly <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> senior advisor) |
