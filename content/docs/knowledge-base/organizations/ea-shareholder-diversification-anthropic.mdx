...
| **Current AI safety funding** | \$120-150M/year (170-470x smaller) |
...
The effective altruism ecosystem faces an extraordinary concentration risk: an estimated \$27-76B in risk-adjusted EA-aligned capital is tied to a single private company, while total annual EA funding is approximately \$120-150M/year. [EA Forum](https://forum.effectivealtruism.org/posts/rRBaP7YbXfZibSn3C/front-load-giving-because-of-anthropic-donors) This represents the largest single-asset concentration in philanthropic history, and it is almost entirely illiquid.
...
| Employee pledges + matching (in DAFs) | \$20-40B | High — legally bound |
...
| **Total risk-adjusted** | **\$27-76B** | Wide range reflects cause allocation uncertainty |

No prudent financial strategy would hold 95%+ of assets in a single illiquid position. Yet this is effectively the EA ecosystem's current situation with respect to its largest pending capital source.
...
**Value drift risk.** As <EntityLink id="E406">Anthropic (Funder)</EntityLink> documents, the fraction of employees with "EA-ish perspectives" is decreasing among newer hires. Delayed liquidity means delayed giving, and delayed giving increases the chance that donors shift cause allocation. [EA Forum](https://forum.effectivealtruism.org/posts/rRBaP7YbXfZibSn3C/front-load-giving-because-of-anthropic-donors)
...
| **Giving Pledge fulfillment** | Only 36% of deceased pledgers met the 50% giving threshold. Original pledgers' wealth grew 283% while giving lagged. [IPS](https://ips-dc.org/report-giving-pledge-at-15/) |
...
**Scale already achieved:** An estimated \$20-40B is already in DAFs through Anthropic's employee matching program—historically 3:1 at 50% of equity, now reduced to 1:1 at 25% for new hires. See <EntityLink id="E412">Anthropic Pre-IPO DAF Transfers</EntityLink> for detailed analysis.
...
20% of \$27-76B is approximately \$5-15B. Even achieving the lower end would represent a transformative injection into the EA ecosystem—roughly 30-100x current annual AI safety funding.
...
| Capital Source | Before | After | Loss |
|----------------|--------|-------|------|
| Founder equity (80% pledged) | \$43-64B | \$9-13B | \$34-51B |
| EA investor stakes | \$5-16B | \$1-3B | \$4-13B |
| Employee pledges + matching | \$20-40B | \$4-8B | \$16-32B |
| **Total EA capital** | **\$27-76B** | **\$5-15B** | **\$20-60B** |
...
| GiveWell | Global health donation advising | \$1B+ annually |
| Senterra Funders | Animal welfare advising | Emerging |
