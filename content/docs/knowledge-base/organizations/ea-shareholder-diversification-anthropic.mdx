...
| Event | Lesson |
|-------|--------|
| **FTX collapse (2022)** | \$500M Anthropic stake liquidated for \$1.34B (2.7x), but proceeds went to creditors, not EA. Had FTX survived, that stake would be worth \≈\$27B today. See <EntityLink id="E696">FTX Collapse Lessons</EntityLink> for detailed analysis. [CNBC](https://www.cnbc.com/2024/03/25/ftx-estate-sells-majority-stake-in-startup-anthropic-for-884-million.html) |
...
| **Value of information** | Deploying some capital now reveals <EntityLink id="E695">EA ecosystem absorption capacity</EntityLink> |
...
| <EntityLink id="E695">EA ecosystem absorption capacity</EntityLink> | \$2-15B/year | Constrains useful deployment rate |
