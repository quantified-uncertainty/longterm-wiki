...
:::note[Page Scope]
This page analyzes diversification strategies for EA-aligned Anthropic shareholders. For the underlying capital estimates, see <EntityLink id="anthropic-investors">Anthropic (Funder)</EntityLink>. For IPO timeline, see <EntityLink id="anthropic-ipo">Anthropic IPO</EntityLink>. For pre-IPO DAF transfer mechanics, see <EntityLink id="anthropic-pre-ipo-daf-transfers">Anthropic Pre-IPO DAF Transfers</EntityLink>. For interventions targeting founder pledge fulfillment, see <EntityLink id="anthropic-pledge-enforcement">Anthropic Founder Pledge Interventions</EntityLink>.
...
At <EntityLink id="anthropic">Anthropic</EntityLink>'s <F e="anthropic" f="valuation">\$380B</F> valuation (Series G, February 2026), the EA-aligned capital breaks down as follows: [Anthropic](https://www.anthropic.com/news/anthropic-raises-30-billion-series-g-funding-380-billion-post-money-valuation)
...
| <EntityLink id="jaan-tallinn">Jaan Tallinn</EntityLink> stake | \$2-6B (conservative) | High — strong AI safety track record |
| <EntityLink id="dustin-moskovitz">Dustin Moskovitz</EntityLink> stake | \$3-9B | Very high — \$500M already transferred |
| **Total risk-adjusted** | **\$27-76B** | Discounted from \$68-119B gross for cause allocation probability (only 2/7 founders EA-aligned) and pledge fulfillment risk. See <EntityLink id="anthropic-investors">Anthropic (Funder)</EntityLink> for methodology. |
...
**Scale already achieved:** An estimated \$20-40B is already in DAFs through Anthropic's employee matching program—historically 3:1 at 50% of equity, now reduced to 1:1 at 25% for new hires. See <EntityLink id="anthropic-pre-ipo-daf-transfers">Anthropic Pre-IPO DAF Transfers</EntityLink> for detailed analysis, including time-sensitive employee tax considerations (ISOs, AMT, 83(b) elections, QSBS eligibility) that create urgency around the transfer timing.
...
**Potential buyers:**
- Good Ventures / <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> (Moskovitz's vehicle)
- Purpose-built EA investment vehicles
- <EntityLink id="longview-philanthropy">Longview Philanthropy</EntityLink> or similar advisors facilitating transfers
...
| **Value of information** | Deploying some capital now reveals <EntityLink id="ea-funding-absorption-capacity">EA ecosystem absorption capacity</EntityLink> |
...
Note: "Before" column shows gross figures for rows 1-3; the total applies the same risk-adjustment (cause allocation, pledge fulfillment) as the overview table. See <EntityLink id="anthropic-investors">Anthropic (Funder)</EntityLink> for methodology.
...
|--------------|------|-----------------|
| <EntityLink id="longview-philanthropy">Longview Philanthropy</EntityLink> | Donor advising for high-net-worth EA donors | \$60M+ advised in 2025; "involves a non-zero amount of advising Anthropic folks" [EA Forum](https://forum.effectivealtruism.org/posts/H8SqwbLxKkiJur3c4/preparing-for-a-flush-future-work-giving-and-conduct) |
| <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> | EA grantmaking infrastructure | Manages Moskovitz's philanthropic capital |
| <EntityLink id="sff">Survival and Flourishing Fund</EntityLink> | AI safety regranting | Tallinn-funded; \$34M disbursed in 2025 |
...
| <EntityLink id="ea-funding-absorption-capacity">EA ecosystem absorption capacity</EntityLink> | \$2-15B/year | Constrains useful deployment rate |
