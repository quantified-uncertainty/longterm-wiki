...
| <EntityLink id="E577" name="jaan-tallinn">Jaan Tallinn</EntityLink> stake | \$2-6B (conservative) | High — strong AI safety track record |
| <EntityLink id="E436" name="dustin-moskovitz">Dustin Moskovitz</EntityLink> stake | \$3-9B | Very high — \$500M already transferred |
| **Total risk-adjusted** | **\$27-76B** | Discounted from \$68-119B gross for cause allocation probability (only 2/7 founders EA-aligned) and pledge fulfillment risk. See <EntityLink id="E406" name="anthropic-investors">Anthropic (Funder)</EntityLink> for methodology. |
