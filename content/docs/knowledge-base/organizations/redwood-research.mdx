...
<FBRecordTable entity="dwMzc9WzPa" collection="key-persons" title="Key People" columns={["person", "title", "start", "is_founder"]} />
...
<FBRecordTable entity="dwMzc9WzPa" collection="research-areas" title="Research Areas" columns={["name", "description", "started"]} />
