...
|------|--------|--------|---------|--------|
| 2021 | <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> | \$9.42M | General support | [OP Grants](https://www.openphilanthropy.org/grants/redwood-research-general-support/) |
