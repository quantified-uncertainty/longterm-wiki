...
ControlAI was founded in 2023 by Andrea Miotti, emerging as an offshoot of Conjecture, an AI startup led by <EntityLink id="connor-leahy">Connor Leahy</EntityLink>.[^cr-f239] The organization was established in the lead-up to the AI Safety Summit at Bletchley Park, UK, where it made a notable splash by hiring a blimp to fly over the summit as part of its advertising campaigns.[^cr-e36a]
...
- **November-December 2023**: Opposed exemptions for foundation models in the <EntityLink id="eu-ai-act">EU AI Act</EntityLink>[^cr-fa1a]
...
- The Times (December 6, 2024) on <EntityLink id="scheming">scheming</EntityLink> ChatGPT[^rc-8de4]
