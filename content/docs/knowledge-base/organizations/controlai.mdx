...
ControlAI has positioned itself in opposition to <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink>'s approach to AI safety, arguing that the funder's strategy is "undemocratic" and centralizes control in a small group of "trusted" actors.[^rc-ff6b] The organization's "Direct Institutional Plan" dedicates over 500 words to criticizing Coefficient Giving (now <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink>) as the main funder in AI safety, highlighting:
