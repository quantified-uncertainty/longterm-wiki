...
ControlAI has positioned itself in opposition to <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink>'s approach to AI safety, arguing that the funder's strategy is "undemocratic" and centralizes control in a small group of "trusted" actors.[^36] The organization's "Direct Institutional Plan" dedicates over 500 words to criticizing Open Philanthropy (now <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink>) as the main funder in AI safety, highlighting:
