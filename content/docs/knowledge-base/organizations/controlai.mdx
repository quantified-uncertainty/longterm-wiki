...
ControlAI is a UK-based organization focused on AI safety and policy advocacy, with the mission to prevent the development of artificial superintelligence (ASI) and ensure humanity retains control over advanced AI systems.[^cr-41ee] The organization operates primarily through campaigns, policy proposals, and public engagement rather than technical research, emphasizing the need for democratic control over transformative AI development.

Founded in 2023 as an offshoot of Conjecture, ControlAI has positioned itself as one of the most professionalized AI activist groups, producing high-quality media campaigns and policy briefs targeted at lawmakers and the general public.[^cr-fa86] The organization's core tagline—"Fighting to keep humanity in control"—specifically targets control over <EntityLink id="E96" name="deepfakes">deepfakes</EntityLink>, AI scaling, foundation models, and AI overall.[^cr-ab9a]

ControlAI's primary theory of change centers on the "Direct Institutional Plan" (DIP), launched in March 2025, which promotes safe-by-design AI engineering, metrology of intelligence, and human-controlled transformative AI.[^cr-dbe2] The organization warns that no current methods exist to contain systems more intelligent than all humanity combined, echoing warnings from AI scientists, world leaders, and CEOs about potential human extinction risks.[^cr-0a18]

## History

### Founding and Early Development

ControlAI was founded in 2023 by Andrea Miotti, emerging as an offshoot of Conjecture, an AI startup led by <EntityLink id="E71" name="connor-leahy">Connor Leahy</EntityLink>.[^cr-f239] The organization was established in the lead-up to the AI Safety Summit at Bletchley Park, UK, where it made a notable splash by hiring a blimp to fly over the summit as part of its advertising campaigns.[^cr-e36a]

Andrea Miotti, who holds a PhD in machine learning robustness and previously worked at Palantir and BCG, founded the organization after leading communications and policy efforts at Conjecture.[^cr-b936] The organization operates as a nonprofit "private company limited by guarantee" in the UK and as a 501(c)(4) nonprofit in the US.[^cr-5fbc]

### Evolution of Strategy

From its inception through 2024, ControlAI ran several major campaigns:

- **October 2023**: Prevented international endorsement of scaling policies at the AI Safety Summit[^cr-5767]
- **November-December 2023**: Opposed exemptions for foundation models in the <EntityLink id="E127" name="eu-ai-act">EU AI Act</EntityLink>[^cr-fa1a]
- **December 2023 - June 2024**: Ran a major campaign against deepfakes[^rc-8e5a]

The organization has evolved from a think tank model to focus on grassroots outreach and direct engagement with policymakers, transitioning to prevent ASI development via direct work.[^cr-e582]

### Recent Developments (2025-2026)

In March 2025, ControlAI launched "The Direct Institutional Plan" as their comprehensive strategy for achieving binding regulation on advanced AI systems.[^cr-6a6a] The UK pilot campaign, running from November 2024 through May 2025, demonstrated significant success: the organization briefed 84 cross-party UK parliamentarians (4 in 10 MPs, 3 in 10 Lords, and 2 in 10 from devolved legislatures), with over 20 publicly supporting their campaign for binding regulation.[^cr-b22b]

By December 2025, a huge coalition of lawmakers had called for binding regulation on powerful AI systems, representing a major milestone for the organization's advocacy efforts.[^cr-0533] As of early 2026, the organization continues scaling the DIP to the UK executive branch and expanding to the US and other countries.[^cr-1534]
...
Andrea Miotti serves as the organization's public face, featured in media outlets and podcasts discussing AI extinction risks.[^cr-838c] The organization reportedly has 9 employees as of 2024.[^cr-07d4]
...
- **Compute cluster monitoring**: Tracking large-scale AI training infrastructure[^cr-5a30]

The DIP is designed as a collaborative framework open to citizens and organizations worldwide, emphasizing independent participation rather than exclusive partnerships.[^cr-758a] ControlAI has developed country-specific policy briefs and offers advice to influential individuals and organizations via a dedicated partners page.[^cr-1f92]

### "A Narrow Path" Policy Framework

The organization's "A Narrow Path" policy paper underwent systematic evaluation through a policy sprint red-teamed by Apart Research in July 2025.[^cr-62ca] The sprint evaluated six policies with code released for reproducibility, demonstrating scalable monitoring of capability acquisition via phase transitions and agent dynamics simulations across eight sectors (from enterprise to critical infrastructure).[^cr-1819]

### Advocacy Tools and Resources

ControlAI has created tools enabling citizens to contact lawmakers, executives, civil service, media, and civil society in their jurisdictions to advocate for superintelligence risk policies.[^cr-4b14] These tools have facilitated over 150,000 messages sent to lawmakers.[^cr-740f]
...
- Drafted and presented **1 AI bill** to the UK Prime Minister's office[^cr-40f4]

The organization's cold-email campaign to British MPs and Lords engaged 70 representatives, with 31 publicly opposing ASI development—a remarkable conversion rate that defied initial predictions of resistance to strong extinction-risk messaging.[^cr-4e9b]
...
- 82% support mandatory AISI testing and company accountability[^cr-e801]
...
- **150,000+ messages** sent to lawmakers via their tools[^cr-5d4e]
...
- **"Artificial Guarantees"** (January 2025): Documenting inconsistencies by AI companies, highlighting shifting statements on risks and broken promises[^cr-958e]
- **"What leaders say about AI"** (September 2024): Compilation of warnings from AI leaders and researchers[^cr-95bb]
- **Rational Animations collaboration**: Video "What if AI just keeps getting smarter?" garnered 1.4 million views, warning of superintelligent, self-improving AI leading to extinction via indifference[^cr-47cd]
...
- Racing to ASI despite warnings, downplaying risks even while acknowledging issues like bioweapon misuse[^cr-912e]
...
- Collaboration with Rational Animations characterized as "really great"[^cr-4caa]
...
Some critics have characterized ControlAI as a group that "dramatically warns of AI's purported extinction risk," potentially sensationalizing risks.[^cr-4f70] However, CEO Andrea Miotti has responded that critics often nitpick experimental setups but should focus on trends in AI behaviors like self-preservation, resistance to shutdown, and strategic deception.[^cr-d7ae]
...
- Verification is extremely difficult due to AI's software nature, enabling hiding of modifications[^cr-b401]
...
- Donor support for their regulation efforts despite skepticism about global enforcement[^cr-38b5]
...
- Unresolved issues around stability under reflection and steering stronger systems[^cr-aea8]
