...
In 2018, FHI received a series of awards totaling up to £13.3 million over three years from <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> (then Coefficient Giving), the largest donation in the history of the Faculty of Philosophy at Oxford. This funding supported work on risks from advanced AI, biosecurity and pandemic preparedness, and macrostrategy.
