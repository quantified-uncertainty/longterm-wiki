...
| **Director** | <EntityLink id="E115" name="elizabeth-kelly">Elizabeth Kelly</EntityLink> (February 2024 – February 2025; departed) |
...
| **Technical Capacity** | Growing but constrained | Staff recruited from <EntityLink id="E201" name="metr">METR</EntityLink>, <EntityLink id="E24" name="apollo-research">Apollo Research</EntityLink>; [73 probationary staff affected by March 2025 layoffs](https://techcrunch.com/2025/02/22/us-ai-safety-institute-could-face-big-cuts/) |
...
The US AI Safety Institute (US AISI), renamed to the **Center for AI Standards and Innovation (CAISI)** in June 2025, represents the United States government's primary institutional response to mounting concerns about artificial intelligence risks. Established in 2023 within the National Institute of Standards and Technology (NIST), the institute serves as the federal government's central hub for AI safety research, evaluation, and standard-setting. The June 2025 renaming followed the Trump administration's revocation of Executive Order 14110 and reflected a shift in emphasis from safety to innovation and competitiveness. Created in the wake of breakthroughs like ChatGPT and growing awareness of potential catastrophic risks from advanced AI systems, the institute bridges the gap between cutting-edge technical research and government policy oversight.
...
| Date | Event |
|------|-------|
| October 30, 2023 | President Biden signs <R id="sid_rJiwPi9OQ9">Executive Order 14110</R> on AI safety |
| November 2023 | VP Harris announces US AISI at UK AI Safety Summit |
| February 8, 2024 | <R id="sid_ApU2XaJ0g2"><EntityLink id="E115" name="elizabeth-kelly">Elizabeth Kelly</EntityLink> appointed Director</R>; Elham Tabassi appointed CTO |
| February 8, 2024 | <R id="sid_yy9mnupbHq">AI Safety Institute Consortium (AISIC) launched</R> with 200+ members |
| March 2024 | \$10 million budget allocated |
| April 2024 | US-UK bilateral agreement signed for joint safety testing |
| May 2024 | <R id="sid_6cDD2u7aZG">International Network of <EntityLink id="E13" name="ai-safety-institutes">AI Safety Institutes</EntityLink></R> launched at Seoul Summit |
| August 29, 2024 | <R id="sid_WWs4vaj0z0">Formal agreements signed with <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> and <EntityLink id="E218" name="openai">OpenAI</EntityLink></R> for model access |
| November 2024 | <R id="sid_doWGJNCFM9">First joint US-UK evaluation</R> of Claude 3.5 Sonnet published |
| December 2024 | <R id="sid_c6m8hMkuIc">First AISIC plenary meeting</R> at University of Maryland |
| January 2025 | Executive Order 14110 revoked by Trump administration |
| June 3, 2025 | <R id="sid_TM0nl9HVcN">Renamed to Center for AI Standards and Innovation (CAISI)</R> |
...
For comparison, the <EntityLink id="E364" name="uk-aisi">UK AI Safety Institute</EntityLink> (now AI Security Institute) received £100M (\$127M) over two years—approximately 12x the initial US AISI allocation on a per-year basis.
...
In February 2024, the <R id="sid_jk09PXcAYU">AI Safety Institute Consortium (AISIC)</R> was launched with over 200 members, later growing to 280+ organizations. The consortium brings together diverse stakeholders to develop science-based guidelines and standards for AI measurement and safety.
...
The consortium received over 600 letters of interest from organizations seeking to participate. In December 2024, members gathered for the <R id="sid_c6m8hMkuIc">first in-person plenary meeting</R> at the University of Maryland to review progress and plan 2025 priorities.
...
|-------|------|-----------------|-------------------|------------------|
| **Claude 3.5 Sonnet** (upgraded) | November 2024 | <R id="sid_doWGJNCFM9">Joint US-UK pre-deployment</R> | Biological, cyber, software development, safeguard efficacy | "Most comprehensive government-led safety evaluation of an advanced AI model to date" - Elizabeth Kelly |
| **OpenAI o1** | December 2024 | <R id="sid_QQnAi98DNH">Joint US-UK pre-deployment</R> | Biological, cyber, reasoning capabilities | Advanced reasoning model with novel chain-of-thought architecture |
...
On August 29, 2024, US AISI <R id="sid_WWs4vaj0z0">signed landmark Memoranda of Understanding</R> with Anthropic and OpenAI, establishing formal frameworks for pre-deployment model access and collaborative safety research.

### Formal Agreements with AI Labs

| Company | Agreement Date | Key Terms | Company Statement |
|---------|----------------|-----------|-------------------|
| **Anthropic** | August 29, 2024 | Pre-deployment access to major new models; collaborative safety research | "Our collaboration with the U.S. AI Safety Institute leverages their wide expertise to rigorously test our models before widespread deployment." - <EntityLink id="E1248" name="jack-clark">Jack Clark</EntityLink>, Co-founder |
...
At the <R id="sid_AuhFpf7RfP">AI Seoul Summit in May 2024</R>, the International Network of AI Safety Institutes was formally launched, with the US playing a leading role alongside the UK, EU, Japan, and other partners.
...
| Member | Institute/Office | Status (as of 2025) |
|--------|------------------|---------------------|
...
The <R id="sid_w4uUvkm9Cv">inaugural convening of the Network</R> was co-hosted by the US Departments of Commerce and State on November 20-21, 2024, in San Francisco, bringing together technical experts to align on priority work areas ahead of the AI Action Summit in Paris (February 2025).
...
On June 3, 2025, Secretary of Commerce Howard Lutnick <R id="sid_TM0nl9HVcN">announced the transformation</R> of the US AI Safety Institute into the **Center for AI Standards and Innovation (CAISI)**. This change followed the Trump administration's revocation of Executive Order 14110 in January 2025.
...
### Official Sources
- <R id="sid_jk09PXcAYU">US AI Safety Institute at NIST</R>
- <R id="sid_ApU2XaJ0g2">Elizabeth Kelly appointment announcement</R>
- <R id="sid_yy9mnupbHq">AISIC Consortium launch</R>
- <R id="sid_WWs4vaj0z0">Anthropic and OpenAI agreements</R>
- <R id="sid_doWGJNCFM9">Claude 3.5 Sonnet evaluation</R>
- <R id="sid_w4uUvkm9Cv">International Network launch</R>
- <R id="sid_TM0nl9HVcN">CAISI transformation announcement</R>

### Analysis and Commentary
- <R id="sid_a9xs1JJs6s">CSIS: The US Vision for AI Safety with Elizabeth Kelly</R>
- <R id="sid_DebIG5qEE8">CSIS: AI Safety Institute International Network Recommendations</R>
- <R id="sid_ed5se6GwSN">Wikipedia: AI Safety Institute</R>
