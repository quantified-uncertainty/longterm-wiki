...
| Date | Event |
|------|-------|
| October 30, 2023 | President Biden signs <R id="NjEyNThiOG">Executive Order 14110</R> on AI safety |
| November 2023 | VP Harris announces US AISI at UK AI Safety Summit |
| February 8, 2024 | <R id="YWMwZDZmNG"><EntityLink id="E115" name="elizabeth-kelly">Elizabeth Kelly</EntityLink> appointed Director</R>; Elham Tabassi appointed CTO |
| February 8, 2024 | <R id="OWI4ZjQxYm">AI Safety Institute Consortium (AISIC) launched</R> with 200+ members |
| March 2024 | \$10 million budget allocated |
| April 2024 | US-UK bilateral agreement signed for joint safety testing |
| May 2024 | <R id="YjlhYTZiOG">International Network of <EntityLink id="E13" name="ai-safety-institutes">AI Safety Institutes</EntityLink></R> launched at Seoul Summit |
| August 29, 2024 | <R id="ZTFjMDAwNj">Formal agreements signed with <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> and <EntityLink id="E218" name="openai">OpenAI</EntityLink></R> for model access |
| November 2024 | <R id="YWFlZWU2ZW">First joint US-UK evaluation</R> of Claude 3.5 Sonnet published |
| December 2024 | <R id="YzI3MTQ5ZT">First AISIC plenary meeting</R> at University of Maryland |
| January 2025 | Executive Order 14110 revoked by Trump administration |
| June 3, 2025 | <R id="NzIyZDMyNm">Renamed to Center for AI Standards and Innovation (CAISI)</R> |
...
In February 2024, the <R id="ZTk4ZjM5M2">AI Safety Institute Consortium (AISIC)</R> was launched with over 200 members, later growing to 280+ organizations. The consortium brings together diverse stakeholders to develop science-based guidelines and standards for AI measurement and safety.
...
The consortium received over 600 letters of interest from organizations seeking to participate. In December 2024, members gathered for the <R id="YzI3MTQ5ZT">first in-person plenary meeting</R> at the University of Maryland to review progress and plan 2025 priorities.
...
|-------|------|-----------------|-------------------|------------------|
| **Claude 3.5 Sonnet** (upgraded) | November 2024 | <R id="YWFlZWU2ZW">Joint US-UK pre-deployment</R> | Biological, cyber, software development, safeguard efficacy | "Most comprehensive government-led safety evaluation of an advanced AI model to date" - Elizabeth Kelly |
| **OpenAI o1** | December 2024 | <R id="NTFkNzA2ND">Joint US-UK pre-deployment</R> | Biological, cyber, reasoning capabilities | Advanced reasoning model with novel chain-of-thought architecture |
...
On August 29, 2024, US AISI <R id="ZTFjMDAwNj">signed landmark Memoranda of Understanding</R> with Anthropic and OpenAI, establishing formal frameworks for pre-deployment model access and collaborative safety research.
...
At the <R id="OWJhNjI4YW">AI Seoul Summit in May 2024</R>, the International Network of AI Safety Institutes was formally launched, with the US playing a leading role alongside the UK, EU, Japan, and other partners.
...
The <R id="NmQ1NDQ5OW">inaugural convening of the Network</R> was co-hosted by the US Departments of Commerce and State on November 20-21, 2024, in San Francisco, bringing together technical experts to align on priority work areas ahead of the AI Action Summit in Paris (February 2025).
...
On June 3, 2025, Secretary of Commerce Howard Lutnick <R id="NzIyZDMyNm">announced the transformation</R> of the US AI Safety Institute into the **Center for AI Standards and Innovation (CAISI)**. This change followed the Trump administration's revocation of Executive Order 14110 in January 2025.
...
### Official Sources
- <R id="ZTk4ZjM5M2">US AI Safety Institute at NIST</R>
- <R id="YWMwZDZmNG">Elizabeth Kelly appointment announcement</R>
- <R id="OWI4ZjQxYm">AISIC Consortium launch</R>
- <R id="ZTFjMDAwNj">Anthropic and OpenAI agreements</R>
- <R id="YWFlZWU2ZW">Claude 3.5 Sonnet evaluation</R>
- <R id="NmQ1NDQ5OW">International Network launch</R>
- <R id="NzIyZDMyNm">CAISI transformation announcement</R>

### Analysis and Commentary
- <R id="YWI5NTBjN2">CSIS: The US Vision for AI Safety with Elizabeth Kelly</R>
- <R id="NzEyZGNhZW">CSIS: AI Safety Institute International Network Recommendations</R>
- <R id="NzQ3ZDZjMT">Wikipedia: AI Safety Institute</R>
