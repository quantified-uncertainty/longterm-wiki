...
The restructuring was approved by the California and Delaware Attorneys General after extensive negotiations. California AG [Rob Bonta](https://en.wikipedia.org/wiki/Rob_Bonta) imposed 20 safety and security requirements as a condition of the restructuring (see the Public Accountability section below for details), while both attorneys general gave their blessing to the deal.[^rc-1b6b][^rc-c636]
...
In 2025, the OpenAI Foundation launched its first major philanthropic initiative: the People-First AI Fund. The fund issued an open call for applications from September 8 through October 8, 2025, targeting U.S.-based nonprofits.[^rc-8f23][^rc-b654]
