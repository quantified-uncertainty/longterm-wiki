...
**Tessa Alexanian**, Technical Lead for the Common Mechanism, previously worked at Zymergen on modular lab automation for four years and served as iGEM's Safety and Security officer for two years. She has collaborated with <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink>, RAND, and the Council on Strategic Risks.[^22]
