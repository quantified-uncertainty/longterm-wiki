...
|-----------|--------|-----------|---------|
| **Talent Density** | <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> | <EntityLink id="E98" name="deepmind">Google DeepMind</EntityLink> | <EntityLink id="E378" name="xai">xAI</EntityLink> |
| **Safety Culture** | <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> | <EntityLink id="E98" name="deepmind">Google DeepMind</EntityLink> | <EntityLink id="E218" name="openai">OpenAI</EntityLink> |
| **Agentic AI** | Tied (Anthropic/OpenAI/Google) | Meta AI | Mistral |
| **Financial Trajectory** | <EntityLink id="E218" name="openai">OpenAI</EntityLink> | <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> | xAI |
| **Infrastructure** | <EntityLink id="E98" name="deepmind">Google DeepMind</EntityLink> | <EntityLink id="E550" name="microsoft">Microsoft</EntityLink>/OpenAI | Anthropic |
...
<FBCompareChart
  property="valuation"
  entities={["anthropic", "openai", "xai", "mistral-ai"]}
  title="AI Lab Valuations"
/>
...
<FBCompareChart
  property="headcount"
  entities={["anthropic", "openai", "deepmind", "mistral-ai"]}
  title="AI Lab Headcount"
/>
...
|---------|---------------------|----------------------|-------------------|
| **Anthropic** | 7 ex-OpenAI co-founders, <EntityLink id="E182" name="jan-leike">Jan Leike</EntityLink>, <EntityLink id="john-schulman" name="john-schulman">John Schulman</EntityLink>, 40-60 interpretability researchers (largest globally), <EntityLink id="E59" name="chris-olah">Chris Olah</EntityLink>'s team | Smaller scale than Google | **Strong inflow** (8x more likely to hire from OpenAI than lose) |
| **Google DeepMind** | <EntityLink id="E101" name="demis-hassabis">Demis Hassabis</EntityLink>, AlphaFold team, TPU access, Gemini team | Brain drain to startups, internal politics | **Stable with leakage** |
| **OpenAI** | <EntityLink id="E269" name="sam-altman">Sam Altman</EntityLink> (fundraising), o1/o3 reasoning team | 75% of co-founders departed, 50% of safety team gone, <EntityLink id="E182" name="jan-leike">Jan Leike</EntityLink> defection | **Significant outflow** |
| **Meta AI** | <EntityLink id="E582" name="yann-lecun">Yann LeCun</EntityLink>, LeCun hiring spree from OpenAI (12+ in 2025), open-source community | Key researchers left for AMI (LeCun startup) | **Mixed** |
| **xAI** | <EntityLink id="E116" name="elon-musk">Elon Musk</EntityLink> (resources/visibility) | Burnout culture, 30+ hour shifts reported, limited safety expertise | **Concerning churn** |
...
*See <EntityLink id="E22" name="anthropic">Anthropic</EntityLink>, <EntityLink id="E405" name="anthropic-valuation">Anthropic Valuation</EntityLink>, <EntityLink id="E413" name="anthropic-impact">Anthropic Impact</EntityLink>*
...
- <EntityLink id="E101" name="demis-hassabis">Demis Hassabis</EntityLink> Nobel Prize credibility
...
*See <EntityLink id="E98" name="deepmind">Google DeepMind</EntityLink>*
...
- <EntityLink id="E269" name="sam-altman">Sam Altman</EntityLink> admitted OpenAI "screwed up" writing quality on GPT-5.2
...
*See <EntityLink id="E218" name="openai">OpenAI</EntityLink>*
...
- <EntityLink id="E582" name="yann-lecun">Yann LeCun</EntityLink> leadership, recent OpenAI talent acquisition
...
*See <EntityLink id="E549" name="meta-ai">Meta AI</EntityLink>*
...
*See <EntityLink id="E378" name="xai">xAI</EntityLink>*
...
| **Thinking Machines Lab (<EntityLink id="E1289" name="mira-murati">Mira Murati</EntityLink>)** | OpenAI talent, \$2B seed | 2% |
...
| **Political attacks** | <EntityLink id="E431" name="david-sacks">David Sacks</EntityLink> (Trump AI czar) calls Anthropic "woke AI" | Medium (policy risk) |
