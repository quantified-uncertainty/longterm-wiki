...
|---------|---------------------|----------------------|-------------------|
| **Anthropic** | 7 ex-OpenAI co-founders, <EntityLink id="E182" name="jan-leike">Jan Leike</EntityLink>, John Schulman, 40-60 interpretability researchers (largest globally), <EntityLink id="E59" name="chris-olah">Chris Olah</EntityLink>'s team | Smaller scale than Google | **Strong inflow** (8x more likely to hire from OpenAI than lose) |
...
| **OpenAI** | <EntityLink id="E269" name="sam-altman">Sam Altman</EntityLink> (fundraising), o1/o3 reasoning team | 75% of co-founders departed, 50% of safety team gone, Jan Leike defection | **Significant outflow** |
