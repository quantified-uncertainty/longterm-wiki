...
**Bear case for OpenAI:** <F e="anthropic" f="revenue-run-rate">\$14B</F>/year losses unsustainable even with \$100B raise; enterprise customers switch to Anthropic; talent exodus accelerates; GPT-5.2 quality issues indicate fundamental problems.
