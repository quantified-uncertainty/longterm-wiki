...
| Career Impact | Very High | 80% of alumni work in <EntityLink id="E439">AI alignment</EntityLink>; placements at <EntityLink id="E22">Anthropic</EntityLink>, <EntityLink id="E218">OpenAI</EntityLink>, <EntityLink id="E98">DeepMind</EntityLink>[^3] |
...
| <EntityLink id="E538">LessWrong</EntityLink> | [lesswrong.com](https://www.lesswrong.com/posts/8vLvpxzpc6ntfBWNo/seri-ml-alignment-theory-scholars-program-2022) |
...
- Activation and <EntityLink id="E479">representation engineering</EntityLink>
- Emergent misalignment detection
- Inoculation prompting techniques
- Developmental interpretability
- Computational mechanics applications
- Glitch token analysis
- <EntityLink id="E282">Situational awareness</EntityLink> evaluations
...
- Marius Hobbhahn (Winter 2022/23, mentored by Evan Hubinger): Founded and became CEO of Apollo Research, a London-based technical alignment organization focused on scheming evaluations and <EntityLink id="E6">AI control</EntityLink>[^46]
...
**Ryan Kidd** serves as Co-Executive Director of MATS and Co-Founder of the London Initiative for Safe AI (LISA).[^50] He was a scholar in MATS's first iteration (which had only 5 scholars total) and has since become a <EntityLink id="E547">Manifund</EntityLink> Regrantor and advisor to organizations including Halcyon Futures, Catalyze Impact, AI Safety ANZ, and Pivotal Research.
...
MATS mentors come from leading organizations including Anthropic, Google DeepMind, Redwood Research, OpenAI, <EntityLink id="E202">MIRI</EntityLink>, ARC (<EntityLink id="E25">Alignment Research Center</EntityLink>), CHAI, <EntityLink id="E47">CAIS</EntityLink>, and the Centre on Long-Term Risk.[^53] Selected examples include:

- **Marius Hobbhahn**: CEO and Director of Apollo Research focusing on evaluations for <EntityLink id="E274">scheming</EntityLink> and control; PhD in Bayesian ML; formerly worked on AI forecasting at Epoch; was a MATS Winter 2022/23 scholar under Evan Hubinger[^54]
...
- **Joe Benton**: Member of Anthropic's Alignment Science team working on <EntityLink id="E271">scalable oversight</EntityLink>, control, chain-of-thought monitoring, and evaluations[^56]
...
- **<EntityLink id="E552">Coefficient Giving</EntityLink>**: Provided grants to support the early SERI MATS trial program under Evan Hubinger[^63]
- **Other supporters (2024)**: Foresight Institute, <EntityLink id="E567">Survival and Flourishing Fund</EntityLink>, Long-Term Future Fund, Craig Falls, and several donors via Manifund[^64]
