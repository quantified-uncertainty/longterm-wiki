...
|-----------|------------|----------|
| **Innovation** | High | Squiggle is unique probabilistic language with native distribution algebra; <EntityLink id="E287" name="squiggleai">SquiggleAI</EntityLink> generates 100-500 line models |
...
| **Open Source** | Fully | All projects MIT licensed on [GitHub](https://github.com/quantified-uncertainty); monorepo includes <EntityLink id="E286" name="squiggle">Squiggle</EntityLink>, Hub, and <EntityLink id="E200" name="metaforecast">Metaforecast</EntityLink> |
| **Funding** | Stable | \$850K+ total: SFF (\$650K through 2022), Future Fund (\$200K, 2022), <EntityLink id="E543" name="ltff">LTFF</EntityLink> (ongoing) |
| **Team Size** | Small | ≈3-5 core contributors including <EntityLink id="ozzie-gooen" name="ozzie-gooen">Ozzie Gooen</EntityLink> (founder), with fiscal sponsorship from <EntityLink id="E558" name="rethink-priorities">Rethink Priorities</EntityLink> |
| **AI Integration** | Active | SquiggleAI uses Claude Sonnet 4.5 (20K token context cached); <EntityLink id="E385" name="roastmypost">RoastMyPost</EntityLink> uses Claude + Perplexity |
...
- **QURI Tools Ecosystem**: Oversaw development of Squiggle, Metaforecast, SquiggleAI, and <EntityLink id="E385" name="roastmypost">RoastMyPost</EntityLink>
...
flowchart TD
    ...
    TOOLS --> ROAST[<EntityLink id="E385" name="roastmypost">RoastMyPost</EntityLink><br/>Blog evaluation]
...
### <EntityLink id="E385" name="roastmypost">RoastMyPost</EntityLink>

[<EntityLink id="E385" name="roastmypost">RoastMyPost</EntityLink>](https://www.roastmypost.org/) is a QURI application that uses LLMs and code to evaluate blog posts and research documents. It was [announced](https://forum.effectivealtruism.org/posts/BdufL4GZmeBht3fak/announcing-roastmypost-llms-eval-blog-posts-and-more) as a tool for improving writing quality in the EA and rationalist communities.
...
**Limitations**: The false positive rate for error detection is significant. <EntityLink id="E385" name="roastmypost">RoastMyPost</EntityLink> is best for flagging issues for human review, not for treating results as authoritative. Fact Check and Fallacy Check work best on fact-dense, rigorous articles.
...
The Survival and Flourishing Fund (SFF) is financed primarily by <EntityLink id="E577" name="jaan-tallinn">Jaan Tallinn</EntityLink> (Skype co-founder, AI safety advocate). In 2025, SFF allocated \$34.33 million to organizations working on existential risk, with ~86% (\$29M) going to AI-related projects. QURI represents one of several epistemic infrastructure investments in SFF's portfolio.
...
| **Key Contributors** | Ozzie Gooen (founder), <EntityLink id="sam-nolan" name="sam-nolan">Sam Nolan</EntityLink>, <EntityLink id="E579" name="nuno-sempere">Nuño Sempere</EntityLink> (Metaforecast), Michael Dickens (unit types) |
...
| **Fermi estimates for cause prioritization** | SquiggleAI, Squiggle | <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>, 80,000 Hours |
| **AI timeline modeling** | Squiggle | AI safety researchers |
| **Forecast aggregation** | Metaforecast | Forecasting community |
| **Writing quality checks** | <EntityLink id="E385" name="roastmypost">RoastMyPost</EntityLink> | EA Forum authors |
...
| **2024** | [<EntityLink id="E385" name="roastmypost">RoastMyPost</EntityLink> launch](https://forum.effectivealtruism.org/posts/BdufL4GZmeBht3fak/announcing-roastmypost-llms-eval-blog-posts-and-more) | LLM blog evaluation tool |
...
- **AI Integration**: SquiggleAI and <EntityLink id="E385" name="roastmypost">RoastMyPost</EntityLink> leverage frontier LLMs
...
- **Integration depth**: Tighter connections between Squiggle, Metaforecast, and <EntityLink id="E385" name="roastmypost">RoastMyPost</EntityLink>
...
- [Announcing <EntityLink id="E385" name="roastmypost">RoastMyPost</EntityLink>](https://forum.effectivealtruism.org/posts/BdufL4GZmeBht3fak/announcing-roastmypost-llms-eval-blog-posts-and-more)
...
- [<EntityLink id="E385" name="roastmypost">RoastMyPost</EntityLink>](https://www.roastmypost.org/)
