...
| **Team Size** | Small | ≈3-5 core contributors including Ozzie Gooen (founder), with fiscal sponsorship from <EntityLink id="E558" name="rethink-priorities">Rethink Priorities</EntityLink> |
...
| **Key Contributors** | Ozzie Gooen (founder), Sam Nolan, <EntityLink id="E579" name="nuno-sempere">Nuño Sempere</EntityLink> (Metaforecast), Michael Dickens (unit types) |
