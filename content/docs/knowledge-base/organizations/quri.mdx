...
|-----------|------------|----------|
| **Innovation** | High | Squiggle is unique probabilistic language with native distribution algebra; <EntityLink id="E287">SquiggleAI</EntityLink> generates 100-500 line models |
...
| **Open Source** | Fully | All projects MIT licensed on [GitHub](https://github.com/quantified-uncertainty); monorepo includes <EntityLink id="E286">Squiggle</EntityLink>, Hub, and <EntityLink id="E200">Metaforecast</EntityLink> |
| **Funding** | Stable | \$850K+ total: SFF (\$650K through 2022), Future Fund (\$200K, 2022), <EntityLink id="E543">LTFF</EntityLink> (ongoing) |
| **Team Size** | Small | ≈3-5 core contributors including Ozzie Gooen (founder), with fiscal sponsorship from <EntityLink id="E558">Rethink Priorities</EntityLink> |
| **AI Integration** | Active | SquiggleAI uses Claude Sonnet 4.5 (20K token context cached); <EntityLink id="E385">RoastMyPost</EntityLink> uses Claude + Perplexity |
...
| **Primary Funders** | <EntityLink id="E567">Survival and Flourishing Fund</EntityLink> (SFF), Long-Term Future Fund (LTFF), Future Fund (pre-FTX) |
...
Gooen discovered effective altruism in college after learning he "sounded like a utilitarian." His path from engineering to forecasting research reflects a consistent interest in applying quantitative methods to important decisions. At FHI, he focused on forecasting infrastructure research, exploring how <EntityLink id="E228">prediction markets</EntityLink> and aggregation methods could improve institutional decision-making.

Beyond QURI, Gooen serves on the boards of [Rethink Charity](https://www.rethinkcharity.org/) and Rethink Priorities. He has contributed to discussions on <EntityLink id="E608">AI governance</EntityLink>, forecasting methodology, and quantitative cause prioritization through extensive writing on the [EA Forum](https://forum.effectivealtruism.org/users/oagr) and [LessWrong](https://www.lesswrong.com/users/ozziegooen).
...
- **QURI Tools Ecosystem**: Oversaw development of Squiggle, Metaforecast, SquiggleAI, and <EntityLink id="E385">RoastMyPost</EntityLink>
...
flowchart TD
    ...
    TOOLS --> ROAST[<EntityLink id="E385">RoastMyPost</EntityLink><br/>Blog evaluation]
...
### <EntityLink id="E385">RoastMyPost</EntityLink>

[<EntityLink id="E385">RoastMyPost</EntityLink>](https://www.roastmypost.org/) is a QURI application that uses LLMs and code to evaluate blog posts and research documents. It was [announced](https://forum.effectivealtruism.org/posts/BdufL4GZmeBht3fak/announcing-roastmypost-llms-eval-blog-posts-and-more) as a tool for improving writing quality in the EA and rationalist communities.
...
**Limitations**: The false positive rate for error detection is significant. <EntityLink id="E385">RoastMyPost</EntityLink> is best for flagging issues for human review, not for treating results as authoritative. Fact Check and Fallacy Check work best on fact-dense, rigorous articles.
...
| **Fermi estimates for cause prioritization** | SquiggleAI, Squiggle | <EntityLink id="E521">Coefficient Giving</EntityLink>, 80,000 Hours |
| **AI timeline modeling** | Squiggle | AI safety researchers |
| **Forecast aggregation** | Metaforecast | Forecasting community |
| **Writing quality checks** | <EntityLink id="E385">RoastMyPost</EntityLink> | EA Forum authors |
...
| **2024** | [<EntityLink id="E385">RoastMyPost</EntityLink> launch](https://forum.effectivealtruism.org/posts/BdufL4GZmeBht3fak/announcing-roastmypost-llms-eval-blog-posts-and-more) | LLM blog evaluation tool |
...
- **AI Integration**: SquiggleAI and <EntityLink id="E385">RoastMyPost</EntityLink> leverage frontier LLMs
...
- **Integration depth**: Tighter connections between Squiggle, Metaforecast, and <EntityLink id="E385">RoastMyPost</EntityLink>
...
- [Announcing <EntityLink id="E385">RoastMyPost</EntityLink>](https://forum.effectivealtruism.org/posts/BdufL4GZmeBht3fak/announcing-roastmypost-llms-eval-blog-posts-and-more)
...
- [<EntityLink id="E385">RoastMyPost</EntityLink>](https://www.roastmypost.org/)
