...
| **Major Funders** | <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink> (\$3.5M+), <EntityLink id="sff">Survival and Flourishing Fund</EntityLink> (\$1.6M+) |
...
- **SPARC (Summer Program on Applied Rationality and Cognition)**: Annual summer programs, including events in 2019 and funding from <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink> (\$304,000 over two years in 2016).[^11]
...
- **<EntityLink id="open-philanthropy">Open Philanthropy</EntityLink>**: Over \$3.5 million
