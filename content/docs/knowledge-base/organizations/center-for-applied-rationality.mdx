...
| **Major Funders** | <EntityLink id="E552">Coefficient Giving</EntityLink> (\$3.5M+), <EntityLink id="E567">Survival and Flourishing Fund</EntityLink> (\$1.6M+) |
...
The organization has offered scholarship programs, including funding from <EntityLink id="E577">Jaan Tallinn</EntityLink> (Skype co-founder) for Estonian students.[^1] CFAR has also provided specialized training for organizations including Facebook and participants in the Thiel Fellowship.[^1]
...
- **SPARC (Summer Program on Applied Rationality and Cognition)**: Annual summer programs, including events in 2019 and funding from <EntityLink id="E552">Coefficient Giving</EntityLink> (\$304,000 over two years in 2016).[^11]
...
- **<EntityLink id="E552">Coefficient Giving</EntityLink>**: Over \$3.5 million
...
CFAR is categorized as an existential risk organization with explicit connections to existential risk from artificial intelligence.[^1] The organization originated from the rationality movement around <EntityLink id="E538">LessWrong</EntityLink>, which pioneered discussions of AI alignment and existential risks.[^1]
