...
|------|-------------|----------------------|
| **July 2019** | <KBF entity="openai" property="total-funding">\$1B</KBF> initial investment | Exclusive Azure supercomputing partnership established |
...
| **AI Business Run Rate** | — | \$13B (annualized from Q2 FY2026) | <KBF entity="openai" property="total-funding">\$13B+</KBF> | 175% YoY growth |
