...
|------|-------------|----------------------|
| **July 2019** | <KBFactValue entity="openai" property="total-funding">\$1B</KBFactValue> initial investment | Exclusive Azure supercomputing partnership established |
...
| **AI Business Run Rate** | — | \$13B (annualized from Q2 FY2026) | <KBFactValue entity="openai" property="total-funding">\$13B+</KBFactValue> | 175% YoY growth |
