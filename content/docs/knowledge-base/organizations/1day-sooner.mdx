...
The organization operates alongside a separately registered 501(c)(4) entity, **1Day Action**, which handles political advocacy work. <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink> provided \$1 million to 1Day Action.[^2]
...
The organization quickly attracted public attention and volunteer signups. Open Philanthropy provided initial funding of \$500,000 in May 2020 (via Waitlist Zero) and \$600,000 in November 2020 for general support.[^9][^10]
...
| Donor | Amount | Notes |
|-------|--------|-------|
| **Coefficient Giving (<EntityLink id="open-philanthropy">Open Philanthropy</EntityLink>)** | \$4,600,000 | Largest single funder; OP rebranded to Coefficient Giving in Nov 2025 |
...
Open Philanthropy (now Coefficient Giving) has provided ≈\$4.6M to 1Day Sooner's 501(c)(3) — roughly 36% of cumulative funding — plus \$1M separately to 1Day Action (the 501(c)(4) entity). The \$4.6M Coefficient Giving line in the table above represents the total from OP, which includes these identified grants:[^9][^10][^17]
...
- **Open Philanthropy/Coefficient Giving** is the largest funding source
...
[^9]: [Open Philanthropy - 1Day Sooner General Support May 2020](https://www.openphilanthropy.org/grants/1day-sooner-general-support-may-2020/) - Initial grant
[^10]: [Open Philanthropy - 1Day Sooner General Support November 2020](https://www.openphilanthropy.org/grants/1day-sooner-general-support-november-2020/) - Second grant
...
[^17]: [Open Philanthropy - 1Day Sooner General Support 2023](https://www.openphilanthropy.org/grants/1day-sooner-general-support-2023/) - 2023 grant
