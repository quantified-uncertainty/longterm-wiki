...
- <EntityLink id="elon-musk">Elon Musk</EntityLink> — Full profile covering AI role, predictions, and track record
- <EntityLink id="giving-pledge">Giving Pledge</EntityLink> — The pledge Musk signed in 2012; historical fulfillment analysis
- <EntityLink id="dustin-moskovitz">Dustin Moskovitz</EntityLink> — Largest AI safety funder, contrasting approach
- <EntityLink id="jaan-tallinn">Jaan Tallinn</EntityLink> — Tech billionaire focused on existential risk
- <EntityLink id="openai">OpenAI</EntityLink> — Organization Musk co-founded
- <EntityLink id="xai">xAI</EntityLink> — Musk's current AI company
