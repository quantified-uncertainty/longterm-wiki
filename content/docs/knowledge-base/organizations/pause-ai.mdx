...
Pause AI's advocacy is directly grounded in concerns emerging from the fields of AI safety and AI alignment research. The movement views the rapid scaling of AI capabilities without solved alignment as fundamentally reckless, increasing the probability of <EntityLink id="existential-catastrophe">existential catastrophe</EntityLink>.[^10]
