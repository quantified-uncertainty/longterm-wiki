...
<KBRecordTable entity="deepmind" collection="model-releases" title="Model & Research Releases" columns={["name", "released", "description"]} />
...
<KBRecordTable entity="deepmind" collection="key-persons" title="Key People" columns={["person", "title", "start", "end", "is_founder"]} />
...
<KBRecordTable entity="deepmind" collection="safety-milestones" title="Safety Milestones" columns={["name", "date", "type", "description"]} />
...
<KBRecordTable entity="deepmind" collection="strategic-partnerships" title="Strategic Partnerships" columns={["partner", "type", "date", "notes"]} />
