...
This framework parallels <EntityLink id="E461" name="responsible-scaling-policies">Anthropic's Responsible Scaling Policies</EntityLink>, representing industry convergence on capability-based safety approaches.
