...
- <R id="MDhiMzZiZj">UK AI Security Institute Official Website</R> - Main portal for the Institute
- <R id="OTFmZjM0ZD">GOV.UK AI Safety Institute Page</R> - Government organizational page
- <R id="MDZjYjc5MD">Introducing the AI Safety Institute</R> - Official overview document
- <R id="NDNmMGUyMD">Fourth Progress Report</R> - May 2024 progress update
- <R id="NTIyY2NiMW">Our 2025 Year in Review</R> - 2025 annual review

### Research Outputs

- <R id="ZTBiMDIwZD">Frontier AI Trends Report</R> - December 2024 assessment of frontier AI capabilities
- <R id="MjExZWM4Mz">Inspect AI Framework</R> - Open-source evaluation framework documentation
- <R id="MzE5M2E3Nz">Inspect Evals</R> - Collection of 100+ pre-built evaluations
- <R id="MjdhNzk5Mz">Early Lessons from Evaluating Frontier AI Systems</R> - Evaluation methodology insights

### Funding Programs

- <R id="NTBhYWYxMD">The Alignment Project</R> - 15 million GBP global alignment research fund
- <R id="N2NjODAwYW">Grants Overview</R> - Information on all AISI grant programs
- <R id="Nzc0ZjQ5Y2">Systemic Safety Grants</R> - 8.5 million GBP societal resilience program

### International Coordination

- <R id="NTJiM2ZhM2">The Bletchley Declaration</R> - November 2023 international agreement
- <R id="YzBmNjc4OT">Chair's Summary of AI Safety Summit 2023</R> - Summit outcomes
- <R id="NzEyZGNhZW">CSIS: The AI Safety Institute International Network</R> - Analysis of international coordination
- <R id="NDY3NmJhZG">Centre for Future Generations: The AI Safety Institute Network</R> - Comparative analysis

### News and Analysis

- <R id="NzQ3ZDZjMT">UK AI Safety Institute Wikipedia</R> - Comprehensive background
- <R id="NDE4YTM2Mz">Computer Weekly: San Francisco Office Announcement</R> - May 2024 expansion
- <R id="ZGQ5NWUxYm">Infosecurity Magazine: AISI Rebrands</R> - February 2025 name change
- <R id="YzYyYjA2Nj">AI Now Statement on Transition</R> - Critical perspective on rebrand
