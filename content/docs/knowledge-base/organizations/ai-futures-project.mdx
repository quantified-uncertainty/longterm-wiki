...
The project has also received support from Lightcone Infrastructure (Oliver Habryka, Rafe Kennedy, Raymond Arnold) for website development and from <EntityLink id="E530" name="futuresearch">FutureSearch</EntityLink> (Tom Liptay, Finn Hambly, Sergio Abriola, Tolga Bilge) for forecasting work.
