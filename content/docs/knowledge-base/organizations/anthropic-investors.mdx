...
**Dustin Moskovitz**, co-founder of Facebook and funder of <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> (formerly <EntityLink id="coefficient-giving" >Open Philanthropy</EntityLink>), reportedly participated in both seed and Series A rounds. According to reporting by Fortune, Moskovitz later moved a <F e="anthropic" f="a9e1f835">\$500 million</F> Anthropic stake into a nonprofit vehicle to reinvest returns.[^rc-b3a8]
