...
| **Founder EA Documentation** | All 7 embedded in EA/AI safety network | 2/7 formal EA commitments, 3/7 deep AI safety roots, 2/7 strong professional ties (details below)[^fortune-pledge] |
| **Expected EA Capital (risk-adjusted)** | \$27-76B | Range reflects uncertainty in founder cause allocation, not EA connections |
...
- Cause allocation for founders—all have EA/AI safety network ties, but Anthropic publicly distances from EA label
...
<EntityLink id="E22">Anthropic</EntityLink>'s valuation growth—from \$550 million in May 2021 to \$380 billion by February 2026 (Series G)—has created substantial philanthropic capital among equity holders with varying degrees of EA alignment.[^anthropic-series-g] EA-aligned equity spans multiple sources: all seven co-founders have pledged to donate 80% of their equity (all are embedded in the EA/rationalist/AI safety network—2 have formal EA commitments, 3 have deep AI safety community roots, 2 have strong professional ties to EA networks),[^fortune-pledge] early investors <EntityLink id="E577">Jaan Tallinn</EntityLink> (conservative estimate: \$2-6B) and <EntityLink id="E436">Dustin Moskovitz</EntityLink> (\$3-9B) hold substantial stakes,[^fortune-moskovitz] and early employees transferred billions to donor-advised funds under Anthropic's historical 3:1 matching program (now 1:1 at 25% for new hires).[^anthropic-careers]
...
Total EA-aligned capital at current valuations ranges from **\$33-172B gross** (conservative to optimistic assumptions), with a risk-adjusted expected value of **\$27-76B**—the wide range reflecting genuine uncertainty about founder cause allocation. While all seven co-founders are embedded in the EA/rationalist/AI safety network, only 2 have formal EA commitments (GWWC pledge, marriage to Karnofsky), and Anthropic has publicly distanced from the EA label—making it uncertain whether pledged capital will flow to EA-identified causes specifically. An estimated \$20-40B is already legally bound in DAFs through the employee matching program—though DAF donors retain discretion over which charities receive grants, and the matching program has been reduced from 3:1 at 50% to 1:1 at 25% for new employees.[^anthropic-careers]
...
|-------|------|--------|-----------|----------------|---------------|
| Seed | Early 2021 | Undisclosed | — | <EntityLink id="E577">Jaan Tallinn</EntityLink>, <EntityLink id="E436">Dustin Moskovitz</EntityLink>, Eric Schmidt | **Yes** |
...
All seven Anthropic co-founders—<EntityLink id="dario-amodei">Dario Amodei</EntityLink>, <EntityLink id="daniela-amodei">Daniela Amodei</EntityLink>, <EntityLink id="chris-olah">Chris Olah</EntityLink>, Tom Brown, Jack Clark, Jared Kaplan, and Sam McCandlish—have pledged to donate 80% of their equity. [Fortune](https://fortune.com/2026/01/27/anthropic-billionaire-cofounders-ceo-dario-amodei-giving-away-80-percent-of-wealth-fighting-inequality-ai-revolution/) The pledge was announced alongside Dario Amodei's January 2026 essay "The Adolescence of Technology," which frames AI-driven wealth inequality as a central concern.[^ea-forum-dario-essay]
...
**Legal status:** The pledges are public commitments. Whether they have legal binding force (e.g., as enforceable contracts or charitable pledge agreements) is not publicly documented. Unlike the <EntityLink id="openai-foundation">OpenAI Foundation</EntityLink>'s legal control over board appointments, enforcement appears to rely on reputational mechanisms.
...
- Lived in a rationalist group house with <EntityLink id="holden-karnofsky">Holden Karnofsky</EntityLink> and <EntityLink id="paul-christiano">Paul Christiano</EntityLink>, when he and Christiano were technical advisors to Open Philanthropy [Perry Metzger/X](https://x.com/perrymetzger/status/1979234761857024385)
...
- Married to <EntityLink id="holden-karnofsky">Holden Karnofsky</EntityLink>, co-founder of GiveWell and former CEO of <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> (formerly Open Philanthropy)
...
- Appeared on <EntityLink id="80000-hours">80,000 Hours</EntityLink> podcast multiple times (episodes #107, career path episode)—80,000 Hours is the EA movement's primary career advisory organization [80,000 Hours](https://80000hours.org/podcast/episodes/chris-olah-interpretability-research/)
...
- Former Policy Director at <EntityLink id="openai">OpenAI</EntityLink>; left alongside the other co-founders over safety concerns
...
- <EntityLink id="holden-karnofsky">Holden Karnofsky</EntityLink> now reports directly to Kaplan at Anthropic, placing one of EA's most prominent figures in his direct reporting line [Fortune](https://fortune.com/2025/02/13/anthropic-hired-president-daniela-amodei-husband-ai-safety-responsible-scaling/)
...
Tallinn co-founded the <EntityLink id="cser">Centre for the Study of Existential Risk</EntityLink> (CSER) and the <EntityLink id="fli">Future of Life Institute</EntityLink> (FLI), and has consistently directed wealth toward existential risk reduction. Given his track record, his Anthropic holdings are highly likely to be directed toward EA-aligned causes.
...
**<EntityLink id="holden-karnofsky">Holden Karnofsky</EntityLink>**: Joined January 2025 as member of technical staff. As Daniela Amodei's spouse, co-founder of GiveWell, and former CEO of <EntityLink id="E521">Coefficient Giving</EntityLink>, represents a direct bridge to EA funding infrastructure. Later hire likely means smaller equity stake but high influence on donation decisions.
...
- **Zach Robinson**: CEO of <EntityLink id="cea">Centre for Effective Altruism</EntityLink>
...
[^nbc-openai-restructuring]: NBC News. "OpenAI restructuring company structure ChatGPT invest own." https://www.nbcnews.com/nbcnews/tech/tech-news/openai-restructuring-company-structure-chatgpt-invest-own-rcna240138
...
The <EntityLink id="E531">Giving Pledge</EntityLink>, founded in 2010 by Bill Gates and Warren Buffett, provides the most relevant historical comparison. A 2025 Institute for Policy Studies analysis reveals:[^ips-giving-pledge]
