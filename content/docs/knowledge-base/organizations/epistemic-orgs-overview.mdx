...
| <EntityLink id="fri">Forecasting Research Institute</EntityLink> | Forecasting methodology research | XPT Tournament, <EntityLink id="E144">ForecastBench</EntityLink>, Superforecaster Studies |
| <EntityLink id="quri">QURI</EntityLink> | Epistemic tools development | <EntityLink id="E286">Squiggle</EntityLink> Language, Squiggle Hub, <EntityLink id="E200">Metaforecast</EntityLink> |
| <EntityLink id="manifold">Manifold</EntityLink> | <EntityLink id="E228">Prediction markets</EntityLink> platform | AI Markets, <EntityLink id="E545">Manifest</EntityLink> Conference, <EntityLink id="E547">Manifund</EntityLink> |
