...
| <EntityLink id="organizations/epistemic-orgs/fri">Forecasting Research Institute</EntityLink> | Forecasting methodology research | XPT Tournament, <EntityLink id="E144">ForecastBench</EntityLink>, Superforecaster Studies |
| <EntityLink id="organizations/epistemic-orgs/quri">QURI</EntityLink> | Epistemic tools development | <EntityLink id="E286">Squiggle</EntityLink> Language, Squiggle Hub, <EntityLink id="E200">Metaforecast</EntityLink> |
| <EntityLink id="organizations/epistemic-orgs/manifold">Manifold</EntityLink> | <EntityLink id="E228">Prediction markets</EntityLink> platform | AI Markets, <EntityLink id="E545">Manifest</EntityLink> Conference, <EntityLink id="E547">Manifund</EntityLink> |

## Why <EntityLink id="E122">Epistemic Infrastructure</EntityLink> Matters for AI Safety
...
- <EntityLink id="E399">AGI Timeline</EntityLink> - Forecasts on when transformative AI may arrive
- <EntityLink id="E448">Alignment Evaluations</EntityLink> - Methods for assessing AI safety
