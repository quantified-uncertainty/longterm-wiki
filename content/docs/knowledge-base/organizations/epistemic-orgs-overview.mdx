...
|--------------|-------|----------------------|
| <EntityLink id="epoch-ai">Epoch AI</EntityLink> | AI trends research & compute tracking | ML Trends Database, Parameter Counts, Training Compute Estimates |
| <EntityLink id="metaculus">Metaculus</EntityLink> | Prediction aggregation platform | AI Forecasting, AGI Timeline Questions, Tournaments |
| <EntityLink id="fri">Forecasting Research Institute</EntityLink> | Forecasting methodology research | XPT Tournament, <EntityLink id="forecastbench">ForecastBench</EntityLink>, Superforecaster Studies |
| <EntityLink id="quri">QURI</EntityLink> | Epistemic tools development | <EntityLink id="squiggle">Squiggle</EntityLink> Language, Squiggle Hub, <EntityLink id="metaforecast">Metaforecast</EntityLink> |
| <EntityLink id="manifold">Manifold</EntityLink> | <EntityLink id="prediction-markets">Prediction markets</EntityLink> platform | AI Markets, <EntityLink id="manifest">Manifest</EntityLink> Conference, <EntityLink id="manifund">Manifund</EntityLink> |
