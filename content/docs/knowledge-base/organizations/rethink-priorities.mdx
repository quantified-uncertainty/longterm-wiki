...
Rethink Priorities claims that its research has influenced significant funding decisions within the effective altruism ecosystem and beyond. The organization reports that by 2023, its research had informed more than \$10 million in grants by other organizations. In 2023 alone, the organization worked with approximately 20 clients, consulted for organizations like GiveWell and <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink>, presented at more than 15 academic institutions, and organized 6 convenings[^rc-bfbc].
