...
A significant leadership change occurred when Marcus A. Davis became sole CEO, transitioning from the previous co-CEO structure with Peter Wildeford[^rc-1430]. This change reflected organizational maturation and a shift in leadership structure.
