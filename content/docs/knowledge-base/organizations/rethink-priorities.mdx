...
As of early 2026, Marcus A. Davis serves as sole CEO after a transition from the previous co-CEO structure with Peter Wildeford[^rc-b803]. The board of directors as of October 2025 included individuals from organizations connected to the effective altruism movement: Marcus Davis (Rethink Priorities), Niel Bowerman (<EntityLink id="E510" name="80000-hours">80,000 Hours</EntityLink>), Nikolai Vetr (Stanford University), and Abigail Olvera[^rc-c059].
