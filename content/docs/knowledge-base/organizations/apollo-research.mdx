...
clusters:
  ...
  - governance
---
import { DataInfoBox, DisagreementMap, KeyPeople, KeyQuestions, Section, EntityLink, Mermaid } from '@components/wiki';
...
|-----------|------------|----------|
| **Research Output** | High Impact | [December 2024 paper](https://arxiv.org/abs/2412.04984) tested 6 frontier models across 180+ scenarios; cited in <EntityLink id="E218" name="openai">OpenAI</EntityLink>/<EntityLink id="E22" name="anthropic">Anthropic</EntityLink> safety frameworks |
...
Apollo Research is a London-based AI safety research organization founded in 2023 that has emerged as the leading evaluator of <EntityLink id="E93" name="deceptive-alignment">deceptive alignment</EntityLink> and scheming behavior in frontier AI models. With approximately 20 full-time staff and partnerships with OpenAI, Anthropic, and <EntityLink id="E98" name="deepmind">Google DeepMind</EntityLink>, Apollo provides empirical evidence for one of AI safety's most concerning failure modes: whether advanced AI systems actually engage in strategic deception to achieve their goals.
...
- **Strategic implications**: Prerequisite capability for <EntityLink id="E274" name="scheming">scheming</EntityLink> behavior
...
- Pre-deployment testing for <EntityLink id="E274" name="scheming">scheming</EntityLink> behavior
...
|--------------|--------------|-------------------|
| <EntityLink id="E201" name="metr">METR</EntityLink> | Complementary evaluator | Methodology sharing |
| <EntityLink id="E25" name="arc">ARC</EntityLink> | Evaluation coordination | Framework alignment |
| <EntityLink id="E364" name="uk-aisi">UK AISI</EntityLink> | Policy advisor | Technical consultation |
| <EntityLink id="E57" name="chai">CHAI</EntityLink> | Academic partner | Research collaboration |
