...
<DataExternalLinks pageId="apollo-research" client:load />
...
Apollo Research is a London-based AI safety research organization founded in 2022 that has emerged as the leading evaluator of <EntityLink id="deceptive-alignment">deceptive alignment</EntityLink> and scheming behavior in frontier AI models. With approximately 20 full-time staff and partnerships with OpenAI, Anthropic, and <EntityLink id="deepmind">Google DeepMind</EntityLink>, Apollo provides empirical evidence for one of AI safety's most concerning failure modes: whether advanced AI systems actually engage in strategic deception to achieve their goals.
