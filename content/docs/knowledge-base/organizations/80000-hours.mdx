...
update_frequency: 21
summary: "80,000 Hours is the largest EA career organization, reaching 10M+ readers and reporting 3,000+ significant career plan changes, with 80% of \\$10M+ funding from Coefficient Giving. Since 2016 they've prioritized AI safety, shifting explicitly to AGI focus in 2025, providing career guidance through their guide, podcast (315+ episodes), job board (10K+ monthly clicks), and one-on-one advising."
clusters:
  - community
  - ai-safety
---
...
| **Primary Funder** | Coefficient Giving (formerly <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>) |
...
Until April 2025, 80,000 Hours operated as a project within Effective Ventures—the umbrella organization that also housed Giving What We Can, the <EntityLink id="E517" name="cea">Centre for Effective Altruism</EntityLink>, and several other EA-affiliated projects. This structure provided administrative support and legal infrastructure but limited operational flexibility.
...
|------|-------------|------------|-----------------|
| **<EntityLink id="E297" name="technical-research">Technical AI Safety Research</EntityLink>** | Developing solutions to prevent dangerous AI behavior | Very high (PhD-level) | Very high |
| **<EntityLink id="E154" name="governance-policy">AI Governance and Policy</EntityLink>** | Shaping regulations and international coordination | High | Very high |
...
|--------------|------------------------|-------------------|
| **Risks from <EntityLink id="E226" name="power-seeking">Power-Seeking AI</EntityLink>** | Top priority; potentially existential | Highest |
...
| **Notable Episodes** | [#226: Ajeya Cotra on transformative AI crunch time](https://80000hours.org/podcast/episodes/ajeya-cotra-transformative-ai-crunch-time/) (Feb 2026); #151: <EntityLink id="E864" name="ajeya-cotra">Ajeya Cotra</EntityLink> on deceptive AI (May 2023) |
...
80,000 Hours receives approximately 80% of its funding from <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>:
...
### Funding Sources
- <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>: 80,000 Hours General Support
- <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>: 80,000 Hours Marketing 2025
- <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>: 80,000 Hours Marketing 2023
- <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>: 80,000 Hours Marketing 2022
