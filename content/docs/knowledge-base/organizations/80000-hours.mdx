...
| **Primary Funder** | Coefficient Giving (formerly <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink>) |
...
80,000 Hours receives approximately 80% of its funding from <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink>:
