...
| **Primary Funder** | Coefficient Giving (formerly <EntityLink id="E552">Coefficient Giving</EntityLink>) |
...
Until April 2025, 80,000 Hours operated as a project within Effective Ventures—the umbrella organization that also housed Giving What We Can, the <EntityLink id="E517">Centre for Effective Altruism</EntityLink>, and several other EA-affiliated projects. This structure provided administrative support and legal infrastructure but limited operational flexibility.
...
|------|-------------|------------|-----------------|
| **<EntityLink id="E297">Technical AI Safety Research</EntityLink>** | Developing solutions to prevent dangerous AI behavior | Very high (PhD-level) | Very high |
| **<EntityLink id="E154">AI Governance and Policy</EntityLink>** | Shaping regulations and <EntityLink id="E171">international coordination</EntityLink> | High | Very high |
...
|--------------|------------------------|-------------------|
| **Risks from <EntityLink id="E226">Power-Seeking AI</EntityLink>** | Top priority; potentially existential | Highest |
...
80,000 Hours receives approximately 80% of its funding from <EntityLink id="E521">Coefficient Giving</EntityLink>:
...
### Funding Sources
- <EntityLink id="E521">Coefficient Giving</EntityLink>: 80,000 Hours General Support
- <EntityLink id="E521">Coefficient Giving</EntityLink>: 80,000 Hours Marketing 2025
- <EntityLink id="E521">Coefficient Giving</EntityLink>: 80,000 Hours Marketing 2023
- <EntityLink id="E521">Coefficient Giving</EntityLink>: 80,000 Hours Marketing 2022
