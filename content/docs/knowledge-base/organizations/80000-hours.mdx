...
<DataExternalLinks pageId="80000-hours" client:load />
...
| **Primary Funder** | Coefficient Giving (formerly <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink>) |
