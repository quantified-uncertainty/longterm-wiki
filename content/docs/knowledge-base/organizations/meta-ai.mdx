...
<KBRecordTable entity="tt0f5PYDCw" collection="key-persons" title="Key People" columns={["person", "title", "start", "is_founder"]} />
...
<KBRecordTable entity="tt0f5PYDCw" collection="model-releases" title="Model Releases" columns={["name", "released", "description"]} />
...
<KBRecordTable entity="tt0f5PYDCw" collection="products" title="Products" columns={["name", "launched", "description"]} />
...
<KBRecordTable entity="tt0f5PYDCw" collection="safety-milestones" title="Safety Milestones" columns={["name", "date", "type", "description"]} />
