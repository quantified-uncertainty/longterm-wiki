...
<KBRecordTable entity="meta-ai" collection="key-persons" title="Key People" columns={["person", "title", "start", "is_founder"]} />
...
<KBRecordTable entity="meta-ai" collection="model-releases" title="Model Releases" columns={["name", "released", "description"]} />
...
<KBRecordTable entity="meta-ai" collection="products" title="Products" columns={["name", "launched", "description"]} />
...
<KBRecordTable entity="meta-ai" collection="safety-milestones" title="Safety Milestones" columns={["name", "date", "type", "description"]} />
