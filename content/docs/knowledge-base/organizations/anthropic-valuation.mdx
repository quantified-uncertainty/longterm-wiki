...
<EntityLink id="E22">Anthropic</EntityLink>'s \$350 billion valuation (January 2026) requires careful analysis. **Previous claims that Anthropic trades "3.8x cheaper" than <EntityLink id="E218">OpenAI</EntityLink> were based on stale data and are incorrect.** With updated figures, Anthropic actually trades at a *higher* revenue multiple than OpenAI.
