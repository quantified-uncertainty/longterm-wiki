...
| Zach Robinson | CEO, <EntityLink id="centre-for-effective-altruism">Centre for Effective Altruism</EntityLink> | Current | Initial trustee[^1][^7] |
...
- <EntityLink id="anthropic-investors">Anthropic (Funder)</EntityLink> — Funding history, founder pledges, and philanthropic implications
- <EntityLink id="anthropic-ipo">Anthropic IPO</EntityLink> — IPO timeline and preparation status
- <EntityLink id="rsp">Responsible Scaling Policy</EntityLink> — Anthropic's safety framework that integrates with LTBT governance
- <EntityLink id="openai">OpenAI</EntityLink> — Competitor with contrasting governance structure
