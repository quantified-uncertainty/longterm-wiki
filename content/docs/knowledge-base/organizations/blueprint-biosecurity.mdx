...
| **Funding** | Moderate, growing | ≈\$1.85M from <EntityLink id="open-philanthropy">Coefficient Giving</EntityLink>; additional grants from Founders Pledge[^3][^4] |
...
[^3]: [Coefficient Giving — Blueprint Biosecurity General Support (2023)](https://www.openphilanthropy.org/grants/blueprint-biosecurity-general-support/)
[^4]: [Coefficient Giving — Blueprint Biosecurity General Support (2024)](https://www.openphilanthropy.org/grants/blueprint-biosecurity-general-support-2024/)
