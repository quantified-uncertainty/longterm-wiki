...
| **Parent** | EA Funds (<EntityLink id="E517" name="cea">Centre for Effective Altruism</EntityLink>) |
...
|--------|--------------|-------------------|---------------------|
| **2017** | ≈\$500K | ≈30% | EA Funds launch; <EntityLink id="E861" name="nick-beckstead">Nick Beckstead</EntityLink> sole manager |
...
|----------|------------|---------------|-------------|
| **<EntityLink id="E297" name="technical-research">Technical AI Safety Research</EntityLink>** | 35% | ≈\$2.3M | Independent research, small teams, lab collaborations |
...
| **<EntityLink id="oliver-habryka" name="oliver-habryka">Oliver Habryka</EntityLink>** | Permanent Manager | CEO of Lightcone Infrastructure (LessWrong); [cofounder of Lighthaven venue](https://www.complexsystemspodcast.com/episodes/bits-and-bricks-oliver-habryka/) | Community infrastructure, epistemics |
...
|---------------|-------------|-----------|
| **<EntityLink id="lawrence-chan" name="lawrence-chan">Lawrence Chan</EntityLink>** | ARC Evals | AI evaluations, safety research |
...
| **<EntityLink id="E435" name="eli-lifland">Eli Lifland</EntityLink>** | Forecasting | Quantitative analysis |
...
In October 2018, a new management team was announced: Matt Fallshaw (chair), <EntityLink id="E575" name="helen-toner">Helen Toner</EntityLink>, Oliver Habryka, Matt Wage, and Alex Zhu, with Nick Beckstead and Jonas Vollmer as advisors. This transition marked a fundamental shift:
...
|--------|------------|-------|
| **<EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>** | ≈40-50% | Regranting arrangement; largest single source |
