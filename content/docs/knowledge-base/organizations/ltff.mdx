...
| **Parent** | EA Funds (<EntityLink id="cea">Centre for Effective Altruism</EntityLink>) |
...
|----------|------------|---------------|-------------|
| **<EntityLink id="technical-research">Technical AI Safety Research</EntityLink>** | 35% | ≈\$2.3M | Independent research, small teams, lab collaborations |
...
| **<EntityLink id="ai-governance">AI Governance</EntityLink> & Policy** | 10% | ≈\$670K | Policy research, advocacy, institutional engagement |
...
LTFF remained relatively stable, with <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> (then Coefficient Giving) providing approximately 40-50% of funding and the remainder from direct donations. The fund [issued statements](https://forum.effectivealtruism.org/posts/PAco5oG579k2qzrh9/ltff-and-eaif-are-unusually-funding-constrained-right-now) about funding constraints in early 2023.
...
|--------|------------|-------|
| **<EntityLink id="coefficient-giving">Coefficient Giving</EntityLink>** | ≈40-50% | Regranting arrangement; largest single source |
