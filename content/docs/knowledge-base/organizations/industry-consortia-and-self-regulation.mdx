...
The Frontier Model Forum was founded in 2023 by <EntityLink id="E22">Anthropic</EntityLink>, Google, Microsoft, and <EntityLink id="E218">OpenAI</EntityLink>, with Meta and xAI subsequently joining. It is explicitly focused on the safety of frontier AI models — the most capable systems at the leading edge of development.
