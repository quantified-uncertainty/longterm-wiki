...
:::note[Page Scope]
This page analyzes the **governance paradox** of the OpenAI Foundation—why a nonprofit "controlling" a <F e="openai" f="valuation-2025">\$500B</F> company provides less accountability than it appears. For Foundation assets, spending projections, and philanthropy analysis, see <EntityLink id="openai-foundation">OpenAI Foundation</EntityLink>. For the legal challenge to this structure, see <EntityLink id="musk-openai-lawsuit">Musk v. OpenAI Lawsuit</EntityLink>.
:::
