...
- <EntityLink id="openai-foundation">OpenAI Foundation</EntityLink> — Assets, spending projections, philanthropic activities
- <EntityLink id="musk-openai-lawsuit">Musk v. OpenAI Lawsuit</EntityLink> — Legal challenge to the restructuring
- <EntityLink id="long-term-benefit-trust">Long-Term Benefit Trust</EntityLink> — Anthropic's contrasting governance approach
- <EntityLink id="openai">OpenAI</EntityLink> — The for-profit company
- <EntityLink id="anthropic">Anthropic</EntityLink> — Competitor with different governance structure
