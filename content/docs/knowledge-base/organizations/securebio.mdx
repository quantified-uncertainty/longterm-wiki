...
| **Funding** | Well-funded by EA sources | ≈\$9.4M from <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink> across multiple grants[^2][^3][^4] |
...
The organization quickly attracted funding from <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink>, receiving multiple grants:
...
|--------|--------|---------|------|
| <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink> | \$4,000,000 | General support (3 years) | 2023 |
...
[^2]: [Open Philanthropy - SecureBio General Support](https://www.openphilanthropy.org/grants/securebio-general-support/) - \$4M grant
[^3]: [Open Philanthropy - SecureBio NAO](https://www.openphilanthropy.org/grants/securebio-nucleic-acid-observatory/) - \$3.43M grant
[^4]: [Open Philanthropy - Biosecurity Research](https://www.openphilanthropy.org/grants/securebio-biosecurity-research/) - \$1.42M grant
...
[^10]: [Open Philanthropy - Pathogen Early Warning](https://www.openphilanthropy.org/grants/securebio-pathogen-early-warning-project/) - \$570K grant
