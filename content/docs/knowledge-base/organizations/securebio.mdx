...
**<EntityLink id="securedna">SecureDNA</EntityLink>**: A legally separate Swiss nonprofit co-founded by Esvelt, providing free DNA synthesis screening software to prevent dangerous pathogen creation. The system can detect hazardous genetic sequences down to 30 base pairs.[^rc-7117]
...
SecureBio collaborates with frontier AI companies including <EntityLink id="anthropic">Anthropic</EntityLink> to build evaluation tools and mitigation strategies. Notably, former SecureBio Research Scientist Anjali Gopal, who co-led the AI project, moved to Anthropic's technical staff.[^rc-ccb6]
...
- **Anjali Gopal** - Former AI Project Co-Lead, now at <EntityLink id="anthropic">Anthropic</EntityLink>[^rc-ccb6]
...
Some experts argue that emphasizing certain risks could "fuel threats rather than mitigate them"—citing how Al Qaeda's <EntityLink id="bioweapons">bioweapons</EntityLink> efforts reportedly began after the United States publicly highlighted biosecurity vulnerabilities.[^rc-d2ee]
