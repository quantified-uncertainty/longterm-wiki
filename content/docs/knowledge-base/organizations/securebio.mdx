...
| **Funding** | Well-funded by EA sources | ≈\$9.4M from <EntityLink id="open-philanthropy">Coefficient Giving</EntityLink> across multiple grants[^rc-14a6][^rc-ddc2][^rc-e509] |
