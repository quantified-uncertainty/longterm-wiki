...
| **Funding** | Well-funded by EA sources | ≈\$9.4M from <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> across multiple grants[^rc-14a6][^rc-ddc2][^rc-e509] |
...
The organization quickly attracted funding from <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink>, receiving multiple grants:
...
|--------|--------|---------|------|
| <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> | \$4,000,000 | General support (3 years) | 2023 |
