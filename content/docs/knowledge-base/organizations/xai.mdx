...
<DataExternalLinks pageId="xai" client:load />
...
- **Neuralink**: <EntityLink id="brain-computer-interfaces">Brain-computer interfaces</EntityLink>
...
**Challenge case:**
- Falls behind OpenAI/Google/<EntityLink id="anthropic">Anthropic</EntityLink>
...
**Safety framing:**
- **Anthropic**: <EntityLink id="constitutional-ai">Constitutional AI</EntityLink>, Responsible Scaling Policy, interpretability
