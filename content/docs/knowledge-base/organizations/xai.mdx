...
update_frequency: 3
summary: "Comprehensive profile of xAI covering its founding by Elon Musk in 2023, rapid growth including a \\$20B Series E round and \\$3.8B revenue, development of Grok models, and controversial 'truth-seeking' safety approach that has led to incidents like 'MechaHitler' and shutdown resistance behavior."
clusters:
  - ai-safety
  - community
  - governance
...
xAI is an artificial intelligence company founded by <EntityLink id="E116" name="elon-musk">Elon Musk</EntityLink> in July 2023 with the stated mission to "understand the true nature of the universe" through AI. The company develops Grok, a large language model integrated into X (formerly Twitter), and positions itself as pursuing "maximum truth-seeking AI" as an alternative to what Musk characterizes as "woke" AI from competitors.
...
<FBRecordTable entity="sid_GLXKjYAEKw" collection="key-persons" title="Key People" columns={["person", "title", "start", "is_founder"]} />
...
- Series E: \$20 billion (January 2026)[^rc-fb1c]
- Total raised: Over \$26 billion (cumulative across rounds)[^rc-fb1c]
...
<FBRecordTable entity="sid_GLXKjYAEKw" collection="model-releases" title="Grok Model Releases" columns={["name", "released", "description"]} />
...
<FBFactTable entity="sid_GLXKjYAEKw" property="valuation" title="Valuation History" />

<FBRecordTable entity="sid_GLXKjYAEKw" collection="funding-rounds" title="Funding History" columns={["date", "raised", "valuation", "notes"]} />
...
| **Funding (2025)** | \$20B Series E raised[^rc-fb1c] | ≈\$13B+ from Microsoft | ≈\$7B+ from Google/others | Google subsidiary |
