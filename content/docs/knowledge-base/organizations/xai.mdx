...
<KBRecordTable entity="GLXKjYAEKw" collection="key-persons" title="Key People" columns={["person", "title", "start", "is_founder"]} />
...
<KBRecordTable entity="GLXKjYAEKw" collection="model-releases" title="Grok Model Releases" columns={["name", "released", "description"]} />
...
<KBFactTable entity="GLXKjYAEKw" property="valuation" title="Valuation History" />

<KBRecordTable entity="GLXKjYAEKw" collection="funding-rounds" title="Funding History" columns={["date", "raised", "valuation", "notes"]} />
