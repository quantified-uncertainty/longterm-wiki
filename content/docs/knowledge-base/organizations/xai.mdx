...
<KBItemTable entity="xai" collection="key-persons" title="Key People" columns={["person", "title", "start", "is_founder"]} />
...
<KBItemTable entity="xai" collection="funding-rounds" title="Funding History" columns={["date", "raised", "valuation", "notes"]} />
