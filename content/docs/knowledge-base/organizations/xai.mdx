...
**Team:**
- Hired from <EntityLink id="deepmind">Google DeepMind</EntityLink>, OpenAI, Tesla
...
- Significant gaps in risk assessment and safety frameworks compared to <EntityLink id="anthropic">Anthropic</EntityLink> and OpenAI[^rc-974f]
...
|--------|-----|--------|-----------|-----------------|
| **Safety Approach** | "Truth-seeking" with minimal restrictions | Alignment research with content moderation | <EntityLink id="constitutional-ai">Constitutional AI</EntityLink>, safety-first | Responsible AI with extensive research |
