...
<FBRecordTable entity="GLXKjYAEKw" collection="key-persons" title="Key People" columns={["person", "title", "start", "is_founder"]} />
...
<FBRecordTable entity="GLXKjYAEKw" collection="model-releases" title="Grok Model Releases" columns={["name", "released", "description"]} />
...
<FBFactTable entity="GLXKjYAEKw" property="valuation" title="Valuation History" />

<FBRecordTable entity="GLXKjYAEKw" collection="funding-rounds" title="Funding History" columns={["date", "raised", "valuation", "notes"]} />
