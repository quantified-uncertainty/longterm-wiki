...
| **Primary Funder** | <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> (initial \$15M, additional \$12M+) |
...
CSET was established through a major philanthropic initiative by <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> (then Open Philanthropy), which recommended a \$15 million grant over five years to Georgetown University specifically to create a new think tank at the intersection of national security and emerging technologies. The founding was motivated by a perceived gap in rigorous, technically-informed policy analysis on AI security issues.

| Milestone | Date | Details |
|-----------|------|---------|
| <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> grant approved | January 2019 | \$15M over 5 years |
...
| **Previous Role** | Senior Research Analyst, <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> |
...
3. **Funder Concentration**: Heavy reliance on <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink>, though diversifying
