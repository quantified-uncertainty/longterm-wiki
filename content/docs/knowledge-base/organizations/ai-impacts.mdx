...
The <EntityLink id="cais">Center for AI Safety</EntityLink>, under director <EntityLink id="dan-hendrycks">Dan Hendrycks</EntityLink>, released a statement equating AI extinction risk to threats from pandemics and nuclear war, signed by researchers across multiple disciplines.[^cr-9f1c] A public poll found that 61% of US respondents view AI as a threat to humanity.[^cr-9f1c] Against this backdrop, AI Impacts' emphasis on empirical analysis and evidence synthesis serves to ground discussions that might otherwise remain primarily theoretical.
