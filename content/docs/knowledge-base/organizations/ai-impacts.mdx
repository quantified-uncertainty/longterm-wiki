...
| **Community Ties** | <EntityLink id="E538">LessWrong</EntityLink>, Effective Altruism |
...
AI Impacts occupies a distinctive niche within the AI safety ecosystem. While organizations like <EntityLink id="E22">Anthropic</EntityLink> and <EntityLink id="E98">DeepMind</EntityLink> focus on technical safety research, and others concentrate on governance and policy, AI Impacts emphasizes empirical analysis and evidence gathering.
...
The <EntityLink id="E47">Center for AI Safety</EntityLink>, under director <EntityLink id="E89">Dan Hendrycks</EntityLink>, released a statement equating AI extinction risk to threats from pandemics and nuclear war, signed by researchers across multiple disciplines.[^7] A public poll found that 61% of US respondents view AI as a threat to humanity.[^7] Against this backdrop, AI Impacts' emphasis on empirical analysis and evidence synthesis serves to ground discussions that might otherwise remain primarily theoretical.
