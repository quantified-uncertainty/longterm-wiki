...
**EA-Adjacent Investors**: The charitable foundation of Facebook co-founder Dustin Moskovitz (a major EA funder through <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink>) is among VARA's investors.[^4]
