...
- **Philanthropic funders** like <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink> that support safety research across multiple institutions
