...
| **S-Process Developers** | Andrew Critch, <EntityLink id="E577" name="jaan-tallinn">Jaan Tallinn</EntityLink>, Oliver Habryka, Kevin Arlin, Jason Moggridge |
...
| 2014 | Co-founder, [FLI](https://futureoflife.org/) | Future of Life Institute (with <EntityLink id="E433" name="max-tegmark">Max Tegmark</EntityLink>, Anthony Aguirre) |
