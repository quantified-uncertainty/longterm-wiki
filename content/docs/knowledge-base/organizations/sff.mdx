...
**LTFF Relationship**: LTFF has received funding from both SFF and Coefficient Giving, making it partially downstream of these larger funders. [About 40% of LTFF's 2022 funding came from Coefficient (then Coefficient Giving)](https://forum.effectivealtruism.org/posts/zt6MsCCDStm74HFwo/ea-funds-organisational-update-open-philanthropy-matching-and). LTFF typically makes smaller grants (\$10K-\$500K) compared to SFF's median ≈\$100K and often funds individuals or very early-stage projects.
