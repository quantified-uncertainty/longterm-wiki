...
---
import {EntityLink, Mermaid, F} from '@components/wiki';
...
Musk's expert witness, financial economist C. Paul Wazzan, calculated damages as Musk's proportional share of OpenAI's current <F e="openai" f="valuation-2025">\$500B</F>+ valuation based on his seed funding:
