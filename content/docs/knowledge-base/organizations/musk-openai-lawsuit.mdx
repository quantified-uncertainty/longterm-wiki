...
| **Defendants** | OpenAI, <EntityLink id="E269" name="sam-altman">Sam Altman</EntityLink>, <EntityLink id="E1012" name="greg-brockman">Greg Brockman</EntityLink>, Microsoft |
...
:::note[Page Scope]
This page covers the **legal challenge** to OpenAI's restructuring. For analysis of the Foundation's governance structure, see <EntityLink id="E404" name="openai-foundation-governance">OpenAI Foundation Governance Paradox</EntityLink>. For Foundation assets and spending, see <EntityLink id="E421" name="openai-foundation">OpenAI Foundation</EntityLink>.
:::

## Overview

<EntityLink id="E116" name="elon-musk">Elon Musk</EntityLink> filed suit against <EntityLink id="E218" name="openai">OpenAI</EntityLink>, <EntityLink id="E269" name="sam-altman">Sam Altman</EntityLink>, Greg Brockman, and Microsoft in August 2024, alleging that OpenAI's leadership fraudulently induced his \$38 million seed donation by promising the organization would remain a nonprofit dedicated to beneficial AI—then converted to a for-profit structure that enriched insiders.
...
| **<EntityLink id="E269" name="sam-altman">Sam Altman</EntityLink>** | CEO, co-founder | Fraud, misrepresentation about nonprofit commitment |
