...
- [FTX Red Flags: Pre-Collapse Warning Signs](/knowledge-base/history/ftx-red-flags-pre-collapse-warning-signs-that-were-overlooked) — Detailed analysis of the governance and financial warning signs that were missed
- [EA Epistemic Failures in the FTX Era](/knowledge-base/history/ea-epistemic-failures-in-the-ftx-era) — The EA community's reckoning with how they missed those warning signs
- [FTX Future Fund](/knowledge-base/organizations/ftx-future-fund) — The philanthropic vehicle that channeled FTX money to AI safety
...
[^32]: [FTX Collapse - EA Forum Topics](https://forum.effectivealtruism.org/topics/ftx-collapse) - EA Forum[^34]: [How FTX's Collapse Impacts AI](https://www.deeplearning.ai/the-batch/how-ftxs-collapse-impacts-ai/) - DeepLearning.AI, The Batch
