...
[Astralis Foundation](https://astralisfoundation.org) is a philanthropic organization with the stated vision of "a flourishing world with secure and beneficial AI for all."[^rc-a3f0] The foundation unites funders, experts, and entrepreneurs to develop and expand interventions in AI safety and governance, providing funding, strategic guidance, and network access to steer AI development toward beneficial outcomes.

The foundation's operational approach emphasizes venture-style high-risk/high-reward philanthropic bets, multi-funder collaboration, evidence-based decision-making, and expert-driven strategy.[^rc-a3f0] Astralis operates from four offices across Stockholm, London, New York, and Vienna, reflecting its global orientation.
...
Astralis organizes its work around three primary focus areas:[^rc-a3f0]

### Building West-Asia Bridges

The foundation supports efforts to establish global governance structures for trustworthy AI innovation. Its flagship initiative in this area is support for the International Dialogues on AI Safety (IDAIS), which brings together AI scientists and policymakers from Western nations and China to discuss safety standards and cooperation. According to the foundation, IDAIS is now in its fourth session.[^rc-a3f0]

### European AI Safety Leadership

Astralis works to strengthen Europe's capacity for safe AI development while preventing catastrophic risks. In this area, the foundation supported the Langsikt Centre in producing policy recommendations for Norwegian decision-makers on AI safety and governance.[^rc-a3f0]

### AI Risk and Opportunity Communication

The foundation aims to inform stakeholders and decision-makers about AI progress and associated dangers. Astralis co-hosted the 2024 Nordics AI Safety Summit and the 2025 Nordic AI Retreat in Stockholm.[^rc-a3f0][^rc-cebf]

## Shared Horizons Fund

Astralis operates the Shared Horizons Fund, a multi-funder vehicle for AI safety grantmaking. The fund is led by Senior Advisor Tim Shavers.[^rc-a2ec] Specific details about the fund's size, grantees, and disbursement strategy have not been publicly disclosed.
...
The foundation's board and advisory circle includes Simran Dhaliwal, Samuel Hargestam, Oliver Edholm, <EntityLink id="E39" name="beth-barnes">Beth Barnes</EntityLink> (founder of <EntityLink id="E201" name="metr">METR</EntityLink>), and Andreas Ehn (first CTO of Spotify).[^rc-a2ec]
