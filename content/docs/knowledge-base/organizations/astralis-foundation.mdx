...
The foundation's board and advisory circle includes Simran Dhaliwal, Samuel Hargestam, Oliver Edholm, <EntityLink id="E39" name="beth-barnes">Beth Barnes</EntityLink> (founder of <EntityLink id="E201" name="metr">METR</EntityLink>), and Andreas Ehn (first CTO of Spotify).[^3]
