...
---
import {DataInfoBox, KeyPeople, Section, Backlinks, Mermaid, DataExternalLinks, EntityLink} from '@components/wiki';

<DataExternalLinks pageId="govai" client:load />
