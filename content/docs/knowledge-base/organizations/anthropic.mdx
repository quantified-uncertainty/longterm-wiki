...
<KBItemTable entity="anthropic" collection="key-persons" title="Key People" columns={["person", "title", "start", "end", "is_founder"]} />
...
<KBItemTable entity="anthropic" collection="board-seats" title="Board of Directors" columns={["member", "role", "appointed", "background", "appointed_by"]} />
...
<KBItemTable entity="anthropic" collection="products" title="Products & Services" columns={["name", "launched", "description"]} />
...
<KBItemTable entity="anthropic" collection="research-areas" title="Research Programs" columns={["name", "description", "team-size", "started"]} />
...
<KBItemTable entity="anthropic" collection="funding-rounds" title="Funding History" columns={["date", "raised", "valuation", "lead_investor", "notes"]} />
