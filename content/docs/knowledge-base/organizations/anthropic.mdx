...
subcategory: labs
---
import {DataInfoBox, EntityLink, DataExternalLinks, SquiggleEstimate, Calc} from '@components/wiki';
...
As of January 2026: <F e="anthropic" f="valuation" /> valuation, <F e="anthropic" f="revenue-arr-2025" /> ARR (end 2025), targeting <F e="anthropic" f="revenue-2026-guidance" /> for 2026. Anthropic trades at ≈<Calc expr="{anthropic.valuation} / {anthropic.revenue-arr-2025}" precision={0} suffix="x" /> revenue vs <EntityLink id="openai">OpenAI</EntityLink>'s ≈25x—see <EntityLink id="anthropic-valuation">Valuation Analysis</EntityLink> for why this premium may or may not be justified (including <F e="anthropic" f="customer-concentration" /> customer concentration risk and margin pressure).
...
currentValuation = 350  // \$B — from canonical facts
...
currentPSRatio = currentValuation / 9  // valuation / ARR
