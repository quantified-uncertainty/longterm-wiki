...
At the \$380B Series G valuation (Feb 2026), Anthropic's ownership includes seven co-founders, strategic tech investors, and EA-aligned early backers. See <EntityLink id="E815">Anthropic Stakeholders</EntityLink> for the full breakdown.
...
| **<EntityLink id="E577">Jaan Tallinn</EntityLink>** | 0.6-1.7% | \$2-6B | Led Series A; AI safety funder |
| **<EntityLink id="E436">Dustin Moskovitz</EntityLink>** | 0.8-2.5% | \$3-9B | \$500M already in nonprofit vehicle |
| **Employee equity pool** | 12-18% | \$46-68B | Historical 3:1 matching (now 1:1 for new hires) |

**EA-aligned capital**: \$27-76B risk-adjusted. Most reliable source: \$16-38B in employee DAFs (legally bound). Only 2/7 founders have strong EA connections. See <EntityLink id="E406">Anthropic (Funder)</EntityLink> for the full analysis.
...
As of February 2026: <F e="anthropic" f="6796e194">\$380B</F> valuation (Series G), <F e="anthropic" f="0ed4db9e">\$14B</F> run-rate revenue, targeting \$20-26B for 2026. Anthropic trades at ≈<Calc expr="{anthropic.6796e194} / {anthropic.0ed4db9e}" precision={0} suffix="x" />  current revenue vs <EntityLink id="openai">OpenAI</EntityLink>'s <Calc expr="{openai.39d6868e} / {openai.609b9796}" precision={0} prefix="≈" suffix="x" />—see <EntityLink id="anthropic-valuation">Valuation Analysis</EntityLink> for analysis, including <F e="anthropic" f="fac5b934">25%</F> customer concentration risk and margin pressure.
...
Claude Code's run-rate revenue exceeded \$2.5 billion as of February 2026, more than doubling since early 2025.[^seriesg] According to Menlo Ventures data from July 2025, Anthropic holds 42% of the enterprise market share for coding, more than double OpenAI's 21%.[^techcrunch1]
