...
According to Menlo Ventures data from July 2025, Anthropic captured <KBF entity="anthropic" property="enterprise-market-share" />% of the enterprise LLM market share by usage—up from 12% two years prior. OpenAI's share declined from 50% to 25% over the same period.[^rc-9c6d]
