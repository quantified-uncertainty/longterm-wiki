...
---
import {EntityLink, KeyQuestions, Section} from '@components/wiki';
...
The Winter Solstice event in December 2025 is the primary publicly documented activity. The event was held at Mox SF (1680 Mission Street, San Francisco), a coworking and events space founded by Austin Chen, formerly co-founder of Manifold Markets and founder of <EntityLink id="E547" name="manifund">Manifund</EntityLink>.[^1] Mox describes itself as "a research-focused incubator & community space for doers of good and masters of craft" and explicitly rents space to aligned community organizers.[^2]
...
No statement from Gratified connecting its event to the Secular Solstice tradition has been found in public sources. Gratified also does not appear in the publicly maintained index of Bay Area rationalist groups on <EntityLink id="E538" name="lesswrong">LessWrong</EntityLink>.[^9]
...
[^1]: Austin Chen, ["Fundraising for Mox: Coworking & Events in SF"](https://forum.effectivealtruism.org/posts/Hx2HFo3hB3T54nZfb/fundraising-for-mox-coworking-and-events-in-sf), EA Forum, March 31, 2025.
[^2]: Austin Chen, ["Introducing the Mox Guest Program"](https://forum.effectivealtruism.org/posts/gmfFDhqw24otdm7NJ/introducing-the-mox-guest-program), EA Forum, October 1, 2025.
[^3]: ["Butoh"](https://en.wikipedia.org/wiki/Butoh), Wikipedia.
[^4]: ["Mox SF — Official Website"](https://moxsf.com/), moxsf.com.
[^5]: ["EA San Francisco Needs a New Lead Organizer"](https://forum.effectivealtruism.org/posts/mQoq3RXtwhgNwLBGN/ea-san-francisco-needs-a-new-lead-organizer), EA Forum, January 5, 2026.
[^6]: ["Secular Solstice"](https://en.wikipedia.org/wiki/Secular_Solstice), Wikipedia.
[^7]: ["At Bay Area's Secular Solstice, Rationalists Grapple with AI Doomsday Scenarios"](https://religionnews.com/2025/12/19/at-bay-areas-secular-solstice-rationalists-grapple-with-ai-doomsday-scenarios/), Religion News Service, December 20, 2025.
[^8]: ["Secular Solstice Round Up 2024"](https://www.lesswrong.com/posts/nLYbjLcvedSZKFME3/secular-solstice-round-up-2024), LessWrong, December 2024.
[^9]: ["Index of Rationalist Groups in the Bay Area — July 2024"](https://www.lesswrong.com/posts/hDefuqC2Rbnr8THYW/index-of-rationalist-groups-in-the-bay-area-july-2024), LessWrong, July 2024.
