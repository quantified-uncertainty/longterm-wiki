...
summary: Gratified is an early-stage coffee and art community organization in San Francisco that hosts events at EA-adjacent venues, including a 24-hour Winter Solstice event at Mox SF in December 2025. It operates under a parent organization called Buttercup Destiny, which is itself described as still in development.
clusters:
  - community
balanceFlags:
