...
| **Funding** | Well-funded by EA sources + traditional philanthropy | >\$29M identified from <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> across multiple grants; NTI parent org founded with \$250M from Ted Turner[^rc-fc52][^rc-6c62] |
...
<EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> identifies NTI | bio as among the "highest-impact biosecurity organizations" in the world.[^rc-fc52] Founders Pledge has recommended NTI | bio as a high-impact giving opportunity in the biosecurity space.[^rc-aaa1]
