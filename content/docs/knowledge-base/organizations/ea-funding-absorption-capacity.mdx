...
:::note[Page Scope]
This page analyzes how much capital the EA ecosystem can productively absorb per year, focused on AI safety. For the capital supply side, see <EntityLink id="E406">Anthropic (Funder)</EntityLink> and <EntityLink id="E694">EA Shareholder Diversification from Anthropic</EntityLink>. For current funding levels, see <EntityLink id="E641">Longtermist Funders</EntityLink>.
