...
:::note[Page Scope]
This page analyzes how much capital the EA ecosystem can productively absorb per year, focused on AI safety. For the capital supply side, see <EntityLink id="E406" name="anthropic-investors">Anthropic (Funder)</EntityLink> and <EntityLink id="E858" name="ea-shareholder-diversification-anthropic">EA Shareholder Diversification from Anthropic</EntityLink>. For current funding levels, see <EntityLink id="E641" name="funders-overview">Longtermist Funders</EntityLink>.
...
Per the <EntityLink id="E641" name="funders-overview">Longtermist Funders</EntityLink> overview, total AI safety funding is approximately \$120-150M/year:

| Funder | Annual AI Safety | Share |
|--------|-----------------|-------|
| <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> (Moskovitz) | \$65M | ≈55% |
...
- **Technical AI safety research** (alignment, interpretability, evaluations): ≈\$40-60M/year across <EntityLink id="E202" name="miri">MIRI</EntityLink>, <EntityLink id="E557" name="redwood-research">Redwood Research</EntityLink>, <EntityLink id="E201" name="metr">METR</EntityLink>, university labs, and independent researchers
- **AI governance and policy**: ≈\$20-30M/year across think tanks, policy organizations, and government-adjacent groups
- **Field-building and talent pipeline**: ≈\$15-25M/year through <EntityLink id="E510" name="80000-hours">80,000 Hours</EntityLink>, university programs, and fellowships
- **Regranting and infrastructure**: ≈\$10-20M/year through <EntityLink id="E543" name="ltff">LTFF</EntityLink>, <EntityLink id="E547" name="manifund">Manifund</EntityLink>, and fiscal sponsors
...
<EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> has been the EA ecosystem's primary experiment in scaling grantmaking:
...
- Rebranded from Open Philanthropy to <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> in November 2025 as part of organizational evolution
...
2. **Regranting infrastructure**: Scale <EntityLink id="E543" name="ltff">LTFF</EntityLink>, <EntityLink id="E547" name="manifund">Manifund</EntityLink>, and SFF 5-10x. Create new regranting bodies for specific cause areas. Cost: \$50-100M/year. Payoff: distributes evaluation capacity.
...
**For grantmakers (<EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>, <EntityLink id="E567" name="sff">SFF</EntityLink>, <EntityLink id="E543" name="ltff">LTFF</EntityLink>):**
