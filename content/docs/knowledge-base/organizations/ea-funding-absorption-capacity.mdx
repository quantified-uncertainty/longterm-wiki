...
:::note[Page Scope]
This page analyzes how much capital the EA ecosystem can productively absorb per year, focused on AI safety. For the capital supply side, see <EntityLink id="E406">Anthropic (Funder)</EntityLink> and <EntityLink id="E697">EA Shareholder Diversification from Anthropic</EntityLink>. For current funding levels, see <EntityLink id="E641">Longtermist Funders</EntityLink>.
...
Per the <EntityLink id="E641">Longtermist Funders</EntityLink> overview, total AI safety funding is approximately \$120-150M/year:

| Funder | Annual AI Safety | Share |
|--------|-----------------|-------|
| <EntityLink id="E521">Coefficient Giving</EntityLink> (Moskovitz) | \$65M | \≈55% |
...
- **Technical AI safety research** (alignment, interpretability, evaluations): \≈\$40-60M/year across <EntityLink id="E202">MIRI</EntityLink>, <EntityLink id="E557">Redwood Research</EntityLink>, <EntityLink id="E201">METR</EntityLink>, university labs, and independent researchers
- **AI governance and policy**: \≈\$20-30M/year across think tanks, policy organizations, and government-adjacent groups
- **Field-building and talent pipeline**: \≈\$15-25M/year through <EntityLink id="E510">80,000 Hours</EntityLink>, university programs, and fellowships
- **Regranting and infrastructure**: \≈\$10-20M/year through <EntityLink id="E543">LTFF</EntityLink>, <EntityLink id="E547">Manifund</EntityLink>, and fiscal sponsors
...
<EntityLink id="E552">Open Philanthropy</EntityLink> has been the EA ecosystem's primary experiment in scaling grantmaking:
...
- Eventually spun out <EntityLink id="E521">Coefficient Giving</EntityLink> (2024) as part of organizational evolution
...
2. **Regranting infrastructure**: Scale <EntityLink id="E543">LTFF</EntityLink>, <EntityLink id="E547">Manifund</EntityLink>, and SFF 5-10x. Create new regranting bodies for specific cause areas. Cost: \$50-100M/year. Payoff: distributes evaluation capacity.
...
**For grantmakers (<EntityLink id="E521">Coefficient Giving</EntityLink>, <EntityLink id="E567">SFF</EntityLink>, <EntityLink id="E543">LTFF</EntityLink>):**
