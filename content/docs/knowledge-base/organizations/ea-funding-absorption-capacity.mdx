...
<EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> has been the EA ecosystem's primary experiment in scaling grantmaking:
...
- Rebranded from Open Philanthropy to <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> in November 2025 as part of organizational evolution
