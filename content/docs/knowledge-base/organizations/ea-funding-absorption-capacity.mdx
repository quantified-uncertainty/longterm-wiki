...
**For grantmakers (<EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>, <EntityLink id="sff">SFF</EntityLink>, <EntityLink id="ltff">LTFF</EntityLink>):**
