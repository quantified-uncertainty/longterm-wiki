...
<FBRecordTable entity="puAffUjWSS" collection="key-persons" title="Key People" columns={["person", "title", "start", "is_founder"]} />
...
<FBRecordTable entity="puAffUjWSS" collection="research-areas" title="Research Areas" columns={["name", "description", "started"]} />
