...
<KBRecordTable entity="puAffUjWSS" collection="key-persons" title="Key People" columns={["person", "title", "start", "is_founder"]} />
...
<KBRecordTable entity="puAffUjWSS" collection="research-areas" title="Research Areas" columns={["name", "description", "started"]} />
