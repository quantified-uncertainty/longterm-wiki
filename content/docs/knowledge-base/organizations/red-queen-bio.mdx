...
| **Funding** | \$15M seed round led by <EntityLink id="openai">OpenAI</EntityLink> | Additional investors: Cerberus Ventures, Fifty Years, Halcyon Futures, Dhuna Ventures, LongeVC[^2][^3] |
