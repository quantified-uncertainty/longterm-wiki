...
|-----------|------------|
| **Founded** | June 2024 |
| **Founders** | <EntityLink id="E163" name="ilya-sutskever">Ilya Sutskever</EntityLink> (CEO), Daniel Gross (departed July 2025), Daniel Levy |
...
In July 2025, the company underwent a significant leadership transition when co-founder Daniel Gross departed to join Meta Superintelligence Labs, with his tenure winding down by June 29, 2025.[^rc-283a] Following this departure, Ilya Sutskever formally assumed the role of CEO, with Daniel Levy taking on the role of President.[^rc-467c] This transition came after SSI had rebuffed an acquisition attempt by Meta earlier in 2025, with Sutskever emphasizing the company's commitment to independence and its singular mission.[^rc-9125]
