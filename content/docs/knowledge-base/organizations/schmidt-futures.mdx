...
Early 2025 marked another significant expansion with the announcement of a \$10 million AI Safety Science program supporting 27 projects on foundational AI safety research.[^17][^18] The program addresses gaps in funding and academic access to frontier models, providing computational support from the Center for AI Safety and <EntityLink id="E218">OpenAI</EntityLink> API access to researchers developing robust benchmarks and evaluations for advanced AI systems.
