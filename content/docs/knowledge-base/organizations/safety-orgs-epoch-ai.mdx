...
| **Funding Stability** | Strong | [\$1.1M Coefficient Giving grant (2025)](https://www.openphilanthropy.org/grants/epoch-ai-general-support-2025/), additional \$1.9M general support |
...
| **Independence** | Medium-High | Nonprofit with EA/<EntityLink id="E552">Coefficient Giving</EntityLink> funding; no industry capture |
...
- **Multimodal shift**: <EntityLink id="E186">Language models</EntityLink> increasingly incorporating image/video data
...
- <EntityLink id="E43">Bioweapons AI uplift analysis</EntityLink>
...
| Compute governance | Standardized international monitoring needed | Enhanced <EntityLink id="E136">export controls</EntityLink> | [Epoch policy research](https://epoch.ai/gradient-updates/three-issues-undermining-compute-based-ai-policies) |
...
- **Pessimists**: <EntityLink id="E281">Sharp left turns</EntityLink> and discontinuities make extrapolation unreliable
...
|--------|--------|--------|---------|
| [Coefficient Giving (2025)](https://www.openphilanthropy.org/grants/epoch-ai-general-support-2025/) | \$1,132,488 | 2 years | General support |
| Coefficient Giving (additional) | \$1,922,565 | Multi-year | General support |
| [Coefficient Giving (FrontierMath)](https://www.openphilanthropy.org/grants/epoch-ai-general-support-2025/) | \$10,000 | 2025 | Benchmark improvements |
| Coefficient Giving (2022) | \$1,960,000 | Initial | Organization founding |
