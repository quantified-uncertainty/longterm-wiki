...
| Attribute | Details |
|-----------|---------|
| **Full Name** | Coefficient Giving (formerly <EntityLink id="E521" name="coefficient-giving">Open Philanthropy</EntityLink>) |
...
| Shallow Review 2024 | \$9,000 | <EntityLink id="E214" name="neel-nanda">Neel Nanda</EntityLink>, Ryan Kidd | Induced further \$5K from OpenPhil |
