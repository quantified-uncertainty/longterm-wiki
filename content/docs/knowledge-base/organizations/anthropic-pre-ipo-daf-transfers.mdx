...
**Data as of**: February 2026. Current valuation: <F e="anthropic" f="valuation">\$380B</F> (Series G). IPO expected: 2026-2027.
:::
...
Only 2 of 7 founders have formal EA commitments—<EntityLink id="dario-amodei">Dario Amodei</EntityLink> (43rd GWWC signatory, early GiveWell supporter) and <EntityLink id="daniela-amodei">Daniela Amodei</EntityLink> (whose spouse <EntityLink id="holden-karnofsky">Holden Karnofsky</EntityLink>, co-founder of GiveWell, joined Anthropic in January 2025)—but all seven are embedded in the EA/rationalist/AI safety network through co-authorships, shared social circles, and the safety-motivated departure from OpenAI. See <EntityLink id="anthropic-investors">Anthropic (Funder)</EntityLink> for detailed individual connections. [Fortune](https://fortune.com/2025/02/13/anthropic-hired-president-daniela-amodei-husband-ai-safety-responsible-scaling/) [EA Forum](https://forum.effectivealtruism.org/posts/53Gc35vDLK2u5nBxP/anthropic-is-not-being-consistently-candid-about-their)
...
**Central estimate: \$1-8B** in pre-IPO founder DAF transfers (EV ≈<F e="anthropic" f="revenue-mid-2025">\$4B</F>). The 90% confidence interval extends from \$0 to \$15B+. All dollar amounts carry 2-3x uncertainty from the equity stake estimates alone.
