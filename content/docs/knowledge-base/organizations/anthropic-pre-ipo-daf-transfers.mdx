...
Most early Anthropic employees likely hold Incentive Stock Options (ISOs). Exercising ISOs triggers Alternative Minimum Tax (AMT) on the spread between the strike price and fair market value (the 409A valuation)—even though the shares are illiquid and cannot be sold.

| Scenario | Strike Price | Current FMV (409A) | Spread | AMT Liability (≈28%) |
|----------|-------------|-------------------|--------|---------------------|
| Early employee (2021) | \$1-5/share | \$270+/share | \$265-269/share | \$74-75/share |
| 2022-2023 hire | \$10-30/share | \$270+/share | \$240-260/share | \$67-73/share |
| 2024 hire | \$50-100/share | \$270+/share | \$170-220/share | \$48-62/share |

**The problem:** An early employee with 100,000 options faces an AMT bill of \$7-8M on exercise—due in cash, on shares they cannot sell. As Anthropic's 409A valuation climbs with each funding round, this bill grows larger every quarter.

**Why this is time-sensitive:** Every new funding round raises the 409A fair market value, increasing the AMT spread. The Series G at \$380B likely pushed the 409A to its highest level yet. Employees who haven't exercised face a rapidly closing window where exercising is affordable.

**DAF interaction:** Donating appreciated stock directly to a DAF avoids both capital gains tax *and* AMT on the donated shares. For employees with ISO holdings and charitable intent, direct stock-to-DAF transfer may be more tax-efficient than exercising, paying AMT, and donating cash later.
...
**For early Anthropic employees and investors:** If Anthropic qualified as a QSBS-eligible company at the time of early grants (2021-2022), and employees have held for 5+ years by 2026-2027, they could potentially exclude \$10M+ per person in capital gains from federal tax. At a combined California rate of ≈37%, this represents up to \$3.7M in tax savings per employee.

**Open question:** Whether Anthropic's structure (Public Benefit Corporation, gross asset size at time of grants) qualifies under Section 1202 remains uncertain. Employees should seek tax counsel immediately—the qualification depends on company status at the time shares were acquired, not current status.
...
| **Any time pre/post-IPO** | Donate stock to DAF instead of selling | Avoids capital gains and potentially AMT |
...
1. Exercises ISOs (triggering AMT)
2. Then donates the exercised shares to a DAF under the matching program
3. Receives 1:1 to 3:1 matching on the donated amount

...captures both the matching benefit *and* avoids capital gains on the donated shares. The combination of matching multiplier plus tax savings makes this among the most financially attractive charitable giving structures available to any private company employee.
