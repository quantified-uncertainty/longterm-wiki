...
:::note[Page Scope]
This page analyzes how much Anthropic equity will be in donor-advised funds before IPO, with emphasis on why equity holders participate. For the broader analysis of all EA-aligned capital at Anthropic, see <EntityLink id="E406" name="anthropic-investors">Anthropic (Funder)</EntityLink>. For interventions targeting founder pledge fulfillment, see <EntityLink id="E411" name="anthropic-pledge-enforcement">Anthropic Founder Pledge Interventions</EntityLink>.

**Data as of**: March 2026. Last primary round: \$380B (Series G, Feb 2026). Secondary market implied: ≈\$595B (Ventuals, Mar 2026). IPO expected: 2026-2027. Employee tender offer (\$5-6B at \$350B) launched Feb 2026.
:::
...
|-----------|------------|
| **Employee equity in DAFs (matching program)** | \$20-40B already committed (at \$380B); \$31-63B at secondary market pricing |
| **Additional employee pre-IPO transfers** | \$1-5B (non-matched, voluntary) |
| **Founder pre-IPO DAF transfers** | \$1-8B (expected; wide range) |
| **Combined pre-IPO DAF total** | **\$22-48B** (at \$380B); **\$34-75B** at secondary market pricing |
...
| **New: Employee tender offer** | \$5-6B at \$350B pre-money (Feb 2026); major new liquidity channel |
...
**2. Behavioral pre-commitment before liquidity.** Behavioral economics research consistently shows that commitment is easier before resources feel "real." Pre-IPO, equity is paper wealth — committing a percentage feels costless. Post-IPO, the same equity shows up as a dollar amount in a brokerage account, and giving feels like a loss. <EntityLink id="E531" name="giving-pledge">Giving Pledge</EntityLink> data shows that living pledgers have grown 166% wealthier (inflation-adjusted) since signing, suggesting wealth compounds faster than giving. [IPS](https://ips-dc.org/report-giving-pledge-at-15/)
...
### Interaction with Employee Tender Offer (Feb 2026)

In February 2026, Anthropic launched a \$5-6B employee share sale program at \$350B pre-money valuation. [Bloomberg](https://www.bloomberg.com/news/articles/2026-02-23/anthropic-kicks-off-share-sale-for-staffers-of-up-to-6-billion) This creates an important decision point for employees choosing between the tender offer and DAF transfers:

| Path | Tax Impact | Charitable Impact | Best For |
|------|-----------|-------------------|----------|
| **Tender offer (sell for cash)** | Capital gains tax on appreciation (≈37% in CA) | None unless employee donates cash afterward | Employees needing liquidity, no charitable intent |
| **DAF transfer (donate shares)** | No capital gains; FMV deduction (30% AGI cap) | Shares go to charity via DAF | Employees with charitable intent; maximizes total impact |
| **Tender offer → donate cash** | Capital gains tax on sale; cash donation deduction (60% AGI cap) | Reduced by ≈37% tax bite | Employees wanting both liquidity and giving |

For employees with charitable intent, DAF transfers remain superior to the tender offer — donating \$1M of stock to a DAF yields \$1M to charity, while selling via tender and donating cash yields only ≈\$630K. However, the tender offer provides an important liquidity option for employees who need cash for AMT payments or personal expenses, and can be combined with DAF transfers (sell some via tender, donate the rest to DAF).

## How Much Is Already in DAFs?

### Employee Equity: \$20-40B Already Committed

The employee equity pool is estimated at 12-18% of Anthropic (\$46-68B at \$380B). [EA Forum](https://forum.effectivealtruism.org/posts/rRBaP7YbXfZibSn3C/front-load-giving-because-of-anthropic-donors) Participation in the matching program varies significantly by cohort:

| Cohort | Headcount | Share of Equity Pool | Program Terms | Est. Participation | DAF Value (at \$380B) |
|--------|-----------|---------------------|---------------|-------------------|---------------------|
| Founding team (2021) | 15-20 | 25-35% | 3:1 at 50% | 50-70% | \$9-22B |
| Early hires (2021-2022) | 50-80 | 20-30% | 3:1 at 50% | 40-60% | \$5-15B |
| Growth phase (2023-2024) | 200-400 | 15-25% | 3:1 at 50% | 20-40% | \$2-9B |
...
| Source | Est. Stake per Founder | Value (at \$380B) | Total (7 founders) |
|--------|----------------------|-------------------|-------------------|
| Forbes (Dec 2025) | ≈1% | ≈\$3.8B | ≈\$27B |
| Brand Vision | 2-3% | \$7.6-11.4B | \$53-80B |
| **Range used here** | **1-3%** | **\$3.8-11.4B** | **\$27-80B** |

[Brand Vision](https://www.brandvm.com/post/dario-amodei-net-worth-in-2025) [Forbes](https://www.forbes.com/profile/dario-amodei/)

Only 2 of 7 founders have formal EA commitments—<EntityLink id="E91" name="dario-amodei">Dario Amodei</EntityLink> (43rd GWWC signatory, early GiveWell supporter) and <EntityLink id="E90" name="daniela-amodei">Daniela Amodei</EntityLink> (whose spouse <EntityLink id="E156" name="holden-karnofsky">Holden Karnofsky</EntityLink>, co-founder of GiveWell, joined Anthropic in January 2025)—but all seven are embedded in the EA/rationalist/AI safety network through co-authorships, shared social circles, and the safety-motivated departure from OpenAI. See <EntityLink id="E406" name="anthropic-investors">Anthropic (Funder)</EntityLink> for detailed individual connections. [Fortune](https://fortune.com/2025/02/13/anthropic-hired-president-daniela-amodei-husband-ai-safety-responsible-scaling/) [EA Forum](https://forum.effectivealtruism.org/posts/53Gc35vDLK2u5nBxP/anthropic-is-not-being-consistently-candid-about-their)
...
The <EntityLink id="E531" name="giving-pledge">Giving Pledge</EntityLink> provides the closest historical analogy for founder pledges, with an important threshold difference: Giving Pledge signatories commit to 50% of wealth, while Anthropic founders committed to 80%. Fulfillment at the higher threshold would likely be even lower. [IPS](https://ips-dc.org/report-giving-pledge-at-15/)
