...
Several Manifund-funded projects have subsequently received larger grants from <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> and other major funders, validating the "quick regrants induce further funding" thesis.
