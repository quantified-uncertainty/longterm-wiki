...
| **Founders** | <EntityLink id="E433" name="max-tegmark">Max Tegmark</EntityLink> (President), <EntityLink id="E577" name="jaan-tallinn">Jaan Tallinn</EntityLink>, Anthony Aguirre (Executive Director), Viktoriya Krakovna, Meia Chita-Tegmark |
