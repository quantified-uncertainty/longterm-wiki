...
| **Funding** | \$2.8M+ from Survival and Flourishing Fund, £1M+ from private foundation, £4M from <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink> (2024) |
...
| <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink> | £4M | October 2024 (3-year commitment) | Supporting mission to transform global resilience to extreme risks |
...
The organization operates in a funding ecosystem heavily concentrated in effective altruism sources, with major grants from the <EntityLink id="sff">Survival and Flourishing Fund</EntityLink> and <EntityLink id="open-philanthropy">Open Philanthropy</EntityLink>. This concentration could create dependencies or alignment pressures, though no specific conflicts of interest or controversies are documented in available sources.[^52]
