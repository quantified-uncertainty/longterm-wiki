...
<DataExternalLinks pageId="lesswrong" client:load />
...
| **Funding Base** | Substantial | Over \$5 million from Survival and Flourishing Fund, Future Fund, and Open Philanthropy combined [EA Forum](https://forum-bots.effectivealtruism.org/topics/lesswrong) |
