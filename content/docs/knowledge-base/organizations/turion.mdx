...
Turion primarily targets investments in AI hardware and semiconductor companies worldwide. The fund's portfolio is concentrated in companies benefiting from the ongoing AI infrastructure buildout, similar to other AI-focused funds like <EntityLink id="situational-awareness-lp">Situational Awareness LP</EntityLink> and <EntityLink id="vara">VARA</EntityLink>.[^rc-a063]
