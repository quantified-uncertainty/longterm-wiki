...
Turion primarily targets investments in AI hardware and semiconductor companies worldwide. The fund's portfolio is concentrated in companies benefiting from the ongoing AI infrastructure buildout, similar to other AI-focused funds like <EntityLink id="E568">Situational Awareness LP</EntityLink> and <EntityLink id="E572">VARA</EntityLink>.[^5]
...
| <EntityLink id="E568">Situational Awareness LP</EntityLink> | ≈\$4B | 47% (H1) | <EntityLink id="E578">Leopold Aschenbrenner</EntityLink> |
| <EntityLink id="E572">VARA</EntityLink> | ≈\$8B | 40% (Q3) | Ben Hoskin, EA connections |
