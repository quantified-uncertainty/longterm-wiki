...
<KBItemTable entity="openai" collection="funding-rounds" title="Funding History" columns={["date", "raised", "valuation", "lead_investor", "notes"]} />
...
<KBItemTable entity="openai" collection="key-persons" title="Key People" columns={["person", "title", "start", "end", "is_founder"]} />
