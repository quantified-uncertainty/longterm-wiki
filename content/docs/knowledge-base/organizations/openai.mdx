...
- Additional <F e="openai" f="609b9796">\$1 billion from API access</F>[^9]
...
| **Funding** | ≈\$1B founder commitment | <F e="openai" f="931278d9">\$13B+ Microsoft investment</F> | 13x scale increase |
...
| **Scaling Laws** | Predictable performance from compute/data | Drove <F e="openai" f="931278d9">\$100B+</F> industry investment | Unclear whether they continue to AGI-level systems |
