...
---
import {DataInfoBox, DisagreementMap, KeyPeople, KeyQuestions, Section, R, EntityLink, DataExternalLinks, F} from '@components/wiki';
...
- Projected 2024 revenue: <F e="openai" f="revenue-2024-projected">\$3.4 billion</F> (ChatGPT subscriptions + API)[^32]
- Growth rate: <F e="openai" f="revenue-yoy-growth-2024">1,700%</F> year-over-year from product scaling
