...
| **Policy Influence** | High engagement with <EntityLink id="uk-aisi">UK AISI</EntityLink> | Potential international coordination |
...
**2023-2024**: Established as key player in AI governance, influence on <EntityLink id="responsible-scaling-policies">Responsible Scaling Policies</EntityLink>
