...
<EntityLink id="anthropic-investors">Anthropic (Funder)</EntityLink> represents potentially the largest future source of longtermist philanthropic capital. At Anthropic's current <F e="anthropic" f="valuation-nov-2025">\$350B</F> valuation:
