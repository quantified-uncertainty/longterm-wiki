...
| **<EntityLink id="dustin-moskovitz">Dustin Moskovitz</EntityLink>** | ≈\$17B | ≈\$700M | **\$65M** | \$4B+ | <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> |
...
|--------------|------|---------------------|---------------|--------------|
| <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> | Foundation | \$65M AI safety | Technical alignment, governance, evals | <EntityLink id="miri">MIRI</EntityLink>, <EntityLink id="redwood-research">Redwood</EntityLink>, <EntityLink id="metr">METR</EntityLink>, GovAI |
