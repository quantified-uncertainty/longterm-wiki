...
|-------|------------|----------------|---------------|------------------|--------------|
| GPT-4o | ≈1.8T (estimated) | 128K tokens | ≈\$18-100M | Multimodal, coding, reasoning | <R id="ZWE4ZTJlZW">OpenAI</R> |
| Claude 3.5 Sonnet | ≈200B (estimated) | 200K tokens | Tens of millions | Long context, safety, coding (93.7% HumanEval) | <R id="MWRkOTFhMm"><EntityLink id="E22" name="anthropic">Anthropic</EntityLink></R> |
| Gemini 1.5 Pro | ≈1.56T (estimated) | 1M+ tokens | ≈\$191M (Ultra) | Multimodal, scientific reasoning | <R id="ZWFiODVkOT">DeepMind</R> |
...
**Reinforcement Learning from Human Feedback (RLHF)**: Used by <R id="NjAyN2YwNz">OpenAI</R> and others to align model outputs with human preferences. Shows 85% preference agreement but may not capture true human values.

**Constitutional AI**: <R id="MzMxYmJhNm">Anthropic's</R> approach using AI feedback to improve helpfulness and harmlessness. Demonstrates 52% reduction in harmful outputs while maintaining capability.
