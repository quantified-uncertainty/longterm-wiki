...
| **Benchmark Performance** | 43-81% on coding tasks | SWE-bench Verified: Claude Opus 4.5 at <F e="openai" f="25d2308f">80.9%</F>, Claude 3.5 Sonnet at 49% ([OpenAI](https://openai.com/index/introducing-swe-bench-verified/)) |
...
- <R id="a4efa407affdbe1c">Devin</R>: Multi-hour software development; [Devin 2.0](https://cognition.ai/blog/devin-annual-performance-review-2025) (April 2025) completes <F e="openai" f="84af6115">83</F>% more junior-level tasks per compute unit
