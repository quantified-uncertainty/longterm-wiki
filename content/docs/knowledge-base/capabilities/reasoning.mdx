...
| o3 (Apr 2025 test) | ≈10% | Updated testing by <EntityLink id="E125" name="epoch-ai">Epoch AI</EntityLink> |
...
Modern AI systems demonstrate increasingly sophisticated planning abilities across various domains, with 2025 marking a major shift toward **<EntityLink id="E2" name="agentic-ai">agentic AI</EntityLink>**—systems that operate with intent, planning, and action rather than single-turn responses. Unlike traditional models, agentic LLMs drive outcomes: they reason through plans, decide what tools they need, execute actions, verify results, and adapt if something fails.
