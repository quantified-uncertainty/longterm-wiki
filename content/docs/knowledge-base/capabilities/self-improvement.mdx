...
| **Task Horizon Growth** | ≈7 months doubling | <EntityLink id="E201">METR</EntityLink> 2025: AI task completion horizons doubling every 7 months (2019-2025); possible 4-month acceleration in 2024 |
...
| <EntityLink id="E538">LessWrong</EntityLink> | [lesswrong.com](https://www.lesswrong.com/w/recursive-self-improvement) |
...
|-----------|------------|-------|
| Severity | **Existential** | Could trigger uncontrollable intelligence explosion; <EntityLink id="E215">Nick Bostrom</EntityLink> estimates fast takeoff could occur within hours to days |
...
| <EntityLink id="E290">Stuart Russell</EntityLink> | UC Berkeley | Self-improvement loop "could quickly escape human oversight" without governance; advocates for purely altruistic, humble machines |
...
| <EntityLink id="E91">Dario Amodei</EntityLink> | <EntityLink id="E22">Anthropic</EntityLink> CEO | "A temporary lead could be parlayed into a durable advantage" due to AI's ability to help make smarter AI |
...
|----------|-----------|----------------|---------------|
| <EntityLink id="E252">Responsible Scaling Policies</EntityLink> | Capability evaluations before deployment | Anthropic, OpenAI, DeepMind implementing | Medium |
| <EntityLink id="E13">AI Safety Institutes</EntityLink> | Government evaluation of dangerous capabilities | US, UK, Japan established | Low-Medium |
