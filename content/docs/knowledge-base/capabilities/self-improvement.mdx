...
The intelligence explosion scenario represents the most extreme form of self-improvement, where AI systems become capable of rapidly and autonomously designing significantly more capable successors. This hypothesis, formalized by I.J. Good in 1965 and popularized by researchers like <R id="OWEzZjZiZD">Nick Bostrom</R> and <EntityLink id="E114" name="eliezer-yudkowsky">Eliezer Yudkowsky</EntityLink>, posits that once AI systems become sufficiently capable at AI research, they could trigger a recursive cycle of improvement that accelerates exponentially.
...
- **Stuart Russell**, <R id="YWQwZDE1ZG">Human Compatible: AI and the Problem of Control</R> (2019) - Control problem framework and beneficial AI principles
