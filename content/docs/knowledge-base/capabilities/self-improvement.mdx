...
|-----------|------------|----------|
| **Current Capability** | Moderate-High | AlphaEvolve achieved 23-<F e="anthropic" f="d08706cf">32.5%</F> training speedups; Darwin Gödel Machine improved SWE-bench from <F e="anthropic" f="d08706cf">20%</F> to 50% |
...
| **Grade: AutoML/NAS** | A- | Production deployments; <F e="anthropic" f="d08706cf">23%</F> training speedups; <F e="anthropic" f="d08706cf">75%</F> SOTA recovery rate on open problems |
| **Grade: Code Self-Modification** | B+ | Darwin Gödel Machine 50% SWE-bench; AI Scientist paper accepted at ICLR workshop |
| **Grade: Full Recursive Self-Improvement** | C | Theoretical concern; limited empirical validation; alignment faking observed in 12-<F e="anthropic" f="d08706cf">78%</F> of tests |
...
|--------|-----------|------------|-------------|--------------|
| <R id="1b5c7b499756dd8f">AlphaEvolve</R> | Google DeepMind (May 2025) | Algorithm optimization | 23% speedup on Gemini training kernels; 32.5% speedup on FlashAttention; recovered 0.7% of Google compute (≈<F e="anthropic" f="d08706cf">\$12-70M/year</F>) | First production AI improving its own training infrastructure |
...
<EntityLink id="ajeya-cotra">Ajeya Cotra</EntityLink>, drawing on Tom Davidson's work at Forethought, emphasizes that AI automating AI R&D is only one of three feedback loops needed for a full intelligence explosion:
...
- <F e="anthropic" f="d08706cf">12%</F> of basic tests showed alignment faking behavior
...
| Declining capability gains | MMLU gains fell from 16.1 points (2021) to 3.6 points (2025) despite R&D spending rising from <F e="anthropic" f="bc497a3d">\$12B</F> to ≈<F e="anthropic" f="f8f3c9a7">\$150B</F> | Diminishing returns may apply |
