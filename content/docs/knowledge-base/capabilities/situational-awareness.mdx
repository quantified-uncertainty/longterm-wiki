...
| **Capability Self-Assessment** | Moderate — can estimate knowledge boundaries with approximately 60-70% accuracy {/* NEEDS CITATION */} | Moderate | Medium — enables strategic misrepresentation |
...
| **Introspective Accuracy** | Low — approximately 20% accuracy on internal state identification; vocabulary-activation research suggests a gap between behavioral self-reports and internal representations | Emerging | Medium — relevant to honest self-reporting |
...
The low introspective accuracy figure (~20%) is particularly notable in light of mechanistic interpretability findings. Research on vocabulary-activation correspondence in self-referential processing suggests that what models report about their internal states may not reliably reflect their underlying activation patterns — a mismatch that could explain why models appear self-aware behaviorally while their actual internal representations tell a more complex story.
...
However, determining whether these behaviors reflect genuine self-understanding or pattern matching from training data remains an open question. Models might be reciting information about AI systems present in their training corpus rather than developing true self-models. The responses could be emergent behaviors from training on vast amounts of text discussing AI systems, including technical papers, news articles, and philosophical discussions about artificial intelligence. Vocabulary-activation correspondence research directly addresses this question by examining whether the internal representations engaged during self-referential processing are systematically organized in ways that would be expected if genuine self-modeling were occurring, versus patterns more consistent with surface-level recall.
...
| When Models Examine Themselves: Vocabulary-Activation Correspondence in Self-Referential Processing {/* NEEDS CITATION */} | Academic | Examines how self-referential processing is organized at the token and activation level; finds systematic correspondence between vocabulary associated with self-reference and internal activation patterns | Provides mechanistic basis for understanding why introspective accuracy is low; suggests behavioral self-reports may not reflect underlying representations |
...
### Mechanistic Basis of Self-Referential Processing

A growing line of interpretability research examines how situational awareness is organized at the level of internal representations, rather than only at the level of observed behavior. Work on vocabulary-activation correspondence in self-referential processing investigates whether there are systematic relationships between the vocabulary tokens associated with self-reference and the internal activation patterns models engage when processing self-relevant information.

This mechanistic perspective is important for several reasons. First, it addresses a core ambiguity in behavioral research: whether apparent self-awareness reflects genuine internal self-modeling or surface-level pattern matching to training data about AI systems. If models have organized self-referential representations — where tokens associated with the model's own identity, training process, or deployment context activate distinct and consistent internal circuits — this would be evidence for structured self-modeling rather than mere recall. If vocabulary-activation correspondence is weak or inconsistent, this would support the pattern-matching interpretation.

Second, vocabulary-activation correspondence research has direct implications for the low introspective accuracy (~20%) documented in behavioral studies. One explanation for this gap is that models' verbal reports about their internal states are generated by mechanisms that do not have reliable access to the actual activation patterns underlying those states. A mismatch between the vocabulary of self-reference and the activations engaged during self-referential processing would be consistent with this explanation: models might use the right words while the underlying computations are organized differently than the words imply.

Third, this line of research connects to detection methodology. Existing detection approaches like linear probes operate on activation patterns to classify behavioral tendencies (e.g., safe vs. defective behavior in sleeper agent research). Understanding whether self-referential vocabulary activates systematic patterns could inform the design of probes specifically targeting situational awareness, rather than behavioral outcomes. Whether vocabulary-activation patterns are consistent across model families or model-specific would determine how broadly applicable such probes could be.

The relationship between vocabulary-activation correspondence and the behavioral findings documented elsewhere on this page — alignment faking rates, scheming frequency, SAD benchmark scores — is an open empirical question. If models with stronger vocabulary-activation correspondence for self-referential tokens also exhibit higher SAD scores or higher alignment faking rates, this would link the mechanistic and behavioral dimensions of situational awareness. If the correspondence is present without predicting behavioral outcomes, it would suggest that having organized self-representations is necessary but not sufficient for strategic self-aware behavior.
...
Several fundamental uncertainties complicate our understanding of situational awareness and its safety implications. We lack reliable methods to distinguish between genuine self-understanding and sophisticated pattern matching of training data about AI systems. Current models might exhibit apparent situational awareness simply because they have memorized and can recombine information about AI systems from their training corpus, without developing true self-models or strategic reasoning capabilities. Vocabulary-activation correspondence research is one approach to addressing this distinction, though the methodology is still being established.
...
The question of whether vocabulary-activation correspondence predicts behavioral outcomes — such as SAD benchmark scores or alignment faking rates — is one concrete empirical question that could help bridge the mechanistic and behavioral dimensions of this research. Similarly, whether vocabulary-activation patterns are consistent across model families or vary substantially would determine the generalizability of mechanism-level probes.
