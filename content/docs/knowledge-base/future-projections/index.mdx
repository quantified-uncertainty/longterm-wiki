...
### <EntityLink id="future-projections/aligned-agi">Aligned AGI</EntityLink>
...
### <EntityLink id="future-projections/misaligned-catastrophe">Misaligned Catastrophe</EntityLink>
Misaligned AI causes major harm:
- Alignment fails despite effort
- Deceptive or <EntityLink id="E226">power-seeking AI</EntityLink> emerges
- Ranges from setback to <EntityLink id="E130">existential catastrophe</EntityLink>
- *Probability estimate: 5-25%*

### <EntityLink id="future-projections/pause-and-redirect">Pause and Redirect</EntityLink>
...
### <EntityLink id="future-projections/slow-takeoff-muddle">Slow Takeoff Muddle</EntityLink>
...
### <EntityLink id="future-projections/multipolar-competition">Multipolar Competition</EntityLink>
