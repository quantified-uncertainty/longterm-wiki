...
<DataExternalLinks pageId="aligned-agi" client:load />

<DataInfoBox entityId="aligned-agi" />
...
| **Technical Feasibility** | Uncertain but plausible | Alignment techniques (<EntityLink id="rlhf">RLHF</EntityLink>, <EntityLink id="constitutional-ai">constitutional AI</EntityLink>, interpretability) showing progress; major labs investing 15-25% of research budget in safety |
...
| **Key Enablers** | Multiple required | Needs: alignment breakthroughs, <EntityLink id="international-coordination">international coordination</EntityLink>, capability plateau, economic incentives aligning |
...
| <EntityLink id="lesswrong">LessWrong</EntityLink> | [lesswrong.com](https://www.lesswrong.com/posts/ZmZBataeY58anJRBb/getting-from-an-unaligned-agi-to-an-aligned-agi) |
