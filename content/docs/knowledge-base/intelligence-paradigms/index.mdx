...
### <EntityLink id="dense-transformers">Dense Transformers</EntityLink>
...
### <EntityLink id="sparse-moe">Sparse MoE</EntityLink>
...
### <EntityLink id="ssm-mamba">SSM/Mamba</EntityLink>
State Space Models:
- Alternative to attention mechanism
- Linear scaling with sequence length
- Emerging research area

### <EntityLink id="neuro-symbolic">Neuro-Symbolic</EntityLink>
...
### <EntityLink id="minimal-scaffolding">Minimal Scaffolding</EntityLink>
Foundation models with basic prompting

### <EntityLink id="light-scaffolding">Light Scaffolding</EntityLink>
Chain-of-thought, few-shot learning

### <EntityLink id="heavy-scaffolding">Heavy Scaffolding</EntityLink>
Extensive tool use, agentic frameworks

## Alternative Pathways

### <EntityLink id="world-models">World Models</EntityLink>
Learning predictive world representations

### <EntityLink id="provable-safe">Provably Safe</EntityLink>
Architectures with formal safety guarantees

### Biological Approaches
- <EntityLink id="brain-computer-interfaces">Brain-Computer Interfaces</EntityLink>
- <EntityLink id="biological-organoid">Biological Organoid</EntityLink>
- <EntityLink id="genetic-enhancement">Genetic Enhancement</EntityLink>
- <EntityLink id="whole-brain-emulation">Whole-Brain Emulation</EntityLink>

### <EntityLink id="novel-unknown">Novel/Unknown</EntityLink>
