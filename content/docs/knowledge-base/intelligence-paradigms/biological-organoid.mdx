...
<DataExternalLinks pageId="biological-organoid" client:load />
...
- <EntityLink id="whole-brain-emulation">Whole Brain Emulation</EntityLink> - Simulating biology rather than using it
- <EntityLink id="neuromorphic">Neuromorphic Hardware</EntityLink> - Silicon inspired by biology
- <EntityLink id="brain-computer-interfaces">Brain-Computer Interfaces</EntityLink> - Connecting silicon to biology
