...
<DataExternalLinks pageId="world-models" client:load />
...
- <EntityLink id="dense-transformers">Dense Transformers</EntityLink> - Alternative LLM approach
- <EntityLink id="neuro-symbolic">Neuro-Symbolic</EntityLink> - Related hybrid approach
- <EntityLink id="provable-safe">Provable Safe</EntityLink> - World model verification is central
