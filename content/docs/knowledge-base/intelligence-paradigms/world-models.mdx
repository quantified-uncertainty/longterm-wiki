...
| **Key Advocate** | <EntityLink id="E582">Yann LeCun</EntityLink> (Meta) | Argues LLMs are "dead end"; JEPA is path to AGI |
...
World models + planning represents an AI architecture paradigm fundamentally different from <EntityLink id="E186">large language models</EntityLink>. Instead of learning to directly produce outputs from inputs, these systems learn an **explicit model of how the world works** and use **search/planning algorithms** to find good actions.
