...
**<EntityLink id="E290" name="stuart-russell">Stuart Russell</EntityLink>'s warning:** In [Human Compatible](https://en.wikipedia.org/wiki/Mind_uploading), calls creating a WBE-based superintelligence "so obviously a bad idea" due to the control problem - human-derived motivations may not remain stable under self-improvement, and emulations may inherit humanity's "darker motivations."
