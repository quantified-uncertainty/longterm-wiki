...
**<EntityLink id="E290" name="stuart-russell">Stuart Russell</EntityLink>'s warning:** Computer scientist <EntityLink id="E290" name="stuart-russell">Stuart Russell</EntityLink>, in [Human Compatible](https://en.wikipedia.org/wiki/Mind_uploading), calls creating a WBE-based superintelligence "so obviously a bad idea" due to the control problem - human-derived motivations may not remain stable under self-improvement, and emulations may inherit humanity's "darker motivations."
...
Economist <EntityLink id="E260" name="robin-hanson">Robin Hanson</EntityLink>'s 2016 book [The Age of Em](https://ageofem.com/) provides the most detailed analysis of a world dominated by brain emulations. Drawing on economics, physics, and computer science, Hanson explores the social and economic implications:
