...
<DataExternalLinks pageId="whole-brain-emulation" client:load />
...
- <EntityLink id="brain-computer-interfaces">Brain-Computer Interfaces</EntityLink> - Related technology path
- <EntityLink id="biological-organoid">Biological/Organoid Computing</EntityLink> - Alternative biological approach
- <EntityLink id="dense-transformers">Dense Transformers</EntityLink> - The likely faster path
