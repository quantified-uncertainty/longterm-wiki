...
<DataExternalLinks pageId="genetic-enhancement" client:load />
...
- <EntityLink id="brain-computer-interfaces">Brain-Computer Interfaces</EntityLink> - Another human enhancement path
- <EntityLink id="collective-intelligence">Collective Intelligence</EntityLink> - Enhancing group cognition instead
- <EntityLink id="biological-organoid">Biological/Organoid</EntityLink> - Using biological neurons for computing
