...
|--------------|------|---------|-------|
| **ARIA (UK)** | Primary funder of Safeguarded AI | <FBF entity="XqjV4mbMXQ" property="total-funding">£59M</FBF> committed | End-to-end verified AI systems |
...
3. **ARIA funding** - <FBF entity="XqjV4mbMXQ" property="total-funding">£59M</FBF>+ committed with clear milestones; additional £110M in related ARIA funding in 2024
