...
<DataExternalLinks pageId="brain-computer-interfaces" client:load />
...
- <EntityLink id="genetic-enhancement">Genetic Enhancement</EntityLink> - Another human augmentation path
- <EntityLink id="whole-brain-emulation">Whole Brain Emulation</EntityLink> - Scanning brains rather than interfacing
- <EntityLink id="collective-intelligence">Collective Intelligence</EntityLink> - Enhancing groups rather than individuals
