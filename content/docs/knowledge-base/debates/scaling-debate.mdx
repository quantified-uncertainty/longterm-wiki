...
<DataExternalLinks pageId="scaling-debate" client:load />
...
- **Stargate Project**: [\$500B committed through 2029](https://openai.com/index/announcing-the-stargate-project/) by OpenAI, SoftBank, Oracle—implicitly betting on scaling
- **Meta's LLM focus**: [Yann LeCun's November 2025 departure](https://fortune.com/2026/01/23/deepmind-demis-hassabis-anthropic-dario-amodei-yann-lecun-ai-davos/) to found Advanced Machine Intelligence Labs signals internal disagreement
