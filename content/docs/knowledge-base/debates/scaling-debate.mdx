...
update_frequency: 45
summary: Comprehensive survey of the 2024-2025 scaling debate, documenting the shift from pure pretraining to 'scaling-plus' approaches after o3 achieved 87.5% on ARC-AGI-1 but GPT-5 faced 2-year delays. Expert consensus has moved to ~45% favoring hybrid approaches, with Epoch AI projecting a data wall by 2026-2030 and AGI timelines spanning 5-30+ years depending on paradigm.
clusters:
  - ai-safety
---
...
| **Data Wall Timeline** | 2026-2030 for human-generated text (industry-wide, per Epoch AI) | [Epoch AI (2022)](https://epoch.ai/blog/will-we-run-out-of-data-limits-of-llm-scaling-based-on-human-generated-data): Stock exhausted depending on overtraining |
| **Investment Level** | \$500B+ committed through 2029 | [Stargate Project](https://openai.com/index/announcing-the-stargate-project/): <EntityLink id="E218" name="openai">OpenAI</EntityLink>, SoftBank, Oracle joint venture |
...
- **Stargate Project**: [\$500B committed through 2029](https://openai.com/index/announcing-the-stargate-project/) by <EntityLink id="E218" name="openai">OpenAI</EntityLink>, SoftBank, Oracle—implicitly betting on scaling
- **<EntityLink id="E549" name="meta-ai">Meta</EntityLink>'s LLM focus**: [<EntityLink id="E582" name="yann-lecun">Yann LeCun</EntityLink>'s November 2025 departure](https://fortune.com/2026/01/23/deepmind-demis-hassabis-anthropic-dario-amodei-yann-lecun-ai-davos/) to found Advanced Machine Intelligence Labs signals internal disagreement
- **<EntityLink id="E98" name="deepmind">DeepMind</EntityLink>'s approach**: Combines scaling with algorithmic innovation (AlphaFold, Gemini)—hedging both sides
...
|--------|---------------|---------------|-----------|
| <EntityLink id="E269" name="sam-altman">Sam Altman</EntityLink> | Pure scaling works | Scaling + reasoning | "There is no wall" (disputed) |
| <EntityLink id="E91" name="dario-amodei">Dario Amodei</EntityLink> | Scaling is primary | Scaling "probably will continue" | Synthetic data "highly promising" |
| <EntityLink id="E582" name="yann-lecun">Yann LeCun</EntityLink> | Skeptic | Strong skeptic | "LLMs are a dead end for AGI" |
| <EntityLink id="E163" name="ilya-sutskever">Ilya Sutskever</EntityLink> | Strong scaling optimist | Nuanced | "Pretraining as we know it will end" |
...
| <EntityLink id="E101" name="demis-hassabis">Demis Hassabis</EntityLink> | Hybrid approach | AGI by 2030 possible | Scaling + algorithmic innovation |
