...
clusters: ["ai-safety"]
---
import {DisagreementMap, InfoBox, KeyQuestions, DataExternalLinks, Mermaid, EntityLink, F} from '@components/wiki';
...
- **Stargate Project**: [<F e="openai" f="valuation-2025">\$500B</F> committed through 2029](https://openai.com/index/announcing-the-stargate-project/) by <EntityLink id="openai">OpenAI</EntityLink>, SoftBank, Oracle—implicitly betting on scaling
...
- **o3 benchmark results**: 96.7% on AIME 2024, 87.7% on GPQA Diamond, <F e="openai" f="o1-swe-bench-score">71.7%</F> on SWE-bench Verified (vs o1's 48.9%)
