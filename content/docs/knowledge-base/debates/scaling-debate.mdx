...
| **Key Milestone (Pro-Scaling)** | o3 achieves <F e="openai" f="84af6115">87.5%</F> on ARC-AGI-1 | [ARC Prize Technical Report](https://arcprize.org/blog/oai-o3-pub-breakthrough): \$3,460/task at maximum compute |
...
- **o3 benchmark results**: <F e="openai" f="84af6115">96.7%</F> on AIME 2024, <F e="openai" f="84af6115">87.7%</F> on GPQA Diamond, <F e="openai" f="25d2308f">71.7%</F> on SWE-bench Verified (vs o1's <F e="openai" f="25d2308f">48.9%</F>)
