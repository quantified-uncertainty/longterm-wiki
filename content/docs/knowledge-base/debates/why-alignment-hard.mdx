...
|--------|------------------|---------------|--------|
| <EntityLink id="E114">Eliezer Yudkowsky</EntityLink> (<EntityLink id="E202">MIRI</EntityLink>) | ≈95% | Optimization generalizes while corrigibility is "anti-natural"; current approaches orthogonal to core difficulties | <R id="361870712c6c16e3"><EntityLink id="E538">LessWrong</EntityLink> surveys</R> |
| <EntityLink id="E220">Paul Christiano</EntityLink> (US AISI, ARC) | 10-20% | "High enough to obsess over"; expects AI takeover more likely than extinction | <R id="ed73cbbe5dec0db9">LessWrong: My views on doom</R> |
...
The wide range (5% to 95%+) reflects disagreement about whether current approaches will scale, whether <EntityLink id="E93">deceptive alignment</EntityLink> is a real concern, and how difficult specification and verification problems truly are.
