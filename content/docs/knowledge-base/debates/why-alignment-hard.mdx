...
This page focuses on arguments for difficulty. Arguments that alignment may be more tractable are covered in companion discussions and by researchers such as <EntityLink id="yann-lecun">Yann LeCun</EntityLink> and those working on empirical alignment benchmarks.
...
**<EntityLink id="openai">OpenAI</EntityLink>'s Collective Alignment initiative** (August 2025)[^7]: OpenAI formed a "Collective Alignment" team in January 2024, arising from a democratic inputs grant program. Their August 2025 update describes a process where participants reviewed synthetic prompts and ranked possible completions according to their own preferences. The initiative found both areas of agreement with OpenAI's Model Spec and areas of notable difference. Acknowledged limitations include: "participant pool is small relative to the global population" and English reading criteria introducing selection bias.
...
**<EntityLink id="anthropic">Anthropic</EntityLink>'s "<EntityLink id="sleeper-agents">Sleeper Agents</EntityLink>" result** (<R id="e5c0904211c7d0cc">Hubinger et al., 2024</R>):
...
**Current state**:
- Progress on <EntityLink id="mech-interp">mechanistic interpretability</EntityLink> of small models and specific circuits; MLSN #8 (February 2023)[^rc-6606] highlighted work isolating the specific mechanism GPT-2 uses to identify indirect objects in sentences, down to specific parameters
...
**<EntityLink id="sycophancy">Sycophancy</EntityLink>**:
...
**<EntityLink id="reward-hacking">Reward hacking</EntityLink>**:
...
**Implication**: Safety measures designed for current capability levels may not be adequate for <EntityLink id="emergent-capabilities">emergent capabilities</EntityLink> that evaluators did not anticipate.
...
None of the five positive developments exist yet at the scale required for <EntityLink id="transformative-ai">transformative AI</EntityLink>. Researchers disagree about how quickly they might be achieved and whether they will be achieved before transformative AI is deployed.
...
- <EntityLink id="rsp">Responsible scaling policies</EntityLink> that gate capability advances on safety evaluations
