...
<DataExternalLinks pageId="why-alignment-hard" client:load />
...
| <EntityLink id="paul-christiano">Paul Christiano</EntityLink> (US AISI, ARC) | 10-20% | "High enough to obsess over"; expects AI takeover more likely than extinction | <R id="ed73cbbe5dec0db9">LessWrong: My views on doom</R> |
...
The wide range (5% to 95%+) reflects disagreement about whether current approaches will scale, whether <EntityLink id="deceptive-alignment">deceptive alignment</EntityLink> is a real concern, and how difficult specification and verification problems truly are.
