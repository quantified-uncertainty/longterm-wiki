...
- GPT-5/6 showing qualitative leap in <EntityLink id="reasoning">reasoning and planning</EntityLink>
...
- If China racing: Pressure for <EntityLink id="short-timeline-policy-implications">short timelines</EntityLink>
