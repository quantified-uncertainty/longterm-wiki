...
| Source | Link |
|--------|------|
| Related Resource | [firstmovers.ai](https://firstmovers.ai/agi-timeline/) |
...
- GPT-5/6 showing qualitative leap in <EntityLink id="E246" name="reasoning">reasoning and planning</EntityLink>
...
- If China racing: Pressure for <EntityLink id="E415" name="short-timeline-policy-implications">short timelines</EntityLink>
