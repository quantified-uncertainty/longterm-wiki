...
**Organizations Leading Work**: <EntityLink id="E22">Anthropic</EntityLink> (mechanistic interpretability team), <EntityLink id="E218">OpenAI</EntityLink> (interpretability research), DeepMind, independent researchers
