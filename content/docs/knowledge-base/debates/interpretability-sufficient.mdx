...
<DataExternalLinks pageId="interpretability-sufficient" client:load />
...
**Organizations Leading Work**: <EntityLink id="anthropic">Anthropic</EntityLink> (mechanistic interpretability team), <EntityLink id="openai">OpenAI</EntityLink> (interpretability research), DeepMind, independent researchers
