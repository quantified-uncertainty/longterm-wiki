...
| **Premise 4 (Time)** | Key uncertainty (crux) | Alignment research at \$180-200M/year vs \$100B+ capabilities; <EntityLink id="racing-dynamics">racing dynamics</EntityLink> persist |
