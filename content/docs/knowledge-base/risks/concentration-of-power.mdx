...
> **For comprehensive analysis**, see <EntityLink id="ai-control-concentration">AI Control Concentration</EntityLink>, which covers:
...
|----------|-----------|--------|
| <EntityLink id="compute-governance" /> | Control access to training resources | Emerging |
...
See <EntityLink id="ai-control-concentration">AI Control Concentration</EntityLink> for detailed analysis.
...
### Primary Reference
- **<EntityLink id="ai-control-concentration">AI Control Concentration</EntityLink>** — Comprehensive parameter page with mechanisms, measurement, and interventions

### Related Risks
- <EntityLink id="compute-concentration" /> — US jurisdictional monopoly over AI compute, cybersecurity, military-commercial dual use
- <EntityLink id="lock-in" /> — Path dependencies reinforcing concentration
- <EntityLink id="racing-dynamics" /> — Competition accelerating unsafe development
- <EntityLink id="authoritarian-takeover" /> — Concentrated power enabling authoritarianism

### Related Parameters
- <EntityLink id="regulatory-capacity">Regulatory Capacity</EntityLink> — Government ability to constrain concentration
- <EntityLink id="coordination-capacity">Coordination Capacity</EntityLink> — Multi-actor cooperation on governance
- <EntityLink id="institutional-quality">Institutional Quality</EntityLink> — Checks and balances strength
