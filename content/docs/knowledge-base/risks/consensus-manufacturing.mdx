...
---
import {DataInfoBox, KeyQuestions, Mermaid, Backlinks, ModelsList, R, EntityLink, DataExternalLinks} from '@components/wiki';

<DataExternalLinks pageId="consensus-manufacturing" client:load />
...
<Backlinks client:load entityId="consensus-manufacturing" />
