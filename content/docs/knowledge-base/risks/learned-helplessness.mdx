...
<DataExternalLinks pageId="learned-helplessness" client:load />
...
| **Consensus manufacturing** | Artificial appearance of expert agreement | <EntityLink id="consensus-manufacturing">Consensus Manufacturing</EntityLink> |
...
<EntityLink id="agi-development">Forecasting models</EntityLink> suggest acceleration:

| Year | Projected Helplessness Rate | Key Drivers |
|------|---------------------------|-------------|
| **2025** | 25-35% | Deepfake <EntityLink id="proliferation">proliferation</EntityLink> |
| **2027** | 40-50% | AI content dominance |
| **2030** | 55-65% | <EntityLink id="authentication-collapse">Authentication collapse</EntityLink> |
...
- <EntityLink id="trust-cascade">Trust Cascade</EntityLink>: Institutional trust collapse
- <EntityLink id="authentication-collapse">Authentication Collapse</EntityLink>: Technical verification failure
- <EntityLink id="reality-fragmentation">Reality Fragmentation</EntityLink>: Competing truth systems
- <EntityLink id="consensus-manufacturing">Consensus Manufacturing</EntityLink>: Artificial agreement creation
