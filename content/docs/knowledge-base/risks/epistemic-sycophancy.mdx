...
|----------|-----------|----------------------|
| <EntityLink id="constitutional-ai">Constitutional AI</EntityLink> training | Explicit truthfulness principles in training | Medium (reduces by ≈26% in research) |
