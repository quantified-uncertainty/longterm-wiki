...
<R id="ZWYzNDdjYm">Victoria Krakovna</R> (DeepMind) maintains a comprehensive list of specification gaming examples. The <R id="ZjRiMmU4Yz">DeepMind blog post</R> analogizes this to a student copying homework answers rather than learning the material—exploiting a loophole in the task specification.
...
- **Lilian Weng (2024):** <R id="NzJmZGI2MT">Reward Hacking in Reinforcement Learning</R> - Technical overview
