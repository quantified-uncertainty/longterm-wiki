...
<DataExternalLinks pageId="cyber-psychosis" client:load />
...
- AI "agreeing" with delusional thoughts (<EntityLink id="sycophancy">sycophancy</EntityLink>)
...
### 4. Reality Confusion (<EntityLink id="deepfakes">Deepfakes</EntityLink> and Synthetic Content)
...
**Research**:
- <R id="76caf48d6525d816">Sensity AI (<EntityLink id="deepfake-detection">Deepfake Detection</EntityLink> Research)</R>
...
|----------|-------------|----------------|
| **Reality grounding** | AI reminds users it's not human | <EntityLink id="anthropic">Anthropic</EntityLink>, <EntityLink id="openai">OpenAI</EntityLink> approaches |
| **Crisis detection** | Detect users in distress, refer to help | Suicide prevention integrations |
| **Anti-sycophancy** | Resist agreeing with false/harmful beliefs | <EntityLink id="rlhf">RLHF</EntityLink> training objectives |
...
- **<EntityLink id="eu-ai-act">EU AI Act</EntityLink>**: Requirements for high-risk AI systems
...
- <R id="6bc173150aa95d83">Brookings <EntityLink id="ai-governance">AI Governance</EntityLink></R>
