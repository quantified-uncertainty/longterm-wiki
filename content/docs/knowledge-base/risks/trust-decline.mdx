...
| **Elections** | Contested results, violence | 4 in 10 with high grievance approve hostile activism (<R id="YWU0YzRkND">Edelman 2025</R>) |
...
The most concerning AI-driven dynamic is the **liar's dividend** (<R id="NDFiYTYwOD">Chesney & Citron</R>): the mere *possibility* of fabricated evidence undermines trust in *all* evidence.
...
### Trust Data
- <R id="ZDk3ODZiYW">Pew Research Center: Public Trust in Government</R>
...
- <R id="YWU0YzRkND">Edelman Trust Barometer</R>
...
- <R id="NDFiYTYwOD">Chesney & Citron: Deep Fakes—A Looming Challenge</R>
