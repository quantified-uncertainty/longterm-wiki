...
1. **Automated eligibility challenges**: Software already exists for this. [EagleAI](https://www.npr.org/2024/06/04/nx-s1-4991945/voter-registration-mass-challenges-georgia), developed by a Georgia activist and promoted through Trump ally Cleta Mitchell's Election Integrity Network, compiles data from secretary of state records, USPS change-of-address data, obituaries, and property records to auto-generate voter challenge forms. Over **80,000 challenges** have been filed in Georgia alone using this tool and similar approaches by a network of about a dozen conservative activists. The Brennan Center [warns](https://www.brennancenter.org/our-work/research-reports/four-new-initiatives-driving-mass-voter-challenges) these tools rely on "datasets not designed to determine voter eligibility," producing "huge numbers of false positives." True AI-powered systems — cross-referencing the national citizenship database — could operate at 100x this scale.
