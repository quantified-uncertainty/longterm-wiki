...
| **Mitigation Maturity** | Medium | <EntityLink id="process-supervision">Process supervision</EntityLink>, domain randomization, and OOD detection show promise but remain incomplete solutions |
...
<DataExternalLinks pageId="distributional-shift" client:load />
