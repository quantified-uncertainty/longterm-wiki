...
| **Regulatory Impact** | Severe if unaddressed | <EntityLink id="E127" name="eu-ai-act">EU AI Act</EntityLink>, <EntityLink id="E252" name="responsible-scaling-policies">RSPs</EntityLink>, and compute governance depend on capability thresholds that sandbagging can circumvent |
