...
[^1]: "A Theory of Epistemic Risk" - Philosophy of Science, July 2019, pp. 522–550 (published online 2022). Funded by the Social Sciences and Humanities Research Council of Canada. Defines epistemic risk as credence sensitivity to graded error, linked to expected inaccuracy and information entropy.

[^2]: European Central Bank Working Paper - Systemic risk definitions and measurement, 2009. Surveys forms of systemic risk including endogenous imbalances, herd behavior, and contagion.

[^3]: Systemic Risk Centre, London School of Economics - Research on endogenous systemic risk, emphasizing that systemic risk is generated within complex systems through feedback dynamics rather than solely from external shocks.

[^4]: OECD - Holistic risk management framework, 2003. Introduced systemic risk as embedded in broader social and financial contexts requiring interdisciplinary analysis.

[^5]: Thinking Ahead Institute - Systemic risk paper, 2023. Defines systemic risk as "the possibility of malfunctioning in complex adaptive systems," emphasizing endogenous feedback dynamics.

[^6]: United Nations Office for Disaster Risk Reduction (UNDRR) - Systemic risk briefing. Extends systemic risk analysis to cascading impacts across ecosystems, health, infrastructure, and food sectors.

[^7]: World Health Organization - Framework on health disinformation and infodemics. Identifies disinformation as a direct threat to public health, particularly during large-scale outbreaks.

[^8]: OECD - Recommendation on Information Integrity, 2024. Addresses systemic vulnerabilities in information ecosystems.

[^9]: DTCC Systemic Risk Barometer Survey, 2024. Found that 55% of respondents believe there is a high or very high chance of a high-impact systemic event in 2025, with geopolitical and cyber risks identified as top concerns.

[^10]: Eurac Research - Workshop on conceptual frameworks for interconnected risks related to climate change, disasters, and societal transitions, 2025. Brought together international researchers to support resilient decision-making at the science-policy interface.
