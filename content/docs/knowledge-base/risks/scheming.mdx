...
| <EntityLink id="E252" name="responsible-scaling-policies" /> | Capability thresholds trigger enhanced safety measures | Medium |
...
- <EntityLink id="E252" name="responsible-scaling-policies" /> — Capability thresholds for enhanced safety measures
