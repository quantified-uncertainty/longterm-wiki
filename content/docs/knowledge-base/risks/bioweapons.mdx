...
|----------|-----------|---------------|
| <EntityLink id="responses/biosecurity">Biosecurity Interventions</EntityLink> | DNA screening, surveillance, countermeasures, physical defenses | High (portfolio) |
...
The [Forecasting Research Institute](https://forecastingresearch.org/ai-enabled-biorisk) surveyed 46 biosecurity experts and 22 superforecasters in early 2025:
...
**Key insight:** Safeguards (closed weights, anti-jailbreaking, DNA screening) can reduce risk nearly to baseline even with advanced AI capabilities.
...
**Existential risk context:** In *The Precipice*, Oxford philosopher <EntityLink id="toby-ord">Toby Ord</EntityLink> estimates the chance of <EntityLink id="existential-catastrophe">existential catastrophe</EntityLink> from engineered pandemics at **1 in 30 by 2100**—second only to AI among anthropogenic risks. While not all engineered pandemics would be AI-assisted, this frames the potential severity. Ord notes that it "now seems within the reach of near-term biological advances to create pandemics that would kill greater than 50% of the population—not just in a particular area, but globally."
...
[Epoch AI's 2025 analysis](https://epoch.ai/gradient-updates/do-the-biorisk-evaluations-of-ai-labs-actually-measure-the-risk-of-developing-bioweapons) of biorisk evaluations across 8 major AI labs identified significant methodological concerns:
...
2025-2026 marked a significant shift in how AI labs and governments assess biological risks. The [Council on Strategic Risks' year-in-review](https://councilonstrategicrisks.org/2025/12/22/2025-aixbio-wrapped-a-year-in-review-and-projections-for-2026/) noted: "The year 2025 brought rising public awareness and discussion of the risks at the AI-biology nexus."

| Development | Date | Significance |
|-------------|------|--------------|
| Evo2 biological AI model released | Feb 2025 | Largest AI biology model trained on 128,000+ genomes |
| FRI expert survey | Feb 2025 | Quantified 5x risk increase from AI capabilities |
| OpenAI's o3 matches expert virologists | Apr 2025 | 94th percentile on Virology Capabilities Test |
| Anthropic ASL-3 activation | May 2025 | First use of highest safety tier for Claude Opus 4 |
| US AI Action Plan biosecurity chapter | Jul 2025 | Federal recognition of AI-enabled pathogen risk |
| UN AI governance bodies formalized | Sep 2025 | Scientific Panel + Global Dialogue established |
| DNA screening patch deployed globally | Oct 2025 | 97% detection rate achieved |
| [Epoch AI evaluation analysis](https://epoch.ai/gradient-updates/do-the-biorisk-evaluations-of-ai-labs-actually-measure-the-risk-of-developing-bioweapons) | 2025 | Found benchmark saturation across labs |
...
**The Sverdlovsk incident (1979):** Accidental release of anthrax spores from a military facility killed at least 68 people (true number unknown—KGB destroyed records). The Soviet government blamed contaminated meat until Boris Yeltsin admitted the truth in 1992.
...
- Coefficient Giving issued <R id="34e710aed540db3c">RFI on far-UVC evaluation</R>
