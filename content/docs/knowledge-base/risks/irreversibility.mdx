...
<DataExternalLinks pageId="irreversibility" client:load />
...
|-----------|------------|----------|
| Severity | **Potentially Permanent** | <EntityLink id="values">Value lock-in</EntityLink> and power concentration could foreclose future options indefinitely |
...
| Timeline | **Near-term Thresholds** | <R id="3b9fccf15651dbbe"><EntityLink id="toby-ord">Toby Ord</EntityLink></R> estimates 1/10 existential risk this century from unaligned AI |
...
| Safety Preparedness | **Inadequate** | <R id="97185b28d68545b4"><EntityLink id="fli">Future of Life Institute</EntityLink></R> finds no leading AI company has adequate guardrails for catastrophic risk |
