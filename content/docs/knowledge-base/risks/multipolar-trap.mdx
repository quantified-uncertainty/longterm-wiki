...
| **Tractability** | Low-Medium (20-35%) | Game-theoretic structure makes unilateral action ineffective; requires <EntityLink id="E171">international coordination</EntityLink> with verification challenges |
