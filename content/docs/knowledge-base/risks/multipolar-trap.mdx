...
<DataExternalLinks pageId="multipolar-trap" client:load />
...
| **Tractability** | Low-Medium (20-35%) | Game-theoretic structure makes unilateral action ineffective; requires <EntityLink id="international-coordination">international coordination</EntityLink> with verification challenges |
