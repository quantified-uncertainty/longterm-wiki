...
<DataExternalLinks pageId="knowledge-monopoly" client:load />
...
| <EntityLink id="epistemics">Epistemic lock-in</EntityLink> | Extreme | Low (30%) | 2035-2050 | Uncertain |
...
|-------|--------------|-------------|-------------------|
| Foundation Models | 85% top-3 | <EntityLink id="openai">OpenAI</EntityLink>, Google, <EntityLink id="anthropic">Anthropic</EntityLink> | High (HHI: 2800) |
...
*Source: <R id="120adc539e2fa558"><EntityLink id="epoch-ai">Epoch AI</EntityLink> Market Analysis</R>, <R id="bf9b38f0f109e5a4">Similarweb Traffic Data</R>*
...
| **Regulatory compliance** | Fixed costs favor large players | <EntityLink id="eu-ai-act">EU AI Act</EntityLink> compliance: €10M+ | <R id="405c2e0945884dba">EU AI Office</R> |
...
- **<EntityLink id="lock-in">Lock-in</EntityLink>**: Switching costs become prohibitive
...
- **No alternatives**: <EntityLink id="human-expertise">Human expertise</EntityLink> atrophied
...
| **<EntityLink id="historical-revisionism">Historical revisionism</EntityLink>** | Training cutoff effects | Temporal | Recent events misrepresented uniformly |
...
| **United Kingdom** | Innovation-first | Low - minimal intervention | <EntityLink id="uk-aisi">UK AI Safety Institute</EntityLink> |
...
- **<EntityLink id="international-coordination">International coordination</EntityLink>**: Will nations allow foreign AI knowledge monopolies?
...
|--------|------|--------------|
| <R id="2d4cab8540b83906">Brookings <EntityLink id="ai-governance">AI Governance</EntityLink></R> | Think tank | Competition policy recommendations |
| <R id="cf5fd74e8db11565">RAND AI Research</R> | Defense analysis | National security implications |
| <R id="f0d95954b449240a"><EntityLink id="cset">CSET</EntityLink> Georgetown</R> | University center | China-US AI competition |
| <R id="1593095c92d34ed8"><EntityLink id="fhi">Future of Humanity Institute</EntityLink></R> | Academic | Long-term governance challenges |
...
- <R id="2111dc0026710661">Anthropic <EntityLink id="constitutional-ai">Constitutional AI</EntityLink></R> - Value alignment research
