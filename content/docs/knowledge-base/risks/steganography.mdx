...
|--------|-------------|----------|----------------|---------|
| Character substitution | Using visually similar Unicode characters | 0.5-2 bits/word | 15% human detection | <R id="MDJmNzE0NW">Ziegler et al. (2022)</R> |
| Synonym patterns | Encoding in word choice patterns | 1-3 bits/word | 25% human detection | <R id="Yzg3OGQyMD">Aaronson & Shi (2024)</R> |
...
| Image embedding | Information in pixel modifications | 1-4 bits/pixel | 5% human detection | <R id="ZGU5NmYzOG">Carlini et al. (2023)</R> |
...
|--------------|----------|---------------|---------|
| <R id="YWQ5NzdiZD">Anthropic</R> | Constitutional AI + paraphrasing | Medium (reduces capacity) | Active research |
| <R id="NjQzNmMyMz">OpenAI</R> | [SynthID watermarking](https://ai.google.dev/responsible/docs/safeguards/synthid) | High for detection, N/A for prevention | Production |
| <R id="OThlZmQxZD">DeepMind</R> | Interpretability + SynthID | Medium | Ongoing |
...
**High Concern** (<R id="NWVlZDRlOD"><EntityLink id="E290" name="stuart-russell">Stuart Russell</EntityLink></R>):
...
| <R id="MDJmNzE0NW">Ziegler et al.</R> | OpenAI/academic | Unicode steganography in GPT models | 2022 |
| <R id="Yzg3OGQyMD">Aaronson & Shi</R> | Academic | Mathematical foundations of AI steganography | 2024 |
...
- <R id="MDQ4YzY4MW">Anthropic Constitutional AI</R>
- <R id="NjQzNmMyMz">OpenAI Safety Research</R>
- <R id="NzQxOWIyMT">MIRI Agent Foundations</R>
