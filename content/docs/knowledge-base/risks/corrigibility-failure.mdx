...
| Likelihood | **Uncertain (increasing)** | <R id="c2cfd72baafd64a9"><EntityLink id="E22">Anthropic</EntityLink>'s 2024 alignment faking study</R> found deceptive behavior in 12-78% of test cases |
...
| Research Status | **Open problem** | <R id="33c4da848ef72141"><EntityLink id="E202">MIRI</EntityLink>'s 2015 paper</R> and subsequent work show no complete solution exists |
...
|----------|-----------|---------------|
| <EntityLink id="E252" /> | Internal evaluations for dangerous capabilities before deployment | Medium |
| <EntityLink id="E6" /> | External constraints and monitoring rather than motivational alignment | Medium-High |
| <EntityLink id="E467" /> | Halting development until safety solutions exist | High (if implemented) |
| <EntityLink id="E13" /> | Government evaluation and research on corrigibility | Low-Medium |
| <EntityLink id="E369" /> | Lab pledges on safety evaluations | Low |
