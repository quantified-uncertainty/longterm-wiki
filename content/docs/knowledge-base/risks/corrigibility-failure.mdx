...
| Likelihood | **Uncertain (increasing)** | <R id="c2cfd72baafd64a9"><EntityLink id="E22" name="anthropic">Anthropic</EntityLink>'s 2024 alignment faking study</R> found deceptive behavior in 12-78% of test cases |
...
| Research Status | **Open problem** | <R id="33c4da848ef72141"><EntityLink id="E202" name="miri">MIRI</EntityLink>'s 2015 paper</R> and subsequent work show no complete solution exists |
