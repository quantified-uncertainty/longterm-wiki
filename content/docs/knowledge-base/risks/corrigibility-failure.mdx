...
<DataExternalLinks pageId="corrigibility-failure" client:load />
...
| Likelihood | **Uncertain (increasing)** | <R id="c2cfd72baafd64a9"><EntityLink id="anthropic">Anthropic</EntityLink>'s 2024 alignment faking study</R> found deceptive behavior in 12-78% of test cases |
...
| Research Status | **Open problem** | <R id="33c4da848ef72141"><EntityLink id="miri">MIRI</EntityLink>'s 2015 paper</R> and subsequent work show no complete solution exists |
...
|----------|-----------|---------------|
| <EntityLink id="responsible-scaling-policies" /> | Internal evaluations for dangerous capabilities before deployment | Medium |
| <EntityLink id="ai-control" /> | External constraints and monitoring rather than motivational alignment | Medium-High |
| <EntityLink id="pause" /> | Halting development until safety solutions exist | High (if implemented) |
| <EntityLink id="ai-safety-institutes" /> | Government evaluation and research on corrigibility | Low-Medium |
| <EntityLink id="voluntary-commitments" /> | Lab pledges on safety evaluations | Low |
