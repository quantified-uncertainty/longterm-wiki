...
Major AI labs have invested in security teams and treat model weights as sensitive assets. <EntityLink id="openai">OpenAI</EntityLink>, <EntityLink id="anthropic">Anthropic</EntityLink>, and Google DeepMind maintain dedicated security teams. Data centers employ physical security measures, and companies run bug bounty programs. Some labs have begun treating frontier model weights as assets requiring national-security-grade protection.
