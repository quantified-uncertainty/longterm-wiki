...
<DataExternalLinks pageId="instrumental-convergence" client:load />
...
| Empirical Evidence | **Emerging** | <EntityLink id="anthropic">Anthropic</EntityLink> documented <R id="1fb3c217c5e296b6">alignment faking in 78% of tests</R> (Dec 2024) |
