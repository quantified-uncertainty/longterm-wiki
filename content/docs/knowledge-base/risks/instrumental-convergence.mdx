...
| Empirical Evidence | **Emerging** | <EntityLink id="E22" name="anthropic">Anthropic</EntityLink> documented <R id="1fb3c217c5e296b6">alignment faking in 78% of tests</R> (Dec 2024) |
...
| Current Manifestation | **Moderate** | Self-preservation behaviors observed in LLMs; <R id="2fdf91febf06daaf"><EntityLink id="E295" name="sycophancy">sycophancy</EntityLink> documented across frontier models</R> |
...
| <EntityLink id="E114" name="eliezer-yudkowsky">Eliezer Yudkowsky</EntityLink> | ≈99% | Views current AI trajectory as almost certainly catastrophic | <R id="ffb7dcedaa0a8711">Wikipedia</R> |
