...
|----------|-----------|---------------|
| <EntityLink id="E468" name="training-programs">Training Programs</EntityLink> | Preserve technical expertise | Medium |
| <EntityLink id="E271" name="scalable-oversight">Scalable Oversight</EntityLink> | Maintain supervision capability | Medium |
