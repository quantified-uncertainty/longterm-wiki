...
<EntityLink id="E218" name="openai">OpenAI</EntityLink>'s GDPval benchmark, measuring performance on real-world tasks, found that Claude Opus 4.1 produces outputs as good as or better than humans in just under half of tested tasks, and that GPT-5 performance more than tripled in one year compared to GPT-4o.[^28]

## Governance Proposals

<EntityLink id="E218" name="openai">OpenAI</EntityLink> has called for governance frameworks for superintelligence development, suggesting that major governments could establish coordinated projects or collectively agree to limit the rate of capability growth at the frontier.[^29]
