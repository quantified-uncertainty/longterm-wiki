...
| Regulatory Coverage | **Partial** | <EntityLink id="E127">EU AI Act</EntityLink> covers high-risk systems; US approach fragmented across sectors |
...
This scenario is particularly insidious because it exploits legitimate organizational needs for efficiency and consistency while leveraging well-documented human tendencies toward <EntityLink id="E32">automation bias</EntityLink>. The distributed nature of adoption means no single entity bears responsibility for the systemic effects, while the opacity of modern AI systems makes the biases extremely difficult to detect until they have already influenced millions of decisions across society.
