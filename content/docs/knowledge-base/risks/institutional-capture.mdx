...
|----------|-----------|---------------|
| <R id="NDRlMGJiNj">EU AI Act</R> | Mandatory risk assessment, human oversight for high-risk AI | Medium-High |
| <R id="N2EzYzdjMD">NIST AI Risk Management Framework</R> | Voluntary bias mitigation guidance | Low-Medium |
...
While Northpointe (the system's developer, now Equivant) disputed aspects of the analysis, <R id="MDg0YjFmMT">subsequent research</R> demonstrated that certain fairness criteria are mathematically incompatible—satisfying calibration (equal accuracy across groups) can conflict with equal error rates across groups. This "impossibility of fairness" theorem shows that algorithmic bias is not merely a technical problem but involves fundamental value trade-offs.
...
This is particularly concerning given that <R id="MmQxZWY5MD">83% of employers now use some form of AI hiring tool</R>, including 99% of Fortune 500 companies. Most hiring AI systems are trained to identify candidates who resemble successful past hires, using metrics like tenure, performance ratings, or advancement within the organization. However, these metrics may reflect historical biases in hiring, management, and evaluation practices rather than genuine job performance capability. If women or minorities faced systematic barriers to advancement in previous eras, an AI system trained to identify candidates likely to advance will systematically screen against women and minorities, even though they may be equally or more capable of performing the job functions.

A <R id="ZTAxNmRiMW">2024 UNESCO study</R> found that major LLMs associate women with "home" and "family" **four times more often** than men, while disproportionately linking male-sounding names to "business," "career," and "executive" roles.

Financial services face similar challenges with credit scoring algorithms that optimize for loan repayment rates rather than borrowers' actual capacity to repay. <R id="MmQ0MjM4OW">Research from Lehigh University</R> found that LLMs used in mortgage lending consistently recommended denying more loans and charging higher interest rates to Black applicants compared to otherwise identical white applicants.
...
- <R id="ZDUxMGRkZT">Stanford research</R> found credit scoring tools are **5-10% less accurate** for lower-income and minority borrowers
...
- The <R id="YTdiZDBmNm">Consumer Financial Protection Bureau estimates</R> that **20% of US adults** are underserved for credit, disproportionately from minority groups
...
The psychological phenomenon of automation bias creates additional challenges for detecting institutional capture because it systematically undermines the human oversight that is supposed to serve as a check on algorithmic decision-making. <R id="ZmU1NTdiZG">A systematic review</R> examining 74 studies found automation bias to be pervasive across domains, particularly in aviation and healthcare. Research by Parasuraman and Riley (1997) and subsequent studies have consistently demonstrated that humans tend to over-rely on automated systems, particularly when those systems demonstrate high reliability in initial use.

**Recent research on automation bias:**
- <R id="YWMxZTRkZj">A 2024 study in International Studies Quarterly</R> tested 9,000 adults across nine countries, finding a "Dunning-Kruger effect" where those with the lowest AI experience showed slight algorithm aversion, but automation bias increased at lower-to-moderate knowledge levels before leveling off
- <R id="Y2E0NmQyNW">Research published in Scientific Reports</R> found that humans **inherit AI biases**: after working with biased AI recommendations, participants continued making the same errors even when the AI was no longer providing suggestions
- A <R id="ODZmOGExNW">2025 review in AI & Society</R> noted that human-in-the-loop processes can become "quasi-automated" where "the human contributes almost nothing" to oversight
...
- Obermeyer, Z., Powers, B., Vogeli, C., & Mullainathan, S. (2019). <R id="ZDE3ZTI3MD">Dissecting racial bias in an algorithm used to manage the health of populations</R>. *Science*, 366(6464), 447-453.
- Angwin, J., Larson, J., Mattu, S., & Kirchner, L. (2016). <R id="NzBiZGQ1YT">Machine Bias</R>. *ProPublica*.
- Logg, J. M., Minson, J. A., & Moore, D. A. (2019). <R id="MjVhNWYyNz">Algorithm appreciation: People prefer algorithmic to human judgment</R>. *Organizational Behavior and Human Decision Processes*, 151, 90-103.

### Hiring and Employment Discrimination

- University of Washington (2024). <R id="NDc4MDljYW">AI tools show biases in ranking job applicants' names according to perceived race and gender</R>.
- Brookings Institution. <R id="ZTAxNmRiMW">Gender, race, and intersectional bias in AI resume screening via language model retrieval</R>.
- NPR (2023). <R id="MmQxZWY5MD">Companies are turning to AI for hiring. That could lead to discrimination</R>.

### Healthcare Algorithms

- npj Digital Medicine (2025). <R id="MDBmMDBhYW">Potential for Algorithmic Bias in Clinical Decision Instrument Development</R>.
- Chicago Booth Review. <R id="ZWQxYWY1MG">How Racial Bias Infected a Major Health-Care Algorithm</R>.

### Credit and Lending

- Lehigh University (2024). <R id="MmQ0MjM4OW">AI Exhibits Racial Bias in Mortgage Underwriting Decisions</R>.
- Stanford HAI. <R id="ZDUxMGRkZT">How Flawed Data Aggravates Inequality in Credit</R>.
- Brookings Institution. <R id="YTdiZDBmNm">Reducing bias in AI-based financial services</R>.

### Automation Bias

- Goddard, K., Roudsari, A., & Wyatt, J. C. (2012). <R id="ZmU1NTdiZG">Automation bias: a systematic review of frequency, effect mediators, and mitigators</R>. *Journal of the American Medical Informatics Association*, 19(1), 121-127.
- Bauer, K., et al. (2024). <R id="YWMxZTRkZj">Bending the Automation Bias Curve: A Study of Human and AI-Based Decision Making in National Security Contexts</R>. *International Studies Quarterly*.
- Leib, M., et al. (2023). <R id="Y2E0NmQyNW">Humans inherit artificial intelligence biases</R>. *Scientific Reports*.

### Regulatory Frameworks

- European Commission. <R id="NDRlMGJiNj">AI Act: Regulatory Framework for AI</R>.
- European Parliament. <R id="Yzc2ZjEwYm">EU AI Act: First Regulation on Artificial Intelligence</R>.
- OECD (2025). <R id="MmQ0NzljOD">AI in policy evaluation: Governing with Artificial Intelligence</R>.

### Criminal Justice

- ProPublica (2016). <R id="YjE4ODg4Mz">How We Analyzed the COMPAS Recidivism Algorithm</R>.
- ProPublica (2016). <R id="MDg0YjFmMT">Bias in Criminal Risk Scores Is Mathematically Inevitable, Researchers Say</R>.

### Government and Policy AI

- MIT Media Lab. <R id="NTY3YzliYT">Algorithmic Decision Making and Governance in the Age of AI</R>.
- Cambridge University Press. <R id="ODI1NTBhYz">Explainable and transparent artificial intelligence for public policymaking</R>.
