...
| **Deanonymization Capability** | Demonstrated at scale | Neural network identified 14.7-52.4% of users from anonymized interaction data ([Nature Communications](https://www.nature.com/articles/ncomms1544)); Netflix Prize data deanonymized via cross-referencing |
| **Face Recognition** | Near-human or superhuman | GPT-4 scored 92.5% on face matching vs 81.3% for humans ([arXiv 2024](https://arxiv.org/html/2401.13641v1)); OpenAI restricts this capability |
...
| **Privacy Concern** | Majority worried | 57% of consumers say AI threatens privacy; 81% expect data misuse ([Pew Research](https://www.pewresearch.org/)) |
...
| **Document analysis** | UK Serious Fraud Office | 30M documents (Rolls-Royce case) | Processed 600,000 documents daily, uncovered critical evidence |
...
GPT-4 has demonstrated underlying face-matching capability that exceeds human performance — scoring [92.5% on standardized tests compared to 81.3% for humans](https://arxiv.org/html/2401.13641v1). While OpenAI restricts this capability in public-facing products, the underlying technical ability exists and will likely become available through other channels.
...
- **Post-Snowden surveys**: 28% of respondents curtailed social media activities; 24% avoided certain topics in phone or email conversations
...
| **U.S. state laws** (20 states by 2025) | Varies by state | Maryland has lowest threshold (10,000 consumers) | No federal framework; patchwork coverage |
