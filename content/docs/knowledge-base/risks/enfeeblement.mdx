...
Modern AI systems increasingly make superior decisions in specialized domains. <R id="OTQ4ZjdkYW">Anthropic's Constitutional AI</R> demonstrates how AI can outperform humans in moral reasoning tasks. As this capability gap widens, rational actors defer to AI judgment, gradually atrophying their own decision-making faculties.
...
Critical systems increasingly embed AI decision-making at foundational levels. <R id="MjI1YWJiOG">RAND Corporation research</R> shows that modern infrastructure dependencies create systemic vulnerability when humans lose operational understanding.
...
**Optimistic View** (<R id="NWVlZDRlOD"><EntityLink id="E290" name="stuart-russell">Stuart Russell</EntityLink></R>): AI should handle tasks it does better, freeing humans for uniquely human activities. Capability loss is acceptable if human welfare improves.
...
**Reversibility Optimists**: Skills can be retrained if needed. <R id="MDdlZDEzMW">RAND research</R> suggests humans adapt to technological change.
...
**Navigation Skills Decline**: GPS adoption led to measurable reductions in spatial navigation abilities. <R id="MTVmMjkxZj">University College London</R> research shows GPS users form weaker mental maps even in familiar environments.
...
**Medical Diagnosis**: Radiologists increasingly rely on AI diagnostic tools. <R id="MjgwMjU1ZD">Nature Medicine</R> shows AI often outperforms humans, but human radiologists using AI without understanding its limitations make more errors than either alone.
...
| <R id="YTE4NjI5Y2">Science</R> | Digital memory effects | External memory reduces internal recall |
| <R id="NTQ2MTI3Nj">Educational Psychology</R> | Calculator dependency | r = -0.23 correlation with perceived math skills |
...
|--------------|----------|-------|
| <R id="MmI4MGUzYm">RAND Corporation</R> | AI and Human Capital | Workforce implications |
| <R id="MTVhODMyNz">CNAS</R> | National Security AI | Strategic implications |
| <R id="MjA1MjUwNj">Brookings AI Governance</R> | Policy Framework | Governance approaches |
...
- <R id="ZDA5ZDQyMT">Center for AI Safety</R>: Comprehensive AI risk assessment
