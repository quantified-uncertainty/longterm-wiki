...
**Optimistic View** (<R id="2ccf0b6518e285d6"><EntityLink id="E290" name="stuart-russell">Stuart Russell</EntityLink></R>): AI should handle tasks it does better, freeing humans for uniquely human activities. Capability loss is acceptable if human welfare improves.
