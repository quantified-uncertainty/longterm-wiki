...
Modern AI systems increasingly make superior decisions in specialized domains. <R id="sid_mkzrGpZl8t">Anthropic's Constitutional AI</R> demonstrates how AI can outperform humans in moral reasoning tasks. As this capability gap widens, rational actors defer to AI judgment, gradually atrophying their own decision-making faculties.
...
Critical systems increasingly embed AI decision-making at foundational levels. <R id="sid_A4BKhrWm7J">RAND Corporation research</R> shows that modern infrastructure dependencies create systemic vulnerability when humans lose operational understanding.
...
**Optimistic View** (<R id="sid_eNHWa6ooGD"><EntityLink id="E290" name="stuart-russell">Stuart Russell</EntityLink></R>): AI should handle tasks it does better, freeing humans for uniquely human activities. Capability loss is acceptable if human welfare improves.

**Pessimistic View** (<EntityLink id="E215" name="nick-bostrom">Nick Bostrom</EntityLink>): Human capability has intrinsic value and instrumental importance for long-term flourishing. Enfeeblement represents genuine loss.
...
**Reversibility Optimists**: Skills can be retrained if needed. <R id="sid_FW4grHaSLm">RAND research</R> suggests humans adapt to technological change.
...
| **Oversight Training** | Specialized AI auditing capabilities | High | <EntityLink id="E201" name="metr" /> evaluation framework |
...
**Navigation Skills Decline**: GPS adoption led to measurable reductions in spatial navigation abilities. <R id="sid_9G6q2cVx0b">University College London</R> research shows GPS users form weaker mental maps even in familiar environments.
...
**Medical Diagnosis**: Radiologists increasingly rely on AI diagnostic tools. <R id="sid_8r2FTCAI9D">Nature Medicine</R> shows AI often outperforms humans, but human radiologists using AI without understanding its limitations make more errors than either alone.
...
- **<EntityLink id="E80" name="corrigibility-failure" />**: Enfeebled humans cannot effectively modify or shut down AI systems
- **<EntityLink id="E105" name="distributional-shift" />**: Dependent humans cannot adapt when AI encounters novel situations
- **<EntityLink id="E179" name="irreversibility" />**: Capability loss makes alternative paths inaccessible
- **<EntityLink id="E239" name="racing-dynamics" />**: Competitive pressure accelerates AI dependency
...
| <R id="sid_5i1kwaCj1b">Science</R> | Digital memory effects | External memory reduces internal recall |
| <R id="sid_AUGA93P6eX">Educational Psychology</R> | Calculator dependency | r = -0.23 correlation with perceived math skills |
...
|--------------|----------|-------|
| <R id="sid_9U6bQ9UjOm">RAND Corporation</R> | AI and Human Capital | Workforce implications |
| <R id="sid_7apvgiwUfr">CNAS</R> | National Security AI | Strategic implications |
| <R id="sid_tEjPH4zzko">Brookings AI Governance</R> | Policy Framework | Governance approaches |
...
- <EntityLink id="E201" name="metr" />: AI evaluation and oversight capabilities
- <EntityLink id="E24" name="apollo-research" />: AI safety evaluation research
- <R id="sid_wf8L3fxlGI">Center for AI Safety</R>: Comprehensive AI risk assessment
