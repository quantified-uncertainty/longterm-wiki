...
<DataExternalLinks pageId="legal-evidence-crisis" client:load />
...
**Research**:
- <R id="2a0bf34d14c516ac"><EntityLink id="deepfake-detection">Deepfake detection</EntityLink> accuracy declining</R>
...
**Example trajectory:**
- 2020: "<EntityLink id="deepfakes">Deepfakes</EntityLink> exist, but this is clearly real"
