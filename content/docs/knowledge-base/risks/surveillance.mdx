...
|----------|-----------|---------------|
| <EntityLink id="E127" name="eu-ai-act" /> | Bans real-time biometric identification in public spaces (with exceptions) | Medium-High (within EU) |
| <EntityLink id="E367" name="us-state-legislation" /> | City/state bans on government facial recognition (San Francisco, etc.) | Low-Medium (fragmented) |
| <EntityLink id="E136" name="export-controls" /> | US Entity List restricts Chinese surveillance company access to American components | Medium |
