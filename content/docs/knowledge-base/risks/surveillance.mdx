...
|----------|-----------|---------------|
| <EntityLink id="E127" /> | Bans real-time biometric identification in public spaces (with exceptions) | Medium-High (within EU) |
| <EntityLink id="E367" /> | City/state bans on government facial recognition (San Francisco, etc.) | Low-Medium (fragmented) |
| <EntityLink id="E136" /> | US Entity List restricts Chinese surveillance company access to American components | Medium |
