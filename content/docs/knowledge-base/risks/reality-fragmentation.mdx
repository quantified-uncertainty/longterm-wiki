...
|------|-------|----------------|
| <EntityLink id="E119" name="epistemic-collapse" /> | *Can society determine what's true?* | Failure of truth-seeking mechanisms and institutions |
| **Reality Fragmentation** (this page) | *Do people agree on facts?* | Society splitting into incompatible realities |
| <EntityLink id="E362" name="trust-decline" /> | *Do people trust institutions?* | Declining confidence in authorities and expertise |
| <EntityLink id="E102" name="disinformation" /> | *Are false claims spreading?* | Individual false narratives rather than systemic fragmentation |
...
- <EntityLink id="E96" name="deepfakes" /> create believable false documentation
...
- 73% of Republicans and 23% of Democrats believe 2020 election was "stolen"[^rc-7cb1]
- Climate change acceptance varies from 95% (Democrats) to 35% (Republicans)[^rc-e0c2]
...
- <EntityLink id="E96" name="deepfakes" /> provide "video proof" of false events
...
- <EntityLink id="E123" name="epistemic-security" /> measures lag behind threats
...
- <EntityLink id="E102" name="disinformation" />: Deliberate spreading of false information
- <EntityLink id="E96" name="deepfakes" />: AI-generated synthetic media undermining trust
- <EntityLink id="E362" name="trust-decline" />: Erosion of institutional credibility
- <EntityLink id="E119" name="epistemic-collapse" />: Complete failure of truth-seeking mechanisms
