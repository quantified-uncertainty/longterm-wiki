...
- **<EntityLink id="projecting-compute-spending">Projecting Compute Spending</EntityLink>** — \$700B+ hyperscaler capex analysis documenting the investment pattern creating these risks

### Broader Risk Context
- **<EntityLink id="concentration-of-power">Concentration of Power</EntityLink>** — The broader risk of AI enabling unprecedented power accumulation
- **<EntityLink id="winner-take-all-concentration">Winner-Take-All Concentration</EntityLink>** — Formal model of self-reinforcing concentration dynamics
- **<EntityLink id="ai-control-concentration">AI Control Concentration</EntityLink>** — Comprehensive analysis of concentration mechanisms and interventions

### Governance Responses
- **<EntityLink id="compute-governance">Compute Governance</EntityLink>** — Frameworks for responsible compute allocation
- **<EntityLink id="export-controls">Export Controls</EntityLink>** — US semiconductor export restrictions
- **<EntityLink id="international-compute-governance">International Compute Regimes</EntityLink>** — International coordination approaches
