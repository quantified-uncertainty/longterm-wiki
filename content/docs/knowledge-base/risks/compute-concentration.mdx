...
US policymakers have explicitly articulated this dynamic. Anthropic CEO Dario Amodei argued in 2025 that enforced <EntityLink id="E136" name="export-controls">export controls</EntityLink> could ensure "a unipolar world, where only the US and its allies have these models."[^rc-6d78] OpenAI has lobbied for aggressive export restrictions on Chinese competitors.[^rc-512f] The Biden administration's AI Diffusion Rule (January 2025) created a three-tier system restricting AI chip exports to approximately 150 countries before the Trump administration rescinded it in May 2025.[^rc-9895]
