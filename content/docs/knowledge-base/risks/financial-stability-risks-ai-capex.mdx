...
The AI industry's capital expenditure surge to \$700B+ in 2026 represents one of the largest capital allocation events in economic history.[^1] Six US companies — Amazon (\$200B), Alphabet (\$175-185B), <EntityLink id="microsoft">Microsoft</EntityLink> (\$145-150B), <EntityLink id="meta-ai">Meta</EntityLink> (<F e="meta-ai" f="27d6b03d">\$115-135B</F>), Oracle (\$50B), and <EntityLink id="xai">xAI</EntityLink> (<F e="xai" f="8306669f">\$30B+</F>) — are collectively betting more than the entire US defense budget on AI infrastructure in a single year.
