...
- **Hardware sales** (≈\$130B): <EntityLink id="E693" name="nvidia">NVIDIA's</EntityLink> revenue is enormous but represents companies buying tools, not generating AI returns
