...
<DataExternalLinks pageId="rogue-ai-scenarios" client:load />
...
- <EntityLink id="scheming" /> — The explicit deception variant; these scenarios are the "scheming not required" counterparts
- <EntityLink id="instrumental-convergence" /> — Theoretical foundation for self-preservation and resource-seeking scenarios
- <EntityLink id="treacherous-turn" /> — The dramatic single-moment variant; these scenarios describe gradual/distributed alternatives
- <EntityLink id="power-seeking" /> — The capability these scenarios converge toward
- <EntityLink id="deceptive-alignment" /> — Related but requires richer internal goal structure than these scenarios assume
- <EntityLink id="sandboxing" /> — Primary defense against the sandbox escape scenario
- <EntityLink id="corrigibility-failure" /> — What the self-preservation scenario produces

<Backlinks client:load entityId="rogue-ai-scenarios" />
