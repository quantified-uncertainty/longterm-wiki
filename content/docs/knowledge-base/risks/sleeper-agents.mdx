...
This persistence was most pronounced in larger models, suggesting that scaling may exacerbate rather than solve <EntityLink id="E93">deceptive alignment</EntityLink> challenges.[^1][^2]
