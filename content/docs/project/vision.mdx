...
description: "2-person-year scope for LongtermWiki: architecture, components, milestones, and success metrics"
sidebar:
  order: 1
update_frequency: 180
summary: Internal planning document outlining a 2-person-year (3-4 people over 6-8 months) scope for building LongtermWiki as a strategic AI safety prioritization platform, with ~170 planned pages across four content layers, 30-50 crux mappings, and 4-6 worldview archetypes. Success targets include 80%+ crux coverage, 10+ annual strategy document citations, and 5+ senior researcher endorsements.
---
...
<Aside type="tip" title="Core Value Proposition">
...
flowchart LR
    ...
    subgraph LTW["LongtermWiki Core"]
        direction TB
        K[Knowledge Base]
        CR[Crux Graph]
        M[Causal Models]
