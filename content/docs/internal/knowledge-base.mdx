...
update_frequency: 90
summary: Internal style guide for wiki content creation, emphasizing flexible hierarchical structure over rigid templates, integrated arguments over sparse sections, and selective use of visualizations. Provides concrete examples of good/bad practices for risk and response pages.
---
import {EntityLink} from '@components/wiki';

**Style Guide ID: `kb-2.0`** (2025-12-26)

<Aside type="note" title="Naming Clarification">
This style guide is about **wiki page authoring** for the knowledge-base section of the wiki (risks, responses, organizations, people). It is not about the KB data package (`packages/kb/`), which stores structured entity facts. For KB data conventions, see <EntityLink id="E827" name="canonical-facts">Canonical Facts & Calc Usage Guide</EntityLink> and <EntityLink id="E1018" name="data-system-authority">Data System Authority Rules</EntityLink>.
</Aside>
...
- **<EntityLink id="E13" name="ai-safety-institutes">AI Safety Institutes</EntityLink>** - Proper hierarchy, integrated assessment, substantive content
- **Compute Governance** - Detailed policy response with good structure
- **<EntityLink id="E93" name="deceptive-alignment">Deceptive Alignment</EntityLink>** - Risk page with assessment tables
