...
**See also**: The Claim-First Wiki Architecture proposal (now removed) was a companion proposal that inverted the data model, making verified atomic claims (rather than prose documents) the primary artifact, with wiki pages as derived views.
...
Recent academic work provides strong validation for the proposition-level and claim-first approaches described in this document and the companion Claim-First Architecture proposal.
