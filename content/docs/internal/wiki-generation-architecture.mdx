...
This produces pages scoring 70-80/100 on our grading rubric. The pipeline has been iterated significantly (see the [Page Creator Pipeline report](/wiki/E747)) and represents solid work. But it has structural limitations:
