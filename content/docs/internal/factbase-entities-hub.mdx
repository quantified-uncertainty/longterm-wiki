...
|-----------|---------------|
| [Entities & Pages](/internal/entities) | All entities with type, aliases, KB fact counts |
| [Entity Profile](/internal/entity-profile) | Per-entity card: facts, related pages, usage tracking |
| [Data Quality](/internal/data-quality) | Field completeness and fact staleness per entity type |
| [Data Sources](/internal/data-sources) | Provenance tracking (Wikidata, manual, inferred) |
| [People Coverage](/internal/people-coverage) | Person entity coverage across pages |
...
|--------------|-----|----------|
| Read all facts about an org | `pnpm crux fb show <slug>` | [Entity Profile dashboard](/internal/entity-profile) |
| See what's missing for an entity | `pnpm crux fb needs-update <slug>` | [Data Quality dashboard](/internal/data-quality) |
...
| Find people who appear in data but lack entities | `pnpm crux tb people discover` | [People Coverage dashboard](/internal/people-coverage) |
