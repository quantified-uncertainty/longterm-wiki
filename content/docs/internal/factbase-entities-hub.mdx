...
- <EntityLink id="E2166" name="research-discovery-hub">Research & Discovery</EntityLink> — where new facts come from before they land in FactBase
- <EntityLink id="E2167" name="verification-source-checking-hub">Verification & Source-Checking</EntityLink> — how stored facts get checked against their cited sources
- <EntityLink id="E2169" name="content-pipelines-hub">Content Pipelines</EntityLink> — how facts feed into wiki page rendering
