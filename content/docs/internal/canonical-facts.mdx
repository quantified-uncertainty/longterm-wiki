...
For entities not yet in KB, `data/facts/*.yaml` remains authoritative. See <EntityLink id="E1042" name="data-system-authority">Data System Authority Rules</EntityLink> for the full hierarchy.
