...
- <EntityLink id="E741" name="rating-system">Rating System</EntityLink> — Current quality scoring system (subscores, derived quality)
- <EntityLink id="E739" name="page-types">Page Type System</EntityLink> — Existing page classification (content/stub/documentation/overview)
- <EntityLink id="E891" name="citation-architecture">Citation Architecture</EntityLink> — How citations work today
- <EntityLink id="E897" name="claims-system-development-roadmap">Claims Development Roadmap</EntityLink> — Claims pipeline future plans
- <EntityLink id="E892" name="claim-first-architecture">Claim-First Architecture</EntityLink> — Long-term vision for claims as first-class data
