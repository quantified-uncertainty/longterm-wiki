...
update_frequency: 60
summary: Documents LongtermWiki's four-level page classification system (content, stub, documentation, overview) with explicit validation rules for each type, where content pages receive full quality grading while stubs/documentation are excluded from validation pipelines.
---
...
readerImportance: 60  # How significant for AI safety prioritization
lastEdited: "2026-01-31"
summary: "One-sentence summary with key conclusions"
ratings:
  novelty: 4
  rigor: 5
  actionability: 3
...
**Open Philanthropy rebranded to <EntityLink id="E521" name="coefficient-giving" /> in November 2025.**
...
1. **Style guides**: Documentation of how to write different page types
   - <EntityLink id="E750" name="risk-style-guide">Risk Style Guide</EntityLink>
   - <EntityLink id="E749" name="response-style-guide">Response Style Guide</EntityLink>

2. **Process documentation**: How LongtermWiki systems work
   - This page (<EntityLink id="E739" name="page-types">Page Types</EntityLink>)
   - Rating system documentation

3. **Internal planning**: Strategy documents, project notes
   - [Similar Projects](/wiki/E881)
   - [Strategy Brainstorm](/wiki/E882)
...
- <EntityLink id="E739" name="page-types">Page Types</EntityLink> (this page)
- <EntityLink id="E750" name="risk-style-guide">Risk Style Guide</EntityLink>
- <EntityLink id="E741" name="rating-system">Rating System</EntityLink>
- [Similar Projects](/wiki/E881)
...
|----------|----------|-------------|
| `knowledge-base-risk` | Risk analysis pages | <EntityLink id="E750" name="risk-style-guide">Risk Style Guide</EntityLink> |
| `knowledge-base-response` | Intervention/response pages | <EntityLink id="E749" name="response-style-guide">Response Style Guide</EntityLink> |
| `knowledge-base-model` | Analytical models | <EntityLink id="E736" name="models-style-guide">Models Style Guide</EntityLink> |
...
4. **Create style guide** in `content/docs/internal/` (it will be served at `/wiki/E<id>`)
