...
1. **Style guides**: Documentation of how to write different page types
   - [Risk Style Guide](/wiki/E750)
   - [Response Style Guide](/wiki/E749)

2. **Process documentation**: How LongtermWiki systems work
   - This page ([Page Types](/wiki/E739))
...
- [Page Types](/wiki/E739) (this page)
- [Risk Style Guide](/wiki/E750)
- [Rating System](/wiki/E741)
...
|----------|----------|-------------|
| `knowledge-base-risk` | Risk analysis pages | [Risk Style Guide](/wiki/E750) |
| `knowledge-base-response` | Intervention/response pages | [Response Style Guide](/wiki/E749) |
| `knowledge-base-model` | Analytical models | [Models Style Guide](/wiki/E736) |
| `ai-transition-model-factor` | ATM top-level factors | [ATM Style Guide](/wiki/E721) |
| `ai-transition-model-sub-item` | ATM sub-factors | [ATM Style Guide](/wiki/E721) |
| `ai-transition-model-scenario` | ATM scenarios | [ATM Style Guide](/wiki/E721) |
