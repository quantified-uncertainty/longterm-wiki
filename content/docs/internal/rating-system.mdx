...
update_frequency: 60
summary: This page documents LongtermWiki's content rating system, which combines LLM-graded subscores (focus, novelty, rigor, completeness, objectivity, concreteness, actionability on 0-10 scales) with automated metrics (word count, citations) to derive quality scores (0-100) and importance ratings for prioritization decisions.
---
...
```bash
# Grade a single page
ANTHROPIC_BILLING_KEY=sk-... node scripts/content/grade-content.mjs --page scheming

# Grade all pages (with cost estimate)
ANTHROPIC_BILLING_KEY=sk-... node scripts/content/grade-content.mjs --dry-run

# Grade and apply to frontmatter
ANTHROPIC_BILLING_KEY=sk-... node scripts/content/grade-content.mjs --apply

# Parallel processing (faster, higher API cost)
ANTHROPIC_BILLING_KEY=sk-... node scripts/content/grade-content.mjs --parallel 5 --apply
```
...
Epistemic honesty, language neutrality, and analytical (not prescriptive) tone. See <EntityLink id="E726" name="common-writing-principles">Common Writing Principles</EntityLink> for full guidance.
...
ratings:
  ...
  concreteness: 4.8
  actionability: 4.8
summary: "This page analyzes X using Y methodology. It finds that Z with N% probability."
---
```
...
```bash
pnpm crux validate templates    # Template structure
pnpm crux validate unified --rules=placeholders  # Incomplete content
```

See <EntityLink id="E739" name="page-types">Page Types</EntityLink> for which pages are validated.

---

## Related Documentation

- <EntityLink id="E726" name="common-writing-principles">Common Writing Principles</EntityLink> - Cross-cutting writing standards (objectivity dimension)
- <EntityLink id="E736" name="models-style-guide">Models Style Guide</EntityLink> - Requirements for analytical model pages
- <EntityLink id="E750" name="risk-style-guide">Risk Style Guide</EntityLink> - Requirements for risk analysis pages
- <EntityLink id="E749" name="response-style-guide">Response Style Guide</EntityLink> - Requirements for intervention pages
- <EntityLink id="E739" name="page-types">Page Types</EntityLink> - How page types affect validation
