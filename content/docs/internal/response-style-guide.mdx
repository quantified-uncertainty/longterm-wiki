...
**Prerequisite**: All response pages must follow the <EntityLink id="E726" name="common-writing-principles">Common Writing Principles</EntityLink> — epistemic honesty, language neutrality, and analytical tone. The **objectivity** rating dimension measures this.
...
See <EntityLink id="E477" name="mech-interp">Mechanistic Interpretability</EntityLink> for reference.
