...
**Prerequisite**: All response pages must follow the [Common Writing Principles](/wiki/E726) — epistemic honesty, language neutrality, and analytical tone. The **objectivity** rating dimension measures this.
...
Task({
  ...
  FIRST: Read /wiki/E749 (Response Style Guide).
...
Task({
  ...
  Read /wiki/E749 (Response Style Guide) first.
