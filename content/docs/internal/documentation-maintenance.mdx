...
| Doc | Review Focus |
|-----|--------------|
| <EntityLink id="E734" name="architecture">Architecture</EntityLink> | Are diagrams still accurate? |
| <EntityLink id="E757" name="automation-tools">Automation Tools</EntityLink> | Do all commands still work? |
| <EntityLink id="E759" name="content-database">Content Database</EntityLink> | Is schema current? |
...
pnpm crux validate docs-freshness

# Check that documented commands still exist
pnpm crux validate docs-commands

# Check that documented files still exist
pnpm crux validate docs-paths
```
...
|--------------|-------------------|
| `scripts/content/page-creator.mjs` | <EntityLink id="E734" name="architecture">Architecture</EntityLink>, <EntityLink id="E757" name="automation-tools">Automation Tools</EntityLink> |
| `apps/wiki-server/src/routes/*` | <EntityLink id="E759" name="content-database">Content Database</EntityLink>, <EntityLink id="E734" name="architecture">Architecture</EntityLink> |
| `scripts/crux.mjs` or `commands/*` | <EntityLink id="E757" name="automation-tools">Automation Tools</EntityLink> |
| `src/content.config.ts` | <EntityLink id="E739" name="page-types">Page Types</EntityLink> |
| Any validation script | <EntityLink id="E757" name="automation-tools">Automation Tools</EntityLink> |
| `.env` variables | <EntityLink id="E734" name="architecture">Architecture</EntityLink> |

---

## Related

- <EntityLink id="E734" name="architecture">Architecture</EntityLink> - System overview
- <EntityLink id="E757" name="automation-tools">Automation Tools</EntityLink> - CLI reference
- <EntityLink id="E755" name="about-this-wiki">About This Wiki</EntityLink> - Contributor overview