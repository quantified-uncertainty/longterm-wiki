...
**Prerequisite**: All risk pages must follow the [Common Writing Principles](/wiki/E726) — epistemic honesty, language neutrality, and analytical tone. The **objectivity** rating dimension measures this.
...
Task({
  ...
  FIRST: Read /wiki/E750 (Risk Style Guide) for requirements.
...
Task({
  ...
  FIRST: Read /wiki/E750 (Risk Style Guide) and the current page.
...
6. **Insider language**: "EA organizations", "non-EA causes" — use descriptive terms per [Common Writing Principles](/wiki/E726)
