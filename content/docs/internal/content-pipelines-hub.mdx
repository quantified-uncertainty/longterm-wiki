...
|-----------|---------------|
| [Suggested Pages](/internal/suggested-pages-dashboard) | Pages recommended for creation (gap analysis) |
| [Improve Runs](/internal/improve-runs-dashboard) | Improvement history, cost, quality delta |
| [Page Changes](/internal/page-changes-dashboard) | Recent edits across the wiki |
| [Update Schedule](/internal/update-schedule-dashboard) | Auto-update run schedule and next executions |
| [Groundskeeper Runs](/internal/groundskeeper-runs-dashboard) | Maintenance job history (validation, fixes, audits) |
...
|--------------|-----|----------|
| Create a new page on a topic | `pnpm crux w create "Title" --tier=standard` | [Suggested Pages dashboard](/internal/suggested-pages-dashboard) |
| Improve a page that needs polish | `pnpm crux w improve <id> --tier=standard --apply` | [Improve Runs dashboard](/internal/improve-runs-dashboard) |
| Fix a CI gate failure | `pnpm crux w validate gate --scope=content --fix` | — |
| See recent edits across the wiki | — | [Page Changes dashboard](/internal/page-changes-dashboard) |
...
| See what gap analysis suggests creating | — | [Suggested Pages dashboard](/internal/suggested-pages-dashboard) |
| Find pages overdue for refresh | — | [Update Schedule dashboard](/internal/update-schedule-dashboard) |
