...
<CardGrid>
  <LinkCard title="Research & Discovery" href="/wiki/E2166" description="The research stage that feeds page creation" />
  <LinkCard title="Verification & Source-Checking" href="/wiki/E2167" description="Validates citations on created/improved pages" />
  <LinkCard title="FactBase & Entities" href="/wiki/E2168" description="The structured data layer that pages reference via FBF" />
</CardGrid>
