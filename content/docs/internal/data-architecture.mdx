...
| `kb_source_checks` | `factbaseSourceChecks` | Per-source checks for FactBase facts. |
...
| `thing_source_checks` | `thingSourceChecks` | Per-source checks keyed by `things.id`. |
...
| `record_source_checks` | `recordSourceChecks` | Per-source checks for financial records. |
