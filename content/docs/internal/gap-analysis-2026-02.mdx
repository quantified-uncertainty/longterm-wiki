...
<Aside type="note" title="Historical Snapshot">
This analysis was conducted in February 2026 when the wiki had 639 pages. As of March 2026, the wiki has grown to ~700 pages. Many of the gaps identified here may have been addressed. Use the [Suggested Pages dashboard](/internal/suggested-pages/) for the current gap picture.
</Aside>
