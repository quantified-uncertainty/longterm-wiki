...
1. ~~Create `data/properties.yaml` with the initial 25 properties~~ -- Done: `packages/kb/data/properties.yaml` with 95 properties
...
5. **Property hierarchy.** Not yet implemented. KB properties have `category` groupings (financial, people, biographical, organization, product, etc.) but no formal sub-property relationships. With 95 properties, some hierarchy may become useful for dashboard navigation.
