...
4. **How do claims and prose stay in sync?** If a claim is updated (new valuation), the prose page should reflect it. If prose is edited directly, should claims be re-extracted? The Claim-First Architecture proposal's answer is "claims are primary, prose is derived" — but that's the long-term vision. In the short term, they'll coexist.
