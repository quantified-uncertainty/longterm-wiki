...
KB facts are rendered on wiki pages via `<FBF>` and `<FBFactValue>` components, and computed values via `<Calc>`. See <EntityLink id="E1018" name="data-system-authority">Data System Authority Rules</EntityLink> for which system is authoritative for which entities.
...
- <EntityLink id="E1018" name="data-system-authority">Data System Authority Rules</EntityLink> — Which data system is authoritative for each entity
