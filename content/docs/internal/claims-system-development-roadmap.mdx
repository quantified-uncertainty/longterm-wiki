...
**Pages with claims today:** 11 entities with 1,514 total claims. Kalshi (242) and Anthropic (325) are the most developed. See entity breakdown in <EntityLink id="E901" name="claims-data-quality-audit">Quality Audit (E901)</EntityLink>.
...
**Goal:** Fix the mechanically-fixable quality issues in existing claims before investing in extraction experiments. The <EntityLink id="E901" name="claims-data-quality-audit">Quality Audit (E901)</EntityLink> found 89% of claims have issues, but many are fixable without re-extraction.
...
**Goal:** Add reasoning traces — structured records of how each claim was derived from source material — to the claims pipeline. This makes verification auditable and enables targeted re-verification. See <EntityLink id="E903" name="reasoning-traces-architecture">Reasoning Traces Architecture (E903)</EntityLink> for the full design.
...
See <EntityLink id="E903" name="reasoning-traces-architecture">Reasoning Traces Architecture (E903)</EntityLink> for the full design of the reasoning transparency layer. The resource transparency gaps and proposals below focus on the source side.
...
- <EntityLink id="E896" name="claims-architecture-decisions">Claims Architecture Decisions (E896)</EntityLink> — Core design decisions, cruxes, worked examples, red-team failure modes
- <EntityLink id="E901" name="claims-data-quality-audit">Claims Data Quality Audit (E901)</EntityLink> — Empirical quality analysis of 1,514 claims
- <EntityLink id="E902" name="claims-extraction-quality-patterns">Extraction Quality Patterns (E902)</EntityLink> — Detailed failure mode catalog with detection and fixes
- <EntityLink id="E903" name="reasoning-traces-architecture">Reasoning Traces Architecture (E903)</EntityLink> — Data model and pipeline design for storing claim derivation chains
- <EntityLink id="E892" name="claim-first-architecture">Claim-First Architecture (E892)</EntityLink> — Long-term vision for claims as the primary wiki artifact
- <EntityLink id="E895" name="content-pipeline-architecture">Content Pipeline Architecture (E895)</EntityLink> — Faster page creation infrastructure (orthogonal but complementary)
