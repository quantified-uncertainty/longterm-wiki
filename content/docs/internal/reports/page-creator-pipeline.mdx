...
Our original <EntityLink id="E538" name="lesswrong">LessWrong</EntityLink> article had **196 table rows** and only **0.9 citations per 100 words**. It was a data dump, not a readable article. Many factual claims had no sources.
</Aside>
