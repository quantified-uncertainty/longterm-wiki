...
| **Deep Research APIs exist** | Perplexity Sonar, <EntityLink id="E218">OpenAI</EntityLink> Deep Research, Gemini Deep Research | Consider OpenRouter for Perplexity API access |
