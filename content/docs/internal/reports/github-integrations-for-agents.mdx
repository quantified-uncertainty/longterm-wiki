...
evergreen: false
summary: Comparative analysis of coordination mechanisms for multi-agent workflows, recommending GitHub Sub-Issues for task decomposition and Discussions for coordination artifacts. Sub-issues (GA March 2025) offer automatic progress tracking, PR auto-close, and assignees. Linear's agent API is the best-designed external option but requires a persistent webhook receiver incompatible with CLI-based agent sessions.
---
