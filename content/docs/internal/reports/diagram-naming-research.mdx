...
| **"Crux" has traction in target audience** | Rationalist/EA community already uses "crux" terminology from <EntityLink id="center-for-applied-rationality">CFAR</EntityLink> | Strong candidate for naming |
...
"If we have overlooked even just one such consideration, then all our best efforts might be for naught – or less. When headed the wrong way, the last thing needed is progress." — <EntityLink id="nick-bostrom">Nick Bostrom</EntityLink>
</Aside>
