...
evergreen: false
summary: Comprehensive survey of visualization tools (DAGitty, Vensim, STELLA, etc.) and academic literature on causal diagram visualization, with assessment of current implementation against best practices. Identifies concrete enhancement opportunities including semantic zoom, node search, and SVG export.
---
...
This report surveys tools and techniques for visualizing complex causal diagrams, with applications to our wiki's causal graph visualization. Key findings:
...
**Example DAGitty diagram:** See the [live DAGitty demo](https://www.dagitty.net/dags.html) for interactive examples.
...
- <EntityLink id="E758" name="cause-effect-diagrams">Cause-Effect Style Guide</EntityLink> - Our conventions
