...
### Our Implementation
- [Master Graph Viewer](/diagrams/master-graph/) - Live implementation
- [Cause-Effect Style Guide](/internal/cause-effect-diagrams/) - Our conventions
...
|------|-----|----------------|
| **Overview** | [/diagrams/master-graph](/diagrams/master-graph/) | High-level categories |
| **Interactive** | [/diagrams/master-graph?level=interactive](/diagrams/master-graph?level=interactive) | Expandable clusters, path highlighting |
| **Expanded** | [/diagrams/master-graph?level=expanded](/diagrams/master-graph?level=expanded) | Subcategories as nodes, mini-map |
| **Detailed** | [/diagrams/master-graph?level=detailed](/diagrams/master-graph?level=detailed) | All factors (160 nodes) |
