...
| summary | 83.0% | Gap — 114 pages missing |
...
5. **Complete `clusters` tagging** for the 89 KB pages without assignments, especially organizations (26% untagged) and responses (17% untagged).
