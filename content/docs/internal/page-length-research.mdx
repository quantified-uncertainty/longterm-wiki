...
The wiki has ~<F e="ssi" f="a0502d56">625</F> pages ranging from empty stubs (0 words) to comprehensive analyses (10,000+ words). Different readers want different levels of depth:
...
2. **Default behavior by page length:**
   - \< <F e="ssi" f="a0502d56">1,500</F> words: all sections expanded (short page, no need to collapse)
   - 1,500–<F e="ssi" f="a0502d56">4,000</F> words: Overview expanded, rest collapsed
...
1. **Three view modes:**
   - **Summary**: InfoBox + structured summary + key takeaways only (~<F e="ssi" f="a0502d56">200–400</F> words). No article body.
   - **Standard**: Overview section + Quick Assessment + collapsed detail sections (~<F e="ssi" f="a0502d56">800–1,500</F> words visible).
...
3. **Persist preference** in localStorage. Default to "Standard" for pages over <F e="ssi" f="a0502d56">3,000</F> words, "Full" for shorter pages.
