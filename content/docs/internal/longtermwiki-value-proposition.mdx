...
Currently, <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink>, <EntityLink id="sff">SFF</EntityLink>, Founders Pledge, EA Funds, and smaller funders each do their own prioritization analysis. This is duplicated work and leads to coordination failures (some areas over-funded, others neglected).
...
2. **Funder outreach:** Talk to <EntityLink id="coefficient-giving">Coefficient</EntityLink>, <EntityLink id="coefficient-giving">Coefficient Giving</EntityLink> program officers, <EntityLink id="sff">SFF</EntityLink>
