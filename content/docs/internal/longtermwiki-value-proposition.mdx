...
Currently, <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink>, <EntityLink id="sff">SFF</EntityLink>, Founders Pledge, EA Funds, and smaller funders each do their own prioritization analysis. This is duplicated work and leads to coordination failures (some areas over-funded, others neglected).
...
The most ambitious version: build an interactive tool where funders can input their credences on key cruxes (timelines, <EntityLink id="deceptive-alignment">deceptive alignment</EntityLink> risk, governance tractability, etc.) and get a personalized priority ranking.
...
2. **Funder outreach:** Talk to <EntityLink id="E521" name="coefficient-giving">Coefficient</EntityLink>, <EntityLink id="E521" name="coefficient-giving">Coefficient Giving</EntityLink> program officers, <EntityLink id="sff">SFF</EntityLink>
