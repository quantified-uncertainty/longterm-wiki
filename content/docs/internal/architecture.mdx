...
Resolution at runtime supports both numeric IDs and slugs, so `<EntityLink id="coefficient-giving" >` and path-based lookups both work.
...
**See**: <EntityLink id="page-creator-pipeline">Page Creator Pipeline</EntityLink> for experiment results.
...
sequenceDiagram
    ...
    MDX->>Component: <EntityLink id="coefficient-giving">
...
- <EntityLink id="entities">Entity Reference</EntityLink> — Complete entity type catalog