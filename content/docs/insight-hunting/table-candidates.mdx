...
> "<EntityLink id="E259">RLHF</EntityLink> provides primarily capability uplift (DOMINANT) with limited safety benefit (LOW-MEDIUM), and fundamentally cannot scale to superhuman tasks where humans can't evaluate outputs."

From Accident Risks table:
> "<EntityLink id="E93">Deceptive alignment</EntityLink> represents an existential risk that is very difficult to detect. 78% alignment faking rate observed in <EntityLink id="E22">Anthropic</EntityLink>'s 2024 study."
