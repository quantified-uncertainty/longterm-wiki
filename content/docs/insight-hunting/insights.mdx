...
sidebar:
  ...
  order: 10
contentFormat: index
summary: This is an infrastructure page that displays a filterable table of discrete insights extracted from other content, rated on four dimensions (surprising, important, actionable, neglected) calibrated for AI safety experts. The page itself contains no actual insights - just the interface and data structure documentation.
---
...
See the [Critical Insights framework](/wiki/E880) for the theoretical basis.
