...
| **Important** | Does this affect decisions or priorities? | "<EntityLink id="E259">RLHF</EntityLink> fundamentally cannot scale to superhuman tasks" |
| **Actionable** | Does this suggest concrete work? | "Linear probes achieve >99% AUROC detecting deception" |
| **Neglected** | Is this getting less attention than deserved? | "Only 2-3 teams globally work on <EntityLink id="E151">goal misgeneralization</EntityLink>" |
