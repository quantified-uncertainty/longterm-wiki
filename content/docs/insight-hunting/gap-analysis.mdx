...
sidebar:
  order: 1
summary: Documentation for an internal tool that prioritizes wiki pages for insight extraction using a weighted formula (importance × quality - existing insights). Provides scoring ranges and workflow for extracting insights from high-potential pages.
---
<LinkCard
