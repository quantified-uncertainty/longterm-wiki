...
export async function seedDivisions() {
  const yamlPath = path.resolve(
    __dirname,
    "../../../packages/factbase/data/fb-entities/coefficient-giving.yaml"
  );
  ...
  if (!programs) {
    throw new Error(
      "packages/factbase/data/fb-entities/coefficient-giving.yaml missing records.funding-programs section"
    );
  }
