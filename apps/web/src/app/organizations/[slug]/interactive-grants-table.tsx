...
} from "@/components/verification/RecordVerificationDot";
    ...
    arr.sort((a, b) => {
      ...
      switch (localSortCol) {
        ...
        case "notes":
          ...
          break;
        case "verified":
          cmp = (a.verification?.verdict ?? "").localeCompare(b.verification?.verdict ?? "");
          break;
      }
...
function CellContent({
  ...
  switch (column) {
    ...
    case "verified":
      return <RecordVerificationDot verification={grant.verification} />;
    case "notes":
      return grant.notes ? (
