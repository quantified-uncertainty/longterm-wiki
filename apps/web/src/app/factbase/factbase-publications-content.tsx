...
import { FBPublicationsTable } from "./factbase-publications-table";
import type { PublicationDataRow } from "./factbase-publications-table";

export function FBPublicationsContent() {
  let publications;
  try {
  ...
  return (
    <>
      ...
      <FBPublicationsTable publications={rows} />
    </>
  );
}
