  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        // Internal monitoring
        { label: "Claims Ingestion", href: internalHref("claims-ingestion-dashboard") },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Statements Architecture", href: internalHref("statements-system-architecture") },
        { label: "Extraction Quality Patterns", href: internalHref("claims-extraction-quality-patterns") },
        ...
        { label: "Data Quality Audit (Claims)", href: internalHref("claims-data-quality-audit") },
