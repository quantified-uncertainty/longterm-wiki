...
export const mdxComponents: Record<string, React.ComponentType<any>> = {
  ...
  FactBaseVerificationsContent: FactBaseSourceChecksContent, // backwards compat alias
  KbVerificationsContent: FactBaseSourceChecksContent, // backwards compat alias
