...
export interface RefMapEntry {
  ...
  /** Claim text from the citation sourcing system */
  claimText?: string;
  /** Accuracy verdict from the citation sourcing pipeline */
 ...
 * to rich reference data (claim sourcing + source metadata).
 *
 * The map is built in the wiki page server component from:
 * 1. Citation quotes from the wiki-server (claim sourcing data)
