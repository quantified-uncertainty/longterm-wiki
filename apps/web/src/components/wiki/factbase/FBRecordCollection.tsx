/**
 * FBRecordCollection -- Renders a factbase record collection as a styled table.
 *
 ...
 *
 * This is a richer alternative to FBRecordTable, with better defaults for
 * column selection (hides source/notes by default), compact row styling,
 * and built-in sorting by date fields.
 *
 * Usage in MDX:
 *   <FBRecordCollection entity="anthropic" collection="funding-rounds" />
 *   <FBRecordCollection entity="anthropic" collection="key-persons" showNotes />
 *   <FBRecordCollection entity="anthropic" collection="model-releases" columns={["name", "released", "safety_level"]} />
 */
...
interface FBRecordCollectionProps {
...
export function FBRecordCollection({
  entity,
  collection,
  title,
  columns,
                ...
                <TableRow key={item.key}>
                  ...
                  <TableCell className="w-8 px-1">
                    <SourcingDot
                      ...
                      size="md"
                      href={verdict?.verdict ? getSourcingHref(collection, recordId) : undefined}
                    />
                  </TableCell>
                </TableRow>
              );
