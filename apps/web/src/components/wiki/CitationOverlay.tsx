  ...
  return createPortal(
    <HoverCard.Root openDelay={200} closeDelay={150}>
      <HoverCard.Trigger asChild>
        <span
          className="citation-source-check-dot"
...
/** Enriches the footnote section at the bottom with source-check badges */
...
/**
 * CitationOverlay — renders source-check indicators on footnote references.
 *
 * This component uses DOM queries after hydration to find footnote ref links
 * (generated by remark-gfm) and attaches HoverCard popovers with source-check
