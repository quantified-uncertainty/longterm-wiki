  ...
  return createPortal(
    <HoverCard.Root openDelay={200} closeDelay={150}>
      <HoverCard.Trigger asChild>
        <span
          className="citation-sourcing-dot"
...
/** Enriches the footnote section at the bottom with sourcing badges */
...
/**
 * CitationOverlay — renders sourcing indicators on footnote references.
 *
 * This component uses DOM queries after hydration to find footnote ref links
 * (generated by remark-gfm) and attaches HoverCard popovers with sourcing
