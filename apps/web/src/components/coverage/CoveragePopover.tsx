...
/**
 * CoveragePopover — Wraps CoverageDots with a hover popover showing
 * score breakdown and signal details.
 *
 * Usage:
 *   <CoveragePopover score={3} signals={["Revenue", "Headcount", "Founded date"]} />
 *
 * For simple use without breakdown, the regular CoverageDots component
 * with its native title tooltip is sufficient.
 */
