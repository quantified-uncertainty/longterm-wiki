---
name: "source-command-review-ontology"
description: "Deep analysis of an entity's ontological structure — sub-entities, relationships, statement organization."
---

# source-command-review-ontology

Use this skill when the user asks to run the migrated source command `review-ontology`.
...
- FactBase facts for this entity (check `packages/factbase/data/fb-entities/`)
...
- **Is it a thing or a category?** "Codex" is a thing. "Anthropic's financial history" is a category of facts *about* Anthropic — not its own entity.
- **Granularity test:** Is this too fine-grained (individual model versions like "Codex Sonnet 4.6") or too coarse ("AI safety research")?
