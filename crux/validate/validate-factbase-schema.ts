 ...
 *
 * Usage:
 *   npx tsx crux/validate/validate-factbase-schema.ts            # errors only (gate mode)
 *   npx tsx crux/validate/validate-factbase-schema.ts --verbose   # include warnings + info
 */
