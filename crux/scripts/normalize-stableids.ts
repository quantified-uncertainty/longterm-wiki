...
if (generateSql) {
  // NOTE: This SQL template was used as a starting point only.
  // The actual committed migration (apps/wiki-server/scripts/0141-normalize-stableids.sql)
  // was hand-curated with the correct table names from schema.ts. Do not use this
  // output directly — refer to the committed SQL file instead.
  console.log(`\n-- ======== PG Migration SQL (TEMPLATE — see committed SQL for production version) ========`);
