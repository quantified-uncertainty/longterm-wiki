...
import { buildSourcingContext } from './sourcing-context.ts';
...
describe('buildSourcingContext', () => {
  ...
  it('queries both slug and stableId', async () => {
    ...
    await buildSourcingContext('anthropic');
