...
/**
 * Tests for source-check evidence deduplication and stale model detection.
 *
 * These test the logic from apps/wiki-server/src/routes/source-check/source-checks.ts
...
// Current checker model — must match the constant in source-checks.ts
