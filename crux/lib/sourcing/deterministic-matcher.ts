 ...
 * than LLM sourcing and costs nothing.
 *
 ...
 * @param manifest - Schema, column mapping, and sourcing config
 */
export function matchRecordAgainstSnapshot(
  ...
  const { matchFields, fuzzyFields = [], exactFields = [] } = manifest.sourcing;
