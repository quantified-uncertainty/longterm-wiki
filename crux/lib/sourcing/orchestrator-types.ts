/**
 * Shared types for the sourcing orchestrator.
...
export interface VerifyItem {
  ...
  /** Last sourcing timestamp (ISO string) if available */
...
export interface OrchestrationSummary {
   ...
   * (storeSourcingEvidence/storeAggregateVerdict) failed. The verdict
...
export interface SourcingedRecordInfo {
  recordType: string;
  recordId: string;
  verdict: string;
  checkedAt?: string;
