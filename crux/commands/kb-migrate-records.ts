 ...
 */
export function personnelId(ownerEntityId: string, collection: string, key: string): string {
 ...
 */
export function grantId(ownerEntityId: string, key: string): string {
 ...
 */
export function fundingRoundId(ownerEntityId: string, key: string): string {
 ...
 */
export function investmentId(ownerEntityId: string, key: string): string {
 ...
 */
export function equityPositionId(ownerEntityId: string, key: string): string {
 ...
 */
export function resolveEntityId(graph: Graph, entityId: string): string {
 ...
 */
export function serializeStakeValue(value: unknown): string | null {
  if (value == null) return null;
  if (Array.isArray(value)) return JSON.stringify(value);
  return String(value);
}

export function mapKeyPerson(
  record: RecordEntry,
  graph: Graph,
...
export function mapCareerHistory(
  record: RecordEntry,
  _graph: Graph,
  ownerEntityId: string,
): PersonnelRow {
