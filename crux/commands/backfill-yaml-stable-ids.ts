 ...
 *   1. Checks packages/factbase/data/fb-entities/{slug}.yaml for an existing stableId
...
KB thing files (packages/factbase/data/fb-entities/*.yaml) when available, otherwise
