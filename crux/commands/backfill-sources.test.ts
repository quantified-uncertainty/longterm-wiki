...
import { buildSearchQuery } from '../lib/backfill-sources/build-search-query.ts';
...
import { isPlaceholderUrl } from '../lib/backfill-sources/verify-source.ts';
import {
...
// ---------------------------------------------------------------------------
// isPlaceholderUrl — reject editor placeholders before paying for verification
// ---------------------------------------------------------------------------
