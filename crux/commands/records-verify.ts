...
// syncVerdictToThings and lookupThingId removed — Things table no longer
// stores verdicts. Verification lives in the unified verification_verdicts table.
...
// syncThingsCommand removed — Things table no longer stores verdicts.
// Verification lives in the unified verification_verdicts table. See discussion #2950.
...
export async function recordsVerifyCommand(
  ...
  // sync-things subcommand removed — Things table no longer stores verdicts
