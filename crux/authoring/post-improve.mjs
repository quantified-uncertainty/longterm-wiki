 ...
 *
 * Usage:
 *   node crux/authoring/post-improve.mjs              # Run all fixes
 *   node crux/authoring/post-improve.mjs --fix-only   # Only fix, don't re-grade
 *   node crux/authoring/post-improve.mjs --grade-only # Only re-grade
 */
...
async function runGrading(limit) {
  ...
  return new Promise((resolve) => {
    const proc = spawn('node', [
      'crux/authoring/grade-content.mjs',
