...
export function IMPROVE_PROMPT(args: ImprovePromptArgs): string {
  const { page, filePath, importPath, directions, analysis, research, objectivityContext, currentContent, entityLookup, claimsContext, gapAnalysisContext, kbContext, tier, templateContext, sourcingContext } = args;
...
The following claims about this entity have been flagged by automated sourcing against primary sources.
