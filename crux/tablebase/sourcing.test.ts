...
describe('buildSourcingPrompt', () => {
  ...
  it('includes human-readable names instead of stableIds in the prompt', () => {
    ...
    const prompt = buildSourcingPrompt('personnel', record, nameMap);
  ...
  it('includes the table name in the prompt', () => {
    const prompt = buildSourcingPrompt('personnel', { id: 'r1' }, new Map());
  ...
  it('includes the source URL in the prompt', () => {
    ...
    const prompt = buildSourcingPrompt('personnel', record, new Map());
  ...
  it('handles records with no entity reference fields', () => {
    ...
    const prompt = buildSourcingPrompt('funding-rounds', record, nameMap);
