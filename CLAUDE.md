...
| Writing/debugging a Playwright spec that visits an `/internal/*` route | `docs/agent-rules/e2e-locator-scoping.md` |
| Running a `/maintain` sweep, or investigating a failing audit item | `docs/agent-rules/maintenance-sweep-discipline.md` |
