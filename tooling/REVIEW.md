...
Review of the `tooling/` directory structure, the crux CLI architecture, and
...
The crux CLI (`tooling/crux.mjs`) is a domain-based CLI with 8 domains and ~98
...
export const PROJECT_ROOT = join(__dirname, '..', '..');  // tooling/../..
```
