 ...
 *
 * Usage:
 *   node tooling/crux.mjs fix imports              # Preview changes (dry run)
 *   node tooling/crux.mjs fix imports --apply      # Apply changes
 *   node tooling/crux.mjs fix imports --verbose    # Show detailed info
 *   node tooling/crux.mjs fix imports --file path  # Fix single file
 */
