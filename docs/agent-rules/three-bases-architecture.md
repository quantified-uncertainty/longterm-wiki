...
1. **Does it have numeric fields to aggregate, many-to-many relationships, or its own directory page?** → **PG-primary TableBase** table (grants, investments, benchmarks pattern). See `docs/agent-rules/tablebase-sync-factory.md`.
...
- Entity-sync plumbing: `docs/agent-rules/tablebase-sync-factory.md`
- Source-check/verdicts: `docs/agent-rules/source-check-system.md`
