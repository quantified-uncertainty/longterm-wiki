...
3. **Create MDX stub**: `content/docs/internal/<slug>-dashboard.mdx`
   ...
   subcategory: dashboards          # or claims-citations
...
**Dashboards:** Pages (E899), Entities (E908), Page Changes (E909), Update Schedule (E900), Suggested Pages (E910), Improve Runs (E911), Agent Sessions (E912), Session Insights (E913), Auto-Update Runs (E914), Auto-Update News (E915), Groundskeeper Runs (E926), System Health (E927), Active Agents (E925).
