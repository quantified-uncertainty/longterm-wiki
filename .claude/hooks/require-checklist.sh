...
echo "BLOCKED: No agent checklist found. Run 'pnpm crux sys agent-checklist init --issue=N' (or 'pnpm crux sys agent-checklist init \"task description\"') before editing code. This is mandatory — see .claude/rules/agent-session-workflow.md" >&2
exit 2
